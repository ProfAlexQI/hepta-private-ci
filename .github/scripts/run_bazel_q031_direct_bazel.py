...
def prepare_bazelisk_environment(env: MutableMapping[str, str]) -> None:
    """Compose Q0.29 while retaining its complete executable-control denylist."""
...
def validate_keyless_windows_gnullvm_command(
    ...
    *,
    ...
    # Re-run the exact Q0.28/Q0.27 command contract after direct executable
    # resolution, then re-use Q0.29's corrected job and path validators.
