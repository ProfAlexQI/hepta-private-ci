...
const thresholds = {
  ...
  interactive_group_count: 113,
  category_counts: { control: 235, input: 50, "menu-item": 78, "micro-surface": 94, panel: 30 },
  state_counts: {
    default: 52,
  ...
  per_crop: {
    control: {
      ...
      mean_saturation_max: 0.112,
      dark_ratio_max: 0.0368,
      edge_luma_p95_min: 246,
      edge_highlight_ratio_min: 0.32,
      cyan_edge_ratio_min: 0.4,
      texture_delta_min: 2.25,
      overbright_ratio_max: 0.48,
      finish_score_min: 0.95,
    },
    input: {
      glass_white_ratio_min: 0.905,
      mean_saturation_max: 0.1,
      dark_ratio_max: 0.055,
      edge_luma_p95_min: 252,
      edge_highlight_ratio_min: 0.69,
      texture_delta_min: 1.8,
      overbright_ratio_max: 0.061,
    },
    "menu-item": {
      glass_white_ratio_min: 0.91,
      mean_saturation_max: 0.09,
      dark_ratio_max: 0.065,
      edge_luma_p95_min: 254.2,
      edge_highlight_ratio_min: 0.82,
      cyan_edge_ratio_min: 0.31,
      texture_delta_min: 3.4,
      overbright_ratio_max: 0.46,
      edge_center_luma_delta_min: 5.8,
      finish_score_min: 1.075,
    },
    "micro-surface": {
      glass_white_ratio_min: 0.86,
      mean_saturation_max: 0.118,
      dark_ratio_max: 0.125,
      edge_luma_p95_min: 251,
      edge_highlight_ratio_min: 0.58,
      texture_delta_min: 6.85,
      overbright_ratio_max: 0.215,
      finish_score_min: 0.93,
    },
    panel: {
      glass_white_ratio_min: 0.925,
      mean_saturation_max: 0.09,
      dark_ratio_max: 0.055,
      edge_luma_p95_min: 249.4,
      edge_highlight_ratio_min: 0.72,
      texture_delta_min: 6.8,
      overbright_ratio_max: 0.22,
      finish_score_min: 1.085,
    },
  },
  group_spread: {
    control: {
      cyan_edge_ratio_spread: 0.42,
      overbright_ratio_spread: 0.16,
      edge_highlight_ratio_spread: 0.52,
      mean_saturation_spread: 0.022,
      dark_ratio_spread: 0.0031,
    },
    "menu-item": {
      cyan_edge_ratio_spread: 0.175,
      overbright_ratio_spread: 0.1,
      edge_highlight_ratio_spread: 0.15,
      mean_saturation_spread: 0.028,
      dark_ratio_spread: 0.04,
    },
  },
};
