...
FILES = {
    ...
    "journal": ROOT / "codex-rs/hepta-memory/src/intelligence_mutation_journal_v2.rs",
    "digest": ROOT
    / "codex-rs/hepta-memory/src/intelligence_mutation_journal/digest.rs",
    "schema": ROOT
    / "codex-rs/hepta-memory/src/intelligence_mutation_journal/schema.rs",
    "replay": ROOT
    / "codex-rs/hepta-memory/src/intelligence_mutation_journal/replay_v2.rs",
    "tests": ROOT
    / "codex-rs/hepta-memory/src/intelligence_mutation_journal/tests_v2.rs",
...
def main() -> int:
    ...
    checks["migration.not_main_lineage"] = "migrations/0012" not in migration
    ...
    checks["framing.only_canonical_entry_registered"] = contains_all(
        ...
        [
            ...
            '#[path = "intelligence_mutation_journal_v2.rs"]',
            "mod intelligence_mutation_journal;",
        ],
    ) and '#[path = "intelligence_mutation_journal.rs"]' not in framing
