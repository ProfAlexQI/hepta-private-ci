...
SOURCE_MODULE="codex-rs/hepta-runtime/src/wg_sg_live_attach_tc_readback_ai_np_final_closeout.rs"

source_report="$("$SOURCE_REPORT_SCRIPT")"

final_closeout_readback_module_present="$(
  bool_for path_exists codex-rs/hepta-runtime/src/wg_sg_live_attach_tc_readback_ai_np_final_closeout_readback.rs
)"
final_closeout_gate_present="$(
  bool_for path_exists scripts/hepta-systems-work-graph-live-attachment-terminal-closeout-readback-audit-index-non-persistence-final-closeout-gate.sh
)"
...
final_closeout_ready_present="$(
  bool_for source_has "ready_for_terminal_closeout_readback_audit_index_final_closeout_readback: true" "$SOURCE_MODULE"
)"
...
jq -n \
  ...
  | {
      ...
      ready_for_terminal_closeout_readback_audit_index_final_closeout_readback_audit_index: true,
