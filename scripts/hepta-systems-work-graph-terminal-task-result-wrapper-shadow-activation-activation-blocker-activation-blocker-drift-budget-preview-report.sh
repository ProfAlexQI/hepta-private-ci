...
activation_blocker_activation_blocker_drift_budget_rust_module_present="$(
...
activation_blocker_activation_blocker_drift_budget_report_script_present="$(
  bool_for path_exists scripts/hepta-systems-work-graph-terminal-task-result-wrapper-shadow-activation-activation-blocker-activation-blocker-drift-budget-preview-report.sh
)"
activation_blocker_activation_blocker_drift_budget_gate_script_present="$(
...
activation_blocker_activation_blocker_readback_rust_module_present="$(
...
activation_blocker_activation_blocker_readback_gate_script_present="$(
...
jq -n \
  --argjson activation_blocker_activation_blocker_drift_budget_rust_module_present "$activation_blocker_activation_blocker_drift_budget_rust_module_present" \
  --argjson activation_blocker_activation_blocker_drift_budget_report_script_present "$activation_blocker_activation_blocker_drift_budget_report_script_present" \
  --argjson activation_blocker_activation_blocker_drift_budget_gate_script_present "$activation_blocker_activation_blocker_drift_budget_gate_script_present" \
  --argjson activation_blocker_activation_blocker_readback_rust_module_present "$activation_blocker_activation_blocker_readback_rust_module_present" \
  --argjson activation_blocker_activation_blocker_readback_gate_script_present "$activation_blocker_activation_blocker_readback_gate_script_present" \
  '
  def prior_gates: [
  ...
  [
    budget("shadow_activation_blocker_activation_blocker_surface_state_drift_zero_tolerance_budget"; "detect_shadow_activation_blocker_activation_blocker_surface_state_drift"; ["activationSurfaceId", "activationState", "blockedByDefault"]; "shadow_activation_blocker_activation_blocker_surface_state_drift_operator_summary"; ["all_shadow_activation_blocker_activation_blocker_drift_budgets_zero_tolerance", "shadow_activation_blocker_activation_blocker_operator_summaries_reviewed"]),
    budget("shadow_activation_blocker_activation_blocker_binding_drift_zero_tolerance_budget"; "detect_shadow_activation_blocker_activation_blocker_binding_drift"; ["activationSurfaceId", "requiredBlockerIds", "actualBlockerIds"]; "shadow_activation_blocker_activation_blocker_binding_drift_operator_summary"; ["all_shadow_activation_blocker_activation_blocker_drift_budgets_zero_tolerance", "shadow_activation_blocker_activation_blocker_operator_summaries_reviewed"]),
    budget("shadow_activation_blocker_activation_enablement_satisfaction_drift_zero_tolerance_budget"; "detect_shadow_activation_blocker_activation_enablement_satisfaction_drift"; ["enablementId", "currentlySatisfied", "requiredEvidenceFields"]; "shadow_activation_blocker_activation_enablement_satisfaction_drift_operator_summary"; ["all_shadow_activation_blocker_activation_blocker_drift_budgets_zero_tolerance", "shadow_activation_blocker_activation_blocker_operator_summaries_reviewed"]),
  ...
  | [
    precondition("all_shadow_activation_blocker_activation_blocker_drift_budgets_zero_tolerance"; $budget_ids; $summary_ids; ["maxAllowedMismatches", "maxAllowedUnreviewedFindings"]),
    ...
    precondition("shadow_activation_blocker_activation_blocker_readback_remains_disabled_until_budget_review"; $budget_ids; []; ["readyForShadowActivationBlockerActivationBlockerReadbackExecution", "readyForActivation", "readyForStoreEnablement"])
  ] as $activation_preconditions
  | [
    blocker("shadow_activation_blocker_activation_blocker_drift_budget_not_executed"; "critical"; "shadow activation blocker activation-blocker drift detectors have zero-tolerance budgets but no readback execution has run"),
  ...
  | {
      ...
      runtime: "hepta",
      status: "ready",
      gate: "hepta_work_graph_terminal_task_result_wrapper_shadow_activation_activation_blocker_activation_blocker_drift_budget_preview_gate",
      schema_version: "work_graph_terminal_task_result_wrapper_shadow_activation_activation_blocker_activation_blocker_drift_budget_preview_v1",
      preview_mode: "read_only_terminal_task_result_wrapper_shadow_activation_activation_blocker_activation_blocker_drift_budget_preview_no_execution",
      ...
      recommended_next_gate: "hepta_work_graph_terminal_task_result_wrapper_shadow_activation_activation_blocker_activation_blocker_promotion_precondition_preview_gate",
      ...
      source_probes: {
        terminal_task_result_wrapper_shadow_activation_activation_blocker_activation_blocker_drift_budget: {
          rust_module_present: $activation_blocker_activation_blocker_drift_budget_rust_module_present,
          report_script_present: $activation_blocker_activation_blocker_drift_budget_report_script_present,
          gate_script_present: $activation_blocker_activation_blocker_drift_budget_gate_script_present
        },
        terminal_task_result_wrapper_shadow_activation_activation_blocker_activation_blocker_readback: {
          rust_module_present: $activation_blocker_activation_blocker_readback_rust_module_present,
          gate_script_present: $activation_blocker_activation_blocker_readback_gate_script_present
        }
      },
      side_effects: {
