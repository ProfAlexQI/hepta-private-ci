...
const thresholds = {
  ...
  v39_interactive_crop_count: 313,
  v39_interactive_group_count: 113,
  ...
  per_crop: {
    control: {
      ...
      edge_highlight_ratio_min: 0.18,
      cyan_edge_ratio_min: 0.38,
      texture_delta_min: 2.15,
      overbright_ratio_max: 0.62,
      finish_score_min: 0.93,
    },
    input: {
      glass_white_ratio_min: 0.902,
      mean_saturation_max: 0.105,
      dark_ratio_max: 0.058,
      edge_luma_p95_min: 251.8,
      edge_highlight_ratio_min: 0.66,
      texture_delta_min: 1.65,
      overbright_ratio_max: 0.07,
    },
    "menu-item": {
      glass_white_ratio_min: 0.902,
      ...
      cyan_edge_ratio_min: 0.266,
      texture_delta_min: 3.25,
      overbright_ratio_max: 0.5,
      edge_center_luma_delta_min: 1.5,
    },
    "micro-surface": {
      glass_white_ratio_min: 0.836,
      mean_saturation_max: 0.13,
      dark_ratio_max: 0.145,
      edge_luma_p95_min: 250.2,
      edge_highlight_ratio_min: 0.44,
      texture_delta_min: 6.6,
      overbright_ratio_max: 0.23,
    },
    panel: {
      glass_white_ratio_min: 0.919,
      mean_saturation_max: 0.095,
      dark_ratio_max: 0.058,
      edge_luma_p95_min: 249,
      edge_highlight_ratio_min: 0.62,
      texture_delta_min: 6.7,
      overbright_ratio_max: 0.24,
    },
  },
  group_spread: {
    control: {
      edge_highlight_ratio_spread_max: 0.62,
      overbright_ratio_spread_max: 0.45,
      cyan_edge_ratio_spread_max: 0.46,
      mean_saturation_spread_max: 0.027,
      dark_ratio_spread_max: 0.004,
    },
    "menu-item": {
      cyan_edge_ratio_spread_max: 0.19,
      overbright_ratio_spread_max: 0.13,
