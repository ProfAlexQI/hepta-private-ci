...
PARTS = [
    ROOT / "scripts/.hnmf-materializer.bytepart0",
    ROOT / "scripts/.hnmf-materializer.bytepart1",
    ROOT / "scripts/.hnmf-materializer.bytepart2",
    ROOT / "scripts/.hnmf-materializer.bytepart3",
]
compressed = b"".join(
