...
report_script="$repo_root/scripts/hepta-context-memory-temporal-graph-shadow-traversal-quality-report.sh"
gate_script="$repo_root/scripts/hepta-context-memory-temporal-graph-shadow-traversal-quality-gate.sh"
...
assert_file_contains "$release_manifest" "scripts/hepta-context-memory-temporal-graph-shadow-traversal-quality-report.sh" \
  "temporal graph shadow traversal quality report release manifest"
assert_file_contains "$release_manifest" "scripts/hepta-context-memory-temporal-graph-shadow-traversal-quality-gate.sh" \
