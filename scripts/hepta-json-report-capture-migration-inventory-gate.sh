...
MAX_LOCAL_CAPTURE_DEFINITION_COUNT="${HEPTA_JSON_CAPTURE_MAX_LOCAL_CAPTURE_DEFINITION_COUNT:-30}"
MAX_LOCAL_EXTRACT_DEFINITION_COUNT="${HEPTA_JSON_CAPTURE_MAX_LOCAL_EXTRACT_DEFINITION_COUNT:-5}"
