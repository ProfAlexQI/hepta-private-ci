...
MAX_LOCAL_CAPTURE_DEFINITION_COUNT="${HEPTA_JSON_CAPTURE_MAX_LOCAL_CAPTURE_DEFINITION_COUNT:-35}"
MAX_LOCAL_EXTRACT_DEFINITION_COUNT="${HEPTA_JSON_CAPTURE_MAX_LOCAL_EXTRACT_DEFINITION_COUNT:-10}"
