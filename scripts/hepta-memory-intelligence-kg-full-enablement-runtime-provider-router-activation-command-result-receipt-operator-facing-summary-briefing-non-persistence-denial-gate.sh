...
EXPORT_QUERY_OBSERVABILITY_JSON="$(
  HEPTA_LIVE_URL="$BASE_URL" \
    ...
    capture_json_report "hepta-memory-intelligence-kg-full-enablement-runtime-provider-router-activation-command-result-receipt-export-query-observability-denial-gate" \
...
operator_summary_briefing_fixtures_json="$(
  jq -n '
    ...
    [
      operator_summary_briefing_fixture("provider-router-activation-command-result-receipt-operator-summary-missing-source-export-query-observability"; "blocked_noop"; "source_export_query_observability_report_required"; {source_export_query_observability_present:false, source_export_query_observability_ready:false, operator_summary_requested:true}),
      operator_summary_briefing_fixture("provider-router-activation-command-result-receipt-operator-summary-request"; "blocked_summary_noop"; "operator_summary_request_shape_denied"; {operator_summary_requested:true}),
      operator_summary_briefing_fixture("provider-router-activation-command-result-receipt-operator-briefing-request"; "blocked_briefing_noop"; "operator_briefing_request_shape_denied"; {operator_briefing_requested:true}),
      operator_summary_briefing_fixture("provider-router-activation-command-result-receipt-operator-summary-materialization-request"; "blocked_summary_noop"; "operator_summary_materialization_denied"; {operator_summary_requested:true, operator_summary_materialization_requested:true}),
      operator_summary_briefing_fixture("provider-router-activation-command-result-receipt-operator-briefing-materialization-request"; "blocked_briefing_noop"; "operator_briefing_materialization_denied"; {operator_briefing_requested:true, operator_briefing_materialization_requested:true}),
      operator_summary_briefing_fixture("provider-router-activation-command-result-receipt-operator-summary-persistence-filesystem-request"; "blocked_summary_noop"; "operator_summary_persistence_filesystem_write_denied"; {operator_summary_requested:true, operator_summary_persistence_requested:true, operator_summary_filesystem_write_requested:true}),
      operator_summary_briefing_fixture("provider-router-activation-command-result-receipt-operator-briefing-persistence-filesystem-request"; "blocked_briefing_noop"; "operator_briefing_persistence_filesystem_write_denied"; {operator_briefing_requested:true, operator_briefing_persistence_requested:true, operator_briefing_filesystem_write_requested:true}),
      operator_summary_briefing_fixture("provider-router-activation-command-result-receipt-operator-summary-briefing-channel-delivery-request"; "blocked_delivery_noop"; "operator_summary_briefing_channel_delivery_denied"; {operator_summary_requested:true, operator_briefing_requested:true, channel_delivery_requested:true, telegram_send_requested:true}),
      operator_summary_briefing_fixture("provider-router-activation-command-result-receipt-operator-summary-briefing-activation-memory-kg-provider"; "blocked_summary_noop"; "activation_memory_kg_rollback_secret_provider_summary_briefing_denied"; {operator_summary_requested:true, operator_briefing_requested:true, activation_from_summary_briefing_requested:true, memory_store_summary_requested:true, live_kg_summary_requested:true, rollback_summary_requested:true, secret_material_summary_requested:true, provider_prompt_summary_requested:true}),
      operator_summary_briefing_fixture("provider-router-activation-command-result-receipt-operator-summary-briefing-external-public-install"; "blocked_delivery_noop"; "external_public_install_restart_active_binary_summary_briefing_denied"; {operator_summary_requested:true, operator_briefing_requested:true, external_send_summary_requested:true, public_claim_summary_requested:true, release_artifact_summary_requested:true, install_summary_requested:true, service_restart_summary_requested:true, active_binary_summary_requested:true})
    ]
  '
)"
...
operator_summary_briefing_contract_hash_sha256="$(
  sha256_text "hepta-full-enablement-runtime-provider-router-activation-command-result-receipt-operator-facing-summary-briefing-non-persistence-denial:$export_query_observability_report_sha256:$operator_summary_briefing_fixtures_sha256:$MIN_LONG_SOAK_SAMPLES"
)"
operator_summary_briefing_policy_hash_sha256="$(
  sha256_text "runtime-provider-router-activation-command-result-receipt-operator-facing-summary-briefing-non-persistence:no-summary:no-briefing:no-delivery:no-receipt:no-runtime:no-provider:no-model:no-secret-read"
)"
...
jq -n -e \
  ...
  '
    ...
    and $source.gate == "hepta_memory_intelligence_kg_full_enablement_runtime_provider_router_activation_command_result_receipt_export_query_observability_denial_gate"
    and $source.activation_command_result_receipt_export_query_observability_schema_version == "memory_intelligence_kg_full_enablement_runtime_provider_router_activation_command_result_receipt_export_query_observability_denial_v1"
    and $source.runtime_provider_router_activation_command_result_receipt_export_query_observability_denial_ready == true
    and $source.runtime_provider_router_activation_command_result_receipt_export_query_observability_denial_status == "blocked"
...
report="$(jq -n \
  ...
  --arg gate "hepta_memory_intelligence_kg_full_enablement_runtime_provider_router_activation_command_result_receipt_operator_facing_summary_briefing_non_persistence_denial_gate" \
  ...
  '{
    ...
    source_activation_command_result_receipt_export_query_observability_status:$source.runtime_provider_router_activation_command_result_receipt_export_query_observability_denial_status,
    ...
    runtime_provider_router_activation_command_result_receipt_export_query_observability_denial_ready:$source.runtime_provider_router_activation_command_result_receipt_export_query_observability_denial_ready,
...
jq -e '
  ...
  and .activation_command_result_receipt_operator_facing_summary_briefing_schema_version == "memory_intelligence_kg_full_enablement_runtime_provider_router_activation_command_result_receipt_operator_facing_summary_briefing_non_persistence_denial_v1"
...
printf '%s\n' "$report"
echo "Hepta memory/intelligence/KG full enablement runtime provider-router activation command result receipt operator-facing summary/briefing non-persistence denial gate passed"
