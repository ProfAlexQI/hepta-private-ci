...
MIGRATION_FINAL_INDEX_REPORT="$ROOT/scripts/hepta-systems-public-ga-readiness-preflight-non-live-adapter-migration-final-index-report.sh"
...
jq -n \
  ...
  --arg gate "scripts/hepta-systems-public-ga-readiness-non-live-migration-final-index-public-ga-readiness-attachment-gate.sh" \
    ...
    and ($side_effects | to_entries | all(.value == false))) as $attachment_ready |
  {
    ...
    source_files:{
      public_ga_readiness_preflight_non_live_adapter_migration_final_index_report:"scripts/hepta-systems-public-ga-readiness-preflight-non-live-adapter-migration-final-index-report.sh",
