...
REPORT_SCRIPT="$ROOT/scripts/hepta-systems-work-graph-agent-jobs-task-board-feature-flag-operator-review-request-precondition-terminal-no-request-closeout-readback-report.sh"
...
jq -e '
  ...
  and .runtime == "hepta"
  and .status == "ready"
  and .gate == "hepta_work_graph_agent_jobs_task_board_feature_flag_operator_review_request_precondition_terminal_no_request_closeout_readback_gate"
  and .schema_version == "work_graph_agent_jobs_task_board_feature_flag_operator_review_request_precondition_terminal_no_request_closeout_readback_v1"
  and .preview_mode == "operator_review_request_precondition_terminal_no_request_closeout_readback_only"
  and .source_terminal_closeout_gate == "hepta_work_graph_agent_jobs_task_board_feature_flag_operator_review_request_precondition_terminal_no_request_closeout_gate"
  and .source_closeout_entry_count == 7
  and .source_closeout_blocker_count == 21
  and .source_required_prior_gate_count == 21
  and .source_terminal_closeout_preconditions_complete == true
  and .source_terminal_closeout_no_request_confirmed == true
  and .source_terminal_closeout_no_authorization_confirmed == true
  and .source_terminal_closeout_ready == true
  and .readback_entry_count == 5
  and .readback_blocker_count == 22
  and .required_prior_gate_count == 22
  and .readback_scope.readback_mode == "operator_review_request_precondition_terminal_no_request_closeout_readback_only"
  ...
  and .readback_scope_terminal_no_request_complete == true
  ...
  and .readback_entries_terminal_no_request_complete == true
  ...
  and .terminal_no_request_closeout_readback_preconditions_complete == true
  ...
  and .recommended_next_gate == "hepta_work_graph_agent_jobs_task_board_feature_flag_operator_review_request_precondition_terminal_no_request_closeout_readback_audit_index_gate"
  ...
  and .ready_for_terminal_no_request_closeout_readback_audit_index == true
  ...
  and .source_probes.terminal_closeout_unrequested_present == true
  and .source_probes.terminal_closeout_ready_present == true
  and .source_probes.terminal_closeout_unpersisted_present == true
  and .source_probes.terminal_closeout_report_gate == "hepta_work_graph_agent_jobs_task_board_feature_flag_operator_review_request_precondition_terminal_no_request_closeout_gate"
  and .source_probes.terminal_closeout_preconditions_complete == true
  and .source_probes.terminal_closeout_ready_for_readback == true
  and .source_probes.terminal_closeout_side_effects_all_false == true
  and (.side_effects | to_entries | all(.value == false))
' >/dev/null <<<"$report"

cargo test --manifest-path "$ROOT/codex-rs/Cargo.toml" -p hepta-runtime \
  work_graph_agent_jobs_task_board_feature_flag_operator_review_request_precondition_terminal_no_request_closeout_readback --lib

echo "Hepta WorkGraph agent_jobs + task_board feature-flag operator review request precondition terminal no-request closeout readback gate passed"
