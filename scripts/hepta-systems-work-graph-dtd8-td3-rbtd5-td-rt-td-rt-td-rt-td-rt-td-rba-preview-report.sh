...
prior_report_script="scripts/hepta-systems-work-graph-dtd8-td3-rbtd5-td-rt-td-rt-td-rt-td-rt-td-rbr-preview-report.sh"
prior_gate_script="scripts/hepta-systems-work-graph-dtd8-td3-rbtd5-td-rt-td-rt-td-rt-td-rt-td-rbr-preview-gate.sh"
...
report_script="scripts/hepta-systems-work-graph-dtd8-td3-rbtd5-td-rt-td-rt-td-rt-td-rt-td-rba-preview-report.sh"
gate_script="scripts/hepta-systems-work-graph-dtd8-td3-rbtd5-td-rt-td-rt-td-rt-td-rt-td-rba-preview-gate.sh"
...
jq -n \
  ...
  }];
  {
    ...
    acknowledgement_contracts: item("deep_td8_td3_rbackack_td14_rcptret_rbackack_contract"; 6),
    non_acceptance_reasons: item("deep_td8_td3_rbackack_td14_rcptret_rbackack_non_acceptance"; 7),
    recording_denials: item("deep_td8_td3_rbackack_td14_rcptret_rbackack_recording_denial"; 7),
    expiry_replay_guards: item("deep_td8_td3_rbackack_td14_rcptret_rbackack_expiry_replay_guard"; 5),
    local_views: item("deep_td8_td3_rbackack_td14_rcptret_rbackack_local_view"; 4),
    invariants: item("deep_td8_td3_rbackack_td14_rcptret_rbackack_invariant"; 6),
    ...
    source_probes: {
      deep_td8_td3_rbackack_td14_receipt_retention_readback_ack: {
      ...
      prior_deep_td8_td3_rbackack_td14_receipt_retention_readback_receipt: {
