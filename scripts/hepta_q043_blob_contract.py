"""Immutable path identities for the Q0.43 parallel-Q0.42 composition."""
...
BLOBS: Final = {
    ...
    "scripts/hepta_q042_blob_contract.py": (
        "3b15e949305f9edade977a368db25c3c78932a8a"
    ),
    "scripts/verify_windows_gnullvm_q042_contract.py": (
        "ead0eeb79959a7afc7973ea58872e7d4461758b7"
    ),
