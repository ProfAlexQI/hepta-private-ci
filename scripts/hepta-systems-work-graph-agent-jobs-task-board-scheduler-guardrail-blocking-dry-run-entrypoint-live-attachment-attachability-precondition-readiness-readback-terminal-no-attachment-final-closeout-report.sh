...
jq -n \
  ...
  | ($source.source_audit_index_no_persistence_confirmed == true
      ...
      and $source.attachability_readback_visible == true
      and $source.attachability_readback_recorded == false
      and $source.attachability_readback_persisted == false
      and $source.attachability_readback_authoritative == false
      and $source.attachability_readback_accepted == false
      ...
      and $source.attachability_readiness_recording_allowed == false
      and $source.attachability_readiness_persistence_allowed == false
  ...
  | ($source.ready_for_terminal_no_attachment_final_closeout == true
  ...
  | ($source.gate == "hepta_work_graph_agent_jobs_task_board_scheduler_guardrail_blocking_dry_run_entrypoint_live_attachment_attachability_precondition_readiness_readback_audit_index_non_persistence_readback_gate"
      ...
      and $source.readback_blocker_count == 59
      and $source.required_prior_gate_count == 24
  ...
  | ($source_non_persistence_readback_ready
      and $source.ready_for_terminal_no_attachment_final_closeout == true) as $source_non_persistence_readback_ready_for_terminal_closeout
  | {
  ...
  | (($final_closeout_blockers | length) == 62
  ...
  | {
      ...
      ready_for_terminal_no_attachment_final_closeout_readback: $terminal_no_attachment_final_closeout_preconditions_complete,
      ...
      source_readbacks: {
        ...
        non_persistence_readback_ready_for_terminal_closeout: $source.ready_for_terminal_no_attachment_final_closeout,
