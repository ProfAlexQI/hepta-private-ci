...
prior_report_script="scripts/hepta-systems-work-graph-dtd8-retack-rbackacktd-rbackacktd-rcptret-rbackack-td-rcptret-rbackack-replay-preview-report.sh"
prior_gate_script="scripts/hepta-systems-work-graph-dtd8-retack-rbackacktd-rbackacktd-rcptret-rbackack-td-rcptret-rbackack-replay-preview-gate.sh"
...
rust_module="codex-rs/hepta-runtime/src/wg_deep_td8_ret_ack_td_rback_ack_td_receipt_retention_readback_ack_td_receipt_retention_readback_ack_td_receipt_retention_readback_ack_td_receipt_retention_readback_ack_td_preview.rs"
report_script="scripts/hepta-systems-work-graph-dtd8-rbackacktd-rcptret-rbackack-td2-preview-report.sh"
gate_script="scripts/hepta-systems-work-graph-dtd8-rbackacktd-rcptret-rbackack-td2-preview-gate.sh"
...
jq -n \
  ...
  '
  def source_ids: [range(0; 6) | "deep_td8_ret_ack_td_rback_ack_td_receipt_retention_readback_ack_td_receipt_retention_readback_ack_td_receipt_retention_readback_ack_td_receipt_retention_readback_ack_\(.)"];
  ...
  }];
  {
    ...
    terminal_decision_surfaces: item("deep_td8_latest_terminal_decision_surface"; 6),
    non_promotion_denials: item("deep_td8_latest_terminal_decision_non_promotion_denial"; 8),
    authority_guards: item("deep_td8_latest_terminal_decision_authority_guard"; 6),
    release_delivery_guards: item("deep_td8_latest_terminal_decision_release_delivery_guard"; 6),
    local_views: item("deep_td8_latest_terminal_decision_local_view"; 4),
    invariants: item("deep_td8_latest_terminal_decision_invariant"; 6),
    ...
    source_probes: {
      ...
      prior_receipt_retention_readback_ack_replay: {
