...
SOURCE_REPORT="$ROOT/scripts/hepta-systems-public-ga-operator-packet-final-index-operator-approval-non-acceptance-report.sh"

[[ -x "$SOURCE_REPORT" ]] || {
  echo "missing executable Public GA operator approval non-acceptance attachment report: $SOURCE_REPORT" >&2
  exit 1
}

if ! command -v jq >/dev/null 2>&1; then
  echo "jq is required to build the Public GA operator approval non-acceptance readback report" >&2
  exit 1
fi
...
jq -e '
  ...
  and .public_ga_operator_approval_non_acceptance_attachment_ready == true
  and .public_ga_operator_approval_non_acceptance_attachment_blocked == true
...
jq -n \
  ...
  '{
    runtime: "hepta",
    surface: "public_ga_operator_approval_non_acceptance_readback",
    plugin_id: "hepta-system@hepta-local",
    status: "ready_blocked",
    source_public_ga_operator_approval_non_acceptance_attachment_surface: $source.surface,
    source_public_ga_operator_approval_non_acceptance_attachment_ready: $source.public_ga_operator_approval_non_acceptance_attachment_ready,
    source_public_ga_operator_approval_non_acceptance_attachment_blocked: $source.public_ga_operator_approval_non_acceptance_attachment_blocked,
    ...
    public_ga_operator_approval_non_acceptance_readback_ready: true,
    public_ga_operator_approval_non_acceptance_readback_blocked: true,
    public_ga_operator_approval_non_acceptance_attachment_attached: true,
    readback_mode: "static_operator_approval_non_acceptance_snapshot_only",
    readback_check_count: 26,
    public_ga_operator_packet_non_send_readback_final_index_attached: $source.public_ga_operator_packet_non_send_readback_final_index_attached,
    operator_approval_non_acceptance_gate_present: $source.operator_approval_non_acceptance_gate_present,
    operator_approval_non_acceptance_doc_present: $source.operator_approval_non_acceptance_doc_present,
    operator_approval_non_acceptance_gate_invoked: false,
    operator_approval_gap_ledger_summary_gate_invoked: false,
    long_soak_required_by_source_non_acceptance_gate: $source.long_soak_required_by_source_non_acceptance_gate,
    ...
    readback_blocker_count: 20,
    public_ga_claim_allowed: false,
    public_ga_claimed: false,
    public_release_published: false,
    rollback_execution_allowed: false,
    next_migration_step: "derive_public_ga_operator_approval_non_acceptance_final_index_without_packet_send",
    local_gate: "scripts/hepta-systems-public-ga-operator-approval-non-acceptance-readback-gate.sh",
    architecture_note: "docs/architecture/HEPTA_SYSTEMS_PUBLIC_GA_OPERATOR_APPROVAL_NON_ACCEPTANCE_READBACK_2026-06-21.md",
    source_files: {
      public_ga_operator_approval_non_acceptance_attachment_report: "scripts/hepta-systems-public-ga-operator-packet-final-index-operator-approval-non-acceptance-report.sh"
    },
