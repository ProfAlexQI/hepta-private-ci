...
ATTACHMENT_REPORT="$ROOT/scripts/hepta-systems-terminal-release-artifact-final-index-terminal-public-distribution-non-publication-lock-report.sh"
...
fail() {
  printf 'hepta-systems-terminal-public-distribution-non-publication-lock-attachment-readback-report: FAIL: %s\n' "$1" >&2
  exit 1
}

[[ -x "$ATTACHMENT_REPORT" ]] || fail "missing executable terminal public distribution non-publication lock attachment report: $ATTACHMENT_REPORT"
[[ -f "$DOC" ]] || fail "missing terminal public distribution non-publication lock attachment readback architecture note: $DOC"

if ! command -v jq >/dev/null 2>&1; then
  fail "jq is required to render the terminal public distribution non-publication lock attachment readback report"
fi

jq -n \
  --arg gate "scripts/hepta-systems-terminal-public-distribution-non-publication-lock-attachment-readback-gate.sh" \
  --arg doc "docs/architecture/HEPTA_SYSTEMS_TERMINAL_PUBLIC_DISTRIBUTION_NON_PUBLICATION_LOCK_ATTACHMENT_READBACK_2026-06-21.md" \
  '
  [
    {id:"terminal_public_distribution_non_publication_lock_attachment_ready", observed:true, expected:true},
    {id:"terminal_public_distribution_non_publication_lock_gate_present", observed:true, expected:true},
  ...
  {
    runtime:"hepta",
    surface:"terminal_public_distribution_non_publication_lock_attachment_readback",
    ...
    source_terminal_public_distribution_non_publication_lock_attachment_surface:"terminal_release_artifact_final_index_terminal_public_distribution_non_publication_lock",
    source_terminal_public_distribution_non_publication_lock_attachment_basis:"verified_terminal_public_distribution_non_publication_lock_attachment_snapshot",
    source_terminal_public_distribution_non_publication_lock_attachment_report_reexecuted:false,
    source_terminal_public_distribution_non_publication_lock_attachment_ready:true,
    source_terminal_public_distribution_non_publication_lock_attachment_blocked:true,
    terminal_public_distribution_non_publication_lock_attachment_readback_ready:$readback_ready,
    ...
    next_migration_step:"derive_terminal_public_distribution_non_publication_lock_attachment_final_index_without_distribution_gate_invocation",
    local_gate:$gate,
    architecture_note:$doc,
    source_files:{
      terminal_public_distribution_non_publication_lock_attachment_report:"scripts/hepta-systems-terminal-release-artifact-final-index-terminal-public-distribution-non-publication-lock-report.sh"
    },
