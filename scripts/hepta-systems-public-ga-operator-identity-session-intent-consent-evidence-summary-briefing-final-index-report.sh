...
SOURCE_REPORT="$ROOT/scripts/hepta-systems-public-ga-operator-identity-session-intent-consent-evidence-summary-briefing-readback-report.sh"

[[ -x "$SOURCE_REPORT" ]] || {
  echo "missing executable Public GA operator identity/session intent consent evidence summary briefing readback report: $SOURCE_REPORT" >&2
  exit 1
}

if ! command -v jq >/dev/null 2>&1; then
  echo "jq is required to build the Public GA operator identity/session intent consent evidence summary briefing final index report" >&2
  exit 1
fi
...
jq -n \
  ...
  '{
    ...
    source_public_ga_operator_identity_session_operator_intent_consent_evidence_summary_briefing_readback_surface: $source.surface,
    source_public_ga_operator_identity_session_operator_intent_consent_evidence_summary_briefing_readback_ready: $source.public_ga_operator_identity_session_operator_intent_consent_evidence_summary_briefing_readback_ready,
    source_public_ga_operator_identity_session_operator_intent_consent_evidence_summary_briefing_readback_blocked: $source.public_ga_operator_identity_session_operator_intent_consent_evidence_summary_briefing_readback_blocked,
    public_ga_operator_identity_session_operator_intent_consent_evidence_summary_briefing_final_index_ready: true,
    public_ga_operator_identity_session_operator_intent_consent_evidence_summary_briefing_final_index_blocked: true,
    public_ga_operator_identity_session_operator_intent_consent_evidence_summary_briefing_readback_attached: true,
    ...
    next_migration_step: "attach_public_ga_operator_identity_session_operator_intent_consent_evidence_summary_briefing_final_index_to_public_ga_operator_identity_session_operator_intent_consent_evidence_final_acknowledgement_non_acceptance_without_summary",
    local_gate: "scripts/hepta-systems-public-ga-operator-identity-session-intent-consent-evidence-summary-briefing-final-index-gate.sh",
    architecture_note: "docs/architecture/HEPTA_SYSTEMS_PUBLIC_GA_OPERATOR_IDENTITY_SESSION_INTENT_CONSENT_EVIDENCE_SUMMARY_BRIEFING_FINAL_INDEX_2026-06-21.md",
    source_files: {
      public_ga_operator_identity_session_intent_consent_evidence_summary_briefing_readback_report: "scripts/hepta-systems-public-ga-operator-identity-session-intent-consent-evidence-summary-briefing-readback-report.sh"
    },
