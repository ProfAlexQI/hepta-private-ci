...
REPORT_SCRIPT="$ROOT/scripts/hepta-systems-work-graph-dtd8-td3-rbtd5-rt10-td-rtx-preview-report.sh"
...
jq -e '
  ...
  and .source_probes.deep_td8_td3_rbackack_td26_receipt_retention_expiry.rust_module_present == true
  and .source_probes.prior_deep_td8_td3_rbackack_td25_terminal_decision_receipt_ack_replay.report_script_present == true
...
echo "Hepta WorkGraph deep td8 td3 rbackack td26 receipt retention expiry preview gate passed"
