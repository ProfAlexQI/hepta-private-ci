...
SOURCE_REPORT="$ROOT/scripts/hepta-systems-plugin-dynamic-activation-connector-start-boundary-readback-report.sh"
...
jq -n \
  ...
  --arg gate "scripts/hepta-systems-plugin-tool-registry-registration-denial-receipt-readback-gate.sh" \
