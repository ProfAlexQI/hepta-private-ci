...
PINNED_TARGET_HEAD="8a94430bb273623be42b68f144f1ab1df343bb53"
TARGET_HEAD="${HEPTA_UPSTREAM_CODEX_LATEST_MULTISURFACE_TARGET_HEAD:-$PINNED_TARGET_HEAD}"
...
if [[ -z "${HEPTA_UPSTREAM_CODEX_LATEST_MULTISURFACE_TARGET_HEAD:-}" ]]; then
