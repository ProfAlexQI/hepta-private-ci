...
prior_report_script="scripts/hepta-systems-work-graph-deep-td8-retention-ack-terminal-decision-receipt-retention-expiry-preview-report.sh"
prior_gate_script="scripts/hepta-systems-work-graph-deep-td8-retention-ack-terminal-decision-receipt-retention-expiry-preview-gate.sh"
...
rust_module="codex-rs/hepta-runtime/src/wg_deep_td8_ret_ack_td_receipt_retention_readback_receipt_preview.rs"
report_script="scripts/hepta-systems-work-graph-deep-td8-retention-ack-terminal-decision-receipt-retention-readback-receipt-preview-report.sh"
gate_script="scripts/hepta-systems-work-graph-deep-td8-retention-ack-terminal-decision-receipt-retention-readback-receipt-preview-gate.sh"
