...
FINAL_ACK_JSON="$(
  HEPTA_LIVE_URL="$BASE_URL" \
    ...
    capture_json_report "hepta-memory-intelligence-kg-full-enablement-operator-canary-controlled-request-harness-operator-review-acknowledgement-activation-command-result-receipt-final-operator-acknowledgement-non-acceptance-denial-gate" \
...
jq -n -e \
  ...
  '
    ...
    and $source.gate == "hepta_memory_intelligence_kg_full_enablement_operator_canary_controlled_request_harness_operator_review_acknowledgement_activation_command_result_receipt_final_operator_acknowledgement_non_acceptance_denial_gate"
    and $source.activation_command_result_receipt_final_operator_acknowledgement_mode == "operator_canary_controlled_request_harness_operator_review_acknowledgement_activation_command_result_receipt_final_operator_acknowledgement_non_acceptance_denial_no_ack_no_acceptance_no_delivery"
    ...
    and $source.operator_canary_controlled_request_harness_operator_review_acknowledgement_activation_command_result_receipt_final_operator_acknowledgement_non_acceptance_denial_status == "blocked"
    ...
    and ($source.allowed_next_actions | any(
      ...
      and .accepts_terminal_decision == false
      and .claims_public_release == false
      and .writes_release_artifact == false
      and .activates_runtime == false
      and .invokes_model == false
      and .writes_memory_or_kg == false
    ))
...
report="$(jq -n \
  ...
  --arg gate "hepta_memory_intelligence_kg_full_enablement_operator_canary_controlled_request_harness_operator_review_acknowledgement_activation_command_result_receipt_terminal_operator_decision_public_claim_non_promotion_denial_gate" \
  ...
  [
    blocked_fixture("operator-canary-controlled-request-harness-activation-result-receipt-terminal-decision-missing-final-ack"; "blocked_noop"; "source_final_operator_acknowledgement_report_required"; {source_final_acknowledgement_present:false, source_final_acknowledgement_ready:false, terminal_operator_decision_requested:true}),
    blocked_fixture("operator-canary-controlled-request-harness-activation-result-receipt-terminal-decision-request"; "blocked_decision_noop"; "terminal_operator_decision_request_shape_denied"; {terminal_operator_decision_requested:true}),
    blocked_fixture("operator-canary-controlled-request-harness-activation-result-receipt-terminal-decision-acceptance-request"; "blocked_acceptance_noop"; "terminal_operator_decision_acceptance_denied"; {terminal_operator_decision_requested:true, terminal_decision_acceptance_requested:true}),
    blocked_fixture("operator-canary-controlled-request-harness-activation-result-receipt-terminal-decision-recording-request"; "blocked_decision_noop"; "terminal_operator_decision_recording_denied"; {terminal_operator_decision_requested:true, terminal_decision_recording_requested:true}),
    ...
    blocked_fixture("operator-canary-controlled-request-harness-activation-result-receipt-terminal-decision-public-claim-request"; "blocked_public_claim_noop"; "public_claim_request_non_promotion_denied"; {terminal_operator_decision_requested:true, public_claim_requested:true, public_claim_promotion_requested:true}),
  ...
  | {
    ...
    base_url:$base_url,
    gate:$gate,
    activation_command_result_receipt_terminal_operator_decision_public_claim_mode:"operator_canary_controlled_request_harness_operator_review_acknowledgement_activation_command_result_receipt_terminal_operator_decision_public_claim_non_promotion_denial",
...
printf '%s\n' "$report" | jq .
echo "Hepta memory/intelligence/KG full enablement operator canary controlled request harness operator review acknowledgement activation command result receipt terminal operator decision public-claim non-promotion denial gate passed"
