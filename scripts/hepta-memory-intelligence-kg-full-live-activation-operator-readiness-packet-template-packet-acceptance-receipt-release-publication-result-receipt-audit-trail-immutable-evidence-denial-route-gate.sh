...
require_source_text() {
  ...
  if ! rg -Fq "$source_text" "$source_file"; then
    echo "missing operator readiness packet template packet-acceptance receipt release publication result receipt audit-trail/immutable-evidence route source text: $label" >&2
    exit 1
  fi
}
...
AUDIT_EVIDENCE_JSON="$(
  capture_json_report \
    "hepta-memory-intelligence-kg-full-live-activation-operator-readiness-packet-template-packet-acceptance-receipt-release-publication-result-receipt-audit-trail-immutable-evidence-denial-gate" \
...
jq -e '
  ...
  and .release_publication_result_receipt_hash_chain_persisted_count == 0
  and .release_publication_result_receipt_merkle_root_recorded_count == 0
  and .release_publication_result_receipt_merkle_root_persisted_count == 0
  and .release_publication_result_receipt_attestation_recorded_count == 0
  and .release_publication_result_receipt_attestation_persisted_count == 0
  and .release_publication_result_receipt_witness_recorded_count == 0
  and .release_publication_result_receipt_witness_persisted_count == 0
  and .release_publication_result_receipt_notary_recorded_count == 0
  and .release_publication_result_receipt_notary_persisted_count == 0
  and .release_publication_result_receipt_ledger_evidence_recorded_count == 0
  and .release_publication_result_receipt_ledger_evidence_persisted_count == 0
  and .release_publication_result_receipt_index_evidence_recorded_count == 0
  and .release_publication_result_receipt_index_evidence_persisted_count == 0
  and .release_publication_result_receipt_delivery_evidence_recorded_count == 0
  and .release_publication_result_receipt_delivery_evidence_persisted_count == 0
  ...
  and (.release_publication_result_receipt_audit_evidence_surfaces | length) == 16
...
require_source_text "$NATIVE_GATEWAY_SOURCE" \
  ...
  "native gateway route/source command count includes packet acceptance receipt release publication result receipt audit-trail/immutable-evidence route"
require_source_text "$NATIVE_GATEWAY_SOURCE" \
  ...
  "native gateway release publication result receipt audit-trail/immutable-evidence endpoint constant"
require_source_text "$NATIVE_GATEWAY_SOURCE" \
  ...
  "native gateway release publication result receipt audit-trail/immutable-evidence endpoint path"
require_source_text "$NATIVE_GATEWAY_SOURCE" \
  ...
  "native gateway release publication result receipt audit-trail/immutable-evidence source command"
require_source_text "$NATIVE_GATEWAY_SOURCE" \
  ...
  "native gateway release publication result receipt audit-trail/immutable-evidence report function"
require_source_text "$NATIVE_GATEWAY_SOURCE" \
  ...
  "packet acceptance receipt release publication result receipt audit-trail/immutable-evidence route enabled"
require_source_text "$NATIVE_GATEWAY_SOURCE" \
  ...
  "packet acceptance receipt release publication result receipt audit-trail/immutable-evidence route ready"
require_source_text "$NATIVE_GATEWAY_SOURCE" \
  ...
  "packet acceptance receipt release publication result receipt audit evidence surface count emitted"
require_source_text "$NATIVE_GATEWAY_SOURCE" \
  '"release_publication_result_receipt_audit_trail_recorded_count": 0' \
  "packet acceptance receipt release publication result receipt audit trail recording denied"

TEST_LOG="$(mktemp /tmp/hepta-operator-readiness-packet-template-packet-acceptance-receipt-release-publication-result-receipt-audit-evidence-route-tests.XXXXXX)"
cargo test --offline --manifest-path "$MANIFEST" -q -p codex-cli --lib \
  hepta_memory_intelligence_kg_full_live_activation_operator_readiness_packet_template_packet_acceptance_receipt_release_publication_result_receipt_audit_trail_immutable_evidence_endpoint_blocks_audit_evidence_and_authority \
  -- --nocapture >"$TEST_LOG"

LIVE_ROUTE_JSON='{}'
if [[ "$REQUIRE_LIVE_ENDPOINT" == "1" ]]; then
  LIVE_ROUTE_JSON="$(
    curl -fsS "$BASE_URL/api/hepta-memory-intelligence-kg-full-live-activation-operator-readiness-packet-template-packet-acceptance-receipt-release-publication-result-receipt-audit-trail-immutable-evidence-denial"
  )"
  jq -e '
    .status == "ready"
    and .route_count == 136
    and .implemented_route_count == 136
    and .missing_route_count == 0
    and .route_count_source_command_accepted == true
    and .memory_intelligence_kg_full_live_activation_operator_readiness_packet_template_packet_acceptance_receipt_release_publication_result_receipt_audit_trail_immutable_evidence_denial_route_enabled == true
    and .memory_intelligence_kg_full_live_activation_operator_readiness_packet_template_packet_acceptance_receipt_release_publication_result_receipt_audit_trail_immutable_evidence_denial_ready == true
    and .source_packet_acceptance_receipt_release_publication_result_receipt_cancellation_supersession_ready == true
    and .release_publication_result_receipt_audit_evidence_surface_count == 16
    and .release_publication_result_receipt_audit_evidence_attempt_count == 16
...
jq -e '
  ...
  and .required_marker_count == 276
  and .present_required_marker_count == 276
...
jq -n \
  ...
  --arg endpoint "/api/hepta-memory-intelligence-kg-full-live-activation-operator-readiness-packet-template-packet-acceptance-receipt-release-publication-result-receipt-audit-trail-immutable-evidence-denial" \
  --arg source_command "/hepta-memory-intelligence-kg-full-live-activation-operator-readiness-packet-template-packet-acceptance-receipt-release-publication-result-receipt-audit-trail-immutable-evidence-denial --json" \
  ...
  '{
    ...
    status:"ready",
    base_url:$base_url,
    gate:"hepta_memory_intelligence_kg_full_live_activation_operator_readiness_packet_template_packet_acceptance_receipt_release_publication_result_receipt_audit_trail_immutable_evidence_denial_route_gate",
    endpoint:$endpoint,
    source_command:$source_command,
    activation_mode:"full_live_activation_operator_readiness_packet_template_packet_acceptance_receipt_release_publication_result_receipt_audit_trail_immutable_evidence_denial_native_route_status",
    ...
    source_route_count_expected:136,
    terminal_required_marker_count_expected:276,
    source_packet_acceptance_receipt_release_publication_result_receipt_cancellation_supersession_ready:$source.source_packet_acceptance_receipt_release_publication_result_receipt_cancellation_supersession_ready,
    release_publication_result_receipt_audit_evidence_surface_count:$source.release_publication_result_receipt_audit_evidence_surface_count,
    release_publication_result_receipt_audit_trail_recorded_count:$source.release_publication_result_receipt_audit_trail_recorded_count,
    release_publication_result_receipt_immutable_evidence_recorded_count:$source.release_publication_result_receipt_immutable_evidence_recorded_count,
    release_publication_result_receipt_hash_chain_recorded_count:$source.release_publication_result_receipt_hash_chain_recorded_count,
    release_publication_result_receipt_ledger_evidence_recorded_count:$source.release_publication_result_receipt_ledger_evidence_recorded_count,
    release_publication_result_receipt_readback_evidence_recorded_count:$source.release_publication_result_receipt_readback_evidence_recorded_count,
    release_publication_result_receipt_audit_evidence_activation_authority_derived_count:$source.release_publication_result_receipt_audit_evidence_activation_authority_derived_count,
    release_publication_result_receipt_audit_evidence_live_execution_allowed_count:$source.release_publication_result_receipt_audit_evidence_live_execution_allowed_count,
...
echo "Hepta memory/intelligence/KG full live activation operator readiness packet template packet acceptance receipt release/publication result receipt audit-trail/immutable-evidence denial route gate passed"
