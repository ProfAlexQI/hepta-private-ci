...
def self_test() -> None:
    ...
    print("PASS_HEPTA_INTELLIGENCE_Q0_59_OBJECT_GRAPH_FIXTURES")
...
def main() -> int:
    try:
        ...
        print("PASS_HEPTA_INTELLIGENCE_Q0_59_IMMUTABLE_OBJECT_GRAPH")
        return 0
    except (ObjectGraphError, subprocess.TimeoutExpired, OSError) as error:
        print(
            f"FAIL_HEPTA_INTELLIGENCE_Q0_59_OBJECT_GRAPH: {error}",
            file=sys.stderr,
        )
        return 1
