...
jq -e '
  ...
  and .source_matrix_no_persistence_confirmed == true
  and .source_matrix_no_live_confirmed == true
  and .source_matrix_ready_for_denial_readback == true
  ...
  and .denial_readback_scope_visible_only_complete == true
  and .denial_readback_entries_complete == true
  and .entrypoint_denial_readbacks_complete == true
  ...
  and .source_readbacks.live_attachment_matrix_report_gate == "hepta_work_graph_agent_jobs_task_board_scheduler_guardrail_blocking_dry_run_entrypoint_live_attachment_precondition_matrix_gate"
  and .source_readbacks.live_attachment_matrix_preconditions_complete == true
  and .source_readbacks.live_attachment_matrix_ready_for_denial_readback == true
  and .source_readbacks.live_attachment_matrix_no_persistence_confirmed == true
  and .source_readbacks.live_attachment_matrix_no_live_confirmed == true
  and .source_readbacks.live_attachment_matrix_side_effects_all_false == true
  and (.side_effects | to_entries | all(.value == false))
' >/dev/null <<<"$report"

tests=(
  live_attachment_denial_readback_derives_from_matrix
  live_attachment_denial_readback_keeps_entrypoints_report_only
  live_attachment_denial_readback_blocks_authority
  live_attachment_denial_readback_has_no_side_effects
)
