...
prior_report_script="scripts/hepta-systems-work-graph-dtd8-td3-rcptret-rbackack-td-rcptret-rbackack-preview-report.sh"
prior_gate_script="scripts/hepta-systems-work-graph-dtd8-td3-rcptret-rbackack-td-rcptret-rbackack-preview-gate.sh"
...
rust_module="codex-rs/hepta-runtime/src/wg_deep_td8_retack_td3_rcptret_rbackack_td_rcptret_rbackack_replay_preview.rs"
report_script="scripts/hepta-systems-work-graph-dtd8-td3-rcptret-rbackack-td-rcptret-rbackack-replay-preview-report.sh"
gate_script="scripts/hepta-systems-work-graph-dtd8-td3-rcptret-rbackack-td-rcptret-rbackack-replay-preview-gate.sh"
...
jq -n \
  ...
  def item($prefix; $count): [range(0; $count) | {
    id: "deep_td8_td3_rcptret_rbackack_td_rcptret_rbackack_replay_\($prefix)_\(.)",
  ...
  }];
  {
    ...
    replay_scenarios: item("replay_scenario"; 6),
    idempotency_guards: item("idempotency_guard"; 7),
    replay_denials: item("replay_denial"; 7),
    monotonicity_checks: item("monotonicity_check"; 5),
    local_views: item("local_view"; 4),
    invariants: item("invariant"; 6),
    ...
    source_probes: {
      deep_td8_td3_rcptret_rbackack_td_receipt_retention_readback_ack_replay: {
      ...
      prior_deep_td8_td3_rcptret_rbackack_td_retention_readback_ack: {
