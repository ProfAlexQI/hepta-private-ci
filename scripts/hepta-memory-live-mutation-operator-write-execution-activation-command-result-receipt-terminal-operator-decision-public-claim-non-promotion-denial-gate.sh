...
FINAL_ACK_JSON="$(
  HEPTA_LIVE_URL="$BASE_URL" \
    ...
    capture_json_report "hepta-memory-live-mutation-operator-write-execution-activation-command-result-receipt-final-operator-acknowledgement-non-acceptance-denial-gate" \
...
jq -n -e \
  ...
  '
    ...
    and $source.gate == "hepta_memory_live_mutation_operator_write_execution_activation_command_result_receipt_final_operator_acknowledgement_non_acceptance_denial_gate"
    and $source.activation_command_result_receipt_final_operator_acknowledgement_mode == "memory_write_execution_activation_command_result_receipt_final_operator_acknowledgement_non_acceptance_denial"
...
report="$(jq -n \
  ...
  --arg gate "hepta_memory_live_mutation_operator_write_execution_activation_command_result_receipt_terminal_operator_decision_public_claim_non_promotion_denial_gate" \
  ...
  [
    blocked_fixture("activation-result-receipt-terminal-decision-missing-final-ack"; "blocked_noop"; "source_final_operator_acknowledgement_report_required"; {source_final_acknowledgement_present:false, source_final_acknowledgement_ready:false, terminal_operator_decision_requested:true}),
    blocked_fixture("activation-result-receipt-terminal-decision-request"; "blocked_decision_noop"; "terminal_operator_decision_request_shape_denied"; {terminal_operator_decision_requested:true}),
    blocked_fixture("activation-result-receipt-terminal-decision-acceptance-request"; "blocked_acceptance_noop"; "terminal_operator_decision_acceptance_denied"; {terminal_operator_decision_requested:true, terminal_decision_acceptance_requested:true}),
    blocked_fixture("activation-result-receipt-terminal-decision-recording-request"; "blocked_decision_noop"; "terminal_operator_decision_recording_denied"; {terminal_operator_decision_requested:true, terminal_decision_recording_requested:true}),
    blocked_fixture("activation-result-receipt-terminal-decision-persistence-filesystem-write-request"; "blocked_decision_noop"; "terminal_operator_decision_persistence_filesystem_write_denied"; {terminal_operator_decision_requested:true, terminal_decision_persistence_requested:true, terminal_decision_filesystem_write_requested:true}),
    ...
    blocked_fixture("activation-result-receipt-terminal-decision-public-claim-request"; "blocked_public_claim_noop"; "public_claim_request_non_promotion_denied"; {terminal_operator_decision_requested:true, public_claim_requested:true, public_claim_promotion_requested:true}),
  ...
  | {
    ...
    base_url:$base_url,
    gate:$gate,
    activation_command_result_receipt_terminal_operator_decision_public_claim_mode:"memory_write_execution_activation_command_result_receipt_terminal_operator_decision_public_claim_non_promotion_denial",
...
printf '%s\n' "$report" | jq .
echo "Hepta memory live mutation operator write execution activation command result receipt terminal operator decision public-claim non-promotion denial gate passed"
