...
prior_report_script="scripts/hepta-systems-work-graph-dtd8-td3-rbtd5-td-rt-td-rtx-preview-report.sh"
prior_gate_script="scripts/hepta-systems-work-graph-dtd8-td3-rbtd5-td-rt-td-rtx-preview-gate.sh"
...
rust_module="codex-rs/hepta-runtime/src/wg_dtd8_td3_rbtd_rbtd_rbtd_rt_td_rt_td_rt_td_rt_td_rt_td_rt_td_rt_td_rt_rbrcpt_preview.rs"
report_script="scripts/hepta-systems-work-graph-dtd8-td3-rbtd5-td-rt-td-rbr-preview-report.sh"
gate_script="scripts/hepta-systems-work-graph-dtd8-td3-rbtd5-td-rt-td-rbr-preview-gate.sh"
...
jq -n \
  ...
  }];
  {
    ...
    receipts: item("deep_td8_td3_rbackack_td10_rcptret_rbrcpt_receipt"; 6),
    digest_checks: item("deep_td8_td3_rbackack_td10_rcptret_rbrcpt_digest_check"; 6),
    mismatch_denials: item("deep_td8_td3_rbackack_td10_rcptret_rbrcpt_mismatch_denial"; 7),
    receipt_guards: item("deep_td8_td3_rbackack_td10_rcptret_rbrcpt_receipt_guard"; 5),
    local_views: item("deep_td8_td3_rbackack_td10_rcptret_rbrcpt_local_view"; 4),
    invariants: item("deep_td8_td3_rbackack_td10_rcptret_rbrcpt_invariant"; 6),
    ...
    source_probes: {
      deep_td8_td3_rbackack_td10_receipt_retention_readback_receipt: {
      ...
      prior_deep_td8_td3_rbackack_td10_receipt_retention_expiry: {
