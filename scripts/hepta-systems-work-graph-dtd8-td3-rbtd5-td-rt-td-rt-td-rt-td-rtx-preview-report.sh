...
prior_report_script="scripts/hepta-systems-work-graph-dtd8-td3-rbtd5-td-rt-td-rt-td-rt-td-rp-preview-report.sh"
prior_gate_script="scripts/hepta-systems-work-graph-dtd8-td3-rbtd5-td-rt-td-rt-td-rt-td-rp-preview-gate.sh"
...
rust_module="codex-rs/hepta-runtime/src/wg_dtd8_td3_rbtd_rbtd_rbtd_rt_td_rt_td_rt_td_rt_td_rt_td_rt_td_rt_td_rt_td_rt_td_rt_expiry_preview.rs"
report_script="scripts/hepta-systems-work-graph-dtd8-td3-rbtd5-td-rt-td-rt-td-rt-td-rtx-preview-report.sh"
gate_script="scripts/hepta-systems-work-graph-dtd8-td3-rbtd5-td-rt-td-rt-td-rt-td-rtx-preview-gate.sh"
...
jq -n \
  ...
  }];
  {
    ...
    retention_policies: item("deep_td8_td3_rbackack_td12_rcptret_policy"; 6),
    expiry_guards: item("deep_td8_td3_rbackack_td12_rcptret_expiry_guard"; 6),
    supersession_guards: item("deep_td8_td3_rbackack_td12_rcptret_supersession_guard"; 5),
    garbage_collection_denials: item("deep_td8_td3_rbackack_td12_rcptret_gc_denial"; 6),
    local_views: item("deep_td8_td3_rbackack_td12_rcptret_local_view"; 4),
    invariants: item("deep_td8_td3_rbackack_td12_rcptret_invariant"; 6),
    ...
    source_probes: {
      deep_td8_td3_rbackack_td12_receipt_retention_expiry: {
      ...
      prior_deep_td8_td3_rbackack_td12_terminal_decision_receipt_ack_replay: {
