...
prior_report_script="scripts/hepta-systems-work-graph-dtd8-retack-rbackacktd-rbackacktd-rcptret-readback-ack-replay-preview-report.sh"
prior_gate_script="scripts/hepta-systems-work-graph-dtd8-retack-rbackacktd-rbackacktd-rcptret-readback-ack-replay-preview-gate.sh"
...
rust_module="codex-rs/hepta-runtime/src/wg_deep_td8_ret_ack_td_rback_ack_td_receipt_retention_readback_ack_td_receipt_retention_readback_ack_td_receipt_retention_readback_ack_td_preview.rs"
report_script="scripts/hepta-systems-work-graph-dtd8-retack-rbackacktd-rbackacktd-rcptret-rbackack-td-preview-report.sh"
gate_script="scripts/hepta-systems-work-graph-dtd8-retack-rbackacktd-rbackacktd-rcptret-rbackack-td-preview-gate.sh"
...
jq -n \
  ...
  '
  def source_ids: [range(0; 6) | "deep_td8_ret_ack_td_rback_ack_td_receipt_retention_readback_ack_td_receipt_retention_readback_ack_td_receipt_retention_readback_ack_\(.)"];
