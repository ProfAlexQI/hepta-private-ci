...
report="$(jq -n \
  ...
  '
    ...
    | {
      ...
      watchdog_operator_security_attention_state_known:($watchdog.operator_security_attention_state_known // false),
      ...
      watchdog_telegram_production_readiness_state_known:($watchdog.telegram_production_readiness_state_known // false),
      watchdog_telegram_production_readiness_classification:($watchdog.telegram_production_readiness_classification // "unknown"),
      ...
      soak_telegram_production_readiness_state_known:($soak.telegram_production_readiness_state_known // false),
      soak_telegram_production_readiness_classification:($soak.telegram_production_readiness_classification // "unknown"),
