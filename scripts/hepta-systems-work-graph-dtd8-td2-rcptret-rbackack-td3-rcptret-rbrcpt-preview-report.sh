...
prior_report_script="scripts/hepta-systems-work-graph-dtd8-td2-rcptret-rbackack-td3-rcptret-expiry-preview-report.sh"
prior_gate_script="scripts/hepta-systems-work-graph-dtd8-td2-rcptret-rbackack-td3-rcptret-expiry-preview-gate.sh"
...
rust_module="codex-rs/hepta-runtime/src/wg_deep_td8_retack_td3_receipt_retention_readback_receipt_preview.rs"
report_script="scripts/hepta-systems-work-graph-dtd8-td2-rcptret-rbackack-td3-rcptret-rbrcpt-preview-report.sh"
gate_script="scripts/hepta-systems-work-graph-dtd8-td2-rcptret-rbackack-td3-rcptret-rbrcpt-preview-gate.sh"
...
jq -n \
  ...
  }];
  {
    ...
    receipts: item("deep_td8_td3_readback_receipt"; 6),
    digest_checks: item("deep_td8_td3_readback_digest_check"; 6),
    mismatch_denials: item("deep_td8_td3_readback_mismatch_denial"; 7),
    receipt_guards: item("deep_td8_td3_readback_receipt_guard"; 5),
    local_views: item("deep_td8_td3_readback_receipt_view"; 4),
    invariants: item("deep_td8_td3_readback_receipt_invariant"; 6),
    ...
    source_probes: {
      deep_td8_td3_terminal_decision_receipt_retention_readback_receipt: {
      ...
      prior_deep_td8_td3_terminal_decision_receipt_retention_expiry: {
