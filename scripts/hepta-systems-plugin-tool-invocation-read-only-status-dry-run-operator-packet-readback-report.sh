...
SOURCE_REPORT="$ROOT/scripts/hepta-systems-plugin-tool-invocation-dry-run-receipt-ledger-preview-readback-report.sh"
...
jq -n \
  ...
  --arg gate "scripts/hepta-systems-plugin-tool-invocation-read-only-status-dry-run-operator-packet-readback-gate.sh" \
