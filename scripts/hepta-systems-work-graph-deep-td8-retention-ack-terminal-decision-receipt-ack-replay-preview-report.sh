...
prior_report_script="scripts/hepta-systems-work-graph-deep-td8-retention-ack-terminal-decision-receipt-ack-preview-report.sh"
prior_gate_script="scripts/hepta-systems-work-graph-deep-td8-retention-ack-terminal-decision-receipt-ack-preview-gate.sh"
...
rust_module="codex-rs/hepta-runtime/src/wg_deep_td8_retention_ack_terminal_decision_receipt_ack_replay_preview.rs"
report_script="scripts/hepta-systems-work-graph-deep-td8-retention-ack-terminal-decision-receipt-ack-replay-preview-report.sh"
gate_script="scripts/hepta-systems-work-graph-deep-td8-retention-ack-terminal-decision-receipt-ack-replay-preview-gate.sh"
...
jq -n \
  ...
  };
  {
    ...
    preview_mode: "read_only_deep_td8_retention_ack_terminal_decision_receipt_acknowledgement_replay_idempotency_preview_no_replay_write",
    ...
    source_probes: {
      deep_td8_retention_ack_terminal_decision_receipt_ack_replay: {
      ...
      prior_deep_td8_retention_ack_terminal_decision_receipt_ack: {
