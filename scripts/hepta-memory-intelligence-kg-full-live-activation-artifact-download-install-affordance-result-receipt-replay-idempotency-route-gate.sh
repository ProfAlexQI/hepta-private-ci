...
echo "artifact download/install affordance result receipt replay/idempotency denial route gate passed: endpoint ready, 18 surfaces, source route count 154, terminal markers 294/294" >&2
