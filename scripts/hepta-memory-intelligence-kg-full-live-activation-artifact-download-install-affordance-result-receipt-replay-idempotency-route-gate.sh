...
echo "artifact download/install affordance result receipt replay/idempotency denial route gate passed: endpoint ready, 18 surfaces, source route count 151, terminal markers 291/291" >&2
