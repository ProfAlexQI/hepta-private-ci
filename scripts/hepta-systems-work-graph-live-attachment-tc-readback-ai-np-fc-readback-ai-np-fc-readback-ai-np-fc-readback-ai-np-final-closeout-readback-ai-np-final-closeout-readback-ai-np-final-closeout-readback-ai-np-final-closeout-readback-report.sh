...
SOURCE_REPORT_SCRIPT="$ROOT/scripts/hepta-systems-work-graph-live-attachment-tc-readback-ai-np-fc-readback-ai-np-fc-readback-ai-np-fc-readback-ai-np-final-closeout-readback-ai-np-final-closeout-readback-ai-np-final-closeout-readback-ai-np-final-closeout-report.sh"

source_report="$(
  capture_json_report \
    "hepta-work-graph-live-attachment-tc-readback-ai-np-fc-readback-ai-np-fc-readback-ai-np-fc-readback-ai-np-final-closeout-readback-ai-np-final-closeout-readback-ai-np-final-closeout-readback-ai-np-final-closeout-report" \
...
jq -n \
  ...
  | (
      ...
      and $source.ready_for_terminal_closeout_readback_audit_index_non_persistence_final_closeout_readback == true
      ...
      and ($source.final_closeout_entries | all(
        .visible == true
        and .closed == true
        and .recorded == false
        and .persisted == false
      ...
      and $source.source_readbacks.non_persistence_readback_no_persistence_confirmed == true
      and $source.source_readbacks.non_persistence_readback_side_effects_all_false == true
      and $source_side_effects_all_false
    ) as $source_final_closeout_no_persistence_confirmed
  | (
      ...
      and $source.source_readbacks.non_persistence_readback_no_live_confirmed == true
      and $source_final_closeout_no_persistence_confirmed
    ) as $source_final_closeout_no_live_confirmed
  | (
      $source.gate == "hepta_work_graph_agent_jobs_task_board_scheduler_guardrail_blocking_dry_run_entrypoint_live_attachment_attachability_precondition_readiness_readback_terminal_no_attachment_final_closeout_readback_terminal_closeout_readback_audit_index_non_persistence_final_closeout_readback_audit_index_non_persistence_final_closeout_readback_audit_index_non_persistence_final_closeout_readback_audit_index_non_persistence_final_closeout_readback_audit_index_non_persistence_final_closeout_readback_audit_index_non_persistence_final_closeout_readback_audit_index_non_persistence_final_closeout_gate"
      ...
      and $source.final_closeout_entry_count == ($source.final_closeout_entries | length)
      and $source.final_closeout_entry_count == 8
      and $source.final_closeout_blocker_count == ($source.final_closeout_blockers | length)
      and $source.final_closeout_blocker_count == 158
      and $source.required_prior_gate_count == ($source.required_prior_gates | length)
      and $source.required_prior_gate_count == 57
      and ($source.final_closeout_blockers | all(.blocked == true))
      and $source_final_closeout_no_live_confirmed
    ) as $source_final_closeout_ready
  | (
      $source_final_closeout_ready
      and $source.ready_for_terminal_closeout_readback_audit_index_non_persistence_final_closeout_readback == true
    ) as $source_final_closeout_ready_for_readback
  | [
    ...
    entry("final_closeout_readback_audit_index_non_persistence_final_closeout_readback_blockers"; "final_closeout_readback.audit_index.non_persistence.final_closeout.readback.blockers"; "one_hundred_fifty_eight_final_closeout_blockers_visible_and_still_blocking"),
    entry("final_closeout_readback_audit_index_non_persistence_final_closeout_readback_priors"; "final_closeout_readback.audit_index.non_persistence.final_closeout.readback.priors"; "fifty_seven_required_prior_gates_visible_but_not_persisted"),
  ...
  | (
    [
      ...
      blocker("final_closeout_readback_audit_index_non_persistence_final_closeout_readback_persistence_blocked"; "persist_live_attachment_attachability_terminal_closeout_readback_audit_index_non_persistence_final_closeout_readback_audit_index_non_persistence_final_closeout_readback_audit_index_non_persistence_final_closeout_readback_audit_index_non_persistence_final_closeout_readback_audit_index_non_persistence_final_closeout_readback_audit_index_non_persistence_final_closeout_readback_audit_index_non_persistence_final_closeout_readback_audit_index_non_persistence_final_closeout_readback"),
  ...
  | (
    ...
    ) as $final_closeout_readback_preconditions_complete
  | {
      product: "Hepta",
      runtime: "hepta",
      status: "ready",
      gate: "hepta_work_graph_agent_jobs_task_board_scheduler_guardrail_blocking_dry_run_entrypoint_live_attachment_attachability_precondition_readiness_readback_terminal_no_attachment_final_closeout_readback_terminal_closeout_readback_audit_index_non_persistence_final_closeout_readback_audit_index_non_persistence_final_closeout_readback_audit_index_non_persistence_final_closeout_readback_audit_index_non_persistence_final_closeout_readback_audit_index_non_persistence_final_closeout_readback_audit_index_non_persistence_final_closeout_readback_audit_index_non_persistence_final_closeout_readback_gate",
      schema_version: "work_graph_agent_jobs_task_board_scheduler_guardrail_blocking_dry_run_entrypoint_live_attachment_attachability_precondition_readiness_readback_terminal_no_attachment_final_closeout_readback_terminal_closeout_readback_audit_index_non_persistence_final_closeout_readback_audit_index_non_persistence_final_closeout_readback_audit_index_non_persistence_final_closeout_readback_audit_index_non_persistence_final_closeout_readback_audit_index_non_persistence_final_closeout_readback_audit_index_non_persistence_final_closeout_readback_audit_index_non_persistence_final_closeout_readback_v1",
      preview_mode: "scheduler_guardrail_blocking_dry_run_entrypoint_live_attachment_attachability_terminal_closeout_readback_audit_index_non_persistence_final_closeout_readback_audit_index_non_persistence_final_closeout_readback_audit_index_non_persistence_final_closeout_readback_audit_index_non_persistence_final_closeout_readback_audit_index_non_persistence_final_closeout_readback_audit_index_non_persistence_final_closeout_readback_audit_index_non_persistence_final_closeout_readback_audit_index_non_persistence_final_closeout_readback_only",
      ...
      recommended_next_gate: "hepta_work_graph_agent_jobs_task_board_scheduler_guardrail_blocking_dry_run_entrypoint_live_attachment_attachability_precondition_readiness_readback_terminal_no_attachment_final_closeout_readback_terminal_closeout_readback_audit_index_non_persistence_final_closeout_readback_audit_index_non_persistence_final_closeout_readback_audit_index_non_persistence_final_closeout_readback_audit_index_non_persistence_final_closeout_readback_audit_index_non_persistence_final_closeout_readback_audit_index_non_persistence_final_closeout_readback_audit_index_non_persistence_final_closeout_readback_audit_index_gate",
      ...
      ready_for_terminal_closeout_readback_audit_index_non_persistence_final_closeout_readback_audit_index: $final_closeout_readback_preconditions_complete,
      ...
      source_readbacks: {
        ...
        final_closeout_ready_for_readback: $source.ready_for_terminal_closeout_readback_audit_index_non_persistence_final_closeout_readback,
