...
prior_report_script="scripts/hepta-systems-work-graph-dtd8-td2-rcptret-rbackack-td3-rcptret-rbackack-replay-preview-report.sh"
prior_gate_script="scripts/hepta-systems-work-graph-dtd8-td2-rcptret-rbackack-td3-rcptret-rbackack-replay-preview-gate.sh"
...
rust_module="codex-rs/hepta-runtime/src/wg_deep_td8_retack_td3_rcptret_rbackack_td_preview.rs"
report_script="scripts/hepta-systems-work-graph-dtd8-td3-rcptret-rbackack-td-preview-report.sh"
gate_script="scripts/hepta-systems-work-graph-dtd8-td3-rcptret-rbackack-td-preview-gate.sh"
...
jq -n \
  ...
  '
  def source_ids: [range(0; 6) | "deep_td8_td3_rcptret_rbackack_td_surface_\(.)"];
  ...
  }];
  {
    ...
    terminal_decision_surfaces: item("deep_td8_td3_rcptret_rbackack_td_surface"; 6),
    non_promotion_denials: item("deep_td8_td3_rcptret_rbackack_td_non_promotion_denial"; 8),
    authority_guards: item("deep_td8_td3_rcptret_rbackack_td_authority_guard"; 6),
    release_delivery_guards: item("deep_td8_td3_rcptret_rbackack_td_release_delivery_guard"; 6),
    local_views: item("deep_td8_td3_rcptret_rbackack_td_local_view"; 4),
    invariants: item("deep_td8_td3_rcptret_rbackack_td_invariant"; 6),
    ...
    source_probes: {
      deep_td8_td3_rcptret_rbackack_terminal_decision: {
