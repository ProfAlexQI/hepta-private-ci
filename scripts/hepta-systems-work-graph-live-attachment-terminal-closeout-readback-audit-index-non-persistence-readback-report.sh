...
SOURCE_REPORT_SCRIPT="$ROOT/scripts/hepta-systems-work-graph-agent-jobs-task-board-scheduler-guardrail-blocking-dry-run-entrypoint-live-attachment-attachability-precondition-readiness-readback-terminal-no-attachment-final-closeout-readback-terminal-closeout-readback-audit-index-report.sh"
source_report="$(
  capture_json_report \
...
jq -n \
  ...
  | ($source.gate == "hepta_work_graph_agent_jobs_task_board_scheduler_guardrail_blocking_dry_run_entrypoint_live_attachment_attachability_precondition_readiness_readback_terminal_no_attachment_final_closeout_readback_terminal_closeout_readback_audit_index_gate"
      ...
      and $source.audit_index_blocker_count == 80
      and $source.required_prior_gate_count == 31
  ...
  | {
    ...
    source_surface_id: "work_graph_agent_jobs_task_board.scheduler_guardrail.live_attachment_attachability_terminal_no_attachment_final_closeout_readback_terminal_closeout_readback_audit_index",
    readback_mode: "live_attachment_attachability_terminal_no_attachment_final_closeout_readback_terminal_closeout_readback_audit_index_non_persistence_readback_only",
    stable_readback_key: "work_graph.agent_jobs_task_board.scheduler_guardrail.live_attachment.attachability_precondition_readiness.readback.terminal_no_attachment_final_closeout.readback.terminal_closeout.readback.audit_index.non_persistence_readback",
  ...
  | [
    entry("terminal_closeout_readback_audit_index_surface_non_persistence_readback"; "live_attachment_attachability_terminal_closeout_readback_audit_index_visible_unrecorded"; "audit_index_visible_without_record_persist_accept_or_authority"),
    entry("terminal_closeout_readback_audit_index_entry_inventory_non_persistence_readback"; "live_attachment_attachability_terminal_closeout_readback_audit_index_entries_visible"; "nine_audit_index_entries_visible_but_not_persisted"),
    entry("terminal_closeout_readback_audit_index_blocker_inventory_non_persistence_readback"; "live_attachment_attachability_terminal_closeout_readback_audit_index_blockers_visible"; "eighty_blockers_visible_and_still_blocking"),
    entry("terminal_closeout_readback_audit_index_prior_chain_non_persistence_readback"; "live_attachment_attachability_terminal_closeout_readback_audit_index_priors_visible"; "thirty_one_required_prior_gates_visible_but_not_persisted"),
    entry("terminal_closeout_readback_audit_index_non_persistence_boundary_readback"; "live_attachment_attachability_terminal_closeout_readback_audit_index_non_persistence_boundary"; "audit_index_does_not_write_event_projection_scheduler_guardrail_or_runtime_state"),
    entry("terminal_closeout_readback_audit_index_no_live_authority_readback"; "live_attachment_attachability_terminal_closeout_readback_audit_index_no_live_authority"; "audit_index_does_not_authorize_attachment_enforcement_interception_work_start_agent_model_external_or_live_cutover")
  ] as $readback_entries
  | (
    [
      blocker("terminal_closeout_readback_audit_index_readback_record_blocked"; "record_live_attachment_attachability_terminal_closeout_readback_audit_index_non_persistence_readback"),
      blocker("terminal_closeout_readback_audit_index_readback_persistence_blocked"; "persist_live_attachment_attachability_terminal_closeout_readback_audit_index_non_persistence_readback"),
      blocker("terminal_closeout_readback_audit_index_readback_acceptance_blocked"; "accept_live_attachment_attachability_terminal_closeout_readback_audit_index_non_persistence_readback")
    ]
  ...
  | {
      ...
      runtime: "hepta",
      status: "ready",
      gate: "hepta_work_graph_agent_jobs_task_board_scheduler_guardrail_blocking_dry_run_entrypoint_live_attachment_attachability_precondition_readiness_readback_terminal_no_attachment_final_closeout_readback_terminal_closeout_readback_audit_index_non_persistence_readback_gate",
      schema_version: "work_graph_agent_jobs_task_board_scheduler_guardrail_blocking_dry_run_entrypoint_live_attachment_attachability_precondition_readiness_readback_terminal_no_attachment_final_closeout_readback_terminal_closeout_readback_audit_index_non_persistence_readback_v1",
      preview_mode: "scheduler_guardrail_blocking_dry_run_entrypoint_live_attachment_attachability_terminal_no_attachment_final_closeout_readback_terminal_closeout_readback_audit_index_non_persistence_readback_only",
      ...
      recommended_next_gate: "hepta_work_graph_agent_jobs_task_board_scheduler_guardrail_blocking_dry_run_entrypoint_live_attachment_attachability_precondition_readiness_readback_terminal_no_attachment_final_closeout_readback_terminal_closeout_readback_audit_index_non_persistence_final_closeout_gate",
