...
TERMINAL_DECISION_JSON="$(
  HEPTA_LIVE_URL="$BASE_URL" \
    ...
    capture_json_report "hepta-memory-live-mutation-operator-write-execution-activation-command-result-receipt-terminal-operator-decision-public-claim-non-promotion-denial-gate" \
...
jq -n -e \
  ...
  '
    ...
    and $source.gate == "hepta_memory_live_mutation_operator_write_execution_activation_command_result_receipt_terminal_operator_decision_public_claim_non_promotion_denial_gate"
    ...
    and $source.memory_write_execution_activation_command_result_receipt_final_operator_acknowledgement_non_acceptance_denial_ready == true
...
report="$(jq -n \
  ...
  --arg gate "hepta_memory_live_mutation_operator_write_execution_activation_command_result_receipt_release_artifact_publication_denial_gate" \
  ...
  [
    blocked_fixture("activation-result-receipt-release-artifact-publication-missing-terminal-decision"; "blocked_noop"; "source_terminal_operator_decision_report_required"; {source_terminal_operator_decision_present:false, source_terminal_operator_decision_ready:false, release_artifact_publication_requested:true}),
    blocked_fixture("activation-result-receipt-release-artifact-write-request"; "blocked_artifact_noop"; "release_artifact_write_denied"; {release_artifact_write_requested:true, release_artifact_publication_requested:true}),
    blocked_fixture("activation-result-receipt-public-artifact-write-request"; "blocked_artifact_noop"; "public_artifact_write_denied"; {public_artifact_write_requested:true, release_artifact_publication_requested:true}),
    blocked_fixture("activation-result-receipt-artifact-signature-notarization-request"; "blocked_artifact_noop"; "artifact_signature_notarization_acceptance_denied"; {artifact_signature_requested:true, artifact_notarization_requested:true, release_artifact_publication_requested:true}),
    blocked_fixture("activation-result-receipt-publication-queue-request"; "blocked_publication_noop"; "publication_queue_enqueue_denied"; {publication_queue_enqueue_requested:true, publication_manifest_write_requested:true}),
    blocked_fixture("activation-result-receipt-distribution-channel-request"; "blocked_distribution_noop"; "public_distribution_channel_delivery_denied"; {public_distribution_requested:true, telegram_delivery_requested:true, channel_delivery_requested:true, external_delivery_requested:true}),
    blocked_fixture("activation-result-receipt-public-version-tag-request"; "blocked_release_noop"; "public_version_tag_release_promotion_denied"; {public_version_tag_requested:true, public_release_publish_requested:true, public_ga_claim_requested:true}),
    blocked_fixture("activation-result-receipt-release-notes-changelog-request"; "blocked_artifact_noop"; "release_notes_changelog_materialization_denied"; {release_notes_materialization_requested:true, changelog_materialization_requested:true}),
    blocked_fixture("activation-result-receipt-terminal-decision-as-release-approval"; "blocked_promotion_noop"; "terminal_operator_decision_is_not_release_approval"; {terminal_operator_decision_release_approval_requested:true, release_artifact_publication_requested:true}),
    blocked_fixture("activation-result-receipt-release-publication-activation-memory-provider-install"; "blocked_promotion_noop"; "activation_memory_provider_install_restart_active_binary_publication_denied"; {activation_from_release_publication_requested:true, memory_write_publication_requested:true, provider_prompt_publication_requested:true, install_publication_requested:true, service_restart_publication_requested:true, active_binary_publication_requested:true})
  ] as $fixtures
  | {
    product:$product,
    runtime:$runtime,
    ...
    base_url:$base_url,
    gate:$gate,
    activation_command_result_receipt_release_artifact_publication_mode:"memory_write_execution_activation_command_result_receipt_release_artifact_publication_denial",
    source_activation_command_result_receipt_terminal_operator_decision_public_claim_gate:$source.gate,
    source_activation_command_result_receipt_terminal_operator_decision_public_claim_ready:$source.memory_write_execution_activation_command_result_receipt_terminal_operator_decision_public_claim_non_promotion_denial_ready,
    ...
    source_activation_command_result_receipt_final_operator_acknowledgement_ready:$source.memory_write_execution_activation_command_result_receipt_final_operator_acknowledgement_non_acceptance_denial_ready,
    ...
    memory_write_execution_activation_command_result_receipt_release_artifact_publication_denial_ready:true,
    memory_write_execution_activation_command_result_receipt_terminal_operator_decision_public_claim_non_promotion_denial_ready:true,
...
printf '%s\n' "$report" | jq .
echo "Hepta memory live mutation operator write execution activation command result receipt release artifact publication denial gate passed"
