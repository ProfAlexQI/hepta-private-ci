...
REPORT_SCRIPT="$ROOT/scripts/hepta-systems-work-graph-terminal-receipt-retention-readback-ack-terminal-decision-receipt-retention-readback-ack-terminal-decision-receipt-retention-readback-ack-terminal-decision-receipt-retention-expiry-preview-report.sh"
...
jq -e '
  ...
  and .runtime == "hepta"
  and .status == "ready"
  and .gate == "hepta_work_graph_persistence_acceptance_effect_application_denial_receipt_retention_expiry_readback_acknowledgement_terminal_decision_non_promotion_receipt_retention_expiry_readback_acknowledgement_terminal_decision_non_promotion_receipt_retention_expiry_readback_acknowledgement_terminal_decision_non_promotion_receipt_retention_expiry_readback_acknowledgement_terminal_decision_non_promotion_receipt_retention_expiry_preview_gate"
  and .schema_version == "work_graph_persistence_acceptance_effect_application_denial_receipt_retention_expiry_readback_acknowledgement_terminal_decision_non_promotion_receipt_retention_expiry_readback_acknowledgement_terminal_decision_non_promotion_receipt_retention_expiry_readback_acknowledgement_terminal_decision_non_promotion_receipt_retention_expiry_readback_acknowledgement_terminal_decision_non_promotion_receipt_retention_expiry_preview_v1"
  ...
  and (.retention_policies | all(.hash_only == true and .persistence_enabled == false and .garbage_collection_allowed == false and ((.required_fields | length) >= 11) and has_durable_fields))
  ...
  and (.supersession_guards | all(.blocks_mutation == true and ((.required_fields | length) >= 10) and has_durable_fields))
  and .garbage_collection_denial_count == 7
  and (.garbage_collection_denials | length) == .garbage_collection_denial_count
  and (.garbage_collection_denials[0].id == "durable_identity_evidence_missing")
  ...
  and (.durable_identity_evidence.required_field_ids | length) == 7
  and (.durable_identity_evidence.required_field_ids | index("workflow_id") != null)
  and (.durable_identity_evidence.required_field_ids | index("receipt_hash") != null)
  and (.durable_identity_evidence.required_for_retention_policy_ids | length) == 6
  ...
  and (.invariants | map(.id) | index("terminal_receipt_retention_readback_ack_terminal_decision_receipt_retention_requires_durable_identity_evidence") != null)
  ...
  and .recommended_next_gate == "hepta_work_graph_persistence_acceptance_effect_application_denial_receipt_retention_expiry_readback_acknowledgement_terminal_decision_non_promotion_receipt_retention_expiry_readback_acknowledgement_terminal_decision_non_promotion_receipt_retention_expiry_readback_acknowledgement_terminal_decision_non_promotion_receipt_retention_expiry_readback_acknowledgement_terminal_decision_non_promotion_receipt_retention_expiry_readback_receipt_preview_gate"
