...
SOURCE_REPORT_SCRIPT="$ROOT/scripts/hepta-systems-work-graph-live-attachment-tc-readback-ai-np-fcrb-ai-np-fcrb-ai-np-fcrb-ai-np-fcrb-ai-np-fc-readback-ai-report.sh"

source_report="$(
  capture_json_report \
    "hepta-work-graph-live-attachment-tc-readback-ai-np-fcrb-ai-np-fcrb-ai-np-fcrb-ai-np-fcrb-ai-np-fc-readback-ai-report" \
...
jq -n \
  ...
  | (
      $source.gate == "hepta_work_graph_agent_jobs_task_board_scheduler_guardrail_blocking_dry_run_entrypoint_live_attachment_attachability_precondition_readiness_readback_terminal_no_attachment_final_closeout_readback_terminal_closeout_readback_audit_index_non_persistence_final_closeout_readback_audit_index_non_persistence_final_closeout_readback_audit_index_non_persistence_final_closeout_readback_audit_index_non_persistence_final_closeout_readback_audit_index_non_persistence_final_closeout_readback_audit_index_non_persistence_final_closeout_readback_audit_index_non_persistence_final_closeout_readback_audit_index_gate"
      ...
      and $source.audit_index_entry_count == ($source.audit_index_entries | length)
      and $source.audit_index_entry_count == 9
      and $source.audit_index_blocker_count == ($source.audit_index_blockers | length)
      and $source.audit_index_blocker_count == 164
      and $source.required_prior_gate_count == ($source.required_prior_gates | length)
      and $source.required_prior_gate_count == 59
