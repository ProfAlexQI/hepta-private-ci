...
prior_report_script="scripts/hepta-systems-work-graph-dtd8-retack-td-rback-ack-td-rcpt-ret-rback-ack-td-rcpt-ret-expiry-preview-report.sh"
prior_gate_script="scripts/hepta-systems-work-graph-dtd8-retack-td-rback-ack-td-rcpt-ret-rback-ack-td-rcpt-ret-expiry-preview-gate.sh"
...
rust_module="codex-rs/hepta-runtime/src/wg_deep_td8_ret_ack_td_rback_ack_td_receipt_retention_readback_ack_td_receipt_retention_readback_receipt_preview.rs"
report_script="scripts/hepta-systems-work-graph-dtd8-retack-td-rback-ack-td-rcpt-ret-rback-ack-td-rcpt-ret-readback-receipt-preview-report.sh"
gate_script="scripts/hepta-systems-work-graph-dtd8-retack-td-rback-ack-td-rcpt-ret-rback-ack-td-rcpt-ret-readback-receipt-preview-gate.sh"
