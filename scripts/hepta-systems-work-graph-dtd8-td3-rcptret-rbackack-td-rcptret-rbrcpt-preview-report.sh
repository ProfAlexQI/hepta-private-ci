...
prior_report_script="scripts/hepta-systems-work-graph-dtd8-td3-rcptret-rbackack-td-rcptret-expiry-preview-report.sh"
prior_gate_script="scripts/hepta-systems-work-graph-dtd8-td3-rcptret-rbackack-td-rcptret-expiry-preview-gate.sh"
...
rust_module="codex-rs/hepta-runtime/src/wg_deep_td8_retack_td3_rcptret_rbackack_td_rcptret_rbrcpt_preview.rs"
report_script="scripts/hepta-systems-work-graph-dtd8-td3-rcptret-rbackack-td-rcptret-rbrcpt-preview-report.sh"
gate_script="scripts/hepta-systems-work-graph-dtd8-td3-rcptret-rbackack-td-rcptret-rbrcpt-preview-gate.sh"
...
jq -n \
  ...
  def item($prefix; $count): [range(0; $count) | {
    id: "deep_td8_td3_rcptret_rbackack_td_rcptret_rbrcpt_\($prefix)_\(.)",
  ...
  }];
  {
    ...
    receipts: item("receipt"; 6),
    digest_checks: item("digest_check"; 6),
    mismatch_denials: item("mismatch_denial"; 7),
    receipt_guards: item("receipt_guard"; 5),
    ...
    source_probes: {
      deep_td8_td3_rcptret_rbackack_td_receipt_retention_readback_receipt: {
      ...
      prior_deep_td8_td3_rcptret_rbackack_td_receipt_retention: {
