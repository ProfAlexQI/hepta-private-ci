...
rust_module="codex-rs/hepta-runtime/src/wg_term_decision_receipt_retention_readback_ack_terminal_decision_receipt_retention_readback_ack_terminal_decision_receipt_retention_readback_ack_terminal_decision_receipt_ack_preview.rs"
report_script="scripts/hepta-systems-work-graph-terminal-receipt-retention-readback-ack-terminal-decision-receipt-retention-readback-ack-terminal-decision-receipt-retention-readback-ack-terminal-decision-receipt-acknowledgement-preview-report.sh"
gate_script="scripts/hepta-systems-work-graph-terminal-receipt-retention-readback-ack-terminal-decision-receipt-retention-readback-ack-terminal-decision-receipt-retention-readback-ack-terminal-decision-receipt-acknowledgement-preview-gate.sh"
prior_report_script="scripts/hepta-systems-work-graph-terminal-receipt-retention-readback-ack-terminal-decision-receipt-retention-readback-ack-terminal-decision-receipt-retention-readback-ack-terminal-decision-receipt-preview-report.sh"
prior_gate_script="scripts/hepta-systems-work-graph-terminal-receipt-retention-readback-ack-terminal-decision-receipt-retention-readback-ack-terminal-decision-receipt-retention-readback-ack-terminal-decision-receipt-preview-gate.sh"
...
jq -n \
  ...
  | [
    reason("durable_identity_evidence_missing"; "terminal decision receipt acknowledgement lacks durable identity evidence"),
  ...
  | [
    denial("deny_durable_identity_terminal_receipt_retention_readback_ack_terminal_decision_receipt_ack_recording"; "durable_identity_evidence"; "terminal decision receipt acknowledgement recording is blocked without durable identity evidence"),
  ...
  | [
    guard("terminal_decision_receipt_expired_before_acknowledgement"; ["receiptId", "expiresAt", "observedAt"] + durable_fields),
    guard("terminal_decision_receipt_scope_superseded_before_acknowledgement"; ["receiptScope", "scopeEpoch", "supersessionHash"] + durable_fields),
    guard("terminal_decision_receipt_digest_mismatch_before_acknowledgement"; ["receiptHash", "acknowledgementHash", "priorGateDigest"] + durable_fields),
    guard("terminal_decision_receipt_acknowledgement_replay_detected"; ["acknowledgementId", "idempotencyKey", "replayHash"] + durable_fields),
    guard("terminal_decision_receipt_cross_scope_acknowledgement_detected"; ["receiptScope", "acknowledgementScope", "scopeBindingHash"] + durable_fields)
  ] as $expiry_replay_guards
  | [
    view("operator_terminal_decision_receipt_acknowledgement_view"; "operator"; ["acknowledgementId", "receiptHash", "acceptanceAllowed", "nextGate"] + durable_fields),
    view("release_owner_terminal_decision_receipt_acknowledgement_view"; "release_owner"; ["releasePublished", "publicClaimRecorded", "authorityGranted", "externalDeliveryDenied"] + durable_fields),
    view("auditor_terminal_decision_receipt_acknowledgement_digest_view"; "auditor"; ["receiptHash", "acknowledgementHash", "priorGateDigest", "recordingDenialId"] + durable_fields),
    view("runtime_terminal_decision_receipt_acknowledgement_zero_effect_view"; "system"; ["acknowledgementRecorded", "authorityGranted", "trafficRouted", "externalSendPerformed"] + durable_fields)
  ] as $local_views
  | [
  ...
  | {
    ...
    runtime: "hepta",
    status: "ready",
    gate: "hepta_work_graph_persistence_acceptance_effect_application_denial_receipt_retention_expiry_readback_acknowledgement_terminal_decision_non_promotion_receipt_retention_expiry_readback_acknowledgement_terminal_decision_non_promotion_receipt_retention_expiry_readback_acknowledgement_terminal_decision_non_promotion_receipt_retention_expiry_readback_acknowledgement_terminal_decision_non_promotion_receipt_acknowledgement_preview_gate",
    schema_version: "work_graph_persistence_acceptance_effect_application_denial_receipt_retention_expiry_readback_acknowledgement_terminal_decision_non_promotion_receipt_retention_expiry_readback_acknowledgement_terminal_decision_non_promotion_receipt_retention_expiry_readback_acknowledgement_terminal_decision_non_promotion_receipt_retention_expiry_readback_acknowledgement_terminal_decision_non_promotion_receipt_acknowledgement_preview_v1",
    ...
    recommended_next_gate: "hepta_work_graph_persistence_acceptance_effect_application_denial_receipt_retention_expiry_readback_acknowledgement_terminal_decision_non_promotion_receipt_retention_expiry_readback_acknowledgement_terminal_decision_non_promotion_receipt_retention_expiry_readback_acknowledgement_terminal_decision_non_promotion_receipt_retention_expiry_readback_acknowledgement_terminal_decision_non_promotion_receipt_acknowledgement_replay_idempotency_preview_gate",
    ...
    source_probes: {
      ...
      terminal_decision_receipt_retention_readback_ack_terminal_decision_receipt_retention_readback_ack_terminal_decision_receipt_retention_readback_ack_terminal_decision_receipt: {
