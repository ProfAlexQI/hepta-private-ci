...
prior_report_script="scripts/hepta-systems-work-graph-deep-td8-terminal-decision-receipt-ack-replay-preview-report.sh"
prior_gate_script="scripts/hepta-systems-work-graph-deep-td8-terminal-decision-receipt-ack-replay-preview-gate.sh"
...
rust_module="codex-rs/hepta-runtime/src/wg_deep_td8_receipt_retention_expiry_preview.rs"
report_script="scripts/hepta-systems-work-graph-deep-td8-receipt-retention-expiry-preview-report.sh"
gate_script="scripts/hepta-systems-work-graph-deep-td8-receipt-retention-expiry-preview-gate.sh"
...
jq -n \
  ...
  def items($prefix; $count): [range(0; $count) | {id: "\($prefix)_\(.)", required_fields: ["priorGate", "receiptHash", "zeroEffectHash"], mutation_allowed: false, required: true}];
  {
    ...
    retention_policies: items("deep_td8_retention_policy"; 6),
    expiry_guards: items("deep_td8_expiry_guard"; 6),
    supersession_guards: items("deep_td8_supersession_guard"; 5),
    garbage_collection_denials: items("deep_td8_gc_denial"; 6),
    local_views: items("deep_td8_retention_view"; 4),
    invariants: items("deep_td8_retention_invariant"; 6),
    ...
    source_probes: {
      deep_td8_receipt_retention_expiry: {
