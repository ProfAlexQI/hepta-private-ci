...
REPORT_SCRIPT="$ROOT/scripts/hepta-systems-work-graph-dtd8-td3-rbtd5-td-rt-td-rt-td-rt-td-rt-td-rtx-preview-report.sh"
...
jq -e '
  ...
  and .source_probes.deep_td8_td3_rbackack_td14_receipt_retention_expiry.rust_module_present == true
  and .source_probes.prior_deep_td8_td3_rbackack_td14_terminal_decision_receipt_ack_replay.report_script_present == true
...
echo "Hepta WorkGraph deep td8 td3 rbackack td14 receipt retention expiry preview gate passed"
