...
prior_report_script="scripts/hepta-systems-work-graph-dtd8-td3-rcptret-rbackack-td-receipt-ack-replay-preview-report.sh"
prior_gate_script="scripts/hepta-systems-work-graph-dtd8-td3-rcptret-rbackack-td-receipt-ack-replay-preview-gate.sh"
...
rust_module="codex-rs/hepta-runtime/src/wg_deep_td8_retack_td3_rcptret_rbackack_td_rcptret_expiry_preview.rs"
report_script="scripts/hepta-systems-work-graph-dtd8-td3-rcptret-rbackack-td-rcptret-expiry-preview-report.sh"
gate_script="scripts/hepta-systems-work-graph-dtd8-td3-rcptret-rbackack-td-rcptret-expiry-preview-gate.sh"
...
jq -n \
  ...
  def item($prefix; $count): [range(0; $count) | {
    id: "deep_td8_td3_rcptret_rbackack_td_rcptret_\($prefix)_\(.)",
  ...
  }];
  {
    ...
    retention_policies: item("policy"; 6),
    expiry_guards: item("expiry_guard"; 6),
    supersession_guards: item("supersession_guard"; 5),
    garbage_collection_denials: item("gc_denial"; 6),
    ...
    source_probes: {
      deep_td8_td3_rcptret_rbackack_td_receipt_retention: {
      ...
      prior_deep_td8_td3_rcptret_rbackack_td_receipt_ack_replay: {
