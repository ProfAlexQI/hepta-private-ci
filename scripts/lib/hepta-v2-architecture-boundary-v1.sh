...
self_test() (
  ...
  mkdir -p "$fixture/codex-rs/hepta-runtime/src/runtime_kernel/"{tests,tool_support}
  cp "$ROOT/codex-rs/hepta-runtime/src/runtime_kernel/tests.rs" "$fixture/codex-rs/hepta-runtime/src/runtime_kernel/tests.rs"
  cp "$ROOT/codex-rs/hepta-runtime/src/runtime_kernel/tests/"part_0{1,2,3}.rs "$fixture/codex-rs/hepta-runtime/src/runtime_kernel/tests/"
  cp "$ROOT/codex-rs/hepta-runtime/src/runtime_kernel/tool_support/native_compat_adapters.rs" "$fixture/codex-rs/hepta-runtime/src/runtime_kernel/tool_support/"
  for source in \
