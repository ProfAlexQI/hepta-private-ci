...
hepta_release_fixture_bound_gate_receipts_json() {
  ...
  ingress_self='{"negative_fixtures":13,"schema":"hepta.native-ingress-composition-self-test.v2","status":"ready"}'
  dependency="$(
  ...
  compat='{"captured_shell_pair_count":1239,"compatibility_payload_count":2512,"counts_may_only_improve":true,"declarative_pair_count":35,"legacy_workgraph_pair_count":8,"pair_count":1282,"schema":"hepta_gate_compat_debt_receipt_v1","status":"ready","unregistered_payload_count":26}'
  compat_self='{"negative_fixtures":3,"schema":"hepta_gate_compat_debt_self_test_v1","status":"ready"}'
