    ...
    'def finding: (keys|sort)==["advisory_id","kind","package","version"] and (.advisory_id==null or (.advisory_id|test("^RUSTSEC-[0-9]{4}-[0-9]{4}$"))) and (.kind|IN("vulnerability","unmaintained","unsound","yanked")) and (.package|type=="string" and length>0) and (.version|type=="string" and length>0);
      ...
      and (
        (
          ...
          and $g["gate-compat-debt"].receipt == {"captured_shell_pair_count":463,"compatibility_payload_count":361,"counts_may_only_improve":true,"current_baseline_monotonic_ratchet":true,"declarative_pair_count":35,"effective_line_maintenance_headroom_percent":3,"entrypoint_manifest_verified":true,"legacy_workgraph_pair_count":0,"logical_compatibility_payload_count":952,"logical_virtual_entrypoint_count":927,"normalized_effective_lines":141142,"normalized_payload_bundle_verified":true,"pair_count":498,"payload_bundle_verified":true,"physical_entrypoint_count":69,"schema":"hepta_gate_compat_debt_receipt_v4","status":"ready","unregistered_payload_count":0,"virtual_entrypoint_count":2}
...
hepta_release_fixture_bound_gate_receipts_json() {
  ...
  compat='{"captured_shell_pair_count":463,"compatibility_payload_count":361,"counts_may_only_improve":true,"current_baseline_monotonic_ratchet":true,"declarative_pair_count":35,"effective_line_maintenance_headroom_percent":3,"entrypoint_manifest_verified":true,"legacy_workgraph_pair_count":0,"logical_compatibility_payload_count":952,"logical_virtual_entrypoint_count":927,"normalized_effective_lines":141142,"normalized_payload_bundle_verified":true,"pair_count":498,"payload_bundle_verified":true,"physical_entrypoint_count":69,"schema":"hepta_gate_compat_debt_receipt_v4","status":"ready","unregistered_payload_count":0,"virtual_entrypoint_count":2}'
