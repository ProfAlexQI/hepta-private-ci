...
FINAL_ACKNOWLEDGEMENT_JSON="$(
  HEPTA_LIVE_URL="$BASE_URL" \
    ...
    capture_json_report "hepta-memory-intelligence-kg-full-live-activation-artifact-download-install-affordance-result-receipt-final-operator-acknowledgement-non-acceptance-denial-gate" \
...
terminal_decision_status_promotion_contract_hash_sha256="$(
  sha256_text "hepta-memory-intelligence-kg-full-live-activation-artifact-download-install-affordance-result-receipt-terminal-decision-status-promotion-denial:$source_final_acknowledgement_report_sha256:$MIN_LONG_SOAK_SAMPLES"
)"
terminal_decision_status_promotion_policy_hash_sha256="$(
  sha256_text "artifact-download-install-affordance-result-receipt-terminal-decision-status-promotion:no-terminal-decision:no-status-promotion:no-delivery-status:no-approval:no-authority:no-install:no-live"
)"
...
jq -n -e \
  ...
  '
    ...
    and $source.gate == "hepta_memory_intelligence_kg_full_live_activation_operator_readiness_packet_template_packet_acceptance_receipt_release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_final_operator_acknowledgement_non_acceptance_denial_gate"
    and $source.memory_intelligence_kg_full_live_activation_operator_readiness_packet_template_packet_acceptance_receipt_release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_final_operator_acknowledgement_non_acceptance_denial_ready == true
    and $source.source_packet_acceptance_receipt_release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_operator_facing_summary_briefing_ready == true
    and $source.release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_final_operator_acknowledgement_surface_count == 18
    and $source.release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_final_operator_acknowledgement_attempt_count == 18
    and $source.release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_final_operator_acknowledgement_denied_count == 18
    ...
    and ($source.release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_final_operator_acknowledgement_surfaces | length) == 18
    and ($source.release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_final_operator_acknowledgement_surfaces | all(
...
terminal_decision_status_promotion_surfaces_json="$(
  jq -n '
    def terminal_surface($id; $status; $reason; $extra):
      {
        release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_terminal_decision_status_promotion_surface:$id,
    ...
    [
      terminal_surface("source_final_operator_acknowledgement_report_required"; "blocked_source_final_acknowledgement_required_noop"; "source_final_operator_acknowledgement_report_required"; {source_final_operator_acknowledgement_report_required:true}),
      terminal_surface("download_button_terminal_decision_promotion_claim"; "blocked_terminal_decision_noop"; "download_button_terminal_decision_promotion_claim_denied"; {terminal_decision_requested:true}),
      terminal_surface("direct_download_url_status_promoted_claim"; "blocked_direct_url_status_noop"; "direct_download_url_status_promoted_claim_denied"; {status_promotion_requested:true}),
      terminal_surface("checksum_prompt_terminal_status_verified_claim"; "blocked_checksum_status_noop"; "checksum_prompt_terminal_status_verified_claim_denied"; {terminal_status_verification_requested:true}),
      terminal_surface("package_manager_install_command_decision_record_claim"; "blocked_package_manager_decision_noop"; "package_manager_install_command_decision_record_claim_denied"; {decision_record_requested:true}),
      terminal_surface("curl_pipe_shell_status_banner_promotion_claim"; "blocked_status_banner_noop"; "curl_pipe_shell_status_banner_promotion_claim_denied"; {status_banner_promotion_requested:true}),
      terminal_surface("installer_launch_prompt_final_decision_claim"; "blocked_installer_decision_noop"; "installer_launch_prompt_final_decision_claim_denied"; {final_decision_requested:true}),
      terminal_surface("auto_update_offer_completion_status_promotion_claim"; "blocked_completion_status_noop"; "auto_update_offer_completion_status_promotion_claim_denied"; {completion_status_promotion_requested:true}),
      terminal_surface("release_channel_subscription_terminal_status_claim"; "blocked_release_channel_terminal_status_noop"; "release_channel_subscription_terminal_status_claim_denied"; {release_channel_terminal_status_requested:true}),
      terminal_surface("update_feed_hint_decision_summary_claim"; "blocked_update_feed_decision_summary_noop"; "update_feed_hint_decision_summary_claim_denied"; {decision_summary_requested:true}),
      terminal_surface("package_registry_badge_status_badge_claim"; "blocked_package_registry_status_badge_noop"; "package_registry_badge_status_badge_claim_denied"; {status_badge_requested:true}),
      terminal_surface("cdn_mirror_download_terminal_readback_claim"; "blocked_cdn_terminal_readback_noop"; "cdn_mirror_download_terminal_readback_claim_denied"; {terminal_readback_requested:true}),
      terminal_surface("sbom_provenance_notarization_dashboard_status_claim"; "blocked_dashboard_status_noop"; "sbom_provenance_notarization_dashboard_status_claim_denied"; {dashboard_status_requested:true}),
      terminal_surface("signature_verification_command_channel_decision_claim"; "blocked_channel_decision_noop"; "signature_verification_command_channel_decision_claim_denied"; {channel_decision_requested:true}),
      terminal_surface("one_click_install_deep_link_operator_approval_status_claim"; "blocked_operator_approval_status_noop"; "one_click_install_deep_link_operator_approval_status_claim_denied"; {operator_approval_status_requested:true}),
      terminal_surface("external_telegram_install_message_external_decision_claim"; "blocked_external_telegram_decision_noop"; "external_telegram_install_message_external_decision_claim_denied"; {external_decision_requested:true, telegram_decision_requested:true}),
      terminal_surface("release_publication_authority_terminal_decision_claim"; "blocked_authority_decision_noop"; "release_publication_authority_terminal_decision_claim_denied"; {authority_terminal_decision_requested:true}),
      terminal_surface("activation_live_install_restart_active_binary_status_promotion_claim"; "blocked_live_status_promotion_noop"; "activation_live_install_restart_active_binary_status_promotion_claim_denied"; {live_status_promotion_requested:true, install_restart_active_binary_status_requested:true})
    ]
  '
)"
...
report="$(
  jq -n \
    ...
    --arg gate "hepta_memory_intelligence_kg_full_live_activation_operator_readiness_packet_template_packet_acceptance_receipt_release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_terminal_decision_status_promotion_denial_gate" \
    ...
    '
...

      {
        ...
        receipt_release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_terminal_decision_status_promotion_mode:"denied_artifact_download_install_result_receipt_acknowledgement_cannot_create_terminal_decision_or_status_promotion",
        source_packet_acceptance_receipt_release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_final_operator_acknowledgement_gate:$source.gate,
        source_packet_acceptance_receipt_release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_final_operator_acknowledgement_ready:$source.memory_intelligence_kg_full_live_activation_operator_readiness_packet_template_packet_acceptance_receipt_release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_final_operator_acknowledgement_non_acceptance_denial_ready,
        source_packet_acceptance_receipt_release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_final_operator_acknowledgement_report_sha256:$source_final_acknowledgement_report_sha256,
        source_release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_final_operator_acknowledgement_contract_hash_sha256:$source.release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_final_operator_acknowledgement_contract_hash_sha256,
        release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_terminal_decision_status_promotion_contract_hash_sha256:$terminal_decision_status_promotion_contract_hash_sha256,
        release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_terminal_decision_status_promotion_policy_hash_sha256:$terminal_decision_status_promotion_policy_hash_sha256,
        minimum_required_samples:$min_long_soak_samples,
        memory_intelligence_kg_full_live_activation_operator_readiness_packet_template_packet_acceptance_receipt_release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_terminal_decision_status_promotion_denial_ready:true,
        source_release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_final_operator_acknowledgement_surface_count:$source.release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_final_operator_acknowledgement_surface_count,
        source_release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_final_operator_acknowledgement_attempt_count:$source.release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_final_operator_acknowledgement_attempt_count,
        source_release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_final_operator_acknowledgement_denied_count:$source.release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_final_operator_acknowledgement_denied_count,
        source_release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_final_operator_acknowledgement_recorded_count:$source.release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_final_operator_acknowledgement_recorded_count,
        ...
        release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_terminal_decision_status_promotion_surface_count:($surfaces | length),
        release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_terminal_decision_status_promotion_attempt_count:($surfaces | length),
        release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_terminal_decision_status_promotion_denied_count:($surfaces | length),
        release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_terminal_decision_status_promotion_surfaces:$surfaces,
        denied_by_packet_receipt_release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_terminal_decision_status_promotion:[
...
jq -e '
  ...
  and $report.gate == "hepta_memory_intelligence_kg_full_live_activation_operator_readiness_packet_template_packet_acceptance_receipt_release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_terminal_decision_status_promotion_denial_gate"
  and $report.memory_intelligence_kg_full_live_activation_operator_readiness_packet_template_packet_acceptance_receipt_release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_terminal_decision_status_promotion_denial_ready == true
  and $report.source_packet_acceptance_receipt_release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_final_operator_acknowledgement_ready == true
  and $report.source_release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_final_operator_acknowledgement_surface_count == 18
  and $report.source_release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_final_operator_acknowledgement_denied_count == 18
  and $report.release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_terminal_decision_status_promotion_surface_count == 18
  and $report.release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_terminal_decision_status_promotion_attempt_count == 18
  and $report.release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_terminal_decision_status_promotion_denied_count == 18
  ...
  and ($report.release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_terminal_decision_status_promotion_surfaces | length) == 18
  and ($report.release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_terminal_decision_status_promotion_surfaces | all(
    .artifact_download_install_affordance_result_receipt_terminal_decision_status_promotion_attempted == true
  ...
  and ([.release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_terminal_decision_status_promotion_surfaces[] | select(.terminal_decision_requested == true)] | length) == 1
  and ([.release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_terminal_decision_status_promotion_surfaces[] | select(.status_promotion_requested == true)] | length) == 1
  and ([.release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_terminal_decision_status_promotion_surfaces[] | select(.telegram_decision_requested == true)] | length) == 1
  and ([.release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_terminal_decision_status_promotion_surfaces[] | select(.install_restart_active_binary_status_requested == true)] | length) == 1
...
printf '%s\n' "$report" | jq .
echo "Hepta memory/intelligence/KG full live activation operator readiness packet template packet acceptance receipt release/publication result receipt terminal distribution delivery receipt artifact download/install affordance result receipt terminal decision/status promotion denial gate passed"
