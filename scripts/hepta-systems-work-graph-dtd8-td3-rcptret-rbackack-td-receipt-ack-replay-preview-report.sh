...
prior_report_script="scripts/hepta-systems-work-graph-dtd8-td3-rcptret-rbackack-td-receipt-ack-preview-report.sh"
prior_gate_script="scripts/hepta-systems-work-graph-dtd8-td3-rcptret-rbackack-td-receipt-ack-preview-gate.sh"
...
rust_module="codex-rs/hepta-runtime/src/wg_deep_td8_retack_td3_rcptret_rbackack_td_receipt_ack_replay_preview.rs"
report_script="scripts/hepta-systems-work-graph-dtd8-td3-rcptret-rbackack-td-receipt-ack-replay-preview-report.sh"
gate_script="scripts/hepta-systems-work-graph-dtd8-td3-rcptret-rbackack-td-receipt-ack-replay-preview-gate.sh"
...
jq -n \
  ...
  '
  def ack_ids: [range(0; 6) | "deep_td8_td3_rcptret_rbackack_td_receipt_ack_\(.)"];
  ...
  }];
  {
    ...
    replay_scenarios: item("deep_td8_td3_rcptret_rbackack_td_receipt_ack_replay_scenario"; 6),
    idempotency_guards: item("deep_td8_td3_rcptret_rbackack_td_receipt_ack_idempotency_guard"; 7),
    replay_denials: item("deep_td8_td3_rcptret_rbackack_td_receipt_ack_replay_denial"; 7),
    monotonicity_checks: item("deep_td8_td3_rcptret_rbackack_td_receipt_ack_monotonicity_check"; 5),
    local_views: item("deep_td8_td3_rcptret_rbackack_td_receipt_ack_replay_local_view"; 4),
    invariants: item("deep_td8_td3_rcptret_rbackack_td_receipt_ack_replay_invariant"; 6),
    ...
    source_probes: {
      deep_td8_td3_rcptret_rbackack_terminal_decision_receipt_ack_replay: {
      ...
      prior_deep_td8_td3_rcptret_rbackack_terminal_decision_receipt_ack: {
