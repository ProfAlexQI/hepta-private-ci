...
jq -n \
  ...
  | (
      ...
      and $source.source_readbacks.non_persistence_readback_preconditions_complete == true
      and $source.source_readbacks.non_persistence_readback_ready_for_final_closeout == true
  ...
  | (
      $source.gate == "hepta_work_graph_agent_jobs_task_board_scheduler_guardrail_blocking_dry_run_entrypoint_live_attachment_attachability_precondition_readiness_readback_terminal_no_attachment_final_closeout_readback_terminal_closeout_readback_audit_index_non_persistence_final_closeout_readback_audit_index_non_persistence_final_closeout_readback_audit_index_non_persistence_final_closeout_readback_audit_index_non_persistence_final_closeout_readback_audit_index_non_persistence_final_closeout_gate"
      ...
      and $source.final_closeout_blocker_count == 134
      and $source.required_prior_gate_count == 49
      and $source_final_closeout_no_live_confirmed
    ) as $source_final_closeout_ready
  | ($source_final_closeout_ready and $source.ready_for_terminal_closeout_readback_audit_index_non_persistence_final_closeout_readback == true) as $source_final_closeout_ready_for_readback
  | [
  ...
  | {
      ...
      preview_mode: "scheduler_guardrail_blocking_dry_run_entrypoint_live_attachment_attachability_terminal_closeout_readback_audit_index_non_persistence_final_closeout_readback_audit_index_non_persistence_final_closeout_readback_audit_index_non_persistence_final_closeout_readback_audit_index_non_persistence_final_closeout_readback_audit_index_non_persistence_final_closeout_readback_only",
      ...
      recommended_next_gate: ($source.recommended_next_gate | sub("_non_persistence_final_closeout_readback_gate$"; "_non_persistence_final_closeout_readback_audit_index_gate")),
