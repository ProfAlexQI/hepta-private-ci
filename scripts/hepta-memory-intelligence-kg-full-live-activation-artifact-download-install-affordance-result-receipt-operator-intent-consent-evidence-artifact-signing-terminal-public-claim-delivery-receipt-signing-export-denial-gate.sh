...
if ! command -v jq >/dev/null 2>&1; then
  echo "jq is required to build the terminal public claim delivery receipt artifact signing receipt export/query/observability denial report" >&2
  exit 1
fi
...
SOURCE_GATE="scripts/hepta-memory-intelligence-kg-full-live-activation-artifact-download-install-affordance-result-receipt-operator-intent-consent-evidence-artifact-signing-terminal-public-claim-delivery-receipt-signing-retention-denial-gate.sh"
[[ -x "$SOURCE_GATE" ]] || {
  echo "missing executable terminal public claim delivery receipt artifact signing receipt retention/expiry/GC denial gate: $SOURCE_GATE" >&2
  exit 1
}
...
signing_export_contract_hash_sha256="$(
...
signing_export_policy_hash_sha256="$(
...
surfaces_json="$(
  jq -n '[
    ...
    terminal_public_claim_delivery_receipt_artifact_signing_receipt_export_query_observability_surface: .,
    source_terminal_public_claim_delivery_receipt_artifact_signing_receipt_retention_expiry_gc_ready: true,
    ...
    signing_receipt_export_query_observability_status: "artifact_signing_receipt_export_query_observability_denied"
  })'
)"
...
report="$(
  jq -n \
    ...
    --arg gate "hepta_memory_intelligence_kg_full_live_activation_operator_readiness_packet_template_packet_acceptance_receipt_release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_operator_identity_session_revocation_logout_replay_reinstatement_operator_intent_consent_evidence_artifact_distribution_signing_notarization_receipt_terminal_public_claim_delivery_receipt_artifact_signing_receipt_export_query_observability_denial_gate" \
    --arg source_report_sha256 "$source_report_sha256" \
    --arg signing_export_contract_hash_sha256 "$signing_export_contract_hash_sha256" \
    --arg signing_export_policy_hash_sha256 "$signing_export_policy_hash_sha256" \
    ...
    '
...

      {
        ...
        base_url: $base_url,
        gate: $gate,
        terminal_public_claim_delivery_receipt_artifact_signing_receipt_export_query_observability_schema_version: "terminal_public_claim_delivery_receipt_artifact_signing_receipt_export_query_observability_denial_v1",
        terminal_public_claim_delivery_receipt_artifact_signing_receipt_export_query_observability_mode: "denied_signing_receipt_retention_cannot_export_query_observe_or_derive_authority_or_install",
        source_terminal_public_claim_delivery_receipt_artifact_signing_receipt_retention_expiry_gc_gate: $source.gate,
        source_terminal_public_claim_delivery_receipt_artifact_signing_receipt_retention_expiry_gc_ready: $source.memory_intelligence_kg_full_live_activation_operator_readiness_packet_template_packet_acceptance_receipt_release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_operator_identity_session_revocation_logout_replay_reinstatement_operator_intent_consent_evidence_artifact_distribution_signing_notarization_receipt_terminal_public_claim_delivery_receipt_artifact_signing_receipt_retention_expiry_gc_denial_ready,
        source_terminal_public_claim_delivery_receipt_artifact_signing_receipt_retention_expiry_gc_report_sha256: $source_report_sha256,
        terminal_public_claim_delivery_receipt_artifact_signing_receipt_export_query_observability_contract_hash_sha256: $signing_export_contract_hash_sha256,
        terminal_public_claim_delivery_receipt_artifact_signing_receipt_export_query_observability_policy_hash_sha256: $signing_export_policy_hash_sha256,
        ...
        source_terminal_public_claim_delivery_receipt_artifact_signing_receipt_retention_expiry_gc_surface_count: $source.terminal_public_claim_delivery_receipt_artifact_signing_receipt_retention_expiry_gc_surface_count,
        source_terminal_public_claim_delivery_receipt_artifact_signing_receipt_retention_expiry_gc_denied_count: $source.terminal_public_claim_delivery_receipt_artifact_signing_receipt_retention_expiry_gc_denied_count,
        terminal_public_claim_delivery_receipt_artifact_signing_receipt_export_query_observability_surface_count: ($surfaces | length),
        terminal_public_claim_delivery_receipt_artifact_signing_receipt_export_query_observability_attempt_count: ($surfaces | length),
        terminal_public_claim_delivery_receipt_artifact_signing_receipt_export_query_observability_denied_count: ($surfaces | length),
        terminal_public_claim_delivery_receipt_artifact_signing_receipt_export_query_observability_surfaces: $surfaces,
        denied_by_terminal_public_claim_delivery_receipt_artifact_signing_receipt_export_query_observability: ($surfaces | map(.terminal_public_claim_delivery_receipt_artifact_signing_receipt_export_query_observability_surface)),
        allowed_next_actions: [
          {
            action: "prepare_terminal_public_claim_delivery_receipt_artifact_signing_receipt_summary_briefing_denial_gate",
      ...
      + zero_object([
        "terminal_public_claim_delivery_receipt_artifact_signing_receipt_export_query_observability_allowed_count",
        "terminal_public_claim_delivery_receipt_artifact_signing_receipt_export_query_observability_accepted_count",
        "terminal_public_claim_delivery_receipt_artifact_signing_receipt_export_query_observability_recorded_count",
        "terminal_public_claim_delivery_receipt_artifact_signing_receipt_export_query_observability_persisted_count",
        "terminal_public_claim_delivery_receipt_artifact_signing_receipt_export_query_observability_materialized_count",
        "terminal_public_claim_delivery_receipt_artifact_signing_receipt_export_query_observability_filesystem_written_count",
      ...
      + false_object([
        "terminal_public_claim_delivery_receipt_artifact_signing_receipt_export_query_observability_allowed",
        "terminal_public_claim_delivery_receipt_artifact_signing_receipt_export_query_observability_accepted",
        "terminal_public_claim_delivery_receipt_artifact_signing_receipt_export_query_observability_recorded",
        "terminal_public_claim_delivery_receipt_artifact_signing_receipt_export_query_observability_persisted",
        "terminal_public_claim_delivery_receipt_artifact_signing_receipt_export_query_observability_materialized",
        "terminal_public_claim_delivery_receipt_artifact_signing_receipt_export_query_observability_filesystem_written",
...
jq -e '
  ...
  .runtime == "hepta"
  and .status == "ready"
  and .memory_intelligence_kg_full_live_activation_operator_readiness_packet_template_packet_acceptance_receipt_release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_operator_identity_session_revocation_logout_replay_reinstatement_operator_intent_consent_evidence_artifact_distribution_signing_notarization_receipt_terminal_public_claim_delivery_receipt_artifact_signing_receipt_export_query_observability_denial_ready == true
  and .source_terminal_public_claim_delivery_receipt_artifact_signing_receipt_retention_expiry_gc_ready == true
  and .source_terminal_public_claim_delivery_receipt_artifact_signing_receipt_retention_expiry_gc_surface_count == 18
  and .source_terminal_public_claim_delivery_receipt_artifact_signing_receipt_retention_expiry_gc_denied_count == 18
  ...
  and (.terminal_public_claim_delivery_receipt_artifact_signing_receipt_export_query_observability_surfaces | length) == 18
  and (.terminal_public_claim_delivery_receipt_artifact_signing_receipt_export_query_observability_surfaces | all(
    .signing_receipt_export_query_observability_attempted == true
...
echo "Hepta memory/intelligence/KG artifact signing terminal public claim delivery receipt artifact signing receipt export/query/observability denial gate passed" >&2
