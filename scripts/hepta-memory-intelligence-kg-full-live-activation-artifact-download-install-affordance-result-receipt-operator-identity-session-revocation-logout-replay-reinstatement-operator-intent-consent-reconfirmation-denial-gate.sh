...
TERMINAL_DECISION_JSON="$(
  HEPTA_LIVE_URL="$BASE_URL" \
    ...
    capture_json_report "hepta-memory-intelligence-kg-full-live-activation-artifact-download-install-affordance-result-receipt-operator-identity-session-revocation-logout-replay-reinstatement-terminal-decision-status-promotion-denial-gate" \
...
operator_intent_consent_contract_hash_sha256="$(
  sha256_text "hepta-memory-intelligence-kg-full-live-activation-artifact-download-install-affordance-result-receipt-operator-identity-session-revocation-logout-replay-reinstatement-operator-intent-consent-reconfirmation-denial:$source_terminal_decision_report_sha256:$MIN_LONG_SOAK_SAMPLES"
)"
operator_intent_consent_policy_hash_sha256="$(
  sha256_text "artifact-download-install-affordance-result-receipt-operator-identity-session-revocation-logout-replay-reinstatement-operator-intent-consent-reconfirmation:no-intent:no-consent:no-reconfirmation:no-approval:no-authority:no-install:no-live"
)"
...
jq -n -e \
  ...
  '
    ...
    and ($source.release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_operator_identity_session_revocation_logout_replay_reinstatement_terminal_decision_status_promotion_surfaces | length) == 18
    and ($source.release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_operator_identity_session_revocation_logout_replay_reinstatement_terminal_decision_status_promotion_surfaces | all(
...
operator_intent_consent_surfaces_json="$(
  jq -n '
    def consent_surface($id; $status; $reason; $extra):
      {
        release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_operator_identity_session_revocation_logout_replay_reinstatement_operator_intent_consent_reconfirmation_surface:$id,
    ...
    [
      consent_surface("source_operator_identity_session_revocation_logout_replay_reinstatement_terminal_decision_status_promotion_report_required"; "blocked_source_terminal_status_required_noop"; "source_operator_identity_session_revocation_logout_replay_reinstatement_terminal_decision_status_promotion_report_required"; {source_terminal_decision_status_promotion_report_required:true}),
      consent_surface("download_button_revocation_replay_operator_intent_reconfirmation_claim"; "blocked_revocation_replay_operator_intent_noop"; "download_button_revocation_replay_operator_intent_reconfirmation_claim_denied"; {operator_intent_reconfirmation_requested:true}),
      consent_surface("direct_download_url_logout_replay_operator_consent_reconfirmation_claim"; "blocked_logout_replay_operator_consent_noop"; "direct_download_url_logout_replay_operator_consent_reconfirmation_claim_denied"; {operator_consent_reconfirmation_requested:true}),
      consent_surface("checksum_identity_reinstatement_intent_signature_claim"; "blocked_identity_reinstatement_intent_signature_noop"; "checksum_identity_reinstatement_intent_signature_claim_denied"; {identity_signature_requested:true}),
      consent_surface("package_manager_session_reinstatement_consent_token_claim"; "blocked_session_reinstatement_consent_token_noop"; "package_manager_session_reinstatement_consent_token_claim_denied"; {session_consent_token_requested:true}),
      consent_surface("curl_pipe_shell_revocation_replay_intent_timestamp_claim"; "blocked_revocation_replay_intent_timestamp_noop"; "curl_pipe_shell_revocation_replay_intent_timestamp_claim_denied"; {revocation_replay_intent_timestamp_requested:true}),
      consent_surface("installer_device_session_consent_nonce_claim"; "blocked_device_session_consent_nonce_noop"; "installer_device_session_consent_nonce_claim_denied"; {device_session_consent_nonce_requested:true}),
      consent_surface("auto_update_session_logout_replay_consent_refresh_claim"; "blocked_session_logout_replay_consent_refresh_noop"; "auto_update_session_logout_replay_consent_refresh_claim_denied"; {logout_replay_consent_refresh_requested:true}),
      consent_surface("release_channel_identity_revocation_replay_intent_status_claim"; "blocked_identity_revocation_replay_intent_status_noop"; "release_channel_identity_revocation_replay_intent_status_claim_denied"; {identity_revocation_replay_intent_status_requested:true}),
      consent_surface("update_feed_session_reinstatement_consent_summary_claim"; "blocked_session_reinstatement_consent_summary_noop"; "update_feed_session_reinstatement_consent_summary_claim_denied"; {session_reinstatement_consent_summary_requested:true}),
      consent_surface("package_registry_identity_badge_intent_badge_claim"; "blocked_identity_badge_intent_badge_noop"; "package_registry_identity_badge_intent_badge_claim_denied"; {operator_intent_badge_requested:true}),
      consent_surface("cdn_session_readback_logout_replay_consent_readback_claim"; "blocked_logout_replay_consent_readback_noop"; "cdn_session_readback_logout_replay_consent_readback_claim_denied"; {consent_readback_requested:true}),
      consent_surface("sbom_identity_dashboard_reinstatement_consent_notification_claim"; "blocked_identity_dashboard_consent_notification_noop"; "sbom_identity_dashboard_reinstatement_consent_notification_claim_denied"; {consent_notification_requested:true}),
      consent_surface("signature_channel_session_consent_delivery_claim"; "blocked_session_channel_consent_delivery_noop"; "signature_channel_session_consent_delivery_claim_denied"; {channel_consent_requested:true}),
      consent_surface("one_click_identity_approval_reinstatement_reconfirmed_consent_claim"; "blocked_identity_approval_reconfirmed_consent_noop"; "one_click_identity_approval_reinstatement_reconfirmed_consent_claim_denied"; {operator_intent_approval_requested:true}),
      consent_surface("external_telegram_identity_session_reinstatement_consent_reconfirmation_claim"; "blocked_external_telegram_consent_noop"; "external_telegram_identity_session_reinstatement_consent_reconfirmation_claim_denied"; {external_consent_requested:true, telegram_consent_requested:true}),
      consent_surface("release_publication_authority_replay_reinstatement_intent_consent_claim"; "blocked_authority_intent_consent_noop"; "release_publication_authority_replay_reinstatement_intent_consent_claim_denied"; {authority_intent_consent_requested:true}),
      consent_surface("activation_live_install_restart_active_binary_reinstatement_consent_claim"; "blocked_live_consent_noop"; "activation_live_install_restart_active_binary_reinstatement_consent_claim_denied"; {live_consent_requested:true, install_restart_active_binary_consent_requested:true})
    ]
  '
)"
...
report="$(
  jq -n \
    ...
    --arg gate "hepta_memory_intelligence_kg_full_live_activation_operator_readiness_packet_template_packet_acceptance_receipt_release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_operator_identity_session_revocation_logout_replay_reinstatement_operator_intent_consent_reconfirmation_denial_gate" \
    ...
    '
...

      {
        ...
        release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_operator_identity_session_revocation_logout_replay_reinstatement_operator_intent_consent_reconfirmation_contract_hash_sha256:$operator_intent_consent_contract_hash_sha256,
        release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_operator_identity_session_revocation_logout_replay_reinstatement_operator_intent_consent_reconfirmation_policy_hash_sha256:$operator_intent_consent_policy_hash_sha256,
        ...
        release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_operator_identity_session_revocation_logout_replay_reinstatement_operator_intent_consent_reconfirmation_surface_count:($surfaces | length),
        release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_operator_identity_session_revocation_logout_replay_reinstatement_operator_intent_consent_reconfirmation_attempt_count:($surfaces | length),
        release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_operator_identity_session_revocation_logout_replay_reinstatement_operator_intent_consent_reconfirmation_denied_count:($surfaces | length),
        ...
        denied_by_packet_receipt_release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_operator_identity_session_revocation_logout_replay_reinstatement_operator_intent_consent_reconfirmation:[
          ...
          "operator_identity_session_revocation_logout_replay_reinstatement_intent_timestamp_recording_denied",
          "operator_identity_session_revocation_logout_replay_reinstatement_consent_nonce_recording_denied",
...
jq -e '
  ...
  and $report.gate == "hepta_memory_intelligence_kg_full_live_activation_operator_readiness_packet_template_packet_acceptance_receipt_release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_operator_identity_session_revocation_logout_replay_reinstatement_operator_intent_consent_reconfirmation_denial_gate"
  and $report.memory_intelligence_kg_full_live_activation_operator_readiness_packet_template_packet_acceptance_receipt_release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_operator_identity_session_revocation_logout_replay_reinstatement_operator_intent_consent_reconfirmation_denial_ready == true
  and $report.source_packet_acceptance_receipt_release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_operator_identity_session_revocation_logout_replay_reinstatement_terminal_decision_status_promotion_ready == true
  and $report.source_release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_operator_identity_session_revocation_logout_replay_reinstatement_terminal_decision_status_promotion_surface_count == 18
  and $report.source_release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_operator_identity_session_revocation_logout_replay_reinstatement_terminal_decision_status_promotion_denied_count == 18
  and $report.release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_operator_identity_session_revocation_logout_replay_reinstatement_operator_intent_consent_reconfirmation_surface_count == 18
  and $report.release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_operator_identity_session_revocation_logout_replay_reinstatement_operator_intent_consent_reconfirmation_attempt_count == 18
  and $report.release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_operator_identity_session_revocation_logout_replay_reinstatement_operator_intent_consent_reconfirmation_denied_count == 18
  ...
  and ($report.release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_operator_identity_session_revocation_logout_replay_reinstatement_operator_intent_consent_reconfirmation_surfaces | length) == 18
  and ($report.release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_operator_identity_session_revocation_logout_replay_reinstatement_operator_intent_consent_reconfirmation_surfaces | all(
    .artifact_download_install_affordance_result_receipt_operator_identity_session_revocation_logout_replay_reinstatement_operator_intent_consent_reconfirmation_attempted == true
  ...
  and ([.release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_operator_identity_session_revocation_logout_replay_reinstatement_operator_intent_consent_reconfirmation_surfaces[] | select(.operator_intent_reconfirmation_requested == true)] | length) == 1
  and ([.release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_operator_identity_session_revocation_logout_replay_reinstatement_operator_intent_consent_reconfirmation_surfaces[] | select(.operator_consent_reconfirmation_requested == true)] | length) == 1
  and ([.release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_operator_identity_session_revocation_logout_replay_reinstatement_operator_intent_consent_reconfirmation_surfaces[] | select(.telegram_consent_requested == true)] | length) == 1
  and ([.release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_operator_identity_session_revocation_logout_replay_reinstatement_operator_intent_consent_reconfirmation_surfaces[] | select(.install_restart_active_binary_consent_requested == true)] | length) == 1
...
printf '%s\n' "$report" | jq .
echo "Hepta memory/intelligence/KG full live activation operator readiness packet template packet acceptance receipt release/publication result receipt terminal distribution delivery receipt artifact download/install affordance result receipt operator identity/session revocation/logout replay/reinstatement operator intent/consent reconfirmation denial gate passed"
