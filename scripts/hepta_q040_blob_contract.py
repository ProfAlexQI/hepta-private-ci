"""Immutable path identities for the Q0.40 linear source composition."""
...
BLOBS: Final = {
    ...
    "scripts/verify-windows-gnullvm-setup-token-boundary.py": "e43fd8d37edf4f1cd48f60498d39596420da4be1",
...
EXECUTABLE: Final = (
    ...
    "scripts/verify-windows-gnullvm-setup-token-boundary.py",
