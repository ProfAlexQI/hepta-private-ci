...
REPORT_SCRIPT="$ROOT/scripts/hepta-systems-work-graph-dtd8-retack-rbackacktd-rbackacktd-rcptret-rbackack-td-receipt-preview-report.sh"
report="$(capture_json_report "hepta-systems-work-graph-dtd8-retack-rbackacktd-rbackacktd-rcptret-rbackack-td-receipt-preview-report" "$REPORT_SCRIPT")"
printf '%s\n' "$report"
...
cargo test --manifest-path "$ROOT/codex-rs/Cargo.toml" -p hepta-runtime \
  wg_deep_td8_ret_ack_td_rback_ack_td_receipt_retention_readback_ack_td_receipt_retention_readback_ack_td_receipt_retention_readback_ack_td_receipt_preview --lib
