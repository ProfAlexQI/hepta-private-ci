...
"""Q0.41 composition of Q0.40 source closure and Q0.39 startup order."""
...
BLOB_CONTRACT_SHA: Final = "badc328fc16bfb233e32fa1f71c37a246c15577c"
...
def validate_startup_increment() -> None:
    require(
    ...
    require(read(DIRECT_ADAPTER) == DIRECT, "Q0.41 direct adapter drifted")
    require(read(JOB_ADAPTER) == JOB, "Q0.41 job adapter drifted")
...
def main(owner: str = "q041") -> None:
    ...
    q040.main("q040" if owner == "q041" else owner)
    validate_startup_increment()
