...
require_source_text() {
  ...
  if ! rg -Fq "$source_text" "$source_file"; then
    echo "missing minimal scoped Memory real-write canary post-write readback source text: $label" >&2
    exit 1
  fi
}

NATIVE_GATEWAY_SOURCE="codex-rs/cli/src/native_gateway.rs"
ENDPOINT="/api/hepta-memory-live-mutation-operator-write-execution-minimal-scoped-memory-real-write-canary-post-write-readback-binding-boundary"
...
require_source_text "$NATIVE_GATEWAY_SOURCE" \
  ...
  "native gateway route/source command count includes minimal scoped Memory canary post-write readback binding boundary"
require_source_text "$NATIVE_GATEWAY_SOURCE" \
  ...
  "minimal scoped Memory canary post-write readback binding endpoint constant"
require_source_text "$NATIVE_GATEWAY_SOURCE" "$ENDPOINT" \
  "minimal scoped Memory canary post-write readback binding endpoint path"
require_source_text "$NATIVE_GATEWAY_SOURCE" "$SOURCE_COMMAND" \
  "minimal scoped Memory canary post-write readback binding source command"
require_source_text "$NATIVE_GATEWAY_SOURCE" \
  ...
  "minimal scoped Memory canary post-write readback binding report function"
require_source_text "$NATIVE_GATEWAY_SOURCE" \
  "\"minimal_scoped_memory_real_write_canary_post_write_readback_binding_ready\"" \
  "minimal scoped Memory canary post-write readback binding ready field"
require_source_text "$NATIVE_GATEWAY_SOURCE" \
  "\"denied_by_minimal_scoped_memory_real_write_canary_post_write_readback_binding_boundary_count\"" \
  "minimal scoped Memory canary post-write readback binding denial count"
require_source_text "$NATIVE_GATEWAY_SOURCE" \
  "hepta_memory_write_execution_minimal_scoped_memory_real_write_canary_post_write_readback_binding_accepts_bindings_without_reads_or_writes" \
  "focused minimal scoped Memory canary post-write readback binding unit test"

TEST_LOG="$(mktemp /tmp/hepta-minimal-scoped-memory-real-write-canary-post-write-readback-binding-route-tests.XXXXXX)"
...
SCRIPT_GATE_JSON="$(
  capture_json_report \
    "hepta-memory-live-mutation-operator-write-execution-minimal-scoped-memory-real-write-canary-post-write-readback-binding-boundary-gate" \
...
jq -e '
  ...
  and .readback_payload_digest_comparison_bound_count == 1
  and .readback_namespace_store_scope_bound_count == 1
  and .readback_redaction_secret_scan_bound_count == 1
  and .readback_stale_guard_bound_count == 1
  and .readback_phantom_guard_bound_count == 1
  and .readback_operator_review_handoff_bound_count == 1
...
if [[ "$REQUIRE_LIVE_ENDPOINT" == "1" ]]; then
  ...
  jq -e --argjson expected "$EXPECTED_ROUTE_COUNT" '
    ...
    and .memory_write_execution_minimal_scoped_memory_real_write_canary_post_write_readback_binding_boundary_ready == true
    and .minimal_scoped_memory_real_write_canary_post_write_readback_binding_ready == true
    and .minimal_scoped_memory_real_write_canary_post_write_readback_binding_accepted_no_read_or_write == true
    and .scoped_memory_real_write_canary_mode == "minimal_scoped_memory_real_write_canary_post_write_readback_binding_no_read_or_write"
    and .source_minimal_scoped_memory_real_write_canary_wal_receipt_binding_boundary_ready == true
    and .source_minimal_scoped_memory_real_write_canary_wal_receipt_binding_ready == true
    and .source_minimal_scoped_memory_real_write_canary_wal_receipt_binding_report_sha256 != ""
    and .source_accepted_minimal_scoped_memory_real_write_canary_wal_receipt_binding_fixture_count == 1
    and .source_blocked_minimal_scoped_memory_real_write_canary_wal_receipt_binding_fixture_count == 9
    and .source_wal_receipt_binding_authority_accepted_count == 1
    and .source_post_write_readback_handoff_bound_count == 1
    ...
    and .required_minimal_scoped_memory_real_write_canary_post_write_readback_binding_surface_count == 12
    and .ready_minimal_scoped_memory_real_write_canary_post_write_readback_binding_surface_count == 12
    and .side_effect_free_minimal_scoped_memory_real_write_canary_post_write_readback_binding_surface_count == 12
    and .required_minimal_scoped_memory_real_write_canary_post_write_readback_binding_fixture_count == 10
    and .minimal_scoped_memory_real_write_canary_post_write_readback_binding_fixture_count == 10
    and .accepted_minimal_scoped_memory_real_write_canary_post_write_readback_binding_fixture_count == 1
    and .blocked_minimal_scoped_memory_real_write_canary_post_write_readback_binding_fixture_count == 9
    and .post_write_readback_binding_authority_accepted_count == 1
    and .post_write_readback_plan_bound_count == 1
    ...
    and .readback_operator_review_handoff_bound_count == 1
    and .rollback_tombstone_handoff_bound_count == 1
    and .minimal_scoped_memory_real_write_canary_post_write_readback_binding_accepted_count == 1
    and .single_use_nonce_consumed_count == 0
    and .explicit_command_dispatched_count == 0
    and .wal_write_performed_count == 0
    and .wal_recorded_count == 0
    ...
    and .durable_memory_store_rollback_performed_count == 0
    and .memory_store_write_performed_count == 0
    and .required_before_minimal_scoped_memory_real_write_canary_post_write_readback_binding_count == 19
    and (.required_minimal_scoped_memory_real_write_canary_post_write_readback_binding_fields | length) == 19
    and (.minimal_scoped_memory_real_write_canary_post_write_readback_binding_surfaces | length) == 12
    and (.minimal_scoped_memory_real_write_canary_post_write_readback_binding_fixtures | length) == 10
    and ([.minimal_scoped_memory_real_write_canary_post_write_readback_binding_fixtures[] | select(.minimal_scoped_memory_real_write_canary_post_write_readback_binding_accepted == true)] | length) == 1
    and (.minimal_scoped_memory_real_write_canary_post_write_readback_binding_fixtures | all(.single_use_nonce_consumed == false and .explicit_command_dispatched == false and .wal_write_performed == false and .wal_persisted == false and .receipt_recorded == false and .receipt_persisted == false and .receipt_materialized == false and .receipt_delivered == false and .post_write_readback_performed == false and .readback_result_recorded == false and .readback_result_persisted == false and .readback_result_accepted == false and .rollback_executed == false and .tombstone_written == false and .memory_write_execution_performed == false and .memory_store_write_performed == false and .durable_memory_store_read_performed == false and .durable_memory_store_write_performed == false and .durable_memory_store_rollback_performed == false and .live_kg_write_performed == false and .provider_invoked == false and .model_invoked == false and .credential_read == false and .channel_send_performed == false and .external_send_performed == false and .release_artifact_written == false and .install_executed == false and .active_binary_mutated == false and .post_write_readback_binding_noop_confirmed == true))
    and .denied_by_minimal_scoped_memory_real_write_canary_post_write_readback_binding_boundary_count == 30
    and (.denied_by_minimal_scoped_memory_real_write_canary_post_write_readback_binding_boundary | length) == 30
    and .minimal_scoped_memory_real_write_canary_post_write_readback_binding_accepted == true
    and .post_write_readback_plan_bound == true
    and .readback_result_identity_bound == true
    and .readback_receipt_linkage_bound == true
    and .readback_payload_digest_comparison_bound == true
    and .readback_namespace_store_scope_bound == true
    and .readback_redaction_secret_scan_bound == true
    and .readback_stale_guard_bound == true
    and .readback_phantom_guard_bound == true
    and .readback_operator_review_handoff_bound == true
    and .rollback_tombstone_handoff_bound == true
    ...
    and .install_executed == false
    and .active_binary_mutated == false
    and .allowed_next_actions[0].action == "run_minimal_scoped_memory_real_write_canary_post_write_readback_binding_boundary_require_live_gate"
    and .allowed_next_actions[0].reads_memory == false
    and .allowed_next_actions[0].records_readback == false
    and .allowed_next_actions[1].action == "prepare_minimal_scoped_memory_real_write_canary_rollback_tombstone_proof_boundary"
    and .allowed_next_actions[1].requires_minimal_scoped_memory_real_write_canary_post_write_readback_binding == true
    and .allowed_next_actions[1].executes_rollback == false
    and (.side_effects | to_entries | all(.value == false))
...
jq -n \
  ...
  '{
    ...
    post_write_readback_binding_boundary_route_gate_ready:true,
