...
report_script="$repo_root/scripts/hepta-context-memory-write-chain-receipt-freshness-report.sh"
...
assert_file_contains "$release_manifest" \
  "scripts/hepta-context-memory-write-chain-receipt-freshness-gate.sh" \
  "memory write-chain receipt freshness release manifest gate entry"
assert_file_contains "$release_manifest" \
  "scripts/hepta-context-memory-write-chain-receipt-freshness-report.sh" \
