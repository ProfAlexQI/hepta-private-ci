...
echo "artifact download/install affordance result receipt retention/expiry/garbage-collection denial route gate passed: endpoint ready, 18 surfaces, terminal markers ${terminal_present_required_marker_count}/${terminal_required_marker_count}" >&2
