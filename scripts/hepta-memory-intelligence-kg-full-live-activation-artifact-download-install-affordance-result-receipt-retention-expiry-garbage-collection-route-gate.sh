...
echo "artifact download/install affordance result receipt retention/expiry/garbage-collection denial route gate passed: endpoint ready, 18 surfaces, source route count 153, terminal markers 293/293" >&2
