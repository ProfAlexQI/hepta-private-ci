...
echo "[hepta-codex-preflight] upstream Codex activation evidence recording dry-run receipt gate"
scripts/hepta-upstream-codex-activation-evidence-recording-dry-run-receipt.sh

echo "[hepta-codex-preflight] upstream Codex activation evidence recording denial matrix gate"
scripts/hepta-upstream-codex-activation-evidence-recording-denial-matrix.sh

echo "[hepta-codex-preflight] upstream Codex activation evidence receipt persistence command contract gate"
...
echo "[hepta-codex-preflight] upstream Codex activation evidence receipt filesystem persistence approval packet gate"
