...
jq -n \
  ...
  | {
      ...
      source_audit_index_gate: "hepta_work_graph_agent_jobs_task_board_feature_flag_operator_review_precondition_non_request_readback_audit_index_gate",
      source_audit_index_entry_count: 6,
      source_audit_index_blocker_count: 15,
