...
prior_report_script="scripts/hepta-systems-work-graph-dtd8-td3-rbtd-rbtd-rbtd-rt-rba-td-rt-rbr-preview-report.sh"
prior_gate_script="scripts/hepta-systems-work-graph-dtd8-td3-rbtd-rbtd-rbtd-rt-rba-td-rt-rbr-preview-gate.sh"
...
rust_module="codex-rs/hepta-runtime/src/wg_dtd8_td3_rbtd_rbtd_rbtd_rt_td_rt_rbackack_preview.rs"
report_script="scripts/hepta-systems-work-graph-dtd8-td3-rbtd-rbtd-rbtd-rt-rba-td-rt-rba-preview-report.sh"
gate_script="scripts/hepta-systems-work-graph-dtd8-td3-rbtd-rbtd-rbtd-rt-rba-td-rt-rba-preview-gate.sh"
...
jq -n \
  ...
  }];
  {
    ...
    acknowledgement_contracts: item("deep_td8_td3_rbackack_td4_rcptret_rbackack_contract"; 6),
    non_acceptance_reasons: item("deep_td8_td3_rbackack_td4_rcptret_rbackack_non_acceptance"; 7),
    recording_denials: item("deep_td8_td3_rbackack_td4_rcptret_rbackack_recording_denial"; 7),
    expiry_replay_guards: item("deep_td8_td3_rbackack_td4_rcptret_rbackack_expiry_replay_guard"; 5),
    local_views: item("deep_td8_td3_rbackack_td4_rcptret_rbackack_local_view"; 4),
    invariants: item("deep_td8_td3_rbackack_td4_rcptret_rbackack_invariant"; 6),
    ...
    source_probes: {
      deep_td8_td3_rbackack_td4_receipt_retention_readback_ack: {
      ...
      prior_deep_td8_td3_rbackack_td4_receipt_retention_readback_receipt: {
