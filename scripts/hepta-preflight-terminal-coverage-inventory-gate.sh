...
phase_family_anchor_specs=(
  ...
  "live-mutation-denial|memory live mutation operator write execution activation command result receipt final operator acknowledgement non-acceptance denial boundary route gate"
  ...
  "core-activation-tail|core activation operator approval gap ledger summary briefing acknowledgement activation command result receipt cancellation supersession denial gate"
  ...
  "latest-regression-and-tests|upstream Codex latest multisurface absorption native route gate"
