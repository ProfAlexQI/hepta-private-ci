...
context-plane-operator-approval-packet-canonical-export-digest.approval-report-lines=29
context-plane-operator-approval-packet-canonical-export-digest.approval-report-sha256=6a20d497af07bc06a02339a94622ceec4c917e91b218ebf4df89aa899628d994
...
context-plane-operator-approval-packet-canonical-export-digest.combined-report-lines=33
context-plane-operator-approval-packet-canonical-export-digest.combined-report-sha256=92636890b6f9c3cd12846d1f4f40270386fb74c55aa1aaab940d587d245eef72
...
if [ "$(line_count "$approval_status")" != "29" ]; then
...
if [ "$(line_count "$combined_status")" != "33" ]; then
  fail "combined canonical line count changed"
fi

if [ "$(printf '%s\n' "$approval_status" | sha256_digest)" != "6a20d497af07bc06a02339a94622ceec4c917e91b218ebf4df89aa899628d994" ]; then
...
if [ "$(printf '%s\n' "$combined_status" | sha256_digest)" != "92636890b6f9c3cd12846d1f4f40270386fb74c55aa1aaab940d587d245eef72" ]; then
...
echo "context-plane-operator-approval-packet-canonical-export-digest.approval-report-lines=29"
echo "context-plane-operator-approval-packet-canonical-export-digest.negative-export-report-lines=4"
echo "context-plane-operator-approval-packet-canonical-export-digest.combined-report-lines=33"
