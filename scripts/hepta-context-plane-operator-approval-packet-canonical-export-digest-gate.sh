...
if [ "$(line_count "$approval_status")" != "129" ]; then
...
if [ "$(line_count "$combined_status")" != "133" ]; then
  fail "combined canonical line count changed"
fi

if [ "$(printf '%s\n' "$approval_status" | sha256_digest)" != "8026268c21e13763e84e03175fe96f24ff23d83cea6ccd3164032a235d692d8a" ]; then
...
if [ "$(printf '%s\n' "$combined_status" | sha256_digest)" != "ddccb8ebfaf3509fc52e353783e8ab819f43cab0d42317b9627d0c27a2981258" ]; then
...
echo "context-plane-operator-approval-packet-canonical-export-digest.approval-report-lines=129"
echo "context-plane-operator-approval-packet-canonical-export-digest.negative-export-report-lines=4"
echo "context-plane-operator-approval-packet-canonical-export-digest.combined-report-lines=133"
