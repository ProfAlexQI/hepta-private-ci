...
for term in \
  ...
  "approval report 47 lines" \
  "negative export report 4 lines" \
  "combined report 51 lines" \
...
context-plane-operator-approval-packet-canonical-export-digest.approval-report-lines=47
context-plane-operator-approval-packet-canonical-export-digest.approval-report-sha256=878b02b1ae4681940810c4344f2b3ba600f6e2ee8ae4e12f67b076217ac4a9a7
...
context-plane-operator-approval-packet-canonical-export-digest.combined-report-lines=51
context-plane-operator-approval-packet-canonical-export-digest.combined-report-sha256=ea56c6a67703b1057cbfa47b89baf43e8abb1a2189509484240543bd5a57c062
...
if [ "$(line_count "$approval_status")" != "47" ]; then
...
if [ "$(line_count "$combined_status")" != "51" ]; then
  fail "combined canonical line count changed"
fi

if [ "$(printf '%s\n' "$approval_status" | sha256_digest)" != "878b02b1ae4681940810c4344f2b3ba600f6e2ee8ae4e12f67b076217ac4a9a7" ]; then
...
if [ "$(printf '%s\n' "$combined_status" | sha256_digest)" != "ea56c6a67703b1057cbfa47b89baf43e8abb1a2189509484240543bd5a57c062" ]; then
...
echo "context-plane-operator-approval-packet-canonical-export-digest.approval-report-lines=47"
echo "context-plane-operator-approval-packet-canonical-export-digest.negative-export-report-lines=4"
echo "context-plane-operator-approval-packet-canonical-export-digest.combined-report-lines=51"
