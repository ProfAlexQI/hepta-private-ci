...
KG_ROLLBACK_KILL_SWITCH_CHECKLIST_JSON="$(
  capture_json_report \
...
source_rollback_kill_switch_checklist_report_sha256="$(sha256_text "$KG_ROLLBACK_KILL_SWITCH_CHECKLIST_JSON")"
redacted_diff_review_checklist_hash_sha256="$(sha256_text "hepta-kg-prompt-preview-redacted-diff-review-checklist:schema:$source_rollback_kill_switch_checklist_report_sha256")"
redacted_diff_review_policy_hash_sha256="$(sha256_text "hepta-kg-prompt-preview-redacted-diff-review-checklist:policy:$source_rollback_kill_switch_checklist_report_sha256")"
redacted_diff_review_side_effect_hash_sha256="$(sha256_text "hepta-kg-prompt-preview-redacted-diff-review-checklist:side-effects:$source_rollback_kill_switch_checklist_report_sha256")"

jq -n -e \
  --argjson source "$KG_ROLLBACK_KILL_SWITCH_CHECKLIST_JSON" \
  '
    $source.runtime == "hepta"
    and $source.status == "ready"
    and $source.gate == "hepta_kg_prompt_preview_rollback_kill_switch_evidence_checklist_gate"
    and $source.rollback_kill_switch_checklist_schema_version == "kg_prompt_preview_rollback_kill_switch_evidence_checklist_v1"
    and $source.rollback_kill_switch_checklist_ready == true
    and $source.rollback_kill_switch_checklist_status == "blocked"
    and $source.rollback_kill_switch_checklist_decision == "blocked_until_rollback_plan_rollback_dry_run_kill_switch_and_kill_switch_dry_run_evidence_are_provided_reviewed_and_explicitly_accepted"
    and ($source.allowed_next_actions | any(.action == "add_redacted_diff_review_checklist" and .status == "allowed_report_only" and .mutates_runtime == false and .permits_prompt_preview == false))
    ...
    and $source.safety_checklist_item_count == 4
    and $source.required_safety_checklist_item_count == 4
    and $source.missing_safety_checklist_item_count == 4
    and $source.safety_checklist_items_all_required == true
    and $source.safety_checklist_items_all_missing == true
    and $source.safety_checklist_items_all_redacted == true
    and $source.safety_checklist_items_all_block_prompt_preview == true
    and $source.safety_checklist_items_all_block_context_injection == true
    and $source.safety_checklist_items_all_not_persisted == true
    ...
    and $source.rollback_kill_switch_checklist_persistence_allowed == false
    and $source.rollback_kill_switch_checklist_persisted == false
    and $source.rollback_kill_switch_checklist_delivery_allowed == false
    and $source.rollback_kill_switch_checklist_delivered == false
...
report="$(jq -n \
  --arg product "Hepta" \
  --arg runtime "hepta" \
  --arg gate "hepta_kg_prompt_preview_redacted_diff_review_checklist_gate" \
  --arg source_rollback_kill_switch_checklist_report_sha256 "$source_rollback_kill_switch_checklist_report_sha256" \
  --arg redacted_diff_review_checklist_hash_sha256 "$redacted_diff_review_checklist_hash_sha256" \
  --arg redacted_diff_review_policy_hash_sha256 "$redacted_diff_review_policy_hash_sha256" \
  --arg redacted_diff_review_side_effect_hash_sha256 "$redacted_diff_review_side_effect_hash_sha256" \
  --argjson source "$KG_ROLLBACK_KILL_SWITCH_CHECKLIST_JSON" \
  '
    [
      {
        checklist_item:"redacted_diff_review_record",
        evidence_kind:"redacted_diff_review",
        required:true,
        present:false,
        redacted_evidence_ref:"missing:kg-prompt-preview-redacted-diff-review:review-record",
        blocks_prompt_preview:true,
        blocks_context_injection:true,
        persisted:false
      },
      {
        checklist_item:"redacted_diff_review_approval_record",
        evidence_kind:"redacted_diff_review_approval",
        required:true,
        present:false,
        redacted_evidence_ref:"missing:kg-prompt-preview-redacted-diff-review:approval-record",
        blocks_prompt_preview:true,
        blocks_context_injection:true,
        persisted:false
      }
    ...
    | ([
      ...
      "redacted_diff_review_checklist_persistence",
      "redacted_diff_review_checklist_delivery",
    ...
    | {
      ...
      status:"ready",
      gate:$gate,
      redacted_diff_review_checklist_schema_version:"kg_prompt_preview_redacted_diff_review_checklist_v1",
      redacted_diff_review_checklist_mode:"stdout_only_schema_only_no_review_acceptance_no_raw_prompt_diff_no_prompt_text_no_payload_text_no_runtime_mutation",
      redacted_diff_review_checklist_ready:true,
      redacted_diff_review_checklist_status:"blocked",
      redacted_diff_review_checklist_decision:"blocked_until_redacted_diff_review_and_approval_records_are_provided_reviewed_and_explicitly_accepted",
      source_rollback_kill_switch_checklist_gate:$source.gate,
      source_rollback_kill_switch_checklist_schema_version:$source.rollback_kill_switch_checklist_schema_version,
      source_rollback_kill_switch_checklist_decision:$source.rollback_kill_switch_checklist_decision,
      source_operator_approval_checklist_gate:$source.source_operator_approval_checklist_gate,
      source_operator_approval_checklist_schema_version:$source.source_operator_approval_checklist_schema_version,
      ...
      source_rollback_kill_switch_checklist_report_sha256:$source_rollback_kill_switch_checklist_report_sha256,
      redacted_diff_review_checklist_hash_sha256:$redacted_diff_review_checklist_hash_sha256,
      redacted_diff_review_policy_hash_sha256:$redacted_diff_review_policy_hash_sha256,
      redacted_diff_review_side_effect_hash_sha256:$redacted_diff_review_side_effect_hash_sha256,
      ...
      source_safety_checklist_item_count:$source.safety_checklist_item_count,
      source_missing_safety_checklist_item_count:$source.missing_safety_checklist_item_count,
      review_checklist_item_count:($review_items | length),
      required_review_checklist_item_count:($review_items | map(select(.required == true)) | length),
      missing_review_checklist_item_count:($review_items | map(select(.present == false)) | length),
      review_checklist_items:$review_items,
      review_checklist_items_all_required:($review_items | all(.required == true)),
      review_checklist_items_all_missing:($review_items | all(.present == false)),
      review_checklist_items_all_redacted:(($review_items | map(.redacted_evidence_ref | startswith("missing:kg-prompt-preview-redacted-diff-review:"))) | all(. == true)),
      review_checklist_items_all_block_prompt_preview:($review_items | all(.blocks_prompt_preview == true)),
      review_checklist_items_all_block_context_injection:($review_items | all(.blocks_context_injection == true)),
      review_checklist_items_all_not_persisted:($review_items | all(.persisted == false)),
      redacted_refs_only:true,
      raw_prompt_diff_count:0,
      prompt_text_included_count:0,
      payload_text_included_count:0,
      redacted_diff_review_present:false,
      redacted_diff_review_accepted:false,
      redacted_diff_review_approval_present:false,
...
jq -e '
  .runtime == "hepta"
  and .status == "ready"
  and .gate == "hepta_kg_prompt_preview_redacted_diff_review_checklist_gate"
  and .redacted_diff_review_checklist_schema_version == "kg_prompt_preview_redacted_diff_review_checklist_v1"
  and .redacted_diff_review_checklist_mode == "stdout_only_schema_only_no_review_acceptance_no_raw_prompt_diff_no_prompt_text_no_payload_text_no_runtime_mutation"
  and .redacted_diff_review_checklist_ready == true
  and .redacted_diff_review_checklist_status == "blocked"
  and .redacted_diff_review_checklist_decision == "blocked_until_redacted_diff_review_and_approval_records_are_provided_reviewed_and_explicitly_accepted"
  and .source_rollback_kill_switch_checklist_gate == "hepta_kg_prompt_preview_rollback_kill_switch_evidence_checklist_gate"
  and .source_rollback_kill_switch_checklist_schema_version == "kg_prompt_preview_rollback_kill_switch_evidence_checklist_v1"
  ...
  and .source_safety_checklist_item_count == 4
  and .source_missing_safety_checklist_item_count == 4
  and .review_checklist_item_count == 2
  and .required_review_checklist_item_count == 2
  and .missing_review_checklist_item_count == 2
  and (.review_checklist_items | length) == 2
  and .review_checklist_items_all_required == true
  and .review_checklist_items_all_missing == true
  and .review_checklist_items_all_redacted == true
  and .review_checklist_items_all_block_prompt_preview == true
  and .review_checklist_items_all_block_context_injection == true
  and .review_checklist_items_all_not_persisted == true
  and (.review_checklist_items | all(.required == true and .present == false and .blocks_prompt_preview == true and .blocks_context_injection == true and .persisted == false and (.redacted_evidence_ref | startswith("missing:kg-prompt-preview-redacted-diff-review:"))))
  and .redacted_refs_only == true
  and .raw_prompt_diff_count == 0
  and .prompt_text_included_count == 0
  and .payload_text_included_count == 0
  and .redacted_diff_review_present == false
  and .redacted_diff_review_accepted == false
  and .redacted_diff_review_approval_present == false
  and .redacted_diff_review_approval_accepted == false
  and .redacted_diff_review_checklist_persistence_allowed == false
  and .redacted_diff_review_checklist_persisted == false
  and .redacted_diff_review_checklist_delivery_allowed == false
  and .redacted_diff_review_checklist_delivered == false
  ...
  and .allowed_next_action_count == 3
  and (.allowed_next_actions | length) == 3
  and (.allowed_next_actions | all(.mutates_runtime == false and .permits_prompt_preview == false))
  and .denied_next_action_count == 28
  and (.denied_next_actions | length) == 28
...
printf '%s\n' "$report"
echo "Hepta KG prompt-preview redacted diff review checklist gate passed"
