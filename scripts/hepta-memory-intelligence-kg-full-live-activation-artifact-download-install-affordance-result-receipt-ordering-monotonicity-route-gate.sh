...
echo "artifact download/install affordance result receipt ordering/monotonicity denial route gate passed: endpoint ready, 18 surfaces, source route count 147, terminal markers 287/287" >&2
