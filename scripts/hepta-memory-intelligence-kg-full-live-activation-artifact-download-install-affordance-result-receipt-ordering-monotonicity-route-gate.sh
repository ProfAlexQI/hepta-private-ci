...
echo "artifact download/install affordance result receipt ordering/monotonicity denial route gate passed: endpoint ready, 18 surfaces, source route count 150, terminal markers 290/290" >&2
