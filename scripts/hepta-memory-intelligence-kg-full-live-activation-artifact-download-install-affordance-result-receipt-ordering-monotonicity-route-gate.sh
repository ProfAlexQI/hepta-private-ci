...
echo "artifact download/install affordance result receipt ordering/monotonicity denial route gate passed: endpoint ready, 18 surfaces, source route count 152, terminal markers 292/292" >&2
