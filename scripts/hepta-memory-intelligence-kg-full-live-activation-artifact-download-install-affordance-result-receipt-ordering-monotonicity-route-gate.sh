...
echo "artifact download/install affordance result receipt ordering/monotonicity denial route gate passed: endpoint ready, 18 surfaces, source route count 149, terminal markers 289/289" >&2
