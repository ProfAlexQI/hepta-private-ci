...
SOURCE_REPORT_SCRIPT="$ROOT/scripts/hepta-systems-work-graph-live-attachment-terminal-closeout-readback-ai-np-fc-readback-ai-np-fc-readback-ai-np-fc-readback-ai-np-final-closeout-readback-audit-index-np-readback-report.sh"

source_report="$(
  capture_json_report \
    "hepta-work-graph-live-attachment-terminal-closeout-readback-ai-np-fc-readback-ai-np-fc-readback-ai-np-fc-readback-ai-np-final-closeout-readback-audit-index-np-readback-report" \
...
jq -n \
  ...
  | (
      $source.gate == "hepta_work_graph_agent_jobs_task_board_scheduler_guardrail_blocking_dry_run_entrypoint_live_attachment_attachability_precondition_readiness_readback_terminal_no_attachment_final_closeout_readback_terminal_closeout_readback_audit_index_non_persistence_final_closeout_readback_audit_index_non_persistence_final_closeout_readback_audit_index_non_persistence_final_closeout_readback_audit_index_non_persistence_final_closeout_readback_audit_index_non_persistence_readback_gate"
      ...
      and $source.readback_blocker_count == 131
      and $source.required_prior_gate_count == 48
      and $source_non_persistence_readback_no_live_confirmed
    ) as $source_non_persistence_readback_ready
  | ($source_non_persistence_readback_ready and $source.ready_for_terminal_closeout_readback_audit_index_non_persistence_final_closeout == true) as $source_non_persistence_readback_ready_for_final_closeout
  | [
  ...
  | (($final_closeout_blockers | length) == 134
  ...
  | {
      ...
      runtime: "hepta",
      status: "ready",
      gate: ($source.recommended_next_gate | sub("_non_persistence_final_closeout_gate$"; "_non_persistence_final_closeout_gate")),
      schema_version: ($source.recommended_next_gate | sub("_non_persistence_final_closeout_gate$"; "_non_persistence_final_closeout_gate") | sub("^hepta_"; "") | sub("_gate$"; "_v1")),
      preview_mode: "scheduler_guardrail_blocking_dry_run_entrypoint_live_attachment_attachability_terminal_closeout_readback_audit_index_non_persistence_final_closeout_readback_audit_index_non_persistence_final_closeout_readback_audit_index_non_persistence_final_closeout_readback_audit_index_non_persistence_final_closeout_readback_audit_index_non_persistence_final_closeout_report_only",
      ...
      recommended_next_gate: ($source.recommended_next_gate | sub("_non_persistence_final_closeout_gate$"; "_non_persistence_final_closeout_readback_gate")),
