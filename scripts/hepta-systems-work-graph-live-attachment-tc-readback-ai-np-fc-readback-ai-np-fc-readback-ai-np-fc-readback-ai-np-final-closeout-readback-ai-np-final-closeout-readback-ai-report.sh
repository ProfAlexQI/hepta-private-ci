...
jq -n \
  ...
  | (
      $source.gate == "hepta_work_graph_agent_jobs_task_board_scheduler_guardrail_blocking_dry_run_entrypoint_live_attachment_attachability_precondition_readiness_readback_terminal_no_attachment_final_closeout_readback_terminal_closeout_readback_audit_index_non_persistence_final_closeout_readback_audit_index_non_persistence_final_closeout_readback_audit_index_non_persistence_final_closeout_readback_audit_index_non_persistence_final_closeout_readback_audit_index_non_persistence_final_closeout_readback_gate"
      ...
      and $source.readback_blocker_count == 137
      and $source.required_prior_gate_count == 50
  ...
  | (
      ($blockers | length) == 140
      and ($blockers | all(.blocked == true and .required_before_acceptance == true))
  ...
  | {
      ...
      recommended_next_gate: ($source.recommended_next_gate | sub("_non_persistence_final_closeout_readback_audit_index_gate$"; "_non_persistence_final_closeout_readback_audit_index_non_persistence_readback_gate")),
