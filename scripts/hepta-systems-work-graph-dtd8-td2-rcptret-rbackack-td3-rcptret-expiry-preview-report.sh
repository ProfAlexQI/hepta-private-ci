...
prior_report_script="scripts/hepta-systems-work-graph-dtd8-td2-rcptret-rbackack-td3-receipt-ack-replay-preview-report.sh"
prior_gate_script="scripts/hepta-systems-work-graph-dtd8-td2-rcptret-rbackack-td3-receipt-ack-replay-preview-gate.sh"
...
rust_module="codex-rs/hepta-runtime/src/wg_deep_td8_retack_td3_receipt_retention_expiry_preview.rs"
report_script="scripts/hepta-systems-work-graph-dtd8-td2-rcptret-rbackack-td3-rcptret-expiry-preview-report.sh"
gate_script="scripts/hepta-systems-work-graph-dtd8-td2-rcptret-rbackack-td3-rcptret-expiry-preview-gate.sh"
...
jq -n \
  ...
  }];
  {
    ...
    retention_policies: item("deep_td8_td3_receipt_retention_policy"; 6),
    expiry_guards: item("deep_td8_td3_receipt_expiry_guard"; 6),
    supersession_guards: item("deep_td8_td3_receipt_supersession_guard"; 5),
    garbage_collection_denials: item("deep_td8_td3_receipt_gc_denial"; 6),
    local_views: item("deep_td8_td3_receipt_retention_view"; 4),
    invariants: item("deep_td8_td3_receipt_retention_invariant"; 6),
    ...
    source_probes: {
      deep_td8_td3_terminal_decision_receipt_retention_expiry: {
      ...
      prior_deep_td8_td3_terminal_decision_receipt_ack_replay: {
