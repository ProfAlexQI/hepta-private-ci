...
require_source_text() {
  ...
  if ! rg -Fq "$source_text" "$source_file"; then
    echo "missing operator-approved bounded provider-router injection dry-run envelope readback audit receipt lane source text: $label" >&2
    exit 1
  fi
}

DRY_RUN_ENVELOPE_LANE_JSON="$(
  curl -fsS "$BASE_URL/api/hepta-memory-intelligence-kg-full-enablement-operator-approved-bounded-provider-router-injection-dry-run-envelope-lane"
)"
...
jq -e '
  ...
  and .bounded_provider_router_injection_dry_run_envelope_requires_explicit_command == true
  and .bounded_provider_router_injection_dry_run_envelope_requires_bounded_provider_router_injection_precondition == true
  and .bounded_provider_router_injection_dry_run_envelope_redaction_required == true
  and .bounded_provider_router_injection_dry_run_envelope_redaction_proof_required == true
  and .bounded_provider_router_injection_dry_run_envelope_scope_binding_required == true
  and .bounded_provider_router_injection_dry_run_envelope_operator_identity_binding_required == true
  and .bounded_provider_router_injection_dry_run_envelope_hash_binding_required == true
  and .bounded_provider_router_injection_dry_run_envelope_provider_router_target_binding_required == true
  and .bounded_provider_router_injection_dry_run_envelope_budget_binding_required == true
  and .bounded_provider_router_injection_dry_run_envelope_shape_locked == true
  ...
  and .bounded_provider_router_injection_dry_run_envelope_rendered_by_report_route == false
  ...
  and .bounded_provider_router_injection_dry_run_envelope_filesystem_written_by_report_route == false
  and .bounded_provider_router_injection_dry_run_envelope_ledger_recorded_by_report_route == false
  and .bounded_provider_router_injection_dry_run_envelope_promotes_activation_authority == false
  ...
  and .side_effects.bounded_provider_router_injection_dry_run_envelope_constructed == false
  and .side_effects.bounded_provider_router_injection_dry_run_envelope_rendered == false
  and .side_effects.bounded_provider_router_injection_dry_run_envelope_recorded == false
  and .side_effects.bounded_provider_router_injection_dry_run_envelope_persisted == false
  and .side_effects.bounded_provider_router_injection_dry_run_envelope_accepted == false
  and .side_effects.bounded_provider_router_injection_dry_run_envelope_executed == false
  and .side_effects.bounded_provider_router_injection_dry_run_envelope_filesystem_written == false
  and .side_effects.bounded_provider_router_injection_dry_run_envelope_ledger_recorded == false
...
require_source_text "$NATIVE_GATEWAY_SOURCE" \
  'const NATIVE_GATEWAY_SOURCE_COMMAND_COUNT: usize = 98;' \
  "native gateway route/source command count includes bounded provider-router injection dry-run envelope readback audit receipt lane and preserved systems routes"
require_source_text "$NATIVE_GATEWAY_SOURCE" \
...
require_source_text "$NATIVE_GATEWAY_SOURCE" \
  ...
  "native gateway operator-approved bounded provider-router injection dry-run envelope readback audit receipt lane endpoint path"
require_source_text "$NATIVE_GATEWAY_SOURCE" \
  ...
  "native gateway operator-approved bounded provider-router injection dry-run envelope readback audit receipt lane source command"
require_source_text "$NATIVE_GATEWAY_SOURCE" \
  ...
  "native gateway operator-approved bounded provider-router injection dry-run envelope readback audit receipt lane report function"
require_source_text "$NATIVE_GATEWAY_SOURCE" \
  '"bounded_provider_router_injection_dry_run_envelope_readback_audit_receipt_lane_enabled": true' \
  "bounded provider-router injection dry-run envelope readback audit receipt lane enabled"
require_source_text "$NATIVE_GATEWAY_SOURCE" \
  ...
  "bounded provider-router injection dry-run envelope readback audit receipt requires dry-run envelope lane"
require_source_text "$NATIVE_GATEWAY_SOURCE" \
  '"bounded_provider_router_injection_dry_run_envelope_readback_audit_receipt_rendered_by_report_route": false' \
  "report route renders no bounded provider-router injection dry-run envelope readback audit receipt"
require_source_text "$NATIVE_GATEWAY_SOURCE" \
  '"bounded_provider_router_injection_dry_run_envelope_readback_audit_receipt_recorded_by_report_route": false' \
  "report route records no bounded provider-router injection dry-run envelope readback audit receipt"
require_source_text "$NATIVE_GATEWAY_SOURCE" \
  '"bounded_provider_router_injection_dry_run_envelope_readback_audit_receipt_persisted_by_report_route": false' \
  "report route persists no bounded provider-router injection dry-run envelope readback audit receipt"
require_source_text "$NATIVE_GATEWAY_SOURCE" \
  '"bounded_provider_router_injection_dry_run_envelope_readback_audit_receipt_accepted_by_report_route": false' \
  "report route accepts no bounded provider-router injection dry-run envelope readback audit receipt"
require_source_text "$NATIVE_GATEWAY_SOURCE" \
  '"bounded_provider_router_injection_dry_run_envelope_readback_audit_receipt_promotes_activation_authority": false' \
  "report route promotes no bounded provider-router injection dry-run envelope readback audit receipt"
require_source_text "$NATIVE_GATEWAY_SOURCE" \
...
TEST_LOG="$(mktemp /tmp/hepta-operator-approved-bounded-provider-router-injection-dry-run-envelope-readback-audit-receipt-lane-tests.XXXXXX)"
cargo test --offline --manifest-path "$MANIFEST" -q -p codex-cli --lib \
  hepta_memory_intelligence_kg_full_enablement_operator_approved_bounded_provider_router_injection_dry_run_envelope_readback_audit_receipt_lane_endpoint_enables_receipt_shape_only \
  -- --nocapture >"$TEST_LOG"
...
report="$(
  jq -n \
    ...
    --arg gate "hepta_memory_intelligence_kg_full_enablement_operator_approved_bounded_provider_router_injection_dry_run_envelope_readback_audit_receipt_lane_gate" \
    --arg endpoint "/api/hepta-memory-intelligence-kg-full-enablement-operator-approved-bounded-provider-router-injection-dry-run-envelope-readback-audit-receipt-lane" \
    --arg dry_run_envelope_lane_endpoint "/api/hepta-memory-intelligence-kg-full-enablement-operator-approved-bounded-provider-router-injection-dry-run-envelope-lane" \
    --arg source_command "/hepta-memory-intelligence-kg-full-enablement-operator-approved-bounded-provider-router-injection-dry-run-envelope-readback-audit-receipt-lane --json" \
    --arg native_gateway_source "$NATIVE_GATEWAY_SOURCE" \
    --arg native_gateway_sha256 "$(sha256_file "$NATIVE_GATEWAY_SOURCE")" \
    --arg test_log "$TEST_LOG" \
    --argjson dry_run_envelope_lane "$DRY_RUN_ENVELOPE_LANE_JSON" \
    '{
      product:$product,
      runtime:$runtime,
      status:"ready",
      ...
      gate:$gate,
      endpoint:$endpoint,
      dry_run_envelope_lane_endpoint:$dry_run_envelope_lane_endpoint,
      source_command:$source_command,
      activation_mode:"operator_approved_bounded_provider_router_injection_dry_run_envelope_readback_audit_receipt_lane_status",
      live_dry_run_envelope_lane_status:$dry_run_envelope_lane.status,
      live_dry_run_envelope_lane_ready:($dry_run_envelope_lane.bounded_provider_router_injection_dry_run_envelope_lane_enabled and $dry_run_envelope_lane.bounded_provider_router_injection_dry_run_envelope_allowed_by_lane),
      source_route_wired:true,
      source_route_count_expected:98,
      ...
      source_contract:{
        ...
        contract:"hepta-native-gateway-operator-approved-bounded-provider-router-injection-dry-run-envelope-readback-audit-receipt-lane-route-v1",
      ...
      blocked_by_bounded_provider_router_injection_dry_run_envelope_readback_audit_receipt_lane_boundary:[
        ...
        "readback_audit_receipt_render_from_report_route_denied",
        "readback_audit_receipt_recording_from_report_route_denied",
        "readback_audit_receipt_persistence_from_report_route_denied",
        "readback_audit_receipt_acceptance_from_report_route_denied",
        "readback_audit_receipt_filesystem_write_denied",
        "readback_audit_receipt_ledger_recording_denied",
      ...
      side_effects:{
        ...
        bounded_provider_router_injection_dry_run_envelope_readback_audit_receipt_filesystem_written:false,
        bounded_provider_router_injection_dry_run_envelope_readback_audit_receipt_ledger_recorded:false,
...
jq -e '
  ...
  and .source_route_count_expected == 98
  and .source_route_tested_by_native_gateway_unit_test == true
  and .live_dry_run_envelope_lane_ready == true
...
echo "Hepta memory/intelligence/KG full enablement operator-approved bounded provider-router injection dry-run envelope readback audit receipt lane gate passed"
