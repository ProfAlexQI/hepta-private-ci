...
prior_report_script="scripts/hepta-systems-work-graph-dtd8-td2-rcptret-rbackack-td3-rcptret-rbrcpt-preview-report.sh"
prior_gate_script="scripts/hepta-systems-work-graph-dtd8-td2-rcptret-rbackack-td3-rcptret-rbrcpt-preview-gate.sh"
...
rust_module="codex-rs/hepta-runtime/src/wg_deep_td8_retack_td3_receipt_retention_readback_ack_preview.rs"
report_script="scripts/hepta-systems-work-graph-dtd8-td2-rcptret-rbackack-td3-rcptret-rbackack-preview-report.sh"
gate_script="scripts/hepta-systems-work-graph-dtd8-td2-rcptret-rbackack-td3-rcptret-rbackack-preview-gate.sh"
...
jq -n \
  ...
  }];
  {
    ...
    acknowledgement_contracts: item("deep_td8_td3_retention_readback_ack_contract"; 6),
    non_acceptance_reasons: item("deep_td8_td3_retention_readback_ack_non_acceptance"; 7),
    recording_denials: item("deep_td8_td3_retention_readback_ack_recording_denial"; 7),
    expiry_replay_guards: item("deep_td8_td3_retention_readback_ack_expiry_replay_guard"; 5),
    local_views: item("deep_td8_td3_retention_readback_ack_view"; 4),
    invariants: item("deep_td8_td3_retention_readback_ack_invariant"; 6),
    ...
    source_probes: {
      deep_td8_td3_terminal_decision_receipt_retention_readback_acknowledgement: {
      ...
      prior_deep_td8_td3_terminal_decision_receipt_retention_readback_receipt: {
