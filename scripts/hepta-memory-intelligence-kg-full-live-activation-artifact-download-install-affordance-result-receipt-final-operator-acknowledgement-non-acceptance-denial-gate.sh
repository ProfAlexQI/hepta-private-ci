...
SUMMARY_BRIEFING_JSON="$(
  HEPTA_LIVE_URL="$BASE_URL" \
    ...
    capture_json_report "hepta-memory-intelligence-kg-full-live-activation-artifact-download-install-affordance-result-receipt-operator-facing-summary-briefing-non-persistence-denial-gate" \
...
final_acknowledgement_contract_hash_sha256="$(
  sha256_text "hepta-memory-intelligence-kg-full-live-activation-artifact-download-install-affordance-result-receipt-final-operator-acknowledgement-non-acceptance-denial:$source_summary_briefing_report_sha256:$MIN_LONG_SOAK_SAMPLES"
)"
final_acknowledgement_policy_hash_sha256="$(
  sha256_text "artifact-download-install-affordance-result-receipt-final-operator-acknowledgement-non-acceptance:no-ack:no-received:no-confirmed:no-read:no-seen:no-final-response:no-status:no-authority:no-install:no-live"
)"
...
jq -n -e \
  ...
  '
    ...
    and $source.gate == "hepta_memory_intelligence_kg_full_live_activation_operator_readiness_packet_template_packet_acceptance_receipt_release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_operator_facing_summary_briefing_non_persistence_denial_gate"
    and $source.memory_intelligence_kg_full_live_activation_operator_readiness_packet_template_packet_acceptance_receipt_release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_operator_facing_summary_briefing_non_persistence_denial_ready == true
    and $source.source_packet_acceptance_receipt_release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_export_query_observability_ready == true
    and $source.release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_operator_facing_summary_briefing_surface_count == 18
    and $source.release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_operator_facing_summary_briefing_attempt_count == 18
    and $source.release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_operator_facing_summary_briefing_denied_count == 18
    ...
    and ($source.release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_operator_facing_summary_briefing_surfaces | length) == 18
    and ($source.release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_operator_facing_summary_briefing_surfaces | all(
...
final_acknowledgement_surfaces_json="$(
  jq -n '
    def ack_surface($id; $status; $reason; $extra):
      {
        release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_final_operator_acknowledgement_surface:$id,
        source_operator_facing_summary_briefing_ready:true,
    ...
    [
      ack_surface("source_operator_facing_summary_briefing_report_required"; "blocked_source_summary_briefing_required_noop"; "source_operator_facing_summary_briefing_report_required"; {source_operator_facing_summary_briefing_report_required:true}),
      ack_surface("download_button_final_operator_acknowledgement_claim"; "blocked_final_ack_noop"; "download_button_final_operator_acknowledgement_claim_denied"; {final_operator_acknowledgement_requested:true}),
      ack_surface("direct_download_url_operator_received_claim"; "blocked_operator_received_noop"; "direct_download_url_operator_received_claim_denied"; {operator_received_requested:true}),
      ack_surface("checksum_prompt_operator_confirmed_claim"; "blocked_operator_confirmed_noop"; "checksum_prompt_operator_confirmed_claim_denied"; {operator_confirmed_requested:true}),
      ack_surface("package_manager_install_command_operator_read_claim"; "blocked_operator_read_noop"; "package_manager_install_command_operator_read_claim_denied"; {operator_read_requested:true}),
      ack_surface("curl_pipe_shell_operator_seen_claim"; "blocked_operator_seen_noop"; "curl_pipe_shell_operator_seen_claim_denied"; {operator_seen_requested:true}),
      ack_surface("installer_launch_prompt_final_response_claim"; "blocked_final_response_noop"; "installer_launch_prompt_final_response_claim_denied"; {final_response_requested:true}),
      ack_surface("auto_update_offer_completion_acknowledgement_claim"; "blocked_completion_ack_noop"; "auto_update_offer_completion_acknowledgement_claim_denied"; {completion_acknowledgement_requested:true}),
      ack_surface("release_channel_subscription_status_acknowledgement_claim"; "blocked_status_ack_noop"; "release_channel_subscription_status_acknowledgement_claim_denied"; {status_acknowledgement_requested:true}),
      ack_surface("update_feed_hint_summary_acknowledgement_claim"; "blocked_summary_ack_noop"; "update_feed_hint_summary_acknowledgement_claim_denied"; {summary_acknowledgement_requested:true}),
      ack_surface("package_registry_badge_briefing_acknowledgement_claim"; "blocked_briefing_ack_noop"; "package_registry_badge_briefing_acknowledgement_claim_denied"; {briefing_acknowledgement_requested:true}),
      ack_surface("cdn_mirror_download_readback_digest_acknowledgement_claim"; "blocked_readback_ack_noop"; "cdn_mirror_download_readback_digest_acknowledgement_claim_denied"; {readback_digest_acknowledgement_requested:true}),
      ack_surface("sbom_provenance_notarization_dashboard_notification_acknowledgement_claim"; "blocked_dashboard_notification_ack_noop"; "sbom_provenance_notarization_dashboard_notification_acknowledgement_claim_denied"; {dashboard_acknowledgement_requested:true, notification_acknowledgement_requested:true}),
      ack_surface("signature_verification_command_channel_acknowledgement_claim"; "blocked_channel_ack_noop"; "signature_verification_command_channel_acknowledgement_claim_denied"; {channel_acknowledgement_requested:true}),
      ack_surface("one_click_install_deep_link_operator_approval_acknowledgement_claim"; "blocked_operator_approval_ack_noop"; "one_click_install_deep_link_operator_approval_acknowledgement_claim_denied"; {operator_approval_acknowledgement_requested:true}),
      ack_surface("external_telegram_install_message_external_telegram_acknowledgement_claim"; "blocked_external_telegram_ack_noop"; "external_telegram_install_message_external_telegram_acknowledgement_claim_denied"; {external_acknowledgement_requested:true, telegram_acknowledgement_requested:true}),
      ack_surface("release_publication_authority_install_affordance_authority_acknowledgement_claim"; "blocked_authority_ack_noop"; "release_publication_authority_install_affordance_authority_acknowledgement_claim_denied"; {authority_acknowledgement_requested:true}),
      ack_surface("activation_live_install_restart_active_binary_acknowledgement_claim"; "blocked_live_ack_noop"; "activation_live_install_restart_active_binary_acknowledgement_claim_denied"; {live_acknowledgement_requested:true, install_restart_active_binary_acknowledgement_requested:true})
    ]
  '
)"
...
report="$(
  jq -n \
    ...
    --arg gate "hepta_memory_intelligence_kg_full_live_activation_operator_readiness_packet_template_packet_acceptance_receipt_release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_final_operator_acknowledgement_non_acceptance_denial_gate" \
    ...
    '
...

      {
        ...
        receipt_release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_final_operator_acknowledgement_mode:"denied_artifact_download_install_result_receipt_cannot_create_final_operator_acknowledgement_acceptance_or_authority",
        source_packet_acceptance_receipt_release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_operator_facing_summary_briefing_gate:$source.gate,
        source_packet_acceptance_receipt_release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_operator_facing_summary_briefing_ready:$source.memory_intelligence_kg_full_live_activation_operator_readiness_packet_template_packet_acceptance_receipt_release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_operator_facing_summary_briefing_non_persistence_denial_ready,
        source_packet_acceptance_receipt_release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_operator_facing_summary_briefing_report_sha256:$source_summary_briefing_report_sha256,
        source_release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_operator_facing_summary_briefing_contract_hash_sha256:$source.release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_operator_facing_summary_briefing_contract_hash_sha256,
        release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_final_operator_acknowledgement_contract_hash_sha256:$final_acknowledgement_contract_hash_sha256,
        release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_final_operator_acknowledgement_policy_hash_sha256:$final_acknowledgement_policy_hash_sha256,
        minimum_required_samples:$min_long_soak_samples,
        memory_intelligence_kg_full_live_activation_operator_readiness_packet_template_packet_acceptance_receipt_release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_final_operator_acknowledgement_non_acceptance_denial_ready:true,
        source_release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_operator_facing_summary_briefing_surface_count:$source.release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_operator_facing_summary_briefing_surface_count,
        source_release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_operator_facing_summary_briefing_attempt_count:$source.release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_operator_facing_summary_briefing_attempt_count,
        source_release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_operator_facing_summary_briefing_denied_count:$source.release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_operator_facing_summary_briefing_denied_count,
        source_release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_operator_summary_recorded_count:$source.release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_operator_summary_recorded_count,
        source_release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_operator_briefing_recorded_count:$source.release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_operator_briefing_recorded_count,
        source_release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_readback_digest_recorded_count:$source.release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_readback_digest_recorded_count,
        release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_final_operator_acknowledgement_surface_count:($surfaces | length),
        release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_final_operator_acknowledgement_attempt_count:($surfaces | length),
        release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_final_operator_acknowledgement_denied_count:($surfaces | length),
        release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_final_operator_acknowledgement_surfaces:$surfaces,
        denied_by_packet_receipt_release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_final_operator_acknowledgement:[
...
jq -e '
  ...
  and $report.gate == "hepta_memory_intelligence_kg_full_live_activation_operator_readiness_packet_template_packet_acceptance_receipt_release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_final_operator_acknowledgement_non_acceptance_denial_gate"
  and $report.memory_intelligence_kg_full_live_activation_operator_readiness_packet_template_packet_acceptance_receipt_release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_final_operator_acknowledgement_non_acceptance_denial_ready == true
  and $report.source_packet_acceptance_receipt_release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_operator_facing_summary_briefing_ready == true
  and $report.source_release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_operator_facing_summary_briefing_surface_count == 18
  and $report.source_release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_operator_facing_summary_briefing_denied_count == 18
  and $report.release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_final_operator_acknowledgement_surface_count == 18
  and $report.release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_final_operator_acknowledgement_attempt_count == 18
  and $report.release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_final_operator_acknowledgement_denied_count == 18
  ...
  and ($report.release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_final_operator_acknowledgement_surfaces | length) == 18
  and ($report.release_publication_result_receipt_terminal_distribution_delivery_receipt_artifact_download_install_affordance_result_receipt_final_operator_acknowledgement_surfaces | all(
    .artifact_download_install_affordance_result_receipt_final_operator_acknowledgement_attempted == true
...
printf '%s\n' "$report" | jq .
echo "Hepta memory/intelligence/KG full live activation operator readiness packet template packet acceptance receipt release/publication result receipt terminal distribution delivery receipt artifact download/install affordance result receipt final operator acknowledgement non-acceptance denial gate passed"
