...
prior_report_script="scripts/hepta-systems-work-graph-dtd8-rbackacktd-rcptret-rbackack-td2-receipt-ack-preview-report.sh"
prior_gate_script="scripts/hepta-systems-work-graph-dtd8-rbackacktd-rcptret-rbackack-td2-receipt-ack-preview-gate.sh"
...
rust_module="codex-rs/hepta-runtime/src/wg_deep_td8_ret_ack_td_rback_ack_td_receipt_retention_readback_ack_td_receipt_retention_readback_ack_td_receipt_retention_readback_ack_td_receipt_retention_readback_ack_td_receipt_ack_replay_preview.rs"
report_script="scripts/hepta-systems-work-graph-dtd8-rbackacktd-rcptret-rbackack-td2-receipt-ack-replay-preview-report.sh"
gate_script="scripts/hepta-systems-work-graph-dtd8-rbackacktd-rcptret-rbackack-td2-receipt-ack-replay-preview-gate.sh"
