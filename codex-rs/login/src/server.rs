        ...
        if is_missing_codex_entitlement_error(code, error_description) {
            (
                ...
                "This account is not currently authorized to use Hepta in this workspace."
                    .to_string(),
                "Contact your workspace administrator to request access to Hepta.".to_string(),
                "Contact your workspace administrator to get access to Hepta, then return to Hepta and try again."
                    .to_string(),
            )
        } else {
            (
                ...
                "Return to Hepta to retry, switch accounts, or contact your workspace admin if access is restricted."
                    .to_string(),
            )
        };
