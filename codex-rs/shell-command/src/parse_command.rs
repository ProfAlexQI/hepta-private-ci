...
/// The easiest way to iterate is to add unit tests and have Hepta fix the implementation.
...
/// Tests are at the top to encourage using TDD + Hepta to fix the implementation.
mod tests {
    use super::*;
