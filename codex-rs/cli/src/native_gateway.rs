...
mod tests {
    ...
    fn control_ui_root_serves_rust_rendered_shell_and_assets() {
        ...
        assert!(body.contains("data-no-js-frontend=\"true\""));
        assert!(body.contains("data-telegram-multi-agent-chat=\"true\""));
        assert!(body.contains("href=\"./styles.css\""));
        assert!(body.contains("src=\"./assets/hepta-agent-logo.png\""));
        assert!(!body.contains("<script"));
        assert!(!body.contains("Native gateway entrypoint running"));
