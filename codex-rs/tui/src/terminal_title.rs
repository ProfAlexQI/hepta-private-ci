...
//! "leave the old title alone" or "clear the title Hepta last wrote".
...
pub(crate) enum SetTerminalTitleResult {
    ...
    /// the title Hepta manages, or some other fallback.
    NoVisibleContent,
}
...
/// or a previous program may have set before Hepta started managing the title.
