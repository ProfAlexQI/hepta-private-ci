...
pub use hepta_runtime::{
    ...
    DEFAULT_TELEGRAM_MODEL_TIMEOUT_MS, HEPTA_CORE_FUSION_READINESS_ENDPOINT,
    ...
    extract_native_telegram_openai_chat_completion_text, hepta_core_fusion_readiness_report,
    hepta_kernel_telegram_prompt, invoke_native_telegram_model_runner_with_plan,
