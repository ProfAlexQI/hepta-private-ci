//! Entry-point for the `codex-exec` compatibility binary.
//!
//! When this CLI is invoked normally, it parses the standard `codex-exec` CLI
//! options and launches the non-interactive Hepta agent. However, if it is
...
//! of the `codex-exec` compatibility binary.
use clap::Parser;
