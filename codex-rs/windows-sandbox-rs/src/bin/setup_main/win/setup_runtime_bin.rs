...
pub(super) fn ensure_codex_app_runtime_bin_readable(
    ...
    // Hepta Desktop copies bundled Windows binaries out of WindowsApps to this
    // fixed LocalAppData cache before launching hepta.exe.
    let runtime_bin_dir = local_app_data.join("Hepta").join("bin");
