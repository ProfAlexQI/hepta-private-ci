...
const SESSION_NAME: &str = "Hepta Windows Sandbox WFP";
const PROVIDER_NAME: &str = "Hepta Windows Sandbox WFP";
const PROVIDER_DESCRIPTION: &str = "Persistent WFP provider for Hepta Windows sandbox filters";
const SUBLAYER_NAME: &str = "Hepta Windows Sandbox WFP";
const SUBLAYER_DESCRIPTION: &str = "Persistent WFP sublayer for Hepta Windows sandbox filters";

// WFP identifies persistent providers, sublayers, and filters by stable GUIDs.
// These values are Hepta-owned identities; do not regenerate them unless we
...
/// Installs the persistent Hepta WFP filters for `account`.
///
...
/// Ensures the persistent Hepta WFP provider exists.
...
/// Ensures the persistent Hepta sublayer exists under the Hepta provider.
