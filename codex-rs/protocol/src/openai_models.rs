//! Shared model metadata types exchanged between Hepta services and clients.
//!
...
/// Metadata describing a Hepta-supported model.
#[derive(Debug, Clone, Deserialize, Serialize, TS, JsonSchema, PartialEq)]
...
/// Model metadata returned by the Hepta backend `/models` endpoint.
