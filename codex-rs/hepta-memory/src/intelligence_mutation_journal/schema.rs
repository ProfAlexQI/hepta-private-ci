...
async fn schema_digest(pool: &SqlitePool) -> Result<Sha256Digest, CognitiveStoreError> {
    ...
    for (name, object_type, sql) in definitions {
        super::super::super::frame_part(&mut hasher, name.as_bytes());
        super::super::super::frame_part(&mut hasher, object_type.as_bytes());
        super::super::super::frame_part(&mut hasher, sql.as_bytes());
    }
