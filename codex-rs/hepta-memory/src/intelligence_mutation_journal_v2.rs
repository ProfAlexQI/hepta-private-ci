...
#[path = "intelligence_mutation_journal/digest.rs"]
mod digest;
#[path = "intelligence_mutation_journal/replay_v2.rs"]
mod replay;
#[path = "intelligence_mutation_journal/schema.rs"]
mod schema;

#[cfg(test)]
#[path = "intelligence_mutation_journal/tests_v2.rs"]
mod tests;
