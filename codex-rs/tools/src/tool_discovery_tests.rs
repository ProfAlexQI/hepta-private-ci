...
#[test]
fn filter_request_plugin_install_discoverable_tools_for_hepta_tui_omits_plugins() {
...
#[test]
fn filter_request_plugin_install_discoverable_tools_keeps_legacy_codex_tui_behavior() {
    let discoverable_tools = vec![
        DiscoverableTool::Connector(Box::new(AppInfo {
            id: "connector_google_calendar".to_string(),
            name: "Google Calendar".to_string(),
