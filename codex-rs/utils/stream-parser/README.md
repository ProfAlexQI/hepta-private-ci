...
**Disclaimer**: This code is pretty complex and Hepta did not manage to write it so before updating the code, make
sure to deeply understand it and don't blindly trust Hepta on it. Feel free to update the documentation as you
modify the code
