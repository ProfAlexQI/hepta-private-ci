...
/// Returns the on-disk cache location for embedded system skills from an absolute Hepta home.
...
/// Installs embedded system skills into `HEPTA_HOME/skills/.system`.
///
