...
/// One Hepta thread/session participating in the rollout.
///
...
/// Provenance for a traced Hepta thread.
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
...
/// One activation of the Hepta runtime for one thread.
///
/// A Hepta turn groups protocol/runtime work for one thread activation.
