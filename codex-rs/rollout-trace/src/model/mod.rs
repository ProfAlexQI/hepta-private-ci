...
/// Hepta conversation/session UUID.
...
/// Process/session ID returned by Hepta's terminal runtime.
...
/// Canonical reduced graph for one Hepta rollout.
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct RolloutTrace {
    pub schema_version: u32,
    /// Unique identity for this trace capture.
    ///
    /// `rollout_id` names the Hepta rollout/session being observed. `trace_id`
