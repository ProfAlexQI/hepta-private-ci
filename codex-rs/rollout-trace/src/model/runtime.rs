...
/// Runtime operation requested by the model, a JS code cell, or Hepta itself.
///
...
pub struct ToolCall {
    ...
    /// Original invocation at the Hepta tool boundary.
    ///
    ...
    /// they describe how Hepta executed the request, not what the caller sent.
