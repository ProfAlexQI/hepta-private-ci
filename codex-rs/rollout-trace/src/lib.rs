//! Trace bundle format, writer, and reducer for Hepta rollouts.
//!
//! This crate owns the trace schema. Hot-path Hepta code should depend on the
...
/// Shared recorder context for inference attempts within one Hepta turn.
...
/// Request data for the canonical Hepta tool boundary.
...
/// Append-only writer used by hot-path Hepta instrumentation.
