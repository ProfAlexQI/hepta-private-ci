...
impl ThreadTraceContext {
    ...
    ///
    /// Trace startup is best-effort. A tracing failure must not make the Hepta
    ...
    /// Emits typed Hepta turn lifecycle events from protocol lifecycle events.
    ...
    /// what Hepta did while executing that boundary.
    ...
    /// Builds reusable inference trace context for one Hepta turn.
    ///
