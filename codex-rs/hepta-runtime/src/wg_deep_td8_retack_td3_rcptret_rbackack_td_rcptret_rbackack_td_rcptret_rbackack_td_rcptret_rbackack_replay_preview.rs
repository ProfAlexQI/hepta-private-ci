...
pub struct DeepTd8Td3RbackAckTd3ReceiptRetentionReadbackAckReplayPreviewReport {
    ...
    pub replay_scenarios: Vec<DeepTd8Td3RbackAckTd3ReceiptRetentionReadbackAckReplayItem>,
    pub idempotency_guards: Vec<DeepTd8Td3RbackAckTd3ReceiptRetentionReadbackAckReplayItem>,
    pub replay_denials: Vec<DeepTd8Td3RbackAckTd3ReceiptRetentionReadbackAckReplayItem>,
    pub monotonicity_checks: Vec<DeepTd8Td3RbackAckTd3ReceiptRetentionReadbackAckReplayItem>,
    pub local_views: Vec<DeepTd8Td3RbackAckTd3ReceiptRetentionReadbackAckReplayItem>,
    pub invariants: Vec<DeepTd8Td3RbackAckTd3ReceiptRetentionReadbackAckReplayItem>,
    ...
    pub side_effects: DeepTd8Td3RbackAckTd3ReceiptRetentionReadbackAckReplaySideEffects,
}

#[derive(Debug, Clone, PartialEq, Eq, Serialize)]
pub struct DeepTd8Td3RbackAckTd3ReceiptRetentionReadbackAckReplayItem {
    pub id: String,
...
pub struct DeepTd8Td3RbackAckTd3ReceiptRetentionReadbackAckReplaySideEffects {
...
pub fn deep_td8_retack_td3_rcptret_rbackack_td_rcptret_rbackack_td_rcptret_rbackack_td_rcptret_rbackack_terminal_decision_gate()
-> String {
    format!(
...
pub fn hepta_work_graph_deep_td8_retack_td3_rcptret_rbackack_td_rcptret_rbackack_td_rcptret_rbackack_td_rcptret_rbackack_replay_preview_report()
-> DeepTd8Td3RbackAckTd3ReceiptRetentionReadbackAckReplayPreviewReport {
    ...
    DeepTd8Td3RbackAckTd3ReceiptRetentionReadbackAckReplayPreviewReport {
        ...
        gate,
        preview_mode: "read_only_deep_td8_td3_rbackack_td3_receipt_retention_readback_acknowledgement_replay_idempotency_preview_no_replay_write",
        ...
        required_prior_gates:
            deep_td8_retack_td3_rcptret_rbackack_td_rcptret_rbackack_td_rcptret_rbackack_td_rcptret_rbackack_replay_required_prior_gates(),
        replay_scenarios,
        idempotency_guards,
        replay_denials,
        monotonicity_checks,
        ...
        recommended_next_gate:
            deep_td8_retack_td3_rcptret_rbackack_td_rcptret_rbackack_td_rcptret_rbackack_td_rcptret_rbackack_terminal_decision_gate(),
        ready_for_terminal_decision_preview: true,
        ready_for_operator_acceptance: false,
        ready_for_live_persistence: false,
        side_effects: DeepTd8Td3RbackAckTd3ReceiptRetentionReadbackAckReplaySideEffects::none(),
    }
}

pub fn deep_td8_retack_td3_rcptret_rbackack_td_rcptret_rbackack_td_rcptret_rbackack_td_rcptret_rbackack_replay_required_prior_gates()
-> Vec<String> {
    let mut gates =
        crate::deep_td8_retack_td3_rcptret_rbackack_td_rcptret_rbackack_td_rcptret_rbackack_td_rcptret_rbackack_required_prior_gates();
    gates.push(
...
fn replay_items(
    prefix: &str,
    count: usize,
) -> Vec<DeepTd8Td3RbackAckTd3ReceiptRetentionReadbackAckReplayItem> {
    (0..count)
        .map(
            |index| DeepTd8Td3RbackAckTd3ReceiptRetentionReadbackAckReplayItem {
                id: format!(
                    "deep_td8_td3_rcptret_rbackack_td_rcptret_rbackack_td_rcptret_rbackack_td_rcptret_rbackack_replay_{prefix}_{index}"
                ),
...
impl DeepTd8Td3RbackAckTd3ReceiptRetentionReadbackAckReplaySideEffects {
    pub fn none() -> Self {
        Self {
...
mod tests {
    ...
    #[test]
    fn work_graph_td3_rbackack_td2_rcptret_rbackack_replay_requires_ack_gate() {
        let report =
            hepta_work_graph_deep_td8_retack_td3_rcptret_rbackack_td_rcptret_rbackack_td_rcptret_rbackack_td_rcptret_rbackack_replay_preview_report();
    ...
    #[test]
    fn work_graph_td3_rbackack_td2_rcptret_rbackack_replay_declares_blocked_scenarios() {
        let report =
            hepta_work_graph_deep_td8_retack_td3_rcptret_rbackack_td_rcptret_rbackack_td_rcptret_rbackack_td_rcptret_rbackack_replay_preview_report();
    ...
    #[test]
    fn work_graph_td3_rbackack_td2_rcptret_rbackack_replay_requires_idempotency_guards() {
        let report =
            hepta_work_graph_deep_td8_retack_td3_rcptret_rbackack_td_rcptret_rbackack_td_rcptret_rbackack_td_rcptret_rbackack_replay_preview_report();
    ...
    #[test]
    fn work_graph_td3_rbackack_td2_rcptret_rbackack_replay_denies_mutating_outcomes() {
        let report =
            hepta_work_graph_deep_td8_retack_td3_rcptret_rbackack_td_rcptret_rbackack_td_rcptret_rbackack_td_rcptret_rbackack_replay_preview_report();
    ...
    #[test]
    fn work_graph_td3_rbackack_td2_rcptret_rbackack_replay_points_to_terminal_decision() {
        let report =
            hepta_work_graph_deep_td8_retack_td3_rcptret_rbackack_td_rcptret_rbackack_td_rcptret_rbackack_td_rcptret_rbackack_replay_preview_report();
    ...
    #[test]
    fn work_graph_td3_rbackack_td2_rcptret_rbackack_replay_has_no_side_effects() {
        let report =
            hepta_work_graph_deep_td8_retack_td3_rcptret_rbackack_td_rcptret_rbackack_td_rcptret_rbackack_td_rcptret_rbackack_replay_preview_report();
