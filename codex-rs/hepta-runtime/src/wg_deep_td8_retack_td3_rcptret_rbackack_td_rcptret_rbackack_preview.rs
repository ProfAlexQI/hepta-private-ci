...
pub struct DeepTd8Td3RbackAckTdReceiptRetentionReadbackAckPreviewReport {
    ...
    pub acknowledgement_contracts: Vec<DeepTd8Td3RbackAckTdReceiptRetentionReadbackAckItem>,
    pub non_acceptance_reasons: Vec<DeepTd8Td3RbackAckTdReceiptRetentionReadbackAckItem>,
    pub recording_denials: Vec<DeepTd8Td3RbackAckTdReceiptRetentionReadbackAckItem>,
    pub expiry_replay_guards: Vec<DeepTd8Td3RbackAckTdReceiptRetentionReadbackAckItem>,
    pub local_views: Vec<DeepTd8Td3RbackAckTdReceiptRetentionReadbackAckItem>,
    pub invariants: Vec<DeepTd8Td3RbackAckTdReceiptRetentionReadbackAckItem>,
    ...
    pub side_effects: DeepTd8Td3RbackAckTdReceiptRetentionReadbackAckSideEffects,
}

#[derive(Debug, Clone, PartialEq, Eq, Serialize)]
pub struct DeepTd8Td3RbackAckTdReceiptRetentionReadbackAckItem {
    pub id: String,
...
pub struct DeepTd8Td3RbackAckTdReceiptRetentionReadbackAckSideEffects {
...
pub fn deep_td8_retack_td3_rcptret_rbackack_td_rcptret_readback_ack_replay_gate() -> String {
    format!(
...
pub fn hepta_work_graph_deep_td8_retack_td3_rcptret_rbackack_td_rcptret_rbackack_preview_report()
-> DeepTd8Td3RbackAckTdReceiptRetentionReadbackAckPreviewReport {
    ...
    let gate = crate::deep_td8_retack_td3_rcptret_rbackack_td_rcptret_readback_ack_gate();
    ...
    DeepTd8Td3RbackAckTdReceiptRetentionReadbackAckPreviewReport {
        ...
        gate,
        preview_mode: "read_only_deep_td8_td3_rcptret_rbackack_td_receipt_retention_readback_acknowledgement_preview_no_recording",
        ...
        required_prior_gates:
            deep_td8_retack_td3_rcptret_rbackack_td_rcptret_rbackack_required_prior_gates(),
        ...
        recommended_next_gate:
            deep_td8_retack_td3_rcptret_rbackack_td_rcptret_readback_ack_replay_gate(),
        ready_for_readback_acknowledgement_replay_preview: true,
        ready_for_operator_acceptance: false,
        ready_for_live_persistence: false,
        side_effects: DeepTd8Td3RbackAckTdReceiptRetentionReadbackAckSideEffects::none(),
    }
}

pub fn deep_td8_retack_td3_rcptret_rbackack_td_rcptret_rbackack_required_prior_gates() -> Vec<String>
{
    let mut gates =
        crate::deep_td8_retack_td3_rcptret_rbackack_td_rcptret_rbrcpt_required_prior_gates();
    gates.push(crate::deep_td8_retack_td3_rcptret_rbackack_td_rcptret_readback_receipt_gate());
    gates
}
...
fn ack_items(
    prefix: &str,
    count: usize,
) -> Vec<DeepTd8Td3RbackAckTdReceiptRetentionReadbackAckItem> {
    (0..count)
        .map(
            |index| DeepTd8Td3RbackAckTdReceiptRetentionReadbackAckItem {
                id: format!("deep_td8_td3_rcptret_rbackack_td_rcptret_rbackack_{prefix}_{index}"),
...
impl DeepTd8Td3RbackAckTdReceiptRetentionReadbackAckSideEffects {
    pub fn none() -> Self {
        Self {
...
mod tests {
    ...
    #[test]
    fn work_graph_td3_rbackack_td_rcptret_rbackack_requires_readback_receipt_gate() {
        let report =
            hepta_work_graph_deep_td8_retack_td3_rcptret_rbackack_td_rcptret_rbackack_preview_report(
            );

        assert_eq!(
            report.required_prior_gates.last(),
            Some(&crate::deep_td8_retack_td3_rcptret_rbackack_td_rcptret_readback_receipt_gate())
        );
    }

    #[test]
    fn work_graph_td3_rbackack_td_rcptret_rbackack_declares_non_accepting_contracts() {
        let report =
            hepta_work_graph_deep_td8_retack_td3_rcptret_rbackack_td_rcptret_rbackack_preview_report(
            );
    ...
    #[test]
    fn work_graph_td3_rbackack_td_rcptret_rbackack_denies_recording_and_delivery() {
        let report =
            hepta_work_graph_deep_td8_retack_td3_rcptret_rbackack_td_rcptret_rbackack_preview_report(
            );
    ...
    #[test]
    fn work_graph_td3_rbackack_td_rcptret_rbackack_guards_expiry_scope_and_replay() {
        let report =
            hepta_work_graph_deep_td8_retack_td3_rcptret_rbackack_td_rcptret_rbackack_preview_report(
            );
    ...
    #[test]
    fn work_graph_td3_rbackack_td_rcptret_rbackack_points_to_replay_gate() {
        let report =
            hepta_work_graph_deep_td8_retack_td3_rcptret_rbackack_td_rcptret_rbackack_preview_report(
            );
    ...
    #[test]
    fn work_graph_td3_rbackack_td_rcptret_rbackack_has_no_side_effects() {
        let report =
            hepta_work_graph_deep_td8_retack_td3_rcptret_rbackack_td_rcptret_rbackack_preview_report(
            );
