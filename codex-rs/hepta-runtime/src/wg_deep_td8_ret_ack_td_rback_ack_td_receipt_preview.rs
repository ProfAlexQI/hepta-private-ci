...
pub struct DeepTd8RetAckTdRbackAckTdReceiptPreviewReport {
    ...
    pub receipts: Vec<DeepTd8RetAckTdRbackAckTdReceiptItem>,
    pub digest_checks: Vec<DeepTd8RetAckTdRbackAckTdReceiptItem>,
    pub mismatch_denials: Vec<DeepTd8RetAckTdRbackAckTdReceiptItem>,
    pub receipt_guards: Vec<DeepTd8RetAckTdRbackAckTdReceiptItem>,
    pub local_views: Vec<DeepTd8RetAckTdRbackAckTdReceiptItem>,
    pub invariants: Vec<DeepTd8RetAckTdRbackAckTdReceiptItem>,
    ...
    pub side_effects: DeepTd8RetAckTdRbackAckTdReceiptSideEffects,
}

#[derive(Debug, Clone, PartialEq, Eq, Serialize)]
pub struct DeepTd8RetAckTdRbackAckTdReceiptItem {
    pub id: String,
...
pub struct DeepTd8RetAckTdRbackAckTdReceiptSideEffects {
...
pub fn deep_td8_ret_ack_td_rback_ack_td_receipt_acknowledgement_gate() -> String {
    format!(
...
pub fn hepta_work_graph_deep_td8_ret_ack_td_rback_ack_td_receipt_preview_report()
-> DeepTd8RetAckTdRbackAckTdReceiptPreviewReport {
    ...
    let gate = crate::deep_td8_ret_ack_td_rback_ack_td_receipt_gate();
    ...
    DeepTd8RetAckTdRbackAckTdReceiptPreviewReport {
        ...
        required_prior_gates: deep_td8_ret_ack_td_rback_ack_td_receipt_required_prior_gates(),
        receipts,
        digest_checks,
        mismatch_denials,
        receipt_guards,
        local_views,
        invariants,
        recommended_next_gate: deep_td8_ret_ack_td_rback_ack_td_receipt_acknowledgement_gate(),
        ready_for_terminal_decision_receipt_acknowledgement_preview: true,
        ready_for_operator_acceptance: false,
        ready_for_live_persistence: false,
        side_effects: DeepTd8RetAckTdRbackAckTdReceiptSideEffects::none(),
    }
}

pub fn deep_td8_ret_ack_td_rback_ack_td_receipt_required_prior_gates() -> Vec<String> {
    let mut gates = crate::deep_td8_ret_ack_td_rback_ack_td_required_prior_gates();
    gates.push(crate::deep_td8_ret_ack_td_receipt_retention_readback_ack_terminal_decision_gate());
    gates
}

pub fn deep_td8_ret_ack_td_rback_ack_td_receipt_ids() -> Vec<String> {
    (0..6)
        .map(|index| format!("deep_td8_ret_ack_td_rback_ack_td_receipt_{index}"))
        .collect()
}

fn receipt_items(prefix: &str, count: usize) -> Vec<DeepTd8RetAckTdRbackAckTdReceiptItem> {
    let source_surface_ids = crate::deep_td8_ret_ack_td_rback_ack_td_surface_ids();
    (0..count)
        .map(|index| DeepTd8RetAckTdRbackAckTdReceiptItem {
...
impl DeepTd8RetAckTdRbackAckTdReceiptSideEffects {
    pub fn none() -> Self {
        Self {
...
mod tests {
    ...
    #[test]
    fn work_graph_deep_td8_ret_ack_td_rback_ack_td_receipt_requires_terminal_decision_gate() {
        let report = hepta_work_graph_deep_td8_ret_ack_td_rback_ack_td_receipt_preview_report();

        assert_eq!(
            report.required_prior_gates.last(),
            Some(
                &crate::deep_td8_ret_ack_td_receipt_retention_readback_ack_terminal_decision_gate()
            )
        );
    }

    #[test]
    fn work_graph_deep_td8_ret_ack_td_rback_ack_td_receipts_are_hash_only() {
        let report = hepta_work_graph_deep_td8_ret_ack_td_rback_ack_td_receipt_preview_report();
    ...
    #[test]
    fn work_graph_deep_td8_ret_ack_td_rback_ack_td_receipts_check_digests_and_mismatches() {
        let report = hepta_work_graph_deep_td8_ret_ack_td_rback_ack_td_receipt_preview_report();
    ...
    #[test]
    fn work_graph_deep_td8_ret_ack_td_rback_ack_td_receipts_guard_recording_and_delivery() {
        let report = hepta_work_graph_deep_td8_ret_ack_td_rback_ack_td_receipt_preview_report();
    ...
    #[test]
    fn work_graph_deep_td8_ret_ack_td_rback_ack_td_receipt_points_to_ack_gate() {
        let report = hepta_work_graph_deep_td8_ret_ack_td_rback_ack_td_receipt_preview_report();

        assert_eq!(
            report.recommended_next_gate,
            deep_td8_ret_ack_td_rback_ack_td_receipt_acknowledgement_gate()
        );
    ...
    #[test]
    fn work_graph_deep_td8_ret_ack_td_rback_ack_td_receipt_has_no_side_effects() {
        let report = hepta_work_graph_deep_td8_ret_ack_td_rback_ack_td_receipt_preview_report();
