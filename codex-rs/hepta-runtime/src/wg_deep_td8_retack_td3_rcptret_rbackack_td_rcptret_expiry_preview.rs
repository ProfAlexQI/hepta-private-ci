...
pub struct DeepTd8Td3RbackAckTdReceiptRetentionExpiryPreviewReport {
    ...
    pub retention_policies: Vec<DeepTd8Td3RbackAckTdReceiptRetentionItem>,
    pub expiry_guards: Vec<DeepTd8Td3RbackAckTdReceiptRetentionItem>,
    pub supersession_guards: Vec<DeepTd8Td3RbackAckTdReceiptRetentionItem>,
    pub garbage_collection_denials: Vec<DeepTd8Td3RbackAckTdReceiptRetentionItem>,
    pub local_views: Vec<DeepTd8Td3RbackAckTdReceiptRetentionItem>,
    pub invariants: Vec<DeepTd8Td3RbackAckTdReceiptRetentionItem>,
    ...
    pub side_effects: DeepTd8Td3RbackAckTdReceiptRetentionSideEffects,
}

#[derive(Debug, Clone, PartialEq, Eq, Serialize)]
pub struct DeepTd8Td3RbackAckTdReceiptRetentionItem {
    pub id: String,
...
pub struct DeepTd8Td3RbackAckTdReceiptRetentionSideEffects {
...
pub fn deep_td8_retack_td3_rcptret_rbackack_td_rcptret_base() -> String {
    let gate = crate::deep_td8_retack_td3_rcptret_rbackack_td_receipt_retention_expiry_gate();
    gate.strip_suffix("_receipt_retention_expiry_preview_gate")
        .unwrap_or(gate.as_str())
        .to_owned()
}

pub fn deep_td8_retack_td3_rcptret_rbackack_td_rcptret_readback_receipt_gate() -> String {
    format!(
        "{}_receipt_retention_expiry_readback_receipt_preview_gate",
        deep_td8_retack_td3_rcptret_rbackack_td_rcptret_base()
    )
}

pub fn hepta_work_graph_deep_td8_retack_td3_rcptret_rbackack_td_rcptret_expiry_preview_report()
-> DeepTd8Td3RbackAckTdReceiptRetentionExpiryPreviewReport {
    ...
    DeepTd8Td3RbackAckTdReceiptRetentionExpiryPreviewReport {
        ...
        gate,
        preview_mode: "read_only_deep_td8_td3_rcptret_rbackack_td_receipt_retention_expiry_preview_no_retention_mutation",
        ...
        required_prior_gates:
            deep_td8_retack_td3_rcptret_rbackack_td_rcptret_expiry_required_prior_gates(),
        retention_policies,
        expiry_guards,
        supersession_guards,
        ...
        recommended_next_gate:
            deep_td8_retack_td3_rcptret_rbackack_td_rcptret_readback_receipt_gate(),
        ready_for_readback_receipt_preview: true,
        ready_for_operator_acceptance: false,
        ready_for_live_persistence: false,
        side_effects: DeepTd8Td3RbackAckTdReceiptRetentionSideEffects::none(),
    }
}

pub fn deep_td8_retack_td3_rcptret_rbackack_td_rcptret_expiry_required_prior_gates() -> Vec<String>
{
    let mut gates =
        crate::deep_td8_retack_td3_rcptret_rbackack_td_receipt_ack_replay_required_prior_gates();
    gates.push(crate::deep_td8_retack_td3_rcptret_rbackack_td_receipt_ack_replay_gate());
    gates
}
...
fn retention_items(
    prefix: &'static str,
    count: usize,
) -> Vec<DeepTd8Td3RbackAckTdReceiptRetentionItem> {
    (0..count)
        .map(|index| DeepTd8Td3RbackAckTdReceiptRetentionItem {
            id: format!("deep_td8_td3_rcptret_rbackack_td_rcptret_{prefix}_{index}"),
...
impl DeepTd8Td3RbackAckTdReceiptRetentionSideEffects {
    pub fn none() -> Self {
        Self {
...
mod tests {
    ...
    #[test]
    fn work_graph_td3_rbackack_td_rcptret_requires_ack_replay_gate() {
        let report =
            hepta_work_graph_deep_td8_retack_td3_rcptret_rbackack_td_rcptret_expiry_preview_report(
            );

        assert_eq!(
            report.required_prior_gates.last(),
            Some(&crate::deep_td8_retack_td3_rcptret_rbackack_td_receipt_ack_replay_gate())
        );
    }

    #[test]
    fn work_graph_td3_rbackack_td_rcptret_declares_bounded_hash_only_policies() {
        let report =
            hepta_work_graph_deep_td8_retack_td3_rcptret_rbackack_td_rcptret_expiry_preview_report(
            );
    ...
    #[test]
    fn work_graph_td3_rbackack_td_rcptret_blocks_expired_or_superseded_scope() {
        let report =
            hepta_work_graph_deep_td8_retack_td3_rcptret_rbackack_td_rcptret_expiry_preview_report(
            );
    ...
    #[test]
    fn work_graph_td3_rbackack_td_rcptret_denies_garbage_collection_mutations() {
        let report =
            hepta_work_graph_deep_td8_retack_td3_rcptret_rbackack_td_rcptret_expiry_preview_report(
            );
    ...
    #[test]
    fn work_graph_td3_rbackack_td_rcptret_keeps_views_local_and_next_gate() {
        let report =
            hepta_work_graph_deep_td8_retack_td3_rcptret_rbackack_td_rcptret_expiry_preview_report(
            );
    ...
    #[test]
    fn work_graph_td3_rbackack_td_rcptret_has_no_side_effects() {
        let report =
            hepta_work_graph_deep_td8_retack_td3_rcptret_rbackack_td_rcptret_expiry_preview_report(
            );
