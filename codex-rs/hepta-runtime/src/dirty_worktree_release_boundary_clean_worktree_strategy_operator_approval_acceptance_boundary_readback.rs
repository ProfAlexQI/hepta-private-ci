...
use crate::DirtyWorktreeReleaseBoundaryCleanWorktreeStrategyOperatorDecisionRecordingBoundaryReadbackReport;
use crate::dirty_worktree_release_boundary_clean_worktree_strategy_operator_decision_recording_boundary_readback_report;

pub const DIRTY_WORKTREE_RELEASE_BOUNDARY_CLEAN_WORKTREE_STRATEGY_OPERATOR_APPROVAL_ACCEPTANCE_BOUNDARY_READBACK_GATE:
    &str = "dirty_worktree_release_boundary_clean_worktree_strategy_operator_approval_acceptance_boundary_readback_gate";
pub const DIRTY_WORKTREE_RELEASE_BOUNDARY_CLEAN_WORKTREE_STRATEGY_OPERATOR_APPROVAL_ACCEPTANCE_BOUNDARY_READBACK_SCHEMA_VERSION:
    &str = "dirty_worktree_release_boundary_clean_worktree_strategy_operator_approval_acceptance_boundary_readback_v1";
pub const DIRTY_WORKTREE_RELEASE_BOUNDARY_CLEAN_WORKTREE_STRATEGY_OPERATOR_APPROVAL_ACCEPTANCE_BOUNDARY_READBACK_RECOMMENDED_NEXT_GATE:
    &str = "phase22_dirty_worktree_release_boundary_clean_worktree_strategy_operator_evidence_recording_boundary_readback_without_recording";

#[derive(Debug, Clone, PartialEq, Eq, Serialize)]
pub struct DirtyWorktreeReleaseBoundaryCleanWorktreeStrategyOperatorApprovalAcceptanceBoundaryReadbackReport {
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize)]
pub struct DirtyWorktreeReleaseBoundaryCleanWorktreeStrategyOperatorApprovalAcceptanceBoundaryReadbackScope
{
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize)]
pub struct DirtyWorktreeReleaseBoundaryCleanWorktreeStrategyOperatorApprovalAcceptanceBoundaryReadbackEntry
{
...
pub struct DirtyWorktreeReleaseBoundaryCleanWorktreeStrategyOperatorApprovalAcceptanceBoundaryReadbackSideEffects
{
...
pub fn dirty_worktree_release_boundary_clean_worktree_strategy_operator_approval_acceptance_boundary_readback_report()
-> DirtyWorktreeReleaseBoundaryCleanWorktreeStrategyOperatorApprovalAcceptanceBoundaryReadbackReport
{
    ...
    dirty_worktree_release_boundary_clean_worktree_strategy_operator_approval_acceptance_boundary_readback_report_from_decision_recording_boundary(&source)
}

pub fn dirty_worktree_release_boundary_clean_worktree_strategy_operator_approval_acceptance_boundary_readback_report_from_decision_recording_boundary(
    source: &DirtyWorktreeReleaseBoundaryCleanWorktreeStrategyOperatorDecisionRecordingBoundaryReadbackReport,
) -> DirtyWorktreeReleaseBoundaryCleanWorktreeStrategyOperatorApprovalAcceptanceBoundaryReadbackReport
{
    let entries =
        dirty_worktree_release_boundary_clean_worktree_strategy_operator_approval_acceptance_boundary_readback_entries(source);
    ...
    DirtyWorktreeReleaseBoundaryCleanWorktreeStrategyOperatorApprovalAcceptanceBoundaryReadbackReport {
        ...
        side_effects:
            DirtyWorktreeReleaseBoundaryCleanWorktreeStrategyOperatorApprovalAcceptanceBoundaryReadbackSideEffects::none(),
    }
}

pub const fn dirty_worktree_release_boundary_clean_worktree_strategy_operator_approval_acceptance_boundary_readback_scope()
-> DirtyWorktreeReleaseBoundaryCleanWorktreeStrategyOperatorApprovalAcceptanceBoundaryReadbackScope
{
    DirtyWorktreeReleaseBoundaryCleanWorktreeStrategyOperatorApprovalAcceptanceBoundaryReadbackScope {
...
pub fn dirty_worktree_release_boundary_clean_worktree_strategy_operator_approval_acceptance_boundary_readback_entries(
    source: &DirtyWorktreeReleaseBoundaryCleanWorktreeStrategyOperatorDecisionRecordingBoundaryReadbackReport,
) -> Vec<
    DirtyWorktreeReleaseBoundaryCleanWorktreeStrategyOperatorApprovalAcceptanceBoundaryReadbackEntry,
>{
...
fn approval_boundary_key(group_type: &str, source_bucket: &str) -> String {
    format!(
        "dirty_worktree.approval_acceptance_boundary.{}.{}",
        key_safe(group_type),
...
fn approval_boundary_route(group_type: &str, source_bucket: &str) -> String {
    format!(
        "readback://release-boundary/dirty-worktree/clean-worktree-strategy/operator-approval-acceptance-boundary/{}/{}",
...
impl DirtyWorktreeReleaseBoundaryCleanWorktreeStrategyOperatorApprovalAcceptanceBoundaryReadbackSideEffects {
...
mod tests {
    ...
    #[test]
    fn approval_acceptance_boundary_readback_is_visible_but_unpersisted() {
        let report =
    ...
    #[test]
    fn boundary_entries_preserve_pending_decisions_and_block_approval_acceptance() {
        let report =
            dirty_worktree_release_boundary_clean_worktree_strategy_operator_approval_acceptance_boundary_readback_report();

        assert!(report.entries.iter().any(|entry| entry.source_bucket == "codex-rs"
            && entry.approval_boundary_key
                == "dirty_worktree.approval_acceptance_boundary.top_level.codex_rs"
            && entry.approval_boundary_route
                == "readback://release-boundary/dirty-worktree/clean-worktree-strategy/operator-approval-acceptance-boundary/top-level/codex-rs"));
    ...
    #[test]
    fn approval_acceptance_boundary_side_effects_are_closed() {
        let report =
            dirty_worktree_release_boundary_clean_worktree_strategy_operator_approval_acceptance_boundary_readback_report();
