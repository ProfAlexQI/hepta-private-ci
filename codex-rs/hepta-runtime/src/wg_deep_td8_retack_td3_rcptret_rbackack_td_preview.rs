...
pub struct DeepTd8Td3ReceiptRetentionReadbackAckTerminalDecisionPreviewReport {
    ...
    pub terminal_decision_surfaces: Vec<DeepTd8Td3ReceiptRetentionReadbackAckTerminalDecisionItem>,
    pub non_promotion_denials: Vec<DeepTd8Td3ReceiptRetentionReadbackAckTerminalDecisionItem>,
    pub authority_guards: Vec<DeepTd8Td3ReceiptRetentionReadbackAckTerminalDecisionItem>,
    pub release_delivery_guards: Vec<DeepTd8Td3ReceiptRetentionReadbackAckTerminalDecisionItem>,
    pub local_views: Vec<DeepTd8Td3ReceiptRetentionReadbackAckTerminalDecisionItem>,
    pub invariants: Vec<DeepTd8Td3ReceiptRetentionReadbackAckTerminalDecisionItem>,
    ...
    pub side_effects: DeepTd8Td3ReceiptRetentionReadbackAckTerminalDecisionSideEffects,
}

#[derive(Debug, Clone, PartialEq, Eq, Serialize)]
pub struct DeepTd8Td3ReceiptRetentionReadbackAckTerminalDecisionItem {
    pub id: String,
...
pub struct DeepTd8Td3ReceiptRetentionReadbackAckTerminalDecisionSideEffects {
...
pub fn deep_td8_retack_td3_rcptret_rbackack_td_base() -> String {
    let gate = crate::deep_td8_retack_td3_receipt_retention_readback_ack_terminal_decision_gate();
    gate.strip_suffix("_preview_gate")
        .unwrap_or(gate.as_str())
        .to_owned()
}

pub fn deep_td8_retack_td3_rcptret_rbackack_td_receipt_gate() -> String {
    format!(
        "{}_receipt_preview_gate",
        deep_td8_retack_td3_rcptret_rbackack_td_base()
    )
}

pub fn hepta_work_graph_deep_td8_retack_td3_rcptret_rbackack_td_preview_report()
-> DeepTd8Td3ReceiptRetentionReadbackAckTerminalDecisionPreviewReport {
    ...
    DeepTd8Td3ReceiptRetentionReadbackAckTerminalDecisionPreviewReport {
        ...
        gate,
        preview_mode: "read_only_deep_td8_td3_receipt_retention_readback_ack_terminal_decision_non_promotion_preview_no_promotion",
        ...
        required_prior_gates: deep_td8_retack_td3_rcptret_rbackack_td_required_prior_gates(),
        ...
        local_views,
        invariants,
        recommended_next_gate: deep_td8_retack_td3_rcptret_rbackack_td_receipt_gate(),
        ready_for_terminal_decision_receipt_preview: true,
        ready_for_operator_acceptance: false,
        ready_for_live_persistence: false,
        side_effects: DeepTd8Td3ReceiptRetentionReadbackAckTerminalDecisionSideEffects::none(),
    }
}

pub fn deep_td8_retack_td3_rcptret_rbackack_td_required_prior_gates() -> Vec<String> {
    let mut gates =
        crate::deep_td8_retack_td3_receipt_retention_readback_ack_replay_required_prior_gates();
    gates.push(crate::deep_td8_retack_td3_receipt_retention_readback_ack_replay_gate());
    gates
}

pub fn deep_td8_retack_td3_rcptret_rbackack_td_surface_ids() -> Vec<String> {
    (0..6)
        .map(|index| format!("deep_td8_retack_td3_rcptret_rbackack_td_surface_{index}"))
        .collect()
}
...
fn terminal_decision_items(
    prefix: &str,
    count: usize,
) -> Vec<DeepTd8Td3ReceiptRetentionReadbackAckTerminalDecisionItem> {
    let source_ids = deep_td8_retack_td3_rcptret_rbackack_td_surface_ids();

    (0..count)
        .map(
            |index| DeepTd8Td3ReceiptRetentionReadbackAckTerminalDecisionItem {
                id: format!("deep_td8_retack_td3_rcptret_rbackack_td_{prefix}_{index}"),
...
impl DeepTd8Td3ReceiptRetentionReadbackAckTerminalDecisionSideEffects {
    pub fn none() -> Self {
        Self {
...
mod tests {
    ...
    fn work_graph_td3_rcptret_rbackack_td_requires_latest_ack_replay_gate() {
        let report = hepta_work_graph_deep_td8_retack_td3_rcptret_rbackack_td_preview_report();

        assert_eq!(
            report.required_prior_gates.last(),
            Some(&crate::deep_td8_retack_td3_receipt_retention_readback_ack_replay_gate())
        );
    }
    ...
    fn work_graph_td3_rcptret_rbackack_td_points_to_receipt_gate() {
        ...
        assert_eq!(
            ...
            deep_td8_retack_td3_rcptret_rbackack_td_receipt_gate()
        );
