...
pub struct DeepTd8Td3TerminalDecisionReceiptRetentionReadbackAckPreviewReport {
    ...
    pub acknowledgement_contracts: Vec<DeepTd8Td3TerminalDecisionReceiptRetentionReadbackAckItem>,
    pub non_acceptance_reasons: Vec<DeepTd8Td3TerminalDecisionReceiptRetentionReadbackAckItem>,
    pub recording_denials: Vec<DeepTd8Td3TerminalDecisionReceiptRetentionReadbackAckItem>,
    pub expiry_replay_guards: Vec<DeepTd8Td3TerminalDecisionReceiptRetentionReadbackAckItem>,
    pub local_views: Vec<DeepTd8Td3TerminalDecisionReceiptRetentionReadbackAckItem>,
    pub invariants: Vec<DeepTd8Td3TerminalDecisionReceiptRetentionReadbackAckItem>,
    ...
    pub side_effects: DeepTd8Td3TerminalDecisionReceiptRetentionReadbackAckSideEffects,
}

#[derive(Debug, Clone, PartialEq, Eq, Serialize)]
pub struct DeepTd8Td3TerminalDecisionReceiptRetentionReadbackAckItem {
    pub id: String,
...
pub struct DeepTd8Td3TerminalDecisionReceiptRetentionReadbackAckSideEffects {
...
pub fn deep_td8_retack_td3_receipt_retention_readback_ack_replay_gate() -> String {
    format!(
...
pub fn hepta_work_graph_deep_td8_retack_td3_receipt_retention_readback_ack_preview_report()
-> DeepTd8Td3TerminalDecisionReceiptRetentionReadbackAckPreviewReport {
    ...
    let gate = crate::deep_td8_retack_td3_receipt_retention_readback_ack_gate();
    ...
    DeepTd8Td3TerminalDecisionReceiptRetentionReadbackAckPreviewReport {
        ...
        gate,
        preview_mode: "read_only_deep_td8_td3_terminal_decision_receipt_retention_readback_acknowledgement_preview_no_recording",
        ...
        required_prior_gates:
            deep_td8_retack_td3_receipt_retention_readback_ack_required_prior_gates(),
        ...
        local_views,
        invariants,
        recommended_next_gate: deep_td8_retack_td3_receipt_retention_readback_ack_replay_gate(),
        ready_for_readback_acknowledgement_replay_preview: true,
        ready_for_operator_acceptance: false,
        ready_for_live_persistence: false,
        side_effects: DeepTd8Td3TerminalDecisionReceiptRetentionReadbackAckSideEffects::none(),
    }
}

pub fn deep_td8_retack_td3_receipt_retention_readback_ack_required_prior_gates() -> Vec<String> {
    let mut gates =
        crate::deep_td8_retack_td3_receipt_retention_readback_receipt_required_prior_gates();
    gates.push(crate::deep_td8_retack_td3_receipt_retention_readback_receipt_gate());
    gates
}
...
fn ack_items(
    prefix: &str,
    count: usize,
) -> Vec<DeepTd8Td3TerminalDecisionReceiptRetentionReadbackAckItem> {
    (0..count)
        .map(
            |index| DeepTd8Td3TerminalDecisionReceiptRetentionReadbackAckItem {
                id: format!("deep_td8_td3_receipt_retention_readback_ack_{prefix}_{index}"),
...
impl DeepTd8Td3TerminalDecisionReceiptRetentionReadbackAckSideEffects {
    pub fn none() -> Self {
        Self {
...
mod tests {
    ...
    #[test]
    fn work_graph_td3_retention_readback_ack_requires_readback_receipt_gate() {
        let report =
            hepta_work_graph_deep_td8_retack_td3_receipt_retention_readback_ack_preview_report();

        assert_eq!(
            report.required_prior_gates.last(),
            Some(&crate::deep_td8_retack_td3_receipt_retention_readback_receipt_gate())
        );
    }

    #[test]
    fn work_graph_td3_retention_readback_ack_declares_non_accepting_contracts() {
        let report =
            hepta_work_graph_deep_td8_retack_td3_receipt_retention_readback_ack_preview_report();
    ...
    #[test]
    fn work_graph_td3_retention_readback_ack_denies_recording_and_delivery() {
        let report =
            hepta_work_graph_deep_td8_retack_td3_receipt_retention_readback_ack_preview_report();
    ...
    #[test]
    fn work_graph_td3_retention_readback_ack_guards_expiry_scope_and_replay() {
        let report =
            hepta_work_graph_deep_td8_retack_td3_receipt_retention_readback_ack_preview_report();
    ...
    #[test]
    fn work_graph_td3_retention_readback_ack_points_to_replay_gate() {
        let report =
            hepta_work_graph_deep_td8_retack_td3_receipt_retention_readback_ack_preview_report();
        ...
        assert_eq!(
            ...
            deep_td8_retack_td3_receipt_retention_readback_ack_replay_gate()
        );
        assert!(report.ready_for_readback_acknowledgement_replay_preview);
    }

    #[test]
    fn work_graph_td3_retention_readback_ack_has_no_side_effects() {
        let report =
            hepta_work_graph_deep_td8_retack_td3_receipt_retention_readback_ack_preview_report();
