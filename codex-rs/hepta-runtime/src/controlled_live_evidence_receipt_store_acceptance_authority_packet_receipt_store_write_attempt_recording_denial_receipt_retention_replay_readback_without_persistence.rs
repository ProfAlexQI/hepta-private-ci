...
use crate::controlled_live_evidence_receipt_store_acceptance_authority_packet_receipt_store_write_attempt_recording_boundary_readback_without_recording::controlled_live_evidence_receipt_store_acceptance_authority_packet_receipt_store_write_attempt_recording_boundary_readback_without_recording_report;
use serde::Serialize;

pub const CONTROLLED_LIVE_EVIDENCE_RECEIPT_STORE_ACCEPTANCE_AUTHORITY_PACKET_RECEIPT_STORE_WRITE_ATTEMPT_RECORDING_DENIAL_RECEIPT_RETENTION_REPLAY_READBACK_WITHOUT_PERSISTENCE_GATE: &str =
    "controlled_live_evidence_receipt_store_acceptance_authority_packet_receipt_store_write_attempt_recording_denial_receipt_retention_replay_readback_without_persistence_gate";
pub const CONTROLLED_LIVE_EVIDENCE_RECEIPT_STORE_ACCEPTANCE_AUTHORITY_PACKET_RECEIPT_STORE_WRITE_ATTEMPT_RECORDING_DENIAL_RECEIPT_RETENTION_REPLAY_READBACK_WITHOUT_PERSISTENCE_SCHEMA_VERSION: &str =
    "controlled_live_evidence_receipt_store_acceptance_authority_packet_receipt_store_write_attempt_recording_denial_receipt_retention_replay_readback_without_persistence_v1";
pub const CONTROLLED_LIVE_EVIDENCE_RECEIPT_STORE_ACCEPTANCE_AUTHORITY_PACKET_RECEIPT_STORE_WRITE_ATTEMPT_RECORDING_DENIAL_RECEIPT_RETENTION_REPLAY_READBACK_WITHOUT_PERSISTENCE_RECOMMENDED_NEXT_GATE: &str =
...
const RETENTION_REPLAY_COLLECTION_ID: &str = "controlled-live-evidence-receipt-store-write-attempt-recording-denial-receipt-retention-replay";
const RETENTION_REPLAY_COLLECTION_ROUTE: &str = "readback://controlled-live/evidence-receipt-store/acceptance-authority-packet/receipt-store-write-attempt-recording-denial-receipts/retention-replay";

#[derive(Debug, Clone, PartialEq, Eq, Serialize)]
pub struct ControlledLiveEvidenceReceiptStoreAcceptanceAuthorityPacketReceiptStoreWriteAttemptRecordingDenialReceiptRetentionReplayReadbackWithoutPersistenceReport {
    ...
    pub source_write_attempt_recording_boundary_ready: bool,
    ...
    pub write_attempt_persistence_allowed: bool,
    ...
    pub entries: Vec<
        ControlledLiveEvidenceReceiptStoreAcceptanceAuthorityPacketReceiptStoreWriteAttemptRecordingDenialReceiptRetentionReplayReadbackWithoutPersistenceEntry,
    >,
    pub recommended_next_gate: &'static str,
    pub side_effects:
        ControlledLiveEvidenceReceiptStoreAcceptanceAuthorityPacketReceiptStoreWriteAttemptRecordingDenialReceiptRetentionReplayReadbackWithoutPersistenceSideEffects,
}

#[derive(Debug, Clone, PartialEq, Eq, Serialize)]
pub struct ControlledLiveEvidenceReceiptStoreAcceptanceAuthorityPacketReceiptStoreWriteAttemptRecordingDenialReceiptRetentionReplayReadbackWithoutPersistenceEntry
{
    pub id: String,
    ...
    pub source_write_attempt_record_id: String,
    pub source_write_attempt_idempotency_key: String,
...
pub struct ControlledLiveEvidenceReceiptStoreAcceptanceAuthorityPacketReceiptStoreWriteAttemptRecordingDenialReceiptRetentionReplayReadbackWithoutPersistenceSideEffects
{
    pub retention_policy_persisted: bool,
    pub replay_index_written: bool,
    pub expiry_enforced: bool,
...
pub fn controlled_live_evidence_receipt_store_acceptance_authority_packet_receipt_store_write_attempt_recording_denial_receipt_retention_replay_readback_without_persistence_report()
-> ControlledLiveEvidenceReceiptStoreAcceptanceAuthorityPacketReceiptStoreWriteAttemptRecordingDenialReceiptRetentionReplayReadbackWithoutPersistenceReport
{
    static REPORT: OnceLock<ControlledLiveEvidenceReceiptStoreAcceptanceAuthorityPacketReceiptStoreWriteAttemptRecordingDenialReceiptRetentionReplayReadbackWithoutPersistenceReport> = OnceLock::new();
    REPORT
        .get_or_init(|| {
    let source =
    ...
    let entries =
        controlled_live_evidence_receipt_store_acceptance_authority_packet_receipt_store_write_attempt_recording_denial_receipt_retention_replay_readback_without_persistence_entries();
    ...
    let retention_replay_readback_ready = source
        ...
        && entries.iter().all(|entry| {
            entry.observed_state
                == "write_attempt_recording_denial_receipt_retention_replay_projected_without_persistence"
                ...
                && !entry.write_attempt_persistence_allowed
    ...
    ControlledLiveEvidenceReceiptStoreAcceptanceAuthorityPacketReceiptStoreWriteAttemptRecordingDenialReceiptRetentionReplayReadbackWithoutPersistenceReport {
        ...
        gate:
            CONTROLLED_LIVE_EVIDENCE_RECEIPT_STORE_ACCEPTANCE_AUTHORITY_PACKET_RECEIPT_STORE_WRITE_ATTEMPT_RECORDING_DENIAL_RECEIPT_RETENTION_REPLAY_READBACK_WITHOUT_PERSISTENCE_GATE,
        schema_version:
            CONTROLLED_LIVE_EVIDENCE_RECEIPT_STORE_ACCEPTANCE_AUTHORITY_PACKET_RECEIPT_STORE_WRITE_ATTEMPT_RECORDING_DENIAL_RECEIPT_RETENTION_REPLAY_READBACK_WITHOUT_PERSISTENCE_SCHEMA_VERSION,
        plugin_id: "hepta-system@hepta-local",
        source_write_attempt_recording_boundary_ready: source
            .write_attempt_recording_boundary_readback_ready,
        ...
        recommended_next_gate:
            CONTROLLED_LIVE_EVIDENCE_RECEIPT_STORE_ACCEPTANCE_AUTHORITY_PACKET_RECEIPT_STORE_WRITE_ATTEMPT_RECORDING_DENIAL_RECEIPT_RETENTION_REPLAY_READBACK_WITHOUT_PERSISTENCE_RECOMMENDED_NEXT_GATE,
        side_effects:
            ControlledLiveEvidenceReceiptStoreAcceptanceAuthorityPacketReceiptStoreWriteAttemptRecordingDenialReceiptRetentionReplayReadbackWithoutPersistenceSideEffects::none(),
    }
        })
        .clone()
}

pub fn controlled_live_evidence_receipt_store_acceptance_authority_packet_receipt_store_write_attempt_recording_denial_receipt_retention_replay_readback_without_persistence_entries()
-> Vec<
    ControlledLiveEvidenceReceiptStoreAcceptanceAuthorityPacketReceiptStoreWriteAttemptRecordingDenialReceiptRetentionReplayReadbackWithoutPersistenceEntry,
>{
    controlled_live_evidence_receipt_store_acceptance_authority_packet_receipt_store_write_attempt_recording_boundary_readback_without_recording_report()
        ...
        .map(|entry| {
            ...
            ControlledLiveEvidenceReceiptStoreAcceptanceAuthorityPacketReceiptStoreWriteAttemptRecordingDenialReceiptRetentionReplayReadbackWithoutPersistenceEntry {
                id: format!(
                    "evidence_receipt_store_acceptance_authority_packet_receipt_store_write_attempt_recording_denial_receipt_retention_replay_without_persistence_{}",
                ...
                source_write_attempt_record_id: entry.write_attempt_record_id,
                source_write_attempt_idempotency_key: entry.write_attempt_idempotency_key,
                ...
                retention_policy_id: format!(
                    "write-attempt-recording-denial-retention-policy:controlled-live-evidence-receipt-store:{}",
                    entry.source_blocker_id
                ),
                retention_policy_route: format!("{RETENTION_REPLAY_COLLECTION_ROUTE}/retention/{hyphenated}"),
                expiry_guard_id: format!(
                    "write-attempt-recording-denial-expiry-guard:controlled-live-evidence-receipt-store:{}",
                    entry.source_blocker_id
                ),
                replay_key: format!(
                    "write-attempt-recording-denial-replay-key:controlled-live-evidence-receipt-store:{}",
                    entry.source_blocker_id
                ),
                replay_idempotency_key: format!(
                    "write-attempt-recording-denial-replay-idempotency:controlled-live-evidence-receipt-store:{}",
                    entry.source_blocker_id
                ),
                ...
                garbage_collection_denial_id: format!(
                    "write-attempt-recording-denial-gc-denial:controlled-live-evidence-receipt-store:{}",
                    entry.source_blocker_id
                ),
                supersession_guard_id: format!(
                    "write-attempt-recording-denial-supersession-guard:controlled-live-evidence-receipt-store:{}",
                    entry.source_blocker_id
                ),
                zero_effect_digest: format!(
                    "sha256:write-attempt-recording-denial-retention-replay-zero-effect:{}",
                    entry.source_blocker_id
                ),
...
mod tests {
    ...
    #[test]
    fn write_attempt_recording_denial_receipt_retention_replay_projects_all_entries() {
        let report =
        ...
        assert!(report.source_write_attempt_recording_boundary_ready);
    ...
    #[test]
    fn write_attempt_recording_denial_receipt_retention_replay_keeps_all_persistence_closed() {
        let report =
            controlled_live_evidence_receipt_store_acceptance_authority_packet_receipt_store_write_attempt_recording_denial_receipt_retention_replay_readback_without_persistence_report();
    ...
    #[test]
    fn write_attempt_recording_denial_receipt_retention_replay_entries_are_stable() {
        let report =
            controlled_live_evidence_receipt_store_acceptance_authority_packet_receipt_store_write_attempt_recording_denial_receipt_retention_replay_readback_without_persistence_report();
        ...
        assert!(report.entries.iter().any(|entry| entry.source_blocker_id
            ...
            && entry.retention_policy_route
                == "readback://controlled-live/evidence-receipt-store/acceptance-authority-packet/receipt-store-write-attempt-recording-denial-receipts/retention-replay/retention/dirty-worktree-boundary"
            && entry.replay_idempotency_key
                == "write-attempt-recording-denial-replay-idempotency:controlled-live-evidence-receipt-store:dirty_worktree_boundary"));
        assert!(report.entries.iter().all(|entry| {
            entry
                .source_boundary_entry_id
                .starts_with("evidence_receipt_store_acceptance_authority_packet_receipt_store_write_attempt_recording_boundary_without_recording_")
                && entry
