...
pub struct DeepTd8Td3ReceiptRetentionReadbackAckTerminalDecisionReceiptAckReplayPreviewReport {
    ...
    pub replay_scenarios:
        Vec<DeepTd8Td3ReceiptRetentionReadbackAckTerminalDecisionReceiptAckReplayItem>,
    ...
    pub monotonicity_checks:
        Vec<DeepTd8Td3ReceiptRetentionReadbackAckTerminalDecisionReceiptAckReplayItem>,
    pub local_views: Vec<DeepTd8Td3ReceiptRetentionReadbackAckTerminalDecisionReceiptAckReplayItem>,
    pub invariants: Vec<DeepTd8Td3ReceiptRetentionReadbackAckTerminalDecisionReceiptAckReplayItem>,
    ...
    pub side_effects:
        DeepTd8Td3ReceiptRetentionReadbackAckTerminalDecisionReceiptAckReplaySideEffects,
}

#[derive(Debug, Clone, PartialEq, Eq, Serialize)]
pub struct DeepTd8Td3ReceiptRetentionReadbackAckTerminalDecisionReceiptAckReplayItem {
    pub id: String,
...
pub struct DeepTd8Td3ReceiptRetentionReadbackAckTerminalDecisionReceiptAckReplaySideEffects {
...
pub fn deep_td8_retack_td3_rcptret_rbackack_td_receipt_retention_expiry_gate() -> String {
    format!(
...
pub fn hepta_work_graph_deep_td8_retack_td3_rcptret_rbackack_td_receipt_ack_replay_preview_report()
-> DeepTd8Td3ReceiptRetentionReadbackAckTerminalDecisionReceiptAckReplayPreviewReport {
    ...
    let gate = crate::deep_td8_retack_td3_rcptret_rbackack_td_receipt_ack_replay_gate();
    ...
    DeepTd8Td3ReceiptRetentionReadbackAckTerminalDecisionReceiptAckReplayPreviewReport {
        ...
        gate,
        preview_mode: "read_only_deep_td8_td3_receipt_retention_readback_ack_terminal_decision_receipt_acknowledgement_replay_idempotency_preview_no_replay_write",
        ...
        required_prior_gates:
            deep_td8_retack_td3_rcptret_rbackack_td_receipt_ack_replay_required_prior_gates(),
        replay_scenarios,
        idempotency_guards,
        replay_denials,
        monotonicity_checks,
        ...
        recommended_next_gate:
            deep_td8_retack_td3_rcptret_rbackack_td_receipt_retention_expiry_gate(),
        ready_for_receipt_retention_expiry_preview: true,
        ready_for_operator_acceptance: false,
        ready_for_live_persistence: false,
        side_effects:
            DeepTd8Td3ReceiptRetentionReadbackAckTerminalDecisionReceiptAckReplaySideEffects::none(),
    }
}

pub fn deep_td8_retack_td3_rcptret_rbackack_td_receipt_ack_replay_required_prior_gates()
-> Vec<String> {
    let mut gates =
        crate::deep_td8_retack_td3_rcptret_rbackack_td_receipt_ack_required_prior_gates();
    gates.push(crate::deep_td8_retack_td3_rcptret_rbackack_td_receipt_acknowledgement_gate());
    gates
}
...
fn replay_items(
    ...
    let source_acknowledgement_ids =
        crate::deep_td8_retack_td3_rcptret_rbackack_td_receipt_ack_ids();

    (0..count)
        .map(
            |index| DeepTd8Td3ReceiptRetentionReadbackAckTerminalDecisionReceiptAckReplayItem {
                id: format!(
                    "deep_td8_retack_td3_rcptret_rbackack_td_receipt_ack_replay_{prefix}_{index}"
                ),
...
impl DeepTd8Td3ReceiptRetentionReadbackAckTerminalDecisionReceiptAckReplaySideEffects {
    pub fn none() -> Self {
        Self {
...
mod tests {
    ...
    fn work_graph_td3_rcptret_rbackack_td_receipt_ack_replay_requires_ack_gate() {
        let report =
            hepta_work_graph_deep_td8_retack_td3_rcptret_rbackack_td_receipt_ack_replay_preview_report();

        assert_eq!(
            report.required_prior_gates.last(),
            Some(&crate::deep_td8_retack_td3_rcptret_rbackack_td_receipt_acknowledgement_gate())
        );
    }
