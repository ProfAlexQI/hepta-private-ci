...
pub struct DeepTd8RetAckTdRbackAckTdReceiptRetentionExpiryPreviewReport {
    ...
    pub retention_policies: Vec<DeepTd8RetAckTdRbackAckTdReceiptRetentionItem>,
    pub expiry_guards: Vec<DeepTd8RetAckTdRbackAckTdReceiptRetentionItem>,
    pub supersession_guards: Vec<DeepTd8RetAckTdRbackAckTdReceiptRetentionItem>,
    pub garbage_collection_denials: Vec<DeepTd8RetAckTdRbackAckTdReceiptRetentionItem>,
    pub local_views: Vec<DeepTd8RetAckTdRbackAckTdReceiptRetentionItem>,
    pub invariants: Vec<DeepTd8RetAckTdRbackAckTdReceiptRetentionItem>,
    ...
    pub side_effects: DeepTd8RetAckTdRbackAckTdReceiptRetentionSideEffects,
}

#[derive(Debug, Clone, PartialEq, Eq, Serialize)]
pub struct DeepTd8RetAckTdRbackAckTdReceiptRetentionItem {
    pub id: &'static str,
...
pub struct DeepTd8RetAckTdRbackAckTdReceiptRetentionSideEffects {
...
pub fn deep_td8_ret_ack_td_rback_ack_td_receipt_retention_base() -> String {
    let gate = crate::deep_td8_ret_ack_td_rback_ack_td_receipt_retention_expiry_gate();
    gate.strip_suffix("_receipt_retention_expiry_preview_gate")
        .unwrap_or(gate.as_str())
        .to_owned()
}

pub fn deep_td8_ret_ack_td_rback_ack_td_receipt_retention_readback_receipt_gate() -> String {
    format!(
        "{}_receipt_retention_expiry_readback_receipt_preview_gate",
        deep_td8_ret_ack_td_rback_ack_td_receipt_retention_base()
    )
}

pub fn hepta_work_graph_deep_td8_ret_ack_td_rback_ack_td_receipt_retention_expiry_preview_report()
-> DeepTd8RetAckTdRbackAckTdReceiptRetentionExpiryPreviewReport {
    ...
    DeepTd8RetAckTdRbackAckTdReceiptRetentionExpiryPreviewReport {
        ...
        gate,
        preview_mode: "read_only_deep_td8_ret_ack_td_rback_ack_td_receipt_retention_expiry_preview_no_retention_mutation",
        ...
        required_prior_gates:
            deep_td8_ret_ack_td_rback_ack_td_receipt_retention_expiry_required_prior_gates(),
        retention_policies,
        expiry_guards,
        supersession_guards,
        ...
        recommended_next_gate:
            deep_td8_ret_ack_td_rback_ack_td_receipt_retention_readback_receipt_gate(),
        ready_for_readback_receipt_preview: true,
        ready_for_operator_acceptance: false,
        ready_for_live_persistence: false,
        side_effects: DeepTd8RetAckTdRbackAckTdReceiptRetentionSideEffects::none(),
    }
}

pub fn deep_td8_ret_ack_td_rback_ack_td_receipt_retention_expiry_required_prior_gates()
-> Vec<String> {
    let mut gates =
        crate::deep_td8_ret_ack_td_rback_ack_td_receipt_ack_replay_required_prior_gates();
    gates.push(crate::deep_td8_ret_ack_td_rback_ack_td_receipt_ack_replay_gate());
    gates
}
...
fn retention_items(
    prefix: &'static str,
    count: usize,
) -> Vec<DeepTd8RetAckTdRbackAckTdReceiptRetentionItem> {
    (0..count)
        .map(|index| DeepTd8RetAckTdRbackAckTdReceiptRetentionItem {
            id: match (prefix, index) {
                ("policy", 0) => "deep_td8_ret_ack_td_rback_ack_td_receipt_retention_policy_hash_only",
                ("policy", 1) => "deep_td8_ret_ack_td_rback_ack_td_receipt_retention_policy_local_scope",
                ("policy", 2) => "deep_td8_ret_ack_td_rback_ack_td_receipt_retention_policy_expiry_bound",
                ("policy", 3) => "deep_td8_ret_ack_td_rback_ack_td_receipt_retention_policy_supersession_bound",
                ("policy", 4) => "deep_td8_ret_ack_td_rback_ack_td_receipt_retention_policy_zero_write",
                ("policy", _) => {
                    "deep_td8_ret_ack_td_rback_ack_td_receipt_retention_policy_external_delivery_denied"
                }
...
impl DeepTd8RetAckTdRbackAckTdReceiptRetentionSideEffects {
    pub fn none() -> Self {
        Self {
...
mod tests {
    ...
    fn work_graph_deep_td8_ret_ack_td_retention_requires_ack_replay_gate() {
        let report = hepta_work_graph_deep_td8_ret_ack_td_rback_ack_td_receipt_retention_expiry_preview_report();

        assert_eq!(
            report.required_prior_gates.last(),
            Some(&crate::deep_td8_ret_ack_td_rback_ack_td_receipt_ack_replay_gate())
        );
    }
