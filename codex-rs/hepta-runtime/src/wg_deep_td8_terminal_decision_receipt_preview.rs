...
pub struct DeepTd8TerminalDecisionReceiptPreviewReport {
    ...
    pub receipts: Vec<DeepTd8TerminalDecisionReceipt>,
    pub digest_checks: Vec<DeepTd8TerminalDecisionReceiptDigestCheck>,
    pub mismatch_denials: Vec<DeepTd8TerminalDecisionReceiptMismatchDenial>,
    pub receipt_guards: Vec<DeepTd8TerminalDecisionReceiptGuard>,
    pub local_views: Vec<DeepTd8TerminalDecisionReceiptLocalView>,
    pub invariants: Vec<DeepTd8TerminalDecisionReceiptInvariant>,
    ...
    pub side_effects: DeepTd8TerminalDecisionReceiptSideEffects,
}

#[derive(Debug, Clone, PartialEq, Eq, Serialize)]
pub struct DeepTd8TerminalDecisionReceipt {
    pub id: &'static str,
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize)]
pub struct DeepTd8TerminalDecisionReceiptDigestCheck {
    pub id: &'static str,
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize)]
pub struct DeepTd8TerminalDecisionReceiptMismatchDenial {
    pub id: &'static str,
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize)]
pub struct DeepTd8TerminalDecisionReceiptGuard {
    pub id: &'static str,
    pub required_fields: Vec<&'static str>,
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize)]
pub struct DeepTd8TerminalDecisionReceiptLocalView {
    pub id: &'static str,
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize)]
pub struct DeepTd8TerminalDecisionReceiptInvariant {
    pub id: &'static str,
    pub required: bool,
    pub reason: &'static str,
}
...
pub struct DeepTd8TerminalDecisionReceiptSideEffects {
...
pub fn deep_td8_terminal_decision_receipt_acknowledgement_gate() -> String {
    format!(
...
pub fn hepta_work_graph_deep_td8_terminal_decision_receipt_preview_report()
-> DeepTd8TerminalDecisionReceiptPreviewReport {
    let receipts = deep_td8_terminal_decision_receipts();
    let digest_checks = deep_td8_terminal_decision_receipt_digest_checks();
    let mismatch_denials = deep_td8_terminal_decision_receipt_mismatch_denials();
    let receipt_guards = deep_td8_terminal_decision_receipt_guards();
    let local_views = deep_td8_terminal_decision_receipt_local_views();
    let invariants = deep_td8_terminal_decision_receipt_invariants();
    let gate = crate::deep_td8_terminal_decision_receipt_gate();
    ...
    DeepTd8TerminalDecisionReceiptPreviewReport {
        ...
        required_prior_gates: deep_td8_terminal_decision_receipt_required_prior_gates(),
        receipts,
        digest_checks,
        mismatch_denials,
        receipt_guards,
        local_views,
        invariants,
        recommended_next_gate: deep_td8_terminal_decision_receipt_acknowledgement_gate(),
        ready_for_terminal_decision_receipt_acknowledgement_preview: true,
        ready_for_operator_acceptance: false,
        ready_for_live_persistence: false,
        side_effects: DeepTd8TerminalDecisionReceiptSideEffects::none(),
    }
}

pub fn deep_td8_terminal_decision_receipt_required_prior_gates() -> Vec<String> {
    let mut gates = crate::deep_td8_terminal_decision_required_prior_gates();
    gates.push(crate::deep_td8_terminal_decision_gate());
    gates
}

pub fn deep_td8_terminal_decision_receipt_ids() -> Vec<&'static str> {
    vec![
        "operator_deep_td8_terminal_decision_non_promotion_receipt",
        "release_owner_deep_td8_terminal_decision_non_promotion_receipt",
        "authority_denial_deep_td8_terminal_decision_receipt",
        "rollout_denial_deep_td8_terminal_decision_receipt",
        "release_publication_denial_deep_td8_terminal_decision_receipt",
        "external_delivery_denial_deep_td8_terminal_decision_receipt",
    ]
}

pub fn deep_td8_terminal_decision_receipts() -> Vec<DeepTd8TerminalDecisionReceipt> {
    let surface_ids = crate::deep_td8_terminal_decision_surface_ids();
    vec![
        receipt(
            "operator_deep_td8_terminal_decision_non_promotion_receipt",
            surface_ids.clone(),
            "hash_only_operator_deep_td8_terminal_decision_receipt",
        ),
        receipt(
            "release_owner_deep_td8_terminal_decision_non_promotion_receipt",
            surface_ids.clone(),
            "hash_only_release_owner_deep_td8_terminal_decision_receipt",
        ),
        receipt(
            "authority_denial_deep_td8_terminal_decision_receipt",
            surface_ids.clone(),
            "hash_only_authority_denial_deep_td8_terminal_decision_receipt",
        ),
        receipt(
            "rollout_denial_deep_td8_terminal_decision_receipt",
            surface_ids.clone(),
            "hash_only_rollout_denial_deep_td8_terminal_decision_receipt",
        ),
        receipt(
            "release_publication_denial_deep_td8_terminal_decision_receipt",
            surface_ids.clone(),
            "hash_only_release_publication_denial_deep_td8_terminal_decision_receipt",
        ),
        receipt(
            "external_delivery_denial_deep_td8_terminal_decision_receipt",
            surface_ids,
            "hash_only_external_delivery_denial_deep_td8_terminal_decision_receipt",
        ),
    ]
}

pub fn deep_td8_terminal_decision_receipt_digest_checks()
-> Vec<DeepTd8TerminalDecisionReceiptDigestCheck> {
    vec![
        digest_check(
            "deep_td8_terminal_decision_surface_digest_matches",
            vec![
...
pub fn deep_td8_terminal_decision_receipt_mismatch_denials()
-> Vec<DeepTd8TerminalDecisionReceiptMismatchDenial> {
    let receipt_ids = deep_td8_terminal_decision_receipt_ids();
    vec![
        mismatch_denial(
            "missing_deep_td8_terminal_decision_surface_cannot_record_receipt",
            receipt_ids.clone(),
            "missing terminal decision surface cannot record receipt",
        ),
        mismatch_denial(
            "mismatched_deep_td8_terminal_decision_hash_cannot_accept",
            receipt_ids.clone(),
...
pub fn deep_td8_terminal_decision_receipt_guards() -> Vec<DeepTd8TerminalDecisionReceiptGuard> {
    vec![
        receipt_guard(
...
pub fn deep_td8_terminal_decision_receipt_local_views()
-> Vec<DeepTd8TerminalDecisionReceiptLocalView> {
    vec![
        local_view(
            "operator_deep_td8_terminal_decision_receipt_view",
            "operator",
            vec![
                "receiptId",
                "receiptHash",
        ...
        local_view(
            "release_owner_deep_td8_terminal_decision_receipt_view",
            "release_owner",
            vec![
                "receiptId",
                "releasePublished",
        ...
        local_view(
            "auditor_deep_td8_terminal_decision_receipt_digest_view",
            "auditor",
            vec![
                "sourceGateDigest",
                "receiptHash",
        ...
        local_view(
            "runtime_deep_td8_terminal_decision_receipt_zero_effect_view",
            "system",
            vec![
                "receiptRecorded",
                "graphStatePersisted",
...
pub fn deep_td8_terminal_decision_receipt_invariants()
-> Vec<DeepTd8TerminalDecisionReceiptInvariant> {
    vec![
        invariant(
            "deep_td8_terminal_decision_receipts_are_hash_only",
            "terminal decision receipts expose hashes and local visibility only",
        ),
        invariant(
            "deep_td8_terminal_decision_receipts_do_not_record",
            "terminal decision receipts cannot record terminal decisions or receipts",
        ),
        invariant(
            "deep_td8_terminal_decision_receipts_block_acceptance",
            "terminal decision receipts cannot become acceptance or approval",
        ),
        invariant(
            "deep_td8_terminal_decision_receipts_block_authority",
            "terminal decision receipts cannot grant authority",
        ),
        invariant(
            "deep_td8_terminal_decision_receipts_block_release_delivery",
            "terminal decision receipts cannot publish, claim, roll out, or send externally",
        ),
        invariant(
            "deep_td8_terminal_decision_receipt_preview_has_no_side_effects",
...
) -> DeepTd8TerminalDecisionReceipt {
    DeepTd8TerminalDecisionReceipt {
        id,
        source_surface_ids,
        receipt_visibility,
...
) -> DeepTd8TerminalDecisionReceiptDigestCheck {
    DeepTd8TerminalDecisionReceiptDigestCheck {
        id,
        required_fields,
...
fn mismatch_denial(
    ...
    reason: &'static str,
) -> DeepTd8TerminalDecisionReceiptMismatchDenial {
    DeepTd8TerminalDecisionReceiptMismatchDenial {
        id,
...
fn receipt_guard(
    id: &'static str,
    required_fields: Vec<&'static str>,
) -> DeepTd8TerminalDecisionReceiptGuard {
    DeepTd8TerminalDecisionReceiptGuard {
        id,
        required_fields,
...
fn local_view(
    ...
    audience: &'static str,
    required_fields: Vec<&'static str>,
) -> DeepTd8TerminalDecisionReceiptLocalView {
    DeepTd8TerminalDecisionReceiptLocalView {
        id,
        audience,
        required_fields,
...
fn invariant(id: &'static str, reason: &'static str) -> DeepTd8TerminalDecisionReceiptInvariant {
    DeepTd8TerminalDecisionReceiptInvariant {
        id,
        required: true,
        reason,
    }
...
impl DeepTd8TerminalDecisionReceiptSideEffects {
    pub fn none() -> Self {
        Self {
...
mod tests {
    ...
    #[test]
    fn work_graph_deep_td8_terminal_decision_receipt_requires_terminal_decision_gate() {
        let report = hepta_work_graph_deep_td8_terminal_decision_receipt_preview_report();

        assert_eq!(
            report.required_prior_gates.last(),
            Some(&crate::deep_td8_terminal_decision_gate())
        );
    }

    #[test]
    fn work_graph_deep_td8_terminal_decision_receipts_are_hash_only() {
        let report = hepta_work_graph_deep_td8_terminal_decision_receipt_preview_report();
    ...
    #[test]
    fn work_graph_deep_td8_terminal_decision_receipts_check_digests() {
        let report = hepta_work_graph_deep_td8_terminal_decision_receipt_preview_report();
    ...
    #[test]
    fn work_graph_deep_td8_terminal_decision_receipts_deny_mismatches() {
        let report = hepta_work_graph_deep_td8_terminal_decision_receipt_preview_report();
    ...
    #[test]
    fn work_graph_deep_td8_terminal_decision_receipts_guard_recording_and_views() {
        let report = hepta_work_graph_deep_td8_terminal_decision_receipt_preview_report();
    ...
    #[test]
    fn work_graph_deep_td8_terminal_decision_receipt_has_no_side_effects() {
        let report = hepta_work_graph_deep_td8_terminal_decision_receipt_preview_report();
        ...
        assert_eq!(
            ...
            deep_td8_terminal_decision_receipt_acknowledgement_gate()
        );
