...
pub struct DeepTd8RetAckTdRbackAckTdReceiptAckReplayPreviewReport {
    ...
    pub replay_scenarios: Vec<DeepTd8RetAckTdRbackAckTdReceiptAckReplayItem>,
    pub idempotency_guards: Vec<DeepTd8RetAckTdRbackAckTdReceiptAckReplayItem>,
    pub replay_denials: Vec<DeepTd8RetAckTdRbackAckTdReceiptAckReplayItem>,
    pub monotonicity_checks: Vec<DeepTd8RetAckTdRbackAckTdReceiptAckReplayItem>,
    pub local_views: Vec<DeepTd8RetAckTdRbackAckTdReceiptAckReplayItem>,
    pub invariants: Vec<DeepTd8RetAckTdRbackAckTdReceiptAckReplayItem>,
    ...
    pub side_effects: DeepTd8RetAckTdRbackAckTdReceiptAckReplaySideEffects,
}

#[derive(Debug, Clone, PartialEq, Eq, Serialize)]
pub struct DeepTd8RetAckTdRbackAckTdReceiptAckReplayItem {
    pub id: String,
...
pub struct DeepTd8RetAckTdRbackAckTdReceiptAckReplaySideEffects {
...
pub fn deep_td8_ret_ack_td_rback_ack_td_receipt_retention_expiry_gate() -> String {
    format!(
...
pub fn hepta_work_graph_deep_td8_ret_ack_td_rback_ack_td_receipt_ack_replay_preview_report()
-> DeepTd8RetAckTdRbackAckTdReceiptAckReplayPreviewReport {
    ...
    let gate = crate::deep_td8_ret_ack_td_rback_ack_td_receipt_ack_replay_gate();
    ...
    DeepTd8RetAckTdRbackAckTdReceiptAckReplayPreviewReport {
        ...
        required_prior_gates:
            deep_td8_ret_ack_td_rback_ack_td_receipt_ack_replay_required_prior_gates(),
        replay_scenarios,
        idempotency_guards,
        replay_denials,
        monotonicity_checks,
        local_views,
        invariants,
        recommended_next_gate: deep_td8_ret_ack_td_rback_ack_td_receipt_retention_expiry_gate(),
        ready_for_receipt_retention_expiry_preview: true,
        ready_for_operator_acceptance: false,
        ready_for_live_persistence: false,
        side_effects: DeepTd8RetAckTdRbackAckTdReceiptAckReplaySideEffects::none(),
    }
}

pub fn deep_td8_ret_ack_td_rback_ack_td_receipt_ack_replay_required_prior_gates() -> Vec<String> {
    let mut gates = crate::deep_td8_ret_ack_td_rback_ack_td_receipt_ack_required_prior_gates();
    gates.push(crate::deep_td8_ret_ack_td_rback_ack_td_receipt_acknowledgement_gate());
    gates
}

fn replay_items(prefix: &str, count: usize) -> Vec<DeepTd8RetAckTdRbackAckTdReceiptAckReplayItem> {
    let source_acknowledgement_ids = crate::deep_td8_ret_ack_td_rback_ack_td_receipt_ack_ids();
    (0..count)
        .map(|index| DeepTd8RetAckTdRbackAckTdReceiptAckReplayItem {
...
impl DeepTd8RetAckTdRbackAckTdReceiptAckReplaySideEffects {
    pub fn none() -> Self {
        Self {
...
mod tests {
    ...
    #[test]
    fn work_graph_deep_td8_ret_ack_td_rback_ack_td_receipt_ack_replay_requires_ack_gate() {
        let report =
            hepta_work_graph_deep_td8_ret_ack_td_rback_ack_td_receipt_ack_replay_preview_report();

        assert_eq!(
            report.required_prior_gates.last(),
            Some(&crate::deep_td8_ret_ack_td_rback_ack_td_receipt_acknowledgement_gate())
        );
    }

    #[test]
    fn work_graph_deep_td8_ret_ack_td_rback_ack_td_receipt_ack_replay_declares_blocked_scenarios() {
        let report =
            hepta_work_graph_deep_td8_ret_ack_td_rback_ack_td_receipt_ack_replay_preview_report();
    ...
    #[test]
    fn work_graph_deep_td8_ret_ack_td_rback_ack_td_receipt_ack_replay_requires_idempotency_guards()
    {
        let report =
            hepta_work_graph_deep_td8_ret_ack_td_rback_ack_td_receipt_ack_replay_preview_report();
    ...
    #[test]
    fn work_graph_deep_td8_ret_ack_td_rback_ack_td_receipt_ack_replay_denies_every_mutating_outcome()
     {
        let report =
            hepta_work_graph_deep_td8_ret_ack_td_rback_ack_td_receipt_ack_replay_preview_report();
    ...
    #[test]
    fn work_graph_deep_td8_ret_ack_td_rback_ack_td_receipt_ack_replay_points_to_retention() {
        let report =
            hepta_work_graph_deep_td8_ret_ack_td_rback_ack_td_receipt_ack_replay_preview_report();

        assert_eq!(
            report.recommended_next_gate,
            deep_td8_ret_ack_td_rback_ack_td_receipt_retention_expiry_gate()
        );
    ...
    #[test]
    fn work_graph_deep_td8_ret_ack_td_rback_ack_td_receipt_ack_replay_has_no_side_effects() {
        let report =
            hepta_work_graph_deep_td8_ret_ack_td_rback_ack_td_receipt_ack_replay_preview_report();
