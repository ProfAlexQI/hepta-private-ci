...
pub struct DeepTd8Td3TerminalDecisionReceiptRetentionReadbackAckReplayPreviewReport {
    ...
    pub replay_scenarios: Vec<DeepTd8Td3TerminalDecisionReceiptRetentionReadbackAckReplayItem>,
    pub idempotency_guards: Vec<DeepTd8Td3TerminalDecisionReceiptRetentionReadbackAckReplayItem>,
    pub replay_denials: Vec<DeepTd8Td3TerminalDecisionReceiptRetentionReadbackAckReplayItem>,
    pub monotonicity_checks: Vec<DeepTd8Td3TerminalDecisionReceiptRetentionReadbackAckReplayItem>,
    pub local_views: Vec<DeepTd8Td3TerminalDecisionReceiptRetentionReadbackAckReplayItem>,
    pub invariants: Vec<DeepTd8Td3TerminalDecisionReceiptRetentionReadbackAckReplayItem>,
    ...
    pub side_effects: DeepTd8Td3TerminalDecisionReceiptRetentionReadbackAckReplaySideEffects,
}

#[derive(Debug, Clone, PartialEq, Eq, Serialize)]
pub struct DeepTd8Td3TerminalDecisionReceiptRetentionReadbackAckReplayItem {
    pub id: String,
...
pub struct DeepTd8Td3TerminalDecisionReceiptRetentionReadbackAckReplaySideEffects {
...
pub fn deep_td8_retack_td3_receipt_retention_readback_ack_terminal_decision_gate() -> String {
    format!(
...
pub fn hepta_work_graph_deep_td8_retack_td3_receipt_retention_readback_ack_replay_preview_report()
-> DeepTd8Td3TerminalDecisionReceiptRetentionReadbackAckReplayPreviewReport {
    ...
    let gate = crate::deep_td8_retack_td3_receipt_retention_readback_ack_replay_gate();
    ...
    DeepTd8Td3TerminalDecisionReceiptRetentionReadbackAckReplayPreviewReport {
        ...
        gate,
        preview_mode: "read_only_deep_td8_td3_terminal_decision_receipt_retention_readback_acknowledgement_replay_idempotency_preview_no_replay_write",
        ...
        required_prior_gates:
            deep_td8_retack_td3_receipt_retention_readback_ack_replay_required_prior_gates(),
        replay_scenarios,
        idempotency_guards,
        replay_denials,
        monotonicity_checks,
        ...
        recommended_next_gate:
            deep_td8_retack_td3_receipt_retention_readback_ack_terminal_decision_gate(),
        ready_for_terminal_decision_preview: true,
        ready_for_operator_acceptance: false,
        ready_for_live_persistence: false,
        side_effects: DeepTd8Td3TerminalDecisionReceiptRetentionReadbackAckReplaySideEffects::none(
        ),
    }
}

pub fn deep_td8_retack_td3_receipt_retention_readback_ack_replay_required_prior_gates()
-> Vec<String> {
    let mut gates =
        crate::deep_td8_retack_td3_receipt_retention_readback_ack_required_prior_gates();
    gates.push(crate::deep_td8_retack_td3_receipt_retention_readback_ack_gate());
    gates
}
...
fn replay_items(
    prefix: &str,
    count: usize,
) -> Vec<DeepTd8Td3TerminalDecisionReceiptRetentionReadbackAckReplayItem> {
    (0..count)
        .map(
            |index| DeepTd8Td3TerminalDecisionReceiptRetentionReadbackAckReplayItem {
                id: format!("deep_td8_td3_receipt_retention_readback_ack_replay_{prefix}_{index}"),
...
impl DeepTd8Td3TerminalDecisionReceiptRetentionReadbackAckReplaySideEffects {
    pub fn none() -> Self {
        Self {
...
mod tests {
    ...
    #[test]
    fn work_graph_td3_retention_readback_ack_replay_requires_ack_gate() {
        let report =
            hepta_work_graph_deep_td8_retack_td3_receipt_retention_readback_ack_replay_preview_report();

        assert_eq!(
            report.required_prior_gates.last(),
            Some(&crate::deep_td8_retack_td3_receipt_retention_readback_ack_gate())
        );
    }

    #[test]
    fn work_graph_td3_retention_readback_ack_replay_declares_blocked_scenarios() {
        let report =
            hepta_work_graph_deep_td8_retack_td3_receipt_retention_readback_ack_replay_preview_report();
    ...
    #[test]
    fn work_graph_td3_retention_readback_ack_replay_requires_idempotency_guards() {
        let report =
            hepta_work_graph_deep_td8_retack_td3_receipt_retention_readback_ack_replay_preview_report();
    ...
    #[test]
    fn work_graph_td3_retention_readback_ack_replay_denies_mutating_outcomes() {
        let report =
            hepta_work_graph_deep_td8_retack_td3_receipt_retention_readback_ack_replay_preview_report();
    ...
    #[test]
    fn work_graph_td3_retention_readback_ack_replay_points_to_terminal_decision() {
        let report =
            hepta_work_graph_deep_td8_retack_td3_receipt_retention_readback_ack_replay_preview_report();
    ...
    #[test]
    fn work_graph_td3_retention_readback_ack_replay_has_no_side_effects() {
        let report =
            hepta_work_graph_deep_td8_retack_td3_receipt_retention_readback_ack_replay_preview_report();
