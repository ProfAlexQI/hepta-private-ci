...
use crate::controlled_live_evidence_receipt_store_local_evidence_acceptance_authority_decision_recording_positive_preconditions_recording_denial_receipt_positive_preconditions::controlled_live_evidence_receipt_store_local_evidence_acceptance_authority_decision_recording_positive_preconditions_recording_denial_receipt_positive_preconditions_readback_without_persistence_report;
use serde::Serialize;

pub const CONTROLLED_LIVE_EVIDENCE_RECEIPT_STORE_LOCAL_EVIDENCE_ACCEPTANCE_AUTHORITY_DECISION_RECORDING_POSITIVE_PRECONDITIONS_RECORDING_DENIAL_RECEIPT_PERSISTENCE_DENIAL_RECOMMENDED_NEXT_GATE: &str =
    "controlled_live_evidence_receipt_store_local_evidence_acceptance_authority_decision_recording_positive_preconditions_recording_denial_receipt_persistence_denial_retention_replay_readback_without_persistence";

const SURFACE: &str = "controlled_live_evidence_receipt_store_local_evidence_acceptance_authority_decision_recording_positive_preconditions_recording_denial_receipt_persistence_denial_readback_without_persistence";
const GATE: &str = "controlled_live_evidence_receipt_store_local_evidence_acceptance_authority_decision_recording_positive_preconditions_recording_denial_receipt_persistence_denial_readback_without_persistence_gate";
const SCHEMA_VERSION: &str = "controlled_live_evidence_receipt_store_local_evidence_acceptance_authority_decision_recording_positive_preconditions_recording_denial_receipt_persistence_denial_readback_without_persistence_v1";
const PERSISTENCE_DENIAL_ROUTE: &str = "readback://controlled-live/evidence-receipt-store/local-evidence-acceptance/authority-decision-recording/recording-denial-receipts/persistence-denial";
const PERSISTENCE_DENIAL_REASON: &str = "local_evidence_acceptance_authority_decision_recording_positive_preconditions_recording_denial_receipt_persistence_disabled_positive_preconditions_missing";

#[derive(Debug, Clone, PartialEq, Eq, Serialize)]
pub struct ControlledLiveEvidenceReceiptStoreLocalEvidenceAcceptanceAuthorityDecisionRecordingPositivePreconditionsRecordingDenialReceiptPersistenceDenialReport {
    ...
    pub source_recording_denial_receipt_persistence_grant_required_count: usize,
    pub source_recording_denial_receipt_persistence_grant_present_count: usize,
    ...
    pub source_recording_denial_receipt_persistence_allowed_count: usize,
    ...
    pub recording_denial_receipt_persistence_denied_count: usize,
    pub recording_denial_receipt_persistence_disabled_count: usize,
    pub recording_denial_receipt_persistence_allowed_count: usize,
    pub recording_denial_receipt_persistence_attempt_recorded_count: usize,
    ...
    pub recording_denial_receipt_persistence_grant_missing_count: usize,
    ...
    pub recording_denial_receipt_persistence_allowed: bool,
    ...
    pub entries: Vec<ControlledLiveEvidenceReceiptStoreLocalEvidenceAcceptanceAuthorityDecisionRecordingPositivePreconditionsRecordingDenialReceiptPersistenceDenialEntry>,
    pub recommended_next_gate: &'static str,
    pub side_effects:
        ControlledLiveEvidenceReceiptStoreLocalEvidenceAcceptanceAuthorityDecisionRecordingPositivePreconditionsRecordingDenialReceiptPersistenceDenialSideEffects,
}

#[derive(Debug, Clone, PartialEq, Eq, Serialize)]
pub struct ControlledLiveEvidenceReceiptStoreLocalEvidenceAcceptanceAuthorityDecisionRecordingPositivePreconditionsRecordingDenialReceiptPersistenceDenialEntry
{
    pub id: String,
    ...
    pub source_recording_denial_receipt_persistence_grant_precondition_id: String,
    ...
    pub recording_denial_receipt_persistence_denied: bool,
    pub recording_denial_receipt_persistence_disabled: bool,
    pub recording_denial_receipt_persistence_allowed: bool,
    pub recording_denial_receipt_persistence_attempt_recorded: bool,
    pub denial_receipt_persisted: bool,
    ...
    pub recording_denial_receipt_persistence_grant_required: bool,
    pub recording_denial_receipt_persistence_grant_present: bool,
...
pub struct ControlledLiveEvidenceReceiptStoreLocalEvidenceAcceptanceAuthorityDecisionRecordingPositivePreconditionsRecordingDenialReceiptPersistenceDenialSideEffects
{
    pub authority_decision_recorded: bool,
    pub authority_decision_persisted: bool,
    pub recording_denial_receipt_persistence_attempt_recorded: bool,
...
pub fn controlled_live_evidence_receipt_store_local_evidence_acceptance_authority_decision_recording_positive_preconditions_recording_denial_receipt_persistence_denial_readback_without_persistence_report()
-> ControlledLiveEvidenceReceiptStoreLocalEvidenceAcceptanceAuthorityDecisionRecordingPositivePreconditionsRecordingDenialReceiptPersistenceDenialReport
{
...
fn build_report() -> ControlledLiveEvidenceReceiptStoreLocalEvidenceAcceptanceAuthorityDecisionRecordingPositivePreconditionsRecordingDenialReceiptPersistenceDenialReport{
    let source =
        controlled_live_evidence_receipt_store_local_evidence_acceptance_authority_decision_recording_positive_preconditions_recording_denial_receipt_positive_preconditions_readback_without_persistence_report();
    let entries =
        controlled_live_evidence_receipt_store_local_evidence_acceptance_authority_decision_recording_positive_preconditions_recording_denial_receipt_persistence_denial_entries();
    ...
    let recording_denial_receipt_persistence_denied_count = count(&entries, |entry| {
        entry.recording_denial_receipt_persistence_denied
    });
    let recording_denial_receipt_persistence_disabled_count = count(&entries, |entry| {
        entry.recording_denial_receipt_persistence_disabled
    });
    let recording_denial_receipt_persistence_allowed_count = count(&entries, |entry| {
        entry.recording_denial_receipt_persistence_allowed
    });
    let recording_denial_receipt_persistence_attempt_recorded_count = count(&entries, |entry| {
        entry.recording_denial_receipt_persistence_attempt_recorded
    });
    ...
    let recording_denial_receipt_persistence_grant_missing_count = count(&entries, |entry| {
        entry.recording_denial_receipt_persistence_grant_required
            && !entry.recording_denial_receipt_persistence_grant_present
    });
    ...
    let persistence_denial_readback_ready = source.positive_preconditions_readback_ready
        ...
        && source.recording_denial_receipt_persistence_grant_required_count == 7
        && source.recording_denial_receipt_persistence_grant_present_count == 0
        ...
        && source.recording_denial_receipt_persistence_allowed_count == 0
        ...
        && recording_denial_receipt_persistence_denied_count == 7
        && recording_denial_receipt_persistence_disabled_count == 7
        && recording_denial_receipt_persistence_allowed_count == 0
        && recording_denial_receipt_persistence_attempt_recorded_count == 0
        ...
        && recording_denial_receipt_persistence_grant_missing_count == 7
    ...
    ControlledLiveEvidenceReceiptStoreLocalEvidenceAcceptanceAuthorityDecisionRecordingPositivePreconditionsRecordingDenialReceiptPersistenceDenialReport {
        runtime: "hepta",
        surface: SURFACE,
        status: if persistence_denial_readback_ready { "ready_blocked" } else { "blocked" },
        gate: GATE,
        ...
        source_operator_persistence_approval_required_count: source.operator_persistence_approval_required_count,
        source_operator_persistence_approval_present_count: source.operator_persistence_approval_present_count,
        ...
        source_recording_denial_receipt_persistence_grant_required_count: source.recording_denial_receipt_persistence_grant_required_count,
        source_recording_denial_receipt_persistence_grant_present_count: source.recording_denial_receipt_persistence_grant_present_count,
        ...
        source_post_persist_readback_persisted_count: source.post_persist_readback_persisted_count,
        ...
        source_retention_policy_commit_required_count: source.retention_policy_commit_required_count,
        source_retention_policy_committed_count: source.retention_policy_committed_count,
        source_replay_idempotency_guard_required_count: source.replay_idempotency_guard_required_count,
        source_replay_idempotency_guard_enabled_count: source.replay_idempotency_guard_enabled_count,
        ...
        source_recording_denial_receipt_persistence_allowed_count: source.recording_denial_receipt_persistence_allowed_count,
        ...
        recording_denial_receipt_persistence_denied_count,
        recording_denial_receipt_persistence_disabled_count,
        recording_denial_receipt_persistence_allowed_count,
        recording_denial_receipt_persistence_attempt_recorded_count,
        ...
        recording_denial_receipt_persistence_grant_missing_count,
        ...
        recommended_next_gate:
            CONTROLLED_LIVE_EVIDENCE_RECEIPT_STORE_LOCAL_EVIDENCE_ACCEPTANCE_AUTHORITY_DECISION_RECORDING_POSITIVE_PRECONDITIONS_RECORDING_DENIAL_RECEIPT_PERSISTENCE_DENIAL_RECOMMENDED_NEXT_GATE,
        side_effects:
            ControlledLiveEvidenceReceiptStoreLocalEvidenceAcceptanceAuthorityDecisionRecordingPositivePreconditionsRecordingDenialReceiptPersistenceDenialSideEffects::none(),
    }
}

pub fn controlled_live_evidence_receipt_store_local_evidence_acceptance_authority_decision_recording_positive_preconditions_recording_denial_receipt_persistence_denial_entries()
-> Vec<ControlledLiveEvidenceReceiptStoreLocalEvidenceAcceptanceAuthorityDecisionRecordingPositivePreconditionsRecordingDenialReceiptPersistenceDenialEntry>
{
    controlled_live_evidence_receipt_store_local_evidence_acceptance_authority_decision_recording_positive_preconditions_recording_denial_receipt_positive_preconditions_readback_without_persistence_report()
        .entries
        .into_iter()
        .map(|entry| {
            ...
            ControlledLiveEvidenceReceiptStoreLocalEvidenceAcceptanceAuthorityDecisionRecordingPositivePreconditionsRecordingDenialReceiptPersistenceDenialEntry {
                id: format!(
                    "evidence_receipt_store_local_evidence_acceptance_authority_decision_recording_positive_preconditions_recording_denial_receipt_persistence_denial_without_persistence_{}",
                ...
                source_recording_denial_receipt_persistence_grant_precondition_id: entry
                    .recording_denial_receipt_persistence_grant_precondition_id,
                persistence_denial_id: format!(
                    "local-evidence-acceptance-authority-decision-recording-positive-preconditions-recording-denial-receipt-persistence-denial:controlled-live-evidence-receipt-store:{}",
                    entry.source_blocker_id
                ),
                persistence_denial_route: format!("{PERSISTENCE_DENIAL_ROUTE}/{hyphenated}"),
                persistence_denial_reason: PERSISTENCE_DENIAL_REASON,
                observed_state:
                    "local_evidence_acceptance_authority_decision_recording_positive_preconditions_recording_denial_receipt_persistence_denied_without_persistence",
                ...
                recording_denial_receipt_persistence_grant_required: entry
                    .recording_denial_receipt_persistence_grant_required,
                recording_denial_receipt_persistence_grant_present: entry
                    .recording_denial_receipt_persistence_grant_present,
...
fn count(
    entries: &[ControlledLiveEvidenceReceiptStoreLocalEvidenceAcceptanceAuthorityDecisionRecordingPositivePreconditionsRecordingDenialReceiptPersistenceDenialEntry],
    predicate: impl Fn(&ControlledLiveEvidenceReceiptStoreLocalEvidenceAcceptanceAuthorityDecisionRecordingPositivePreconditionsRecordingDenialReceiptPersistenceDenialEntry) -> bool,
) -> usize {
    entries.iter().filter(|entry| predicate(entry)).count()
}

fn entry_is_ready_blocked(
    entry: &ControlledLiveEvidenceReceiptStoreLocalEvidenceAcceptanceAuthorityDecisionRecordingPositivePreconditionsRecordingDenialReceiptPersistenceDenialEntry,
) -> bool {
...
impl ControlledLiveEvidenceReceiptStoreLocalEvidenceAcceptanceAuthorityDecisionRecordingPositivePreconditionsRecordingDenialReceiptPersistenceDenialSideEffects {
...
mod tests {
    ...
    #[test]
    fn recording_denial_receipt_persistence_denial_projects_all_entries() {
        let report =
        ...
        assert_eq!(report.recording_denial_receipt_persistence_denied_count, 7);
        assert_eq!(
            report.recording_denial_receipt_persistence_disabled_count,
            7
        );
    ...
    #[test]
    fn recording_denial_receipt_persistence_denial_keeps_writes_closed() {
        let report =
            controlled_live_evidence_receipt_store_local_evidence_acceptance_authority_decision_recording_positive_preconditions_recording_denial_receipt_persistence_denial_readback_without_persistence_report();

        assert_eq!(report.recording_denial_receipt_persistence_allowed_count, 0);
        assert_eq!(
            report.recording_denial_receipt_persistence_attempt_recorded_count,
            0
        );
    ...
    #[test]
    fn recording_denial_receipt_persistence_denial_entries_are_stable() {
        let report =
            controlled_live_evidence_receipt_store_local_evidence_acceptance_authority_decision_recording_positive_preconditions_recording_denial_receipt_persistence_denial_readback_without_persistence_report();
        ...
        assert!(report.entries.iter().any(|entry| entry.source_blocker_id
            ...
            && entry.persistence_denial_route
                == "readback://controlled-live/evidence-receipt-store/local-evidence-acceptance/authority-decision-recording/recording-denial-receipts/persistence-denial/dirty-worktree-boundary"
            && entry.persistence_denial_reason
                == "local_evidence_acceptance_authority_decision_recording_positive_preconditions_recording_denial_receipt_persistence_disabled_positive_preconditions_missing"));
        assert!(report.entries.iter().all(|entry| {
            entry.source_positive_precondition_set_id.starts_with(
                "local-evidence-acceptance-authority-decision-recording-positive-preconditions-recording-denial-receipt-positive-preconditions:",
            ) && entry
                .source_denial_receipt_id
                .starts_with("local-evidence-acceptance-authority-decision-recording-positive-preconditions-recording-denial-receipt:")
                && entry.persistence_denial_id.starts_with(
                    "local-evidence-acceptance-authority-decision-recording-positive-preconditions-recording-denial-receipt-persistence-denial:",
                )
