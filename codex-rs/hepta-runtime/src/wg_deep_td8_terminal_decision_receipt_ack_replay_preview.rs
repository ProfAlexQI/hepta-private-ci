...
pub struct DeepTd8TerminalDecisionReceiptAckReplayPreviewReport {
    ...
    pub replay_scenarios: Vec<DeepTd8ReceiptAckReplayScenario>,
    pub idempotency_guards: Vec<DeepTd8ReceiptAckIdempotencyGuard>,
    pub replay_denials: Vec<DeepTd8ReceiptAckReplayDenial>,
    pub monotonicity_checks: Vec<DeepTd8ReceiptAckMonotonicityCheck>,
    pub local_views: Vec<DeepTd8ReceiptAckReplayLocalView>,
    pub invariants: Vec<DeepTd8ReceiptAckReplayInvariant>,
    ...
    pub side_effects: DeepTd8ReceiptAckReplaySideEffects,
}

#[derive(Debug, Clone, PartialEq, Eq, Serialize)]
pub struct DeepTd8ReceiptAckReplayScenario {
    pub id: &'static str,
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize)]
pub struct DeepTd8ReceiptAckIdempotencyGuard {
    pub id: &'static str,
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize)]
pub struct DeepTd8ReceiptAckReplayDenial {
    pub id: &'static str,
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize)]
pub struct DeepTd8ReceiptAckMonotonicityCheck {
    pub id: &'static str,
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize)]
pub struct DeepTd8ReceiptAckReplayLocalView {
    pub id: &'static str,
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize)]
pub struct DeepTd8ReceiptAckReplayInvariant {
    pub id: &'static str,
    pub required: bool,
    pub reason: &'static str,
}
...
pub struct DeepTd8ReceiptAckReplaySideEffects {
...
pub fn deep_td8_receipt_retention_expiry_gate() -> String {
    format!(
...
pub fn hepta_work_graph_deep_td8_terminal_decision_receipt_ack_replay_preview_report()
-> DeepTd8TerminalDecisionReceiptAckReplayPreviewReport {
    let replay_scenarios = deep_td8_receipt_ack_replay_scenarios();
    let idempotency_guards = deep_td8_receipt_ack_idempotency_guards();
    let replay_denials = deep_td8_receipt_ack_replay_denials();
    let monotonicity_checks = deep_td8_receipt_ack_monotonicity_checks();
    let local_views = deep_td8_receipt_ack_replay_local_views();
    let invariants = deep_td8_receipt_ack_replay_invariants();
    let gate = crate::deep_td8_terminal_decision_receipt_ack_replay_gate();
    ...
    DeepTd8TerminalDecisionReceiptAckReplayPreviewReport {
        ...
        required_prior_gates: deep_td8_terminal_decision_receipt_ack_replay_required_prior_gates(),
        replay_scenarios,
        idempotency_guards,
        replay_denials,
        monotonicity_checks,
        local_views,
        invariants,
        recommended_next_gate: deep_td8_receipt_retention_expiry_gate(),
        ready_for_receipt_retention_expiry_preview: true,
        ready_for_operator_acceptance: false,
        ready_for_live_persistence: false,
        side_effects: DeepTd8ReceiptAckReplaySideEffects::none(),
    }
}

pub fn deep_td8_terminal_decision_receipt_ack_replay_required_prior_gates() -> Vec<String> {
    let mut gates = crate::deep_td8_terminal_decision_receipt_ack_required_prior_gates();
    gates.push(crate::deep_td8_terminal_decision_receipt_acknowledgement_gate());
    gates
}

pub fn deep_td8_receipt_ack_replay_scenario_ids() -> Vec<&'static str> {
    vec![
        "duplicate_deep_td8_terminal_decision_receipt_replay",
        "duplicate_deep_td8_terminal_decision_receipt_acknowledgement_replay",
        "stale_deep_td8_terminal_decision_receipt_digest_replay",
        "superseded_deep_td8_terminal_decision_receipt_scope_replay",
        "cross_scope_deep_td8_terminal_decision_receipt_acknowledgement_replay",
        "out_of_order_deep_td8_terminal_decision_receipt_acknowledgement_replay",
    ]
}

pub fn deep_td8_receipt_ack_replay_scenarios() -> Vec<DeepTd8ReceiptAckReplayScenario> {
    let acknowledgement_ids = crate::deep_td8_terminal_decision_receipt_ack_ids();
    vec![
        replay_scenario(
            "duplicate_deep_td8_terminal_decision_receipt_replay",
...
pub fn deep_td8_receipt_ack_idempotency_guards() -> Vec<DeepTd8ReceiptAckIdempotencyGuard> {
    vec![
        idempotency_guard(
        ...
        idempotency_guard(
            "deep_td8_receipt_acknowledgement_idempotency_key_required",
...
pub fn deep_td8_receipt_ack_replay_denials() -> Vec<DeepTd8ReceiptAckReplayDenial> {
    let scenario_ids = deep_td8_receipt_ack_replay_scenario_ids();
    vec![
        replay_denial(
...
pub fn deep_td8_receipt_ack_monotonicity_checks() -> Vec<DeepTd8ReceiptAckMonotonicityCheck> {
    vec![
        monotonicity_check(
...
pub fn deep_td8_receipt_ack_replay_local_views() -> Vec<DeepTd8ReceiptAckReplayLocalView> {
    vec![
        local_view(
...
pub fn deep_td8_receipt_ack_replay_invariants() -> Vec<DeepTd8ReceiptAckReplayInvariant> {
    vec![
        invariant(
...
) -> DeepTd8ReceiptAckReplayScenario {
    DeepTd8ReceiptAckReplayScenario {
        id,
...
) -> DeepTd8ReceiptAckIdempotencyGuard {
    DeepTd8ReceiptAckIdempotencyGuard {
        id,
        required_fields,
...
) -> DeepTd8ReceiptAckMonotonicityCheck {
    DeepTd8ReceiptAckMonotonicityCheck {
        id,
        compared_fields,
...
fn local_view(
    ...
    audience: &'static str,
    required_fields: Vec<&'static str>,
) -> DeepTd8ReceiptAckReplayLocalView {
    DeepTd8ReceiptAckReplayLocalView {
        id,
        audience,
        required_fields,
...
fn invariant(id: &'static str, reason: &'static str) -> DeepTd8ReceiptAckReplayInvariant {
    DeepTd8ReceiptAckReplayInvariant {
        id,
        required: true,
        reason,
    }
...
impl DeepTd8ReceiptAckReplaySideEffects {
    pub fn none() -> Self {
        Self {
...
mod tests {
    ...
    fn work_graph_deep_td8_ack_replay_requires_acknowledgement_gate() {
        let report =
            hepta_work_graph_deep_td8_terminal_decision_receipt_ack_replay_preview_report();

        assert_eq!(
            report.required_prior_gates.last(),
            Some(&crate::deep_td8_terminal_decision_receipt_acknowledgement_gate())
        );
    }
    ...
    fn work_graph_deep_td8_ack_replay_enforces_monotonicity_and_next_gate() {
        ...
        assert_eq!(
            ...
            deep_td8_receipt_retention_expiry_gate()
        );
    }
