...
pub struct DeepTd8Td3TerminalDecisionReceiptAckPreviewReport {
    ...
    pub acknowledgement_contracts: Vec<DeepTd8Td3TerminalDecisionReceiptAckItem>,
    pub non_acceptance_reasons: Vec<DeepTd8Td3TerminalDecisionReceiptAckItem>,
    pub recording_denials: Vec<DeepTd8Td3TerminalDecisionReceiptAckItem>,
    pub expiry_replay_guards: Vec<DeepTd8Td3TerminalDecisionReceiptAckItem>,
    pub local_views: Vec<DeepTd8Td3TerminalDecisionReceiptAckItem>,
    pub invariants: Vec<DeepTd8Td3TerminalDecisionReceiptAckItem>,
    ...
    pub side_effects: DeepTd8Td3TerminalDecisionReceiptAckSideEffects,
}

#[derive(Debug, Clone, PartialEq, Eq, Serialize)]
pub struct DeepTd8Td3TerminalDecisionReceiptAckItem {
    pub id: String,
...
pub struct DeepTd8Td3TerminalDecisionReceiptAckSideEffects {
...
pub fn deep_td8_retack_td3_receipt_ack_replay_gate() -> String {
    format!(
...
pub fn hepta_work_graph_deep_td8_retack_td3_receipt_ack_preview_report()
-> DeepTd8Td3TerminalDecisionReceiptAckPreviewReport {
    let acknowledgement_contracts = td3_ack_items("acknowledgement_contract", 6);
    let non_acceptance_reasons = td3_ack_items("non_acceptance_reason", 7);
    let recording_denials = td3_ack_items("recording_denial", 7);
    let expiry_replay_guards = td3_ack_items("expiry_replay_guard", 5);
    let local_views = td3_ack_items("local_view", 4);
    let invariants = td3_ack_items("invariant", 6);
    let gate = crate::deep_td8_retack_td3_receipt_acknowledgement_gate();
    ...
    DeepTd8Td3TerminalDecisionReceiptAckPreviewReport {
        ...
        gate,
        preview_mode: "read_only_deep_td8_td3_terminal_decision_receipt_acknowledgement_preview_no_recording",
        ...
        required_prior_gates: deep_td8_retack_td3_receipt_ack_required_prior_gates(),
        ...
        local_views,
        invariants,
        recommended_next_gate: deep_td8_retack_td3_receipt_ack_replay_gate(),
        ready_for_terminal_decision_receipt_acknowledgement_replay_preview: true,
        ready_for_operator_acceptance: false,
        ready_for_live_persistence: false,
        side_effects: DeepTd8Td3TerminalDecisionReceiptAckSideEffects::none(),
    }
}

pub fn deep_td8_retack_td3_receipt_ack_required_prior_gates() -> Vec<String> {
    let mut gates = crate::deep_td8_retack_td3_receipt_required_prior_gates();
    gates.push(crate::deep_td8_retack_td3_receipt_gate());
    gates
}

pub fn deep_td8_retack_td3_receipt_ack_ids() -> Vec<String> {
    (0..6)
        .map(|index| format!("deep_td8_retack_td3_receipt_ack_{index}"))
        .collect()
}

fn td3_ack_items(prefix: &str, count: usize) -> Vec<DeepTd8Td3TerminalDecisionReceiptAckItem> {
    let source_receipt_ids = crate::deep_td8_retack_td3_receipt_ids();

    (0..count)
        .map(|index| DeepTd8Td3TerminalDecisionReceiptAckItem {
            id: format!("deep_td8_retack_td3_receipt_ack_{prefix}_{index}"),
...
impl DeepTd8Td3TerminalDecisionReceiptAckSideEffects {
    pub fn none() -> Self {
        Self {
...
mod tests {
    ...
    #[test]
    fn work_graph_td3_receipt_ack_requires_receipt_gate() {
        let report = hepta_work_graph_deep_td8_retack_td3_receipt_ack_preview_report();

        assert_eq!(
            report.required_prior_gates.last(),
            Some(&crate::deep_td8_retack_td3_receipt_gate())
        );
    }

    #[test]
    fn work_graph_td3_receipt_ack_declares_non_accepting_contracts() {
        let report = hepta_work_graph_deep_td8_retack_td3_receipt_ack_preview_report();
    ...
    #[test]
    fn work_graph_td3_receipt_ack_denies_recording_and_delivery() {
        let report = hepta_work_graph_deep_td8_retack_td3_receipt_ack_preview_report();
    ...
    #[test]
    fn work_graph_td3_receipt_ack_guards_expiry_scope_and_replay() {
        let report = hepta_work_graph_deep_td8_retack_td3_receipt_ack_preview_report();
    ...
    #[test]
    fn work_graph_td3_receipt_ack_points_to_replay_gate() {
        let report = hepta_work_graph_deep_td8_retack_td3_receipt_ack_preview_report();

        assert_eq!(
            report.recommended_next_gate,
            deep_td8_retack_td3_receipt_ack_replay_gate()
        );
    ...
    #[test]
    fn work_graph_td3_receipt_ack_has_no_side_effects() {
        let report = hepta_work_graph_deep_td8_retack_td3_receipt_ack_preview_report();
