...
pub struct DeepTd8RetAckTdRbackAckTdReceiptRetentionReadbackAckTdReceiptAckPreviewReport {
    ...
    pub acknowledgement_contracts:
        Vec<DeepTd8RetAckTdRbackAckTdReceiptRetentionReadbackAckTdReceiptAckItem>,
    ...
    pub expiry_replay_guards:
        Vec<DeepTd8RetAckTdRbackAckTdReceiptRetentionReadbackAckTdReceiptAckItem>,
    pub local_views: Vec<DeepTd8RetAckTdRbackAckTdReceiptRetentionReadbackAckTdReceiptAckItem>,
    pub invariants: Vec<DeepTd8RetAckTdRbackAckTdReceiptRetentionReadbackAckTdReceiptAckItem>,
    ...
    pub side_effects: DeepTd8RetAckTdRbackAckTdReceiptRetentionReadbackAckTdReceiptAckSideEffects,
}

#[derive(Debug, Clone, PartialEq, Eq, Serialize)]
pub struct DeepTd8RetAckTdRbackAckTdReceiptRetentionReadbackAckTdReceiptAckItem {
    pub id: String,
...
pub struct DeepTd8RetAckTdRbackAckTdReceiptRetentionReadbackAckTdReceiptAckSideEffects {
...
pub fn deep_td8_ret_ack_td_rback_ack_td_receipt_retention_readback_ack_td_receipt_ack_replay_gate()
-> String {
    format!(
...
pub fn hepta_work_graph_deep_td8_ret_ack_td_rback_ack_td_receipt_retention_readback_ack_td_receipt_ack_preview_report()
-> DeepTd8RetAckTdRbackAckTdReceiptRetentionReadbackAckTdReceiptAckPreviewReport {
    ...
    let gate = crate::deep_td8_ret_ack_td_rback_ack_td_receipt_retention_readback_ack_td_receipt_acknowledgement_gate();
    ...
    DeepTd8RetAckTdRbackAckTdReceiptRetentionReadbackAckTdReceiptAckPreviewReport {
        ...
        required_prior_gates: deep_td8_ret_ack_td_rback_ack_td_receipt_retention_readback_ack_td_receipt_ack_required_prior_gates(),
        ...
        local_views,
        invariants,
        recommended_next_gate: deep_td8_ret_ack_td_rback_ack_td_receipt_retention_readback_ack_td_receipt_ack_replay_gate(),
        ready_for_terminal_decision_receipt_acknowledgement_replay_preview: true,
        ready_for_operator_acceptance: false,
        ready_for_live_persistence: false,
        side_effects: DeepTd8RetAckTdRbackAckTdReceiptRetentionReadbackAckTdReceiptAckSideEffects::none(),
    }
}

pub fn deep_td8_ret_ack_td_rback_ack_td_receipt_retention_readback_ack_td_receipt_ack_required_prior_gates()
-> Vec<String> {
    let mut gates = crate::deep_td8_ret_ack_td_rback_ack_td_receipt_retention_readback_ack_td_receipt_required_prior_gates();
    gates.push(
...
pub fn deep_td8_ret_ack_td_rback_ack_td_receipt_retention_readback_ack_td_receipt_ack_ids()
-> Vec<String> {
    (0..6)
        .map(|index| format!("deep_td8_ret_ack_td_rback_ack_td_receipt_retention_readback_ack_td_receipt_ack_{index}"))
        .collect()
}
...
fn ack_items(
    ...
    let source_receipt_ids =
        crate::deep_td8_ret_ack_td_rback_ack_td_receipt_retention_readback_ack_td_receipt_ids();
    (0..count)
        .map(|index| DeepTd8RetAckTdRbackAckTdReceiptRetentionReadbackAckTdReceiptAckItem {
...
impl DeepTd8RetAckTdRbackAckTdReceiptRetentionReadbackAckTdReceiptAckSideEffects {
    pub fn none() -> Self {
        Self {
...
mod tests {
    ...
    #[test]
    fn work_graph_deep_td8_ret_ack_td_rback_ack_td_receipt_retention_readback_ack_td_receipt_ack_requires_receipt_gate()
     {
        let report = hepta_work_graph_deep_td8_ret_ack_td_rback_ack_td_receipt_retention_readback_ack_td_receipt_ack_preview_report();

        assert_eq!(
            report.required_prior_gates.last(),
            Some(&crate::deep_td8_ret_ack_td_rback_ack_td_receipt_retention_readback_ack_td_receipt_gate())
        );
    }

    #[test]
    fn work_graph_deep_td8_ret_ack_td_rback_ack_td_receipt_retention_readback_ack_td_receipt_ack_declares_non_accepting_contracts()
     {
        let report = hepta_work_graph_deep_td8_ret_ack_td_rback_ack_td_receipt_retention_readback_ack_td_receipt_ack_preview_report();
    ...
    #[test]
    fn work_graph_deep_td8_ret_ack_td_rback_ack_td_receipt_retention_readback_ack_td_receipt_ack_denies_recording_and_delivery()
     {
        let report = hepta_work_graph_deep_td8_ret_ack_td_rback_ack_td_receipt_retention_readback_ack_td_receipt_ack_preview_report();
    ...
    #[test]
    fn work_graph_deep_td8_ret_ack_td_rback_ack_td_receipt_retention_readback_ack_td_receipt_ack_guards_expiry_scope_and_replay()
     {
        let report = hepta_work_graph_deep_td8_ret_ack_td_rback_ack_td_receipt_retention_readback_ack_td_receipt_ack_preview_report();
    ...
    #[test]
    fn work_graph_deep_td8_ret_ack_td_rback_ack_td_receipt_retention_readback_ack_td_receipt_ack_points_to_replay_gate()
     {
        let report = hepta_work_graph_deep_td8_ret_ack_td_rback_ack_td_receipt_retention_readback_ack_td_receipt_ack_preview_report();

        assert_eq!(
            report.recommended_next_gate,
            deep_td8_ret_ack_td_rback_ack_td_receipt_retention_readback_ack_td_receipt_ack_replay_gate()
        );
    ...
    #[test]
    fn work_graph_deep_td8_ret_ack_td_rback_ack_td_receipt_retention_readback_ack_td_receipt_ack_has_no_side_effects()
     {
        let report = hepta_work_graph_deep_td8_ret_ack_td_rback_ack_td_receipt_retention_readback_ack_td_receipt_ack_preview_report();
