...
pub struct WorkGraphAgentJobsTaskBoardFeatureFlagEnablementPreconditionDenialAuditIndexNonPersistenceReadbackReport {
    ...
    pub source_denial_audit_index_preconditions_complete: bool,
    pub source_denial_audit_index_no_record_persist_accept_confirmed: bool,
    pub source_denial_audit_index_no_authorization_confirmed: bool,
    pub source_denial_audit_index_ready: bool,
...
-> WorkGraphAgentJobsTaskBoardFeatureFlagEnablementPreconditionDenialAuditIndexNonPersistenceReadbackReport{
    ...
    let source_denial_audit_index_no_record_persist_accept_confirmed = source.audit_index_visible
        && !source.audit_index_recorded
        && !source.audit_index_persisted
        && !source.audit_index_authoritative
        && !source.audit_index_acceptance_allowed
        && source.side_effects
            == WorkGraphAgentJobsTaskBoardFeatureFlagEnablementPreconditionDenialAuditIndexSideEffects::none(
            );
    let source_denial_audit_index_no_authorization_confirmed = !source
        .audit_index_authorizes_config_write
    ...
    let source_denial_audit_index_ready = source.gate
        == WORK_GRAPH_AGENT_JOBS_TASK_BOARD_FEATURE_FLAG_ENABLEMENT_PRECONDITION_DENIAL_AUDIT_INDEX_GATE
        && source.denial_audit_index_preconditions_complete
        && source.ready_for_non_persistence_readback
        && source_denial_audit_index_no_record_persist_accept_confirmed
        && source_denial_audit_index_no_authorization_confirmed;
    ...
    let non_persistence_readback_preconditions_complete = source_denial_audit_index_ready
    ...
    WorkGraphAgentJobsTaskBoardFeatureFlagEnablementPreconditionDenialAuditIndexNonPersistenceReadbackReport {
        ...
        source_denial_audit_index_preconditions_complete: source.denial_audit_index_preconditions_complete,
        source_denial_audit_index_no_record_persist_accept_confirmed,
        source_denial_audit_index_no_authorization_confirmed,
...
mod tests {
    ...
    fn denial_audit_index_non_persistence_readback_derives_from_audit_index() {
        ...
        assert!(report.source_denial_audit_index_preconditions_complete);
        assert!(report.source_denial_audit_index_no_record_persist_accept_confirmed);
        assert!(report.source_denial_audit_index_no_authorization_confirmed);
        assert!(report.source_denial_audit_index_ready);
