...
use crate::work_graph_agent_jobs_task_board_scheduler_guardrail_blocking_dry_run_entrypoint_live_attachment_precondition_matrix_denial_readback_audit_index::{
...
pub const WORK_GRAPH_AGENT_JOBS_TASK_BOARD_SCHEDULER_GUARDRAIL_BLOCKING_DRY_RUN_ENTRYPOINT_LIVE_ATTACHMENT_PRECONDITION_MATRIX_DENIAL_READBACK_AUDIT_INDEX_NON_PERSISTENCE_READBACK_GATE:
    &str =
...
pub const WORK_GRAPH_AGENT_JOBS_TASK_BOARD_SCHEDULER_GUARDRAIL_BLOCKING_DRY_RUN_ENTRYPOINT_LIVE_ATTACHMENT_PRECONDITION_MATRIX_DENIAL_READBACK_AUDIT_INDEX_NON_PERSISTENCE_READBACK_SCHEMA_VERSION:
    &str = "work_graph_agent_jobs_task_board_scheduler_guardrail_blocking_dry_run_entrypoint_live_attachment_precondition_matrix_denial_readback_audit_index_non_persistence_readback_v1";
pub const WORK_GRAPH_AGENT_JOBS_TASK_BOARD_SCHEDULER_GUARDRAIL_BLOCKING_DRY_RUN_ENTRYPOINT_LIVE_ATTACHMENT_PRECONDITION_MATRIX_DENIAL_READBACK_AUDIT_INDEX_NON_PERSISTENCE_READBACK_RECOMMENDED_NEXT_GATE:
    &str =
...
pub struct WorkGraphAgentJobsTaskBoardSchedulerGuardrailBlockingDryRunEntrypointLiveAttachmentPreconditionMatrixDenialReadbackAuditIndexNonPersistenceReadbackReport {
    ...
    pub readback_scope:
        WorkGraphSchedulerGuardrailLiveAttachmentPreconditionMatrixDenialReadbackAuditIndexNonPersistenceReadbackScopePreview,
    pub readback_entries:
        Vec<WorkGraphSchedulerGuardrailLiveAttachmentPreconditionMatrixDenialReadbackAuditIndexNonPersistenceReadbackEntryPreview>,
    pub readback_blockers:
        Vec<WorkGraphSchedulerGuardrailLiveAttachmentPreconditionMatrixDenialReadbackAuditIndexNonPersistenceReadbackBlockerPreview>,
    ...
    pub matrix_recording_allowed: bool,
    pub matrix_persistence_allowed: bool,
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize)]
pub struct WorkGraphSchedulerGuardrailLiveAttachmentPreconditionMatrixDenialReadbackAuditIndexNonPersistenceReadbackScopePreview
{
    pub id: &'static str,
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize)]
pub struct WorkGraphSchedulerGuardrailLiveAttachmentPreconditionMatrixDenialReadbackAuditIndexNonPersistenceReadbackEntryPreview
{
    pub id: &'static str,
    pub stable_readback_key: &'static str,
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize)]
pub struct WorkGraphSchedulerGuardrailLiveAttachmentPreconditionMatrixDenialReadbackAuditIndexNonPersistenceReadbackBlockerPreview
{
    pub id: &'static str,
...
pub struct WorkGraphAgentJobsTaskBoardSchedulerGuardrailBlockingDryRunEntrypointLiveAttachmentPreconditionMatrixDenialReadbackAuditIndexNonPersistenceReadbackSideEffects
{
...
pub fn hepta_work_graph_agent_jobs_task_board_scheduler_guardrail_blocking_dry_run_entrypoint_live_attachment_precondition_matrix_denial_readback_audit_index_non_persistence_readback_report()
-> WorkGraphAgentJobsTaskBoardSchedulerGuardrailBlockingDryRunEntrypointLiveAttachmentPreconditionMatrixDenialReadbackAuditIndexNonPersistenceReadbackReport{
    let source =
        hepta_work_graph_agent_jobs_task_board_scheduler_guardrail_blocking_dry_run_entrypoint_live_attachment_precondition_matrix_denial_readback_audit_index_report();
    let readback_scope =
        work_graph_agent_jobs_task_board_scheduler_guardrail_blocking_dry_run_entrypoint_live_attachment_precondition_matrix_denial_readback_audit_index_non_persistence_readback_scope();
    let readback_entries =
        work_graph_agent_jobs_task_board_scheduler_guardrail_blocking_dry_run_entrypoint_live_attachment_precondition_matrix_denial_readback_audit_index_non_persistence_readback_entries();
    ...
    let source_audit_index_no_live_confirmed = source.ready_for_non_persistence_readback
        && !source.audit_index_authorizes_denial_readback_recording
        && !source.audit_index_authorizes_denial_readback_persistence
        && !source.audit_index_authorizes_matrix_recording
        && !source.audit_index_authorizes_matrix_persistence
        ...
        && !source.audit_index_authorizes_replay_or_rollback
    ...
    let source_audit_index_ready = source.gate
        == WORK_GRAPH_AGENT_JOBS_TASK_BOARD_SCHEDULER_GUARDRAIL_BLOCKING_DRY_RUN_ENTRYPOINT_LIVE_ATTACHMENT_PRECONDITION_MATRIX_DENIAL_READBACK_AUDIT_INDEX_GATE
        && source.source_denial_readback_ready
        && source.source_denial_readback_no_persistence_confirmed
        && source.source_denial_readback_no_live_confirmed
        && source.source_denial_readback_ready_for_audit_index
        && source.audit_index_scope_report_only_complete
        ...
        && source.audit_index_blocker_count == 39
        && source.required_prior_gate_count == 18
    ...
    let readback_blockers_complete =
        readback_blockers.len() == 42 && readback_blockers.iter().all(|blocker| blocker.blocked);
    ...
    WorkGraphAgentJobsTaskBoardSchedulerGuardrailBlockingDryRunEntrypointLiveAttachmentPreconditionMatrixDenialReadbackAuditIndexNonPersistenceReadbackReport {
        ...
        schema_version:
            WORK_GRAPH_AGENT_JOBS_TASK_BOARD_SCHEDULER_GUARDRAIL_BLOCKING_DRY_RUN_ENTRYPOINT_LIVE_ATTACHMENT_PRECONDITION_MATRIX_DENIAL_READBACK_AUDIT_INDEX_NON_PERSISTENCE_READBACK_SCHEMA_VERSION,
        preview_mode:
            "scheduler_guardrail_blocking_dry_run_entrypoint_live_attachment_precondition_matrix_denial_readback_audit_index_non_persistence_readback_only",
        ...
        recommended_next_gate:
            WORK_GRAPH_AGENT_JOBS_TASK_BOARD_SCHEDULER_GUARDRAIL_BLOCKING_DRY_RUN_ENTRYPOINT_LIVE_ATTACHMENT_PRECONDITION_MATRIX_DENIAL_READBACK_AUDIT_INDEX_NON_PERSISTENCE_READBACK_RECOMMENDED_NEXT_GATE,
...
pub fn work_graph_agent_jobs_task_board_scheduler_guardrail_blocking_dry_run_entrypoint_live_attachment_precondition_matrix_denial_readback_audit_index_non_persistence_readback_scope()
-> WorkGraphSchedulerGuardrailLiveAttachmentPreconditionMatrixDenialReadbackAuditIndexNonPersistenceReadbackScopePreview{
    WorkGraphSchedulerGuardrailLiveAttachmentPreconditionMatrixDenialReadbackAuditIndexNonPersistenceReadbackScopePreview {
...
pub fn work_graph_agent_jobs_task_board_scheduler_guardrail_blocking_dry_run_entrypoint_live_attachment_precondition_matrix_denial_readback_audit_index_non_persistence_readback_entries()
-> Vec<WorkGraphSchedulerGuardrailLiveAttachmentPreconditionMatrixDenialReadbackAuditIndexNonPersistenceReadbackEntryPreview>{
    vec![
        readback_entry(
            "live_attachment_audit_index_surface_non_persistence_readback",
            "live_attachment_denial_readback_audit_index_visible_unrecorded",
        ...
        readback_entry(
            ...
            "live_attachment_denial_readback_audit_index_entries_visible",
            "nine_audit_index_entries_visible_but_not_persisted",
        ),
        readback_entry(
            "live_attachment_audit_index_blocker_inventory_non_persistence_readback",
            "live_attachment_denial_readback_audit_index_blockers_visible",
            "thirty_nine_blockers_visible_and_still_blocking",
        ),
        readback_entry(
            "live_attachment_audit_index_prior_chain_non_persistence_readback",
            "live_attachment_denial_readback_audit_index_priors_visible",
            "eighteen_required_prior_gates_visible_but_not_persisted",
        ),
        readback_entry(
            "live_attachment_audit_index_non_persistence_boundary_readback",
            "live_attachment_denial_readback_audit_index_non_persistence_boundary",
        ...
        readback_entry(
            ...
            "live_attachment_denial_readback_audit_index_no_live_authority",
            "audit_index_does_not_authorize_attachment_enforcement_interception_work_start_agent_model_external_or_live_cutover",
        ),
    ]
}

pub fn work_graph_agent_jobs_task_board_scheduler_guardrail_blocking_dry_run_entrypoint_live_attachment_precondition_matrix_denial_readback_audit_index_non_persistence_readback_blockers()
-> Vec<WorkGraphSchedulerGuardrailLiveAttachmentPreconditionMatrixDenialReadbackAuditIndexNonPersistenceReadbackBlockerPreview>{
    vec![
        blocker(
...
pub fn work_graph_agent_jobs_task_board_scheduler_guardrail_blocking_dry_run_entrypoint_live_attachment_precondition_matrix_denial_readback_audit_index_non_persistence_readback_required_prior_gates()
-> Vec<&'static str> {
    let mut required_prior_gates = vec![
        WORK_GRAPH_AGENT_JOBS_TASK_BOARD_SCHEDULER_GUARDRAIL_BLOCKING_DRY_RUN_ENTRYPOINT_LIVE_ATTACHMENT_PRECONDITION_MATRIX_DENIAL_READBACK_AUDIT_INDEX_GATE,
    ];
    required_prior_gates.extend(crate::work_graph_agent_jobs_task_board_scheduler_guardrail_blocking_dry_run_entrypoint_live_attachment_precondition_matrix_denial_readback_audit_index::work_graph_agent_jobs_task_board_scheduler_guardrail_blocking_dry_run_entrypoint_live_attachment_precondition_matrix_denial_readback_audit_index_required_prior_gates());
    required_prior_gates
}

impl WorkGraphAgentJobsTaskBoardSchedulerGuardrailBlockingDryRunEntrypointLiveAttachmentPreconditionMatrixDenialReadbackAuditIndexNonPersistenceReadbackSideEffects {
...
) -> WorkGraphSchedulerGuardrailLiveAttachmentPreconditionMatrixDenialReadbackAuditIndexNonPersistenceReadbackEntryPreview{
    WorkGraphSchedulerGuardrailLiveAttachmentPreconditionMatrixDenialReadbackAuditIndexNonPersistenceReadbackEntryPreview {
        id,
        stable_readback_key,
        observed_state,
...
) -> WorkGraphSchedulerGuardrailLiveAttachmentPreconditionMatrixDenialReadbackAuditIndexNonPersistenceReadbackBlockerPreview{
    WorkGraphSchedulerGuardrailLiveAttachmentPreconditionMatrixDenialReadbackAuditIndexNonPersistenceReadbackBlockerPreview {
        id,
        blocked_action,
        blocked: true,
...
mod tests {
    ...
    #[test]
    fn live_attachment_audit_index_non_persistence_readback_derives_from_audit_index() {
        let report =
        ...
        assert_eq!(report.source_audit_index_blocker_count, 39);
        ...
        assert_eq!(report.readback_blocker_count, 42);
        assert_eq!(report.required_prior_gate_count, 19);
    }

    #[test]
    fn live_attachment_audit_index_non_persistence_readback_stays_unpersisted() {
        let report =
            hepta_work_graph_agent_jobs_task_board_scheduler_guardrail_blocking_dry_run_entrypoint_live_attachment_precondition_matrix_denial_readback_audit_index_non_persistence_readback_report();
    ...
    #[test]
    fn live_attachment_audit_index_non_persistence_readback_blocks_live_paths() {
        let report =
            hepta_work_graph_agent_jobs_task_board_scheduler_guardrail_blocking_dry_run_entrypoint_live_attachment_precondition_matrix_denial_readback_audit_index_non_persistence_readback_report();
        ...
        assert!(!report.matrix_recording_allowed);
        assert!(!report.matrix_persistence_allowed);
    ...
    #[test]
    fn live_attachment_audit_index_non_persistence_readback_has_no_side_effects() {
        let report =
            hepta_work_graph_agent_jobs_task_board_scheduler_guardrail_blocking_dry_run_entrypoint_live_attachment_precondition_matrix_denial_readback_audit_index_non_persistence_readback_report();
        ...
        assert!(
            !side_effects.filesystem_written
                ...
                && !side_effects.audit_index_readback_recorded
                && !side_effects.audit_index_readback_persisted
                && !side_effects.audit_index_readback_accepted
