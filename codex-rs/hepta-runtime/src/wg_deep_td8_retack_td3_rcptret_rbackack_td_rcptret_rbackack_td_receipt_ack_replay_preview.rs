...
pub struct DeepTd8Td3RbackAckTd2TerminalDecisionReceiptAckReplayPreviewReport {
    ...
    pub replay_scenarios: Vec<DeepTd8Td3RbackAckTd2TerminalDecisionReceiptAckReplayItem>,
    pub idempotency_guards: Vec<DeepTd8Td3RbackAckTd2TerminalDecisionReceiptAckReplayItem>,
    pub replay_denials: Vec<DeepTd8Td3RbackAckTd2TerminalDecisionReceiptAckReplayItem>,
    pub monotonicity_checks: Vec<DeepTd8Td3RbackAckTd2TerminalDecisionReceiptAckReplayItem>,
    pub local_views: Vec<DeepTd8Td3RbackAckTd2TerminalDecisionReceiptAckReplayItem>,
    pub invariants: Vec<DeepTd8Td3RbackAckTd2TerminalDecisionReceiptAckReplayItem>,
    ...
    pub side_effects: DeepTd8Td3RbackAckTd2TerminalDecisionReceiptAckReplaySideEffects,
}

#[derive(Debug, Clone, PartialEq, Eq, Serialize)]
pub struct DeepTd8Td3RbackAckTd2TerminalDecisionReceiptAckReplayItem {
    pub id: String,
...
pub struct DeepTd8Td3RbackAckTd2TerminalDecisionReceiptAckReplaySideEffects {
...
pub fn deep_td8_retack_td3_rcptret_rbackack_td_rcptret_rbackack_td_receipt_retention_expiry_gate()
-> String {
    format!(
...
pub fn hepta_work_graph_deep_td8_retack_td3_rcptret_rbackack_td_rcptret_rbackack_td_receipt_ack_replay_preview_report()
-> DeepTd8Td3RbackAckTd2TerminalDecisionReceiptAckReplayPreviewReport {
    ...
    let gate =
        crate::deep_td8_retack_td3_rcptret_rbackack_td_rcptret_rbackack_td_receipt_ack_replay_gate(
        );
    ...
    DeepTd8Td3RbackAckTd2TerminalDecisionReceiptAckReplayPreviewReport {
        ...
        gate,
        preview_mode: "read_only_deep_td8_td3_rbackack_td_receipt_retention_readback_ack_terminal_decision_receipt_acknowledgement_replay_idempotency_preview_no_replay_write",
        ...
        required_prior_gates:
            deep_td8_retack_td3_rcptret_rbackack_td_rcptret_rbackack_td_receipt_ack_replay_required_prior_gates(),
        replay_scenarios,
        idempotency_guards,
        replay_denials,
        monotonicity_checks,
        ...
        recommended_next_gate:
            deep_td8_retack_td3_rcptret_rbackack_td_rcptret_rbackack_td_receipt_retention_expiry_gate(),
        ready_for_receipt_retention_expiry_preview: true,
        ready_for_operator_acceptance: false,
        ready_for_live_persistence: false,
        side_effects:
            DeepTd8Td3RbackAckTd2TerminalDecisionReceiptAckReplaySideEffects::none(),
    }
}

pub fn deep_td8_retack_td3_rcptret_rbackack_td_rcptret_rbackack_td_receipt_ack_replay_required_prior_gates()
-> Vec<String> {
    let mut gates =
        crate::deep_td8_retack_td3_rcptret_rbackack_td_rcptret_rbackack_td_receipt_ack_required_prior_gates();
    gates.push(crate::deep_td8_retack_td3_rcptret_rbackack_td_rcptret_rbackack_td_receipt_acknowledgement_gate());
    gates
}
...
fn replay_items(
    prefix: &str,
    count: usize,
) -> Vec<DeepTd8Td3RbackAckTd2TerminalDecisionReceiptAckReplayItem> {
    let source_acknowledgement_ids =
        crate::deep_td8_retack_td3_rcptret_rbackack_td_rcptret_rbackack_td_receipt_ack_ids();

    (0..count)
        .map(
            |index| DeepTd8Td3RbackAckTd2TerminalDecisionReceiptAckReplayItem {
                id: format!(
                    "deep_td8_retack_td3_rcptret_rbackack_td_rcptret_rbackack_td_receipt_ack_replay_{prefix}_{index}"
                ),
...
impl DeepTd8Td3RbackAckTd2TerminalDecisionReceiptAckReplaySideEffects {
    pub fn none() -> Self {
        Self {
...
mod tests {
    ...
    fn work_graph_td3_rcptret_rbackack_td_receipt_ack_replay_requires_ack_gate() {
        let report =
            hepta_work_graph_deep_td8_retack_td3_rcptret_rbackack_td_rcptret_rbackack_td_receipt_ack_replay_preview_report();

        assert_eq!(
            report.required_prior_gates.last(),
            Some(&crate::deep_td8_retack_td3_rcptret_rbackack_td_rcptret_rbackack_td_receipt_acknowledgement_gate())
        );
    }
