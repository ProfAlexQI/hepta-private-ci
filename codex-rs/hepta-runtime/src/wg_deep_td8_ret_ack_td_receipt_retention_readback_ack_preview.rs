...
pub struct DeepTd8RetAckTdReceiptRetentionReadbackAckPreviewReport {
    ...
    pub acknowledgement_contracts: Vec<DeepTd8RetAckTdReceiptRetentionReadbackAckItem>,
    pub non_acceptance_reasons: Vec<DeepTd8RetAckTdReceiptRetentionReadbackAckItem>,
    pub recording_denials: Vec<DeepTd8RetAckTdReceiptRetentionReadbackAckItem>,
    pub expiry_replay_guards: Vec<DeepTd8RetAckTdReceiptRetentionReadbackAckItem>,
    pub local_views: Vec<DeepTd8RetAckTdReceiptRetentionReadbackAckItem>,
    pub invariants: Vec<DeepTd8RetAckTdReceiptRetentionReadbackAckItem>,
    ...
    pub side_effects: DeepTd8RetAckTdReceiptRetentionReadbackAckSideEffects,
}

#[derive(Debug, Clone, PartialEq, Eq, Serialize)]
pub struct DeepTd8RetAckTdReceiptRetentionReadbackAckItem {
    pub id: &'static str,
...
pub struct DeepTd8RetAckTdReceiptRetentionReadbackAckSideEffects {
...
pub fn deep_td8_ret_ack_td_receipt_retention_readback_ack_replay_gate() -> String {
    format!(
...
pub fn hepta_work_graph_deep_td8_ret_ack_td_receipt_retention_readback_ack_preview_report()
-> DeepTd8RetAckTdReceiptRetentionReadbackAckPreviewReport {
    ...
    let gate = crate::deep_td8_ret_ack_td_receipt_retention_readback_ack_gate();
    ...
    DeepTd8RetAckTdReceiptRetentionReadbackAckPreviewReport {
        ...
        gate,
        preview_mode: "read_only_deep_td8_ret_ack_td_receipt_retention_readback_acknowledgement_preview_no_recording",
        ...
        required_prior_gates:
            deep_td8_ret_ack_td_receipt_retention_readback_ack_required_prior_gates(),
        ...
        local_views,
        invariants,
        recommended_next_gate: deep_td8_ret_ack_td_receipt_retention_readback_ack_replay_gate(),
        ready_for_acknowledgement_replay_idempotency_preview: true,
        ready_for_operator_acceptance: false,
        ready_for_live_persistence: false,
        side_effects: DeepTd8RetAckTdReceiptRetentionReadbackAckSideEffects::none(),
    }
}

pub fn deep_td8_ret_ack_td_receipt_retention_readback_ack_required_prior_gates() -> Vec<String> {
    let mut gates =
        crate::deep_td8_ret_ack_td_receipt_retention_readback_receipt_required_prior_gates();
    gates.push(crate::deep_td8_ret_ack_td_receipt_retention_readback_receipt_gate());
    gates
}

pub fn deep_td8_ret_ack_td_receipt_retention_readback_ack_ids() -> Vec<&'static str> {
    vec![
...
fn ack_items(
    prefix: &'static str,
    count: usize,
) -> Vec<DeepTd8RetAckTdReceiptRetentionReadbackAckItem> {
    let receipt_ids = vec![
    ...
    (0..count)
        .map(|index| DeepTd8RetAckTdReceiptRetentionReadbackAckItem {
            id: match (prefix, index) {
                ...
                ("contract", 4) => "public_claim_denial_deep_td8_ret_ack_td_readback_ack_contract",
                ("contract", _) => {
                ...
                ("non_acceptance", 1) => "deep_td8_ret_ack_td_readback_ack_cannot_record_receipt",
                ("non_acceptance", 2) => "deep_td8_ret_ack_td_readback_ack_cannot_record_approval",
                ("non_acceptance", 3) => "deep_td8_ret_ack_td_readback_ack_cannot_grant_authority",
                ("non_acceptance", 4) => {
                    "deep_td8_ret_ack_td_readback_ack_cannot_enable_persistence"
                }
                ("non_acceptance", 5) => "deep_td8_ret_ack_td_readback_ack_cannot_start_rollout",
                ("non_acceptance", _) => "deep_td8_ret_ack_td_readback_ack_cannot_publish_or_send",
                ...
                ("recording_denial", _) => "deep_td8_ret_ack_td_external_delivery_recording_denied",
                ...
                ("expiry_replay_guard", _) => "deep_td8_ret_ack_td_ack_zero_effect_digest_matches",
                ...
                ("local_view", 2) => "release_owner_deep_td8_ret_ack_td_readback_ack_denial_view",
                ("local_view", _) => "runtime_deep_td8_ret_ack_td_readback_ack_zero_effect_view",
                ("invariant", 0) => "deep_td8_ret_ack_td_readback_acknowledgements_are_hash_only",
                ("invariant", 1) => {
                ...
                ("invariant", 3) => "deep_td8_ret_ack_td_readback_acknowledgements_block_authority",
                ("invariant", 4) => "deep_td8_ret_ack_td_readback_ack_views_are_local_only",
                ("invariant", _) => "deep_td8_ret_ack_td_readback_ack_preview_has_no_side_effects",
                _ => unreachable!(),
            },
...
impl DeepTd8RetAckTdReceiptRetentionReadbackAckSideEffects {
    pub fn none() -> Self {
        Self {
...
mod tests {
    ...
    fn work_graph_deep_td8_ret_ack_td_readback_ack_requires_readback_receipt_gate() {
        let report =
            hepta_work_graph_deep_td8_ret_ack_td_receipt_retention_readback_ack_preview_report();

        assert_eq!(
            report.required_prior_gates.last(),
            Some(&crate::deep_td8_ret_ack_td_receipt_retention_readback_receipt_gate())
        );
    }
    ...
    fn work_graph_deep_td8_ret_ack_td_readback_ack_guards_expiry_scope_and_replay() {
        ...
        assert_eq!(
            ...
            deep_td8_ret_ack_td_receipt_retention_readback_ack_replay_gate()
        );
        assert!(
            report
                .expiry_replay_guards
