...
use crate::controlled_live_evidence_receipt_store_local_evidence_acceptance_recording_boundary_readback_without_recording::controlled_live_evidence_receipt_store_local_evidence_acceptance_recording_boundary_readback_without_recording_report;
use serde::Serialize;

pub const CONTROLLED_LIVE_EVIDENCE_RECEIPT_STORE_LOCAL_EVIDENCE_ACCEPTANCE_RECORDING_DENIAL_RECEIPT_READBACK_WITHOUT_PERSISTENCE_GATE: &str =
    "controlled_live_evidence_receipt_store_local_evidence_acceptance_recording_denial_receipt_readback_without_persistence_gate";
pub const CONTROLLED_LIVE_EVIDENCE_RECEIPT_STORE_LOCAL_EVIDENCE_ACCEPTANCE_RECORDING_DENIAL_RECEIPT_READBACK_WITHOUT_PERSISTENCE_SCHEMA_VERSION: &str =
    "controlled_live_evidence_receipt_store_local_evidence_acceptance_recording_denial_receipt_readback_without_persistence_v1";
pub const CONTROLLED_LIVE_EVIDENCE_RECEIPT_STORE_LOCAL_EVIDENCE_ACCEPTANCE_RECORDING_DENIAL_RECEIPT_READBACK_WITHOUT_PERSISTENCE_RECOMMENDED_NEXT_GATE: &str =
...
const DENIAL_RECEIPT_COLLECTION_ID: &str =
    "controlled-live-evidence-receipt-store-local-evidence-acceptance-recording-denial-receipts";
const DENIAL_RECEIPT_COLLECTION_ROUTE: &str = "readback://controlled-live/evidence-receipt-store/local-evidence-acceptance/recording-denial-receipts";
const DENIAL_RECEIPT_SCHEMA_VERSION: &str =
    "controlled_live_local_evidence_acceptance_source_recording_denial_receipt_v1";
const RECORDING_DENIAL_REASON: &str =
    "local_evidence_acceptance_source_recording_disabled_open_preconditions_missing";

#[derive(Debug, Clone, PartialEq, Eq, Serialize)]
pub struct ControlledLiveEvidenceReceiptStoreLocalEvidenceAcceptanceRecordingDenialReceiptReadbackWithoutPersistenceReport {
    ...
    pub source_record_schema_projected_count: usize,
    ...
    pub source_acceptance_source_record_id_attached_count: usize,
    ...
    pub acceptance_source_recording_disabled_count: usize,
    ...
    pub local_evidence_acceptance_recording_denial_receipt_readback_ready: bool,
    ...
    pub entries: Vec<
        ControlledLiveEvidenceReceiptStoreLocalEvidenceAcceptanceRecordingDenialReceiptReadbackWithoutPersistenceEntry,
    >,
    pub recommended_next_gate: &'static str,
    pub side_effects:
        ControlledLiveEvidenceReceiptStoreLocalEvidenceAcceptanceRecordingDenialReceiptReadbackWithoutPersistenceSideEffects,
}

#[derive(Debug, Clone, PartialEq, Eq, Serialize)]
pub struct ControlledLiveEvidenceReceiptStoreLocalEvidenceAcceptanceRecordingDenialReceiptReadbackWithoutPersistenceEntry
{
    pub id: String,
    pub source_blocker_id: &'static str,
    pub source_boundary_entry_id: String,
    pub source_recording_boundary_id: String,
    ...
    pub source_acceptance_source_record_id_attached: bool,
    ...
    pub acceptance_source_recording_disabled: bool,
    pub acceptance_source_recording_allowed: bool,
    pub acceptance_source_recorded: bool,
    pub acceptance_source_persisted: bool,
    pub denial_receipt_persistence_allowed: bool,
...
pub struct ControlledLiveEvidenceReceiptStoreLocalEvidenceAcceptanceRecordingDenialReceiptReadbackWithoutPersistenceSideEffects
{
    pub acceptance_source_recorded: bool,
    pub acceptance_source_persisted: bool,
    pub denial_receipt_persisted: bool,
...
pub fn controlled_live_evidence_receipt_store_local_evidence_acceptance_recording_denial_receipt_readback_without_persistence_report()
-> ControlledLiveEvidenceReceiptStoreLocalEvidenceAcceptanceRecordingDenialReceiptReadbackWithoutPersistenceReport{
    ...
    REPORT
        .get_or_init(|| {
            ...
            let entries =
                controlled_live_evidence_receipt_store_local_evidence_acceptance_recording_denial_receipt_readback_without_persistence_entries();
            ...
            let source_recording_boundary_attached_count = entries
                ...
                .count();
            let source_acceptance_source_record_id_attached_count = entries
                .iter()
                .filter(|entry| entry.source_acceptance_source_record_id_attached)
                .count();
            ...
            let recording_precondition_missing_count = entries
                ...
                .count();
            let acceptance_source_recording_disabled_count = entries
                .iter()
                .filter(|entry| entry.acceptance_source_recording_disabled)
                .count();
            ...
            let local_evidence_acceptance_recording_denial_receipt_readback_ready =
                source.local_evidence_acceptance_recording_boundary_readback_ready
                    && source.boundary_entry_count == 7
                    && source.boundary_projected_count == 7
                    && source.boundary_ready_count == 7
                    && source.source_acceptance_source_attached_count == 7
                    && source.record_schema_projected_count == 7
                    ...
                    && entries.iter().all(|entry| {
                        entry.observed_state
                            == "local_evidence_acceptance_recording_denial_receipt_projected_without_persistence"
            ...
            ControlledLiveEvidenceReceiptStoreLocalEvidenceAcceptanceRecordingDenialReceiptReadbackWithoutPersistenceReport {
                ...
                status: if local_evidence_acceptance_recording_denial_receipt_readback_ready {
                    "ready_blocked"
                } else {
                    "blocked"
                },
                gate:
                    CONTROLLED_LIVE_EVIDENCE_RECEIPT_STORE_LOCAL_EVIDENCE_ACCEPTANCE_RECORDING_DENIAL_RECEIPT_READBACK_WITHOUT_PERSISTENCE_GATE,
                schema_version:
                    CONTROLLED_LIVE_EVIDENCE_RECEIPT_STORE_LOCAL_EVIDENCE_ACCEPTANCE_RECORDING_DENIAL_RECEIPT_READBACK_WITHOUT_PERSISTENCE_SCHEMA_VERSION,
                plugin_id: "hepta-system@hepta-local",
                source_recording_boundary_ready:
                    source.local_evidence_acceptance_recording_boundary_readback_ready,
                ...
                source_acceptance_source_attached_count:
                    source.source_acceptance_source_attached_count,
                source_record_schema_projected_count: source.record_schema_projected_count,
                source_recording_precondition_missing_count:
                    source.recording_precondition_missing_count,
                ...
                local_evidence_acceptance_recording_denial_receipt_readback_ready,
                ...
                recommended_next_gate:
                    CONTROLLED_LIVE_EVIDENCE_RECEIPT_STORE_LOCAL_EVIDENCE_ACCEPTANCE_RECORDING_DENIAL_RECEIPT_READBACK_WITHOUT_PERSISTENCE_RECOMMENDED_NEXT_GATE,
                side_effects:
                    ControlledLiveEvidenceReceiptStoreLocalEvidenceAcceptanceRecordingDenialReceiptReadbackWithoutPersistenceSideEffects::none(),
            }
        })
        .clone()
}

pub fn controlled_live_evidence_receipt_store_local_evidence_acceptance_recording_denial_receipt_readback_without_persistence_entries()
-> Vec<
    ControlledLiveEvidenceReceiptStoreLocalEvidenceAcceptanceRecordingDenialReceiptReadbackWithoutPersistenceEntry,
>{
    controlled_live_evidence_receipt_store_local_evidence_acceptance_recording_boundary_readback_without_recording_report()
        ...
        .map(|entry| {
            ...
            ControlledLiveEvidenceReceiptStoreLocalEvidenceAcceptanceRecordingDenialReceiptReadbackWithoutPersistenceEntry {
                id: format!(
                    "evidence_receipt_store_local_evidence_acceptance_recording_denial_receipt_without_persistence_{}",
                ...
                source_acceptance_source_record_id: entry.acceptance_source_record_id,
                ...
                source_denial_reason: entry.denial_reason,
                denial_receipt_id: format!(
                    "local-evidence-acceptance-recording-denial-receipt:controlled-live-evidence-receipt-store:{}:not-persisted",
                    entry.source_blocker_id
                ),
                denial_receipt_route: format!("{DENIAL_RECEIPT_COLLECTION_ROUTE}/{hyphenated}"),
                denial_receipt_digest: format!(
                    "sha256:controlled-live-evidence-receipt-store-local-evidence-acceptance-recording-denial:{}:not-persisted",
                    entry.source_blocker_id
                ),
                denial_receipt_schema_version: DENIAL_RECEIPT_SCHEMA_VERSION,
                denial_receipt_idempotency_key: format!(
                    "controlled-live-evidence-receipt-store.local-evidence-acceptance-recording-denial-receipt.idempotency.{}",
                    entry.source_blocker_id
                ),
                ...
                source_denial_receipt_id_attached: entry.denial_receipt_projected,
                recording_denial_reason_projected: true,
                recording_precondition_missing: entry.recording_precondition_missing,
                acceptance_source_recording_disabled: !entry.acceptance_source_recording_allowed,
                acceptance_source_recording_allowed: false,
                acceptance_source_recorded: false,
                acceptance_source_persisted: false,
                denial_receipt_persistence_allowed: false,
...
impl ControlledLiveEvidenceReceiptStoreLocalEvidenceAcceptanceRecordingDenialReceiptReadbackWithoutPersistenceSideEffects {
...
mod tests {
    ...
    #[test]
    fn local_evidence_acceptance_recording_denial_receipt_projects_all_entries() {
        let report =
        ...
        assert_eq!(report.source_acceptance_source_record_id_attached_count, 7);
        assert_eq!(report.source_denial_receipt_id_attached_count, 7);
        assert_eq!(report.recording_denial_reason_projected_count, 7);
        assert!(report.local_evidence_acceptance_recording_denial_receipt_readback_ready);
    }

    #[test]
    fn local_evidence_acceptance_recording_denial_receipt_keeps_persistence_closed() {
        let report =
            controlled_live_evidence_receipt_store_local_evidence_acceptance_recording_denial_receipt_readback_without_persistence_report();
        ...
        assert_eq!(report.acceptance_source_recording_disabled_count, 7);
    ...
    #[test]
    fn local_evidence_acceptance_recording_denial_receipt_entries_are_stable() {
        let report =
            controlled_live_evidence_receipt_store_local_evidence_acceptance_recording_denial_receipt_readback_without_persistence_report();
        ...
        assert!(report.entries.iter().any(|entry| entry.source_blocker_id
            ...
            && entry.denial_receipt_route
                == "readback://controlled-live/evidence-receipt-store/local-evidence-acceptance/recording-denial-receipts/dirty-worktree-boundary"
            && entry.denial_receipt_id
                == "local-evidence-acceptance-recording-denial-receipt:controlled-live-evidence-receipt-store:dirty_worktree_boundary:not-persisted"
            && entry.denial_receipt_idempotency_key
                == "controlled-live-evidence-receipt-store.local-evidence-acceptance-recording-denial-receipt.idempotency.dirty_worktree_boundary"));
