...
pub struct DeepTd8Td3RbackAckTd4TerminalDecisionPreviewReport {
    ...
    pub terminal_decision_surfaces: Vec<DeepTd8Td3RbackAckTd4TerminalDecisionItem>,
    pub non_promotion_denials: Vec<DeepTd8Td3RbackAckTd4TerminalDecisionItem>,
    pub authority_guards: Vec<DeepTd8Td3RbackAckTd4TerminalDecisionItem>,
    pub release_delivery_guards: Vec<DeepTd8Td3RbackAckTd4TerminalDecisionItem>,
    pub local_views: Vec<DeepTd8Td3RbackAckTd4TerminalDecisionItem>,
    pub invariants: Vec<DeepTd8Td3RbackAckTd4TerminalDecisionItem>,
    ...
    pub side_effects: DeepTd8Td3RbackAckTd4TerminalDecisionSideEffects,
}

#[derive(Debug, Clone, PartialEq, Eq, Serialize)]
pub struct DeepTd8Td3RbackAckTd4TerminalDecisionItem {
    pub id: String,
...
pub struct DeepTd8Td3RbackAckTd4TerminalDecisionSideEffects {
...
pub fn deep_td8_retack_td3_rcptret_rbackack_td_rcptret_rbackack_td_rcptret_rbackack_td_rcptret_rbackack_td_base()
-> String {
    let gate =
...
pub fn deep_td8_retack_td3_rcptret_rbackack_td_rcptret_rbackack_td_rcptret_rbackack_td_rcptret_rbackack_td_receipt_gate()
-> String {
    format!(
        "{}_receipt_preview_gate",
        deep_td8_retack_td3_rcptret_rbackack_td_rcptret_rbackack_td_rcptret_rbackack_td_rcptret_rbackack_td_base()
    )
}

pub fn hepta_work_graph_deep_td8_retack_td3_rcptret_rbackack_td_rcptret_rbackack_td_rcptret_rbackack_td_rcptret_rbackack_td_preview_report()
-> DeepTd8Td3RbackAckTd4TerminalDecisionPreviewReport {
    ...
    DeepTd8Td3RbackAckTd4TerminalDecisionPreviewReport {
        ...
        required_prior_gates:
            deep_td8_retack_td3_rcptret_rbackack_td_rcptret_rbackack_td_rcptret_rbackack_td_rcptret_rbackack_td_required_prior_gates(),
        ...
        recommended_next_gate:
            deep_td8_retack_td3_rcptret_rbackack_td_rcptret_rbackack_td_rcptret_rbackack_td_rcptret_rbackack_td_receipt_gate(),
        ready_for_terminal_decision_receipt_preview: true,
        ready_for_operator_acceptance: false,
        ready_for_live_persistence: false,
        side_effects: DeepTd8Td3RbackAckTd4TerminalDecisionSideEffects::none(),
    }
}

pub fn deep_td8_retack_td3_rcptret_rbackack_td_rcptret_rbackack_td_rcptret_rbackack_td_rcptret_rbackack_td_required_prior_gates()
-> Vec<String> {
    let mut gates =
        crate::deep_td8_retack_td3_rcptret_rbackack_td_rcptret_rbackack_td_rcptret_rbackack_td_rcptret_rbackack_replay_required_prior_gates();
    gates.push(crate::deep_td8_retack_td3_rcptret_rbackack_td_rcptret_rbackack_td_rcptret_rbackack_td_rcptret_rbackack_readback_ack_replay_gate());
    gates
}

pub fn deep_td8_retack_td3_rcptret_rbackack_td_rcptret_rbackack_td_rcptret_rbackack_td_rcptret_rbackack_td_surface_ids()
-> Vec<String> {
    (0..6)
        .map(|index| {
            format!("deep_td8_retack_td3_rcptret_rbackack_td_rcptret_rbackack_td_rcptret_rbackack_td_rcptret_rbackack_td_surface_{index}")
        })
        .collect()
}
...
fn terminal_decision_items(
    prefix: &str,
    count: usize,
) -> Vec<DeepTd8Td3RbackAckTd4TerminalDecisionItem> {
    let source_ids =
        deep_td8_retack_td3_rcptret_rbackack_td_rcptret_rbackack_td_rcptret_rbackack_td_rcptret_rbackack_td_surface_ids(
        );

    (0..count)
        .map(|index| DeepTd8Td3RbackAckTd4TerminalDecisionItem {
            id: format!(
                "deep_td8_retack_td3_rcptret_rbackack_td_rcptret_rbackack_td_rcptret_rbackack_td_rcptret_rbackack_td_{prefix}_{index}"
            ),
...
impl DeepTd8Td3RbackAckTd4TerminalDecisionSideEffects {
    pub fn none() -> Self {
        Self {
...
mod tests {
    ...
    #[test]
    fn work_graph_td3_rcptret_rbackack_td_requires_latest_ack_replay_gate() {
        let report = hepta_work_graph_deep_td8_retack_td3_rcptret_rbackack_td_rcptret_rbackack_td_rcptret_rbackack_td_rcptret_rbackack_td_preview_report();

        assert_eq!(
            report.required_prior_gates.last(),
            Some(
                &crate::deep_td8_retack_td3_rcptret_rbackack_td_rcptret_rbackack_td_rcptret_rbackack_td_rcptret_rbackack_readback_ack_replay_gate()
            )
        );
    }

    #[test]
    fn work_graph_td3_rcptret_rbackack_td_declares_local_terminal_surfaces() {
        let report = hepta_work_graph_deep_td8_retack_td3_rcptret_rbackack_td_rcptret_rbackack_td_rcptret_rbackack_td_rcptret_rbackack_td_preview_report();
    ...
    #[test]
    fn work_graph_td3_rcptret_rbackack_td_blocks_promotion_paths() {
        let report = hepta_work_graph_deep_td8_retack_td3_rcptret_rbackack_td_rcptret_rbackack_td_rcptret_rbackack_td_rcptret_rbackack_td_preview_report();
    ...
    #[test]
    fn work_graph_td3_rcptret_rbackack_td_keeps_authority_and_delivery_denied() {
        let report = hepta_work_graph_deep_td8_retack_td3_rcptret_rbackack_td_rcptret_rbackack_td_rcptret_rbackack_td_rcptret_rbackack_td_preview_report();
    ...
    #[test]
    fn work_graph_td3_rcptret_rbackack_td_points_to_receipt_gate() {
        let report = hepta_work_graph_deep_td8_retack_td3_rcptret_rbackack_td_rcptret_rbackack_td_rcptret_rbackack_td_rcptret_rbackack_td_preview_report();
    ...
    #[test]
    fn work_graph_td3_rcptret_rbackack_td_has_no_side_effects() {
        let report = hepta_work_graph_deep_td8_retack_td3_rcptret_rbackack_td_rcptret_rbackack_td_rcptret_rbackack_td_rcptret_rbackack_td_preview_report();
