...
pub struct DeepTd8RetAckTdRbackAckTdReceiptRetentionReadbackAckPreviewReport {
    ...
    pub acknowledgement_contracts: Vec<DeepTd8RetAckTdRbackAckTdReceiptRetentionReadbackAckItem>,
    pub non_acceptance_reasons: Vec<DeepTd8RetAckTdRbackAckTdReceiptRetentionReadbackAckItem>,
    pub recording_denials: Vec<DeepTd8RetAckTdRbackAckTdReceiptRetentionReadbackAckItem>,
    pub expiry_replay_guards: Vec<DeepTd8RetAckTdRbackAckTdReceiptRetentionReadbackAckItem>,
    pub local_views: Vec<DeepTd8RetAckTdRbackAckTdReceiptRetentionReadbackAckItem>,
    pub invariants: Vec<DeepTd8RetAckTdRbackAckTdReceiptRetentionReadbackAckItem>,
    ...
    pub side_effects: DeepTd8RetAckTdRbackAckTdReceiptRetentionReadbackAckSideEffects,
}

#[derive(Debug, Clone, PartialEq, Eq, Serialize)]
pub struct DeepTd8RetAckTdRbackAckTdReceiptRetentionReadbackAckItem {
    pub id: &'static str,
...
pub struct DeepTd8RetAckTdRbackAckTdReceiptRetentionReadbackAckSideEffects {
...
pub fn deep_td8_ret_ack_td_rback_ack_td_receipt_retention_readback_ack_replay_gate() -> String {
    format!(
...
pub fn hepta_work_graph_deep_td8_ret_ack_td_rback_ack_td_receipt_retention_readback_ack_preview_report()
-> DeepTd8RetAckTdRbackAckTdReceiptRetentionReadbackAckPreviewReport {
    ...
    let gate = crate::deep_td8_ret_ack_td_rback_ack_td_receipt_retention_readback_ack_gate();
    ...
    DeepTd8RetAckTdRbackAckTdReceiptRetentionReadbackAckPreviewReport {
        ...
        gate,
        preview_mode: "read_only_deep_td8_ret_ack_td_rback_ack_td_receipt_retention_readback_acknowledgement_preview_no_recording",
        ...
        required_prior_gates:
            deep_td8_ret_ack_td_rback_ack_td_receipt_retention_readback_ack_required_prior_gates(),
        ...
        recommended_next_gate:
            deep_td8_ret_ack_td_rback_ack_td_receipt_retention_readback_ack_replay_gate(),
        ready_for_acknowledgement_replay_idempotency_preview: true,
        ready_for_operator_acceptance: false,
        ready_for_live_persistence: false,
        side_effects: DeepTd8RetAckTdRbackAckTdReceiptRetentionReadbackAckSideEffects::none(),
    }
}

pub fn deep_td8_ret_ack_td_rback_ack_td_receipt_retention_readback_ack_required_prior_gates()
-> Vec<String> {
    let mut gates =
        crate::deep_td8_ret_ack_td_rback_ack_td_receipt_retention_readback_receipt_required_prior_gates();
    gates.push(crate::deep_td8_ret_ack_td_rback_ack_td_receipt_retention_readback_receipt_gate());
    gates
}

pub fn deep_td8_ret_ack_td_rback_ack_td_receipt_retention_readback_ack_ids() -> Vec<&'static str> {
    vec![
...
fn ack_items(
    prefix: &'static str,
    count: usize,
) -> Vec<DeepTd8RetAckTdRbackAckTdReceiptRetentionReadbackAckItem> {
    let receipt_ids = vec![
    ...
    (0..count)
        .map(
            |index| DeepTd8RetAckTdRbackAckTdReceiptRetentionReadbackAckItem {
...
impl DeepTd8RetAckTdRbackAckTdReceiptRetentionReadbackAckSideEffects {
    pub fn none() -> Self {
        Self {
...
mod tests {
    ...
    fn work_graph_deep_td8_ret_ack_td_readback_ack_requires_readback_receipt_gate() {
        let report =
            hepta_work_graph_deep_td8_ret_ack_td_rback_ack_td_receipt_retention_readback_ack_preview_report();

        assert_eq!(
            report.required_prior_gates.last(),
            Some(
                &crate::deep_td8_ret_ack_td_rback_ack_td_receipt_retention_readback_receipt_gate()
            )
        );
    }
