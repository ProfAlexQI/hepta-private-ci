...
pub struct DeepTd8RetAckTdReceiptRetentionReadbackAckReplayPreviewReport {
    ...
    pub replay_scenarios: Vec<DeepTd8RetAckTdReceiptRetentionReadbackAckReplayItem>,
    pub idempotency_guards: Vec<DeepTd8RetAckTdReceiptRetentionReadbackAckReplayItem>,
    pub replay_denials: Vec<DeepTd8RetAckTdReceiptRetentionReadbackAckReplayItem>,
    pub monotonicity_checks: Vec<DeepTd8RetAckTdReceiptRetentionReadbackAckReplayItem>,
    pub local_views: Vec<DeepTd8RetAckTdReceiptRetentionReadbackAckReplayItem>,
    pub invariants: Vec<DeepTd8RetAckTdReceiptRetentionReadbackAckReplayItem>,
    ...
    pub side_effects: DeepTd8RetAckTdReceiptRetentionReadbackAckReplaySideEffects,
}

#[derive(Debug, Clone, PartialEq, Eq, Serialize)]
pub struct DeepTd8RetAckTdReceiptRetentionReadbackAckReplayItem {
    pub id: &'static str,
...
pub struct DeepTd8RetAckTdReceiptRetentionReadbackAckReplaySideEffects {
...
pub fn deep_td8_ret_ack_td_receipt_retention_readback_ack_terminal_decision_gate() -> String {
    format!(
...
pub fn hepta_work_graph_deep_td8_ret_ack_td_receipt_retention_readback_ack_replay_preview_report()
-> DeepTd8RetAckTdReceiptRetentionReadbackAckReplayPreviewReport {
    ...
    let gate = crate::deep_td8_ret_ack_td_receipt_retention_readback_ack_replay_gate();
    ...
    DeepTd8RetAckTdReceiptRetentionReadbackAckReplayPreviewReport {
        ...
        gate,
        preview_mode: "read_only_deep_td8_ret_ack_td_receipt_retention_readback_acknowledgement_replay_idempotency_preview_no_replay_write",
        ...
        required_prior_gates:
            deep_td8_ret_ack_td_receipt_retention_readback_ack_replay_required_prior_gates(),
        replay_scenarios,
        idempotency_guards,
        replay_denials,
        monotonicity_checks,
        ...
        recommended_next_gate:
            deep_td8_ret_ack_td_receipt_retention_readback_ack_terminal_decision_gate(),
        ready_for_terminal_decision_non_promotion_preview: true,
        ready_for_operator_acceptance: false,
        ready_for_live_persistence: false,
        side_effects: DeepTd8RetAckTdReceiptRetentionReadbackAckReplaySideEffects::none(),
    }
}

pub fn deep_td8_ret_ack_td_receipt_retention_readback_ack_replay_required_prior_gates()
-> Vec<String> {
    let mut gates =
        crate::deep_td8_ret_ack_td_receipt_retention_readback_ack_required_prior_gates();
    gates.push(crate::deep_td8_ret_ack_td_receipt_retention_readback_ack_gate());
    gates
}
...
fn replay_items(
    prefix: &'static str,
    count: usize,
) -> Vec<DeepTd8RetAckTdReceiptRetentionReadbackAckReplayItem> {
    let ack_ids = crate::deep_td8_ret_ack_td_receipt_retention_readback_ack_ids();
    (0..count)
        .map(
            |index| DeepTd8RetAckTdReceiptRetentionReadbackAckReplayItem {
...
impl DeepTd8RetAckTdReceiptRetentionReadbackAckReplaySideEffects {
    pub fn none() -> Self {
        Self {
...
mod tests {
    ...
    fn work_graph_deep_td8_ret_ack_td_ack_replay_requires_acknowledgement_gate() {
        let report =
            hepta_work_graph_deep_td8_ret_ack_td_receipt_retention_readback_ack_replay_preview_report(
            );

        assert_eq!(
            report.required_prior_gates.last(),
            Some(&crate::deep_td8_ret_ack_td_receipt_retention_readback_ack_gate())
        );
    }
