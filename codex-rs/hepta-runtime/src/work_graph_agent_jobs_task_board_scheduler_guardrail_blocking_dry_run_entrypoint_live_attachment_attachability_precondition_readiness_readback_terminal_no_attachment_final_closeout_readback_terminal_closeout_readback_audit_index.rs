...
use crate::work_graph_agent_jobs_task_board_scheduler_guardrail_blocking_dry_run_entrypoint_live_attachment_attachability_precondition_readiness_readback_terminal_no_attachment_final_closeout_readback_terminal_closeout_readback::{
...
pub const WORK_GRAPH_AGENT_JOBS_TASK_BOARD_SCHEDULER_GUARDRAIL_BLOCKING_DRY_RUN_ENTRYPOINT_LIVE_ATTACHMENT_ATTACHABILITY_PRECONDITION_READINESS_READBACK_TERMINAL_NO_ATTACHMENT_FINAL_CLOSEOUT_READBACK_TERMINAL_CLOSEOUT_READBACK_AUDIT_INDEX_GATE:
    &str =
...
pub const WORK_GRAPH_AGENT_JOBS_TASK_BOARD_SCHEDULER_GUARDRAIL_BLOCKING_DRY_RUN_ENTRYPOINT_LIVE_ATTACHMENT_ATTACHABILITY_PRECONDITION_READINESS_READBACK_TERMINAL_NO_ATTACHMENT_FINAL_CLOSEOUT_READBACK_TERMINAL_CLOSEOUT_READBACK_AUDIT_INDEX_SCHEMA_VERSION:
    &str = "work_graph_agent_jobs_task_board_scheduler_guardrail_blocking_dry_run_entrypoint_live_attachment_attachability_precondition_readiness_readback_terminal_no_attachment_final_closeout_readback_terminal_closeout_readback_audit_index_v1";
pub const WORK_GRAPH_AGENT_JOBS_TASK_BOARD_SCHEDULER_GUARDRAIL_BLOCKING_DRY_RUN_ENTRYPOINT_LIVE_ATTACHMENT_ATTACHABILITY_PRECONDITION_READINESS_READBACK_TERMINAL_NO_ATTACHMENT_FINAL_CLOSEOUT_READBACK_TERMINAL_CLOSEOUT_READBACK_AUDIT_INDEX_RECOMMENDED_NEXT_GATE:
    &str =
...
pub struct WorkGraphAgentJobsTaskBoardSchedulerGuardrailBlockingDryRunEntrypointLiveAttachmentAttachabilityPreconditionReadinessReadbackTerminalNoAttachmentFinalCloseoutReadbackTerminalCloseoutReadbackAuditIndexReport {
    ...
    pub audit_index_scope:
        WorkGraphSchedulerGuardrailLiveAttachmentAttachabilityTerminalNoAttachmentFinalCloseoutReadbackTerminalCloseoutReadbackAuditIndexScopePreview,
    pub audit_index_entries:
        Vec<WorkGraphSchedulerGuardrailLiveAttachmentAttachabilityTerminalNoAttachmentFinalCloseoutReadbackTerminalCloseoutReadbackAuditIndexEntryPreview>,
    pub audit_index_blockers:
        Vec<WorkGraphSchedulerGuardrailLiveAttachmentAttachabilityTerminalNoAttachmentFinalCloseoutReadbackTerminalCloseoutReadbackAuditIndexBlockerPreview>,
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize)]
pub struct WorkGraphSchedulerGuardrailLiveAttachmentAttachabilityTerminalNoAttachmentFinalCloseoutReadbackTerminalCloseoutReadbackAuditIndexScopePreview
{
    pub id: &'static str,
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize)]
pub struct WorkGraphSchedulerGuardrailLiveAttachmentAttachabilityTerminalNoAttachmentFinalCloseoutReadbackTerminalCloseoutReadbackAuditIndexEntryPreview
{
    pub id: &'static str,
    pub stable_index_key: &'static str,
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize)]
pub struct WorkGraphSchedulerGuardrailLiveAttachmentAttachabilityTerminalNoAttachmentFinalCloseoutReadbackTerminalCloseoutReadbackAuditIndexBlockerPreview
{
    pub id: &'static str,
...
pub struct WorkGraphAgentJobsTaskBoardSchedulerGuardrailBlockingDryRunEntrypointLiveAttachmentAttachabilityPreconditionReadinessReadbackTerminalNoAttachmentFinalCloseoutReadbackTerminalCloseoutReadbackAuditIndexSideEffects
{
...
pub fn hepta_work_graph_agent_jobs_task_board_scheduler_guardrail_blocking_dry_run_entrypoint_live_attachment_attachability_precondition_readiness_readback_terminal_no_attachment_final_closeout_readback_terminal_closeout_readback_audit_index_report()
-> WorkGraphAgentJobsTaskBoardSchedulerGuardrailBlockingDryRunEntrypointLiveAttachmentAttachabilityPreconditionReadinessReadbackTerminalNoAttachmentFinalCloseoutReadbackTerminalCloseoutReadbackAuditIndexReport{
    let source =
        hepta_work_graph_agent_jobs_task_board_scheduler_guardrail_blocking_dry_run_entrypoint_live_attachment_attachability_precondition_readiness_readback_terminal_no_attachment_final_closeout_readback_terminal_closeout_readback_report();
    let audit_index_scope =
        work_graph_agent_jobs_task_board_scheduler_guardrail_blocking_dry_run_entrypoint_live_attachment_attachability_precondition_readiness_readback_terminal_no_attachment_final_closeout_readback_terminal_closeout_readback_audit_index_scope();
    let audit_index_entries =
        work_graph_agent_jobs_task_board_scheduler_guardrail_blocking_dry_run_entrypoint_live_attachment_attachability_precondition_readiness_readback_terminal_no_attachment_final_closeout_readback_terminal_closeout_readback_audit_index_entries();
    let audit_index_blockers = work_graph_agent_jobs_task_board_scheduler_guardrail_blocking_dry_run_entrypoint_live_attachment_attachability_precondition_readiness_readback_terminal_no_attachment_final_closeout_readback_terminal_closeout_readback_audit_index_blockers_from_source(
        source
            .readback_blockers
            .iter()
            .map(|blocker| (blocker.id, blocker.blocked_action)),
    );
    let mut required_prior_gates = vec![
        WORK_GRAPH_AGENT_JOBS_TASK_BOARD_SCHEDULER_GUARDRAIL_BLOCKING_DRY_RUN_ENTRYPOINT_LIVE_ATTACHMENT_ATTACHABILITY_PRECONDITION_READINESS_READBACK_TERMINAL_NO_ATTACHMENT_FINAL_CLOSEOUT_READBACK_TERMINAL_CLOSEOUT_READBACK_GATE,
    ];
    required_prior_gates.extend(source.required_prior_gates.iter().copied());
    let source_terminal_closeout_readback_side_effects_all_false = source.side_effects
    ...
    let source_terminal_closeout_readback_no_persistence_confirmed = source
        .terminal_closeout_readback_preconditions_complete
        && source.terminal_closeout_readback_visible
        && !source.terminal_closeout_readback_recorded
        && !source.terminal_closeout_readback_persisted
        && !source.terminal_closeout_readback_authoritative
        && !source.terminal_closeout_readback_accepted
        && source.source_terminal_closeout_visible
        && !source.source_terminal_closeout_recorded
        && !source.source_terminal_closeout_persisted
        && !source.source_terminal_closeout_authoritative
        && !source.source_terminal_closeout_accepted
        && !source.terminal_closeout_recording_allowed
        && !source.terminal_closeout_persistence_allowed
        && !source.terminal_closeout_acceptance_allowed
        && !source.work_graph_event_persistence_allowed
        && !source.projection_persistence_allowed
        && source_terminal_closeout_readback_side_effects_all_false;
    ...
    let source_terminal_closeout_readback_ready = source.gate
        ...
        && source.terminal_closeout_readback_preconditions_complete
        && source.readback_entry_count == 7
        && source.readback_blocker_count == 77
        && source.required_prior_gate_count == 30
    ...
    let source_terminal_closeout_readback_ready_for_audit_index =
        source_terminal_closeout_readback_ready
            && source.ready_for_terminal_closeout_readback_audit_index;
    ...
    let audit_index_blockers_complete = audit_index_blockers.len() == 80
    ...
    WorkGraphAgentJobsTaskBoardSchedulerGuardrailBlockingDryRunEntrypointLiveAttachmentAttachabilityPreconditionReadinessReadbackTerminalNoAttachmentFinalCloseoutReadbackTerminalCloseoutReadbackAuditIndexReport {
        ...
        schema_version:
            WORK_GRAPH_AGENT_JOBS_TASK_BOARD_SCHEDULER_GUARDRAIL_BLOCKING_DRY_RUN_ENTRYPOINT_LIVE_ATTACHMENT_ATTACHABILITY_PRECONDITION_READINESS_READBACK_TERMINAL_NO_ATTACHMENT_FINAL_CLOSEOUT_READBACK_TERMINAL_CLOSEOUT_READBACK_AUDIT_INDEX_SCHEMA_VERSION,
        preview_mode:
            "scheduler_guardrail_blocking_dry_run_entrypoint_live_attachment_attachability_terminal_no_attachment_final_closeout_readback_terminal_closeout_readback_audit_index_report_only",
        ...
        recommended_next_gate:
            WORK_GRAPH_AGENT_JOBS_TASK_BOARD_SCHEDULER_GUARDRAIL_BLOCKING_DRY_RUN_ENTRYPOINT_LIVE_ATTACHMENT_ATTACHABILITY_PRECONDITION_READINESS_READBACK_TERMINAL_NO_ATTACHMENT_FINAL_CLOSEOUT_READBACK_TERMINAL_CLOSEOUT_READBACK_AUDIT_INDEX_RECOMMENDED_NEXT_GATE,
        audit_index_scope_complete,
        audit_index_entries_complete,
        audit_index_blockers_complete,
        ...
        source_terminal_closeout_readback_visible: source.terminal_closeout_readback_visible,
        source_terminal_closeout_readback_recorded: source.terminal_closeout_readback_recorded,
        source_terminal_closeout_readback_persisted: source.terminal_closeout_readback_persisted,
        source_terminal_closeout_readback_authoritative: source.terminal_closeout_readback_authoritative,
        source_terminal_closeout_readback_accepted: source.terminal_closeout_readback_accepted,
        source_terminal_closeout_visible: source.source_terminal_closeout_visible,
        source_terminal_closeout_recorded: source.source_terminal_closeout_recorded,
        source_terminal_closeout_persisted: source.source_terminal_closeout_persisted,
        source_terminal_closeout_authoritative: source.source_terminal_closeout_authoritative,
        source_terminal_closeout_accepted: source.source_terminal_closeout_accepted,
        ...
        side_effects:
            WorkGraphAgentJobsTaskBoardSchedulerGuardrailBlockingDryRunEntrypointLiveAttachmentAttachabilityPreconditionReadinessReadbackTerminalNoAttachmentFinalCloseoutReadbackTerminalCloseoutReadbackAuditIndexSideEffects::none(),
    }
}

pub fn work_graph_agent_jobs_task_board_scheduler_guardrail_blocking_dry_run_entrypoint_live_attachment_attachability_precondition_readiness_readback_terminal_no_attachment_final_closeout_readback_terminal_closeout_readback_audit_index_scope()
-> WorkGraphSchedulerGuardrailLiveAttachmentAttachabilityTerminalNoAttachmentFinalCloseoutReadbackTerminalCloseoutReadbackAuditIndexScopePreview{
    WorkGraphSchedulerGuardrailLiveAttachmentAttachabilityTerminalNoAttachmentFinalCloseoutReadbackTerminalCloseoutReadbackAuditIndexScopePreview {
        id: "agent_jobs_task_board_scheduler_guardrail_live_attachment_attachability_terminal_no_attachment_final_closeout_readback_terminal_closeout_readback_audit_index_scope",
        source_surface_id:
            "work_graph_agent_jobs_task_board.scheduler_guardrail.live_attachment_attachability_terminal_no_attachment_final_closeout_readback_terminal_closeout_readback",
        index_mode:
            "live_attachment_attachability_terminal_no_attachment_final_closeout_readback_terminal_closeout_readback_audit_index_report_only",
        stable_index_key:
            "work_graph.agent_jobs_task_board.scheduler_guardrail.live_attachment.attachability_precondition_readiness.readback.terminal_no_attachment_final_closeout.readback.terminal_closeout.readback.audit_index",
        index_visible: true,
...
pub fn work_graph_agent_jobs_task_board_scheduler_guardrail_blocking_dry_run_entrypoint_live_attachment_attachability_precondition_readiness_readback_terminal_no_attachment_final_closeout_readback_terminal_closeout_readback_audit_index_entries()
-> Vec<WorkGraphSchedulerGuardrailLiveAttachmentAttachabilityTerminalNoAttachmentFinalCloseoutReadbackTerminalCloseoutReadbackAuditIndexEntryPreview>{
    vec![
        audit_index_entry(
            "terminal_no_attachment_final_closeout_readback_terminal_closeout_readback_scope_audit_index",
            "live_attachment_attachability_terminal_no_attachment_final_closeout_readback_terminal_closeout_readback.audit_index.scope",
            "agent_jobs_task_board_scheduler_guardrail_live_attachment_attachability_terminal_no_attachment_final_closeout_readback_terminal_closeout_readback_scope",
        ...
        audit_index_entry(
            ...
            "live_attachment_attachability_terminal_no_attachment_final_closeout_readback_terminal_closeout_readback.audit_index.entries",
        ...
        audit_index_entry(
            ...
            "live_attachment_attachability_terminal_no_attachment_final_closeout_readback_terminal_closeout_readback.audit_index.source_summary",
        ...
        audit_index_entry(
            ...
            "live_attachment_attachability_terminal_no_attachment_final_closeout_readback_terminal_closeout_readback.audit_index.blockers",
            "terminal_no_attachment_final_closeout_readback_terminal_closeout_blocker_inventory_readback",
            "blocker_inventory",
        ),
        audit_index_entry(
            "terminal_no_attachment_final_closeout_readback_terminal_closeout_prior_chain_audit_index",
            "live_attachment_attachability_terminal_no_attachment_final_closeout_readback_terminal_closeout_readback.audit_index.prior_chain",
        ...
        audit_index_entry(
            ...
            "live_attachment_attachability_terminal_no_attachment_final_closeout_readback_terminal_closeout_readback.audit_index.non_persistence_boundary",
        ...
        audit_index_entry(
            ...
            "live_attachment_attachability_terminal_no_attachment_final_closeout_readback_terminal_closeout_readback.audit_index.no_live_authority",
        ...
        audit_index_entry(
            ...
            "live_attachment_attachability_terminal_no_attachment_final_closeout_readback_terminal_closeout_readback.audit_index.branch_state",
        ...
        audit_index_entry(
            ...
            "live_attachment_attachability_terminal_no_attachment_final_closeout_readback_terminal_closeout_readback.audit_index.trace_evidence",
...
pub fn work_graph_agent_jobs_task_board_scheduler_guardrail_blocking_dry_run_entrypoint_live_attachment_attachability_precondition_readiness_readback_terminal_no_attachment_final_closeout_readback_terminal_closeout_readback_audit_index_blockers()
-> Vec<WorkGraphSchedulerGuardrailLiveAttachmentAttachabilityTerminalNoAttachmentFinalCloseoutReadbackTerminalCloseoutReadbackAuditIndexBlockerPreview>{
    let source_blockers =
        crate::work_graph_agent_jobs_task_board_scheduler_guardrail_blocking_dry_run_entrypoint_live_attachment_attachability_precondition_readiness_readback_terminal_no_attachment_final_closeout_readback_terminal_closeout_readback::work_graph_agent_jobs_task_board_scheduler_guardrail_blocking_dry_run_entrypoint_live_attachment_attachability_precondition_readiness_readback_terminal_no_attachment_final_closeout_readback_terminal_closeout_readback_blockers();
    work_graph_agent_jobs_task_board_scheduler_guardrail_blocking_dry_run_entrypoint_live_attachment_attachability_precondition_readiness_readback_terminal_no_attachment_final_closeout_readback_terminal_closeout_readback_audit_index_blockers_from_source(
        source_blockers
            .into_iter()
            .map(|blocker| (blocker.id, blocker.blocked_action)),
    )
...
fn work_graph_agent_jobs_task_board_scheduler_guardrail_blocking_dry_run_entrypoint_live_attachment_attachability_precondition_readiness_readback_terminal_no_attachment_final_closeout_readback_terminal_closeout_readback_audit_index_blockers_from_source<I>(
    source_blockers: I,
) -> Vec<WorkGraphSchedulerGuardrailLiveAttachmentAttachabilityTerminalNoAttachmentFinalCloseoutReadbackTerminalCloseoutReadbackAuditIndexBlockerPreview>
where
    I: IntoIterator<Item = (&'static str, &'static str)>,
{
    let mut blockers = vec![
        audit_index_blocker(
            "terminal_no_attachment_final_closeout_readback_terminal_closeout_readback_audit_index_record_blocked",
        ...
        audit_index_blocker(
            "terminal_no_attachment_final_closeout_readback_terminal_closeout_readback_audit_index_persistence_blocked",
        ...
        audit_index_blocker(
            "terminal_no_attachment_final_closeout_readback_terminal_closeout_readback_audit_index_acceptance_blocked",
    ...
    blockers.extend(
        source_blockers
            .into_iter()
            .map(|(id, blocked_action)| audit_index_blocker(id, blocked_action)),
    );
    blockers
}

pub fn work_graph_agent_jobs_task_board_scheduler_guardrail_blocking_dry_run_entrypoint_live_attachment_attachability_precondition_readiness_readback_terminal_no_attachment_final_closeout_readback_terminal_closeout_readback_audit_index_required_prior_gates()
-> Vec<&'static str> {
    let mut required_prior_gates = vec![
        WORK_GRAPH_AGENT_JOBS_TASK_BOARD_SCHEDULER_GUARDRAIL_BLOCKING_DRY_RUN_ENTRYPOINT_LIVE_ATTACHMENT_ATTACHABILITY_PRECONDITION_READINESS_READBACK_TERMINAL_NO_ATTACHMENT_FINAL_CLOSEOUT_READBACK_TERMINAL_CLOSEOUT_READBACK_GATE,
    ];
    required_prior_gates.extend(crate::work_graph_agent_jobs_task_board_scheduler_guardrail_blocking_dry_run_entrypoint_live_attachment_attachability_precondition_readiness_readback_terminal_no_attachment_final_closeout_readback_terminal_closeout_readback::work_graph_agent_jobs_task_board_scheduler_guardrail_blocking_dry_run_entrypoint_live_attachment_attachability_precondition_readiness_readback_terminal_no_attachment_final_closeout_readback_terminal_closeout_readback_required_prior_gates());
    required_prior_gates
}
...
) -> WorkGraphSchedulerGuardrailLiveAttachmentAttachabilityTerminalNoAttachmentFinalCloseoutReadbackTerminalCloseoutReadbackAuditIndexEntryPreview{
    WorkGraphSchedulerGuardrailLiveAttachmentAttachabilityTerminalNoAttachmentFinalCloseoutReadbackTerminalCloseoutReadbackAuditIndexEntryPreview {
        id,
        stable_index_key,
        source_readback_id,
...
) -> WorkGraphSchedulerGuardrailLiveAttachmentAttachabilityTerminalNoAttachmentFinalCloseoutReadbackTerminalCloseoutReadbackAuditIndexBlockerPreview{
    WorkGraphSchedulerGuardrailLiveAttachmentAttachabilityTerminalNoAttachmentFinalCloseoutReadbackTerminalCloseoutReadbackAuditIndexBlockerPreview {
        id,
        blocked_action,
        blocked: true,
        reason: "required before terminal closeout readback audit index can be recorded, accepted, enforced, or cut live",
        required_before_acceptance: true,
    }
}

impl WorkGraphAgentJobsTaskBoardSchedulerGuardrailBlockingDryRunEntrypointLiveAttachmentAttachabilityPreconditionReadinessReadbackTerminalNoAttachmentFinalCloseoutReadbackTerminalCloseoutReadbackAuditIndexSideEffects
{
...
mod tests {
    ...
    #[test]
    fn terminal_closeout_readback_audit_index_derives_from_readback() {
        let report =
        ...
        assert_eq!(report.source_readback_blocker_count, 77);
        assert_eq!(report.source_required_prior_gate_count, 30);
    ...
    #[test]
    fn terminal_closeout_readback_audit_index_is_visible_only() {
        let report =
            hepta_work_graph_agent_jobs_task_board_scheduler_guardrail_blocking_dry_run_entrypoint_live_attachment_attachability_precondition_readiness_readback_terminal_no_attachment_final_closeout_readback_terminal_closeout_readback_audit_index_report();
    ...
    #[test]
    fn terminal_closeout_readback_audit_index_blocks_live_paths() {
        let report =
            hepta_work_graph_agent_jobs_task_board_scheduler_guardrail_blocking_dry_run_entrypoint_live_attachment_attachability_precondition_readiness_readback_terminal_no_attachment_final_closeout_readback_terminal_closeout_readback_audit_index_report();
    ...
    #[test]
    fn terminal_closeout_readback_audit_index_links_priors_and_side_effects() {
        let report =
            hepta_work_graph_agent_jobs_task_board_scheduler_guardrail_blocking_dry_run_entrypoint_live_attachment_attachability_precondition_readiness_readback_terminal_no_attachment_final_closeout_readback_terminal_closeout_readback_audit_index_report();
        ...
        assert_eq!(
            ...
            work_graph_agent_jobs_task_board_scheduler_guardrail_blocking_dry_run_entrypoint_live_attachment_attachability_precondition_readiness_readback_terminal_no_attachment_final_closeout_readback_terminal_closeout_readback_audit_index_required_prior_gates()
        );
        assert_eq!(
