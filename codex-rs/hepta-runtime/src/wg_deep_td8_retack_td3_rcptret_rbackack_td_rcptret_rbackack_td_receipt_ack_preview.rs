...
pub struct DeepTd8Td3RbackAckTd2TerminalDecisionReceiptAckPreviewReport {
    ...
    pub acknowledgement_contracts: Vec<DeepTd8Td3RbackAckTd2TerminalDecisionReceiptAckItem>,
    pub non_acceptance_reasons: Vec<DeepTd8Td3RbackAckTd2TerminalDecisionReceiptAckItem>,
    pub recording_denials: Vec<DeepTd8Td3RbackAckTd2TerminalDecisionReceiptAckItem>,
    pub expiry_replay_guards: Vec<DeepTd8Td3RbackAckTd2TerminalDecisionReceiptAckItem>,
    pub local_views: Vec<DeepTd8Td3RbackAckTd2TerminalDecisionReceiptAckItem>,
    pub invariants: Vec<DeepTd8Td3RbackAckTd2TerminalDecisionReceiptAckItem>,
    ...
    pub side_effects: DeepTd8Td3RbackAckTd2TerminalDecisionReceiptAckSideEffects,
}

#[derive(Debug, Clone, PartialEq, Eq, Serialize)]
pub struct DeepTd8Td3RbackAckTd2TerminalDecisionReceiptAckItem {
    pub id: String,
...
pub struct DeepTd8Td3RbackAckTd2TerminalDecisionReceiptAckSideEffects {
...
pub fn deep_td8_retack_td3_rcptret_rbackack_td_rcptret_rbackack_td_receipt_ack_replay_gate()
-> String {
    format!(
        "{}_receipt_acknowledgement_replay_idempotency_preview_gate",
        crate::wg_deep_td8_retack_td3_rcptret_rbackack_td_rcptret_rbackack_td_preview::deep_td8_retack_td3_rcptret_rbackack_td_rcptret_rbackack_td_base()
    )
}

pub fn hepta_work_graph_deep_td8_retack_td3_rcptret_rbackack_td_rcptret_rbackack_td_receipt_ack_preview_report()
-> DeepTd8Td3RbackAckTd2TerminalDecisionReceiptAckPreviewReport {
    ...
    let gate = crate::deep_td8_retack_td3_rcptret_rbackack_td_rcptret_rbackack_td_receipt_acknowledgement_gate();
    ...
    DeepTd8Td3RbackAckTd2TerminalDecisionReceiptAckPreviewReport {
        ...
        gate,
        preview_mode: "read_only_deep_td8_td3_rbackack_td_receipt_retention_readback_ack_terminal_decision_receipt_acknowledgement_preview_no_recording",
        ...
        required_prior_gates:
            deep_td8_retack_td3_rcptret_rbackack_td_rcptret_rbackack_td_receipt_ack_required_prior_gates(),
        ...
        local_views,
        invariants,
        recommended_next_gate: deep_td8_retack_td3_rcptret_rbackack_td_rcptret_rbackack_td_receipt_ack_replay_gate(),
        ready_for_terminal_decision_receipt_acknowledgement_replay_preview: true,
        ready_for_operator_acceptance: false,
        ready_for_live_persistence: false,
        side_effects:
            DeepTd8Td3RbackAckTd2TerminalDecisionReceiptAckSideEffects::none(),
    }
}

pub fn deep_td8_retack_td3_rcptret_rbackack_td_rcptret_rbackack_td_receipt_ack_required_prior_gates()
-> Vec<String> {
    let mut gates = crate::deep_td8_retack_td3_rcptret_rbackack_td_rcptret_rbackack_td_receipt_required_prior_gates();
    gates.push(crate::deep_td8_retack_td3_rcptret_rbackack_td_rcptret_rbackack_td_receipt_gate());
    gates
}

pub fn deep_td8_retack_td3_rcptret_rbackack_td_rcptret_rbackack_td_receipt_ack_ids() -> Vec<String>
{
    (0..6)
        .map(|index| {
            format!(
                "deep_td8_retack_td3_rcptret_rbackack_td_rcptret_rbackack_td_receipt_ack_{index}"
            )
        })
        .collect()
}
...
fn ack_items(
    prefix: &str,
    count: usize,
) -> Vec<DeepTd8Td3RbackAckTd2TerminalDecisionReceiptAckItem> {
    let source_receipt_ids =
        crate::deep_td8_retack_td3_rcptret_rbackack_td_rcptret_rbackack_td_receipt_ids();

    (0..count)
        .map(
            |index| DeepTd8Td3RbackAckTd2TerminalDecisionReceiptAckItem {
                id: format!("deep_td8_retack_td3_rcptret_rbackack_td_rcptret_rbackack_td_receipt_ack_{prefix}_{index}"),
...
impl DeepTd8Td3RbackAckTd2TerminalDecisionReceiptAckSideEffects {
    pub fn none() -> Self {
        Self {
...
mod tests {
    ...
    fn work_graph_td3_rcptret_rbackack_td_receipt_ack_requires_receipt_gate() {
        let report =
            hepta_work_graph_deep_td8_retack_td3_rcptret_rbackack_td_rcptret_rbackack_td_receipt_ack_preview_report();

        assert_eq!(
            report.required_prior_gates.last(),
            Some(
                &crate::deep_td8_retack_td3_rcptret_rbackack_td_rcptret_rbackack_td_receipt_gate()
            )
        );
    }
    ...
    fn work_graph_td3_rcptret_rbackack_td_receipt_ack_points_to_replay_gate() {
        ...
        assert_eq!(
            ...
            deep_td8_retack_td3_rcptret_rbackack_td_rcptret_rbackack_td_receipt_ack_replay_gate()
        );
