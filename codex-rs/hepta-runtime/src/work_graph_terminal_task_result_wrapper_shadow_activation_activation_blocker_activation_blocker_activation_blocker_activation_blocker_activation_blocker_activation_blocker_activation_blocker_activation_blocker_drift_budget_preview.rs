...
pub const WORK_GRAPH_TERMINAL_TASK_RESULT_WRAPPER_SHADOW_ACTIVATION_ACTIVATION_BLOCKER_ACTIVATION_BLOCKER_ACTIVATION_BLOCKER_ACTIVATION_BLOCKER_ACTIVATION_BLOCKER_ACTIVATION_BLOCKER_ACTIVATION_BLOCKER_ACTIVATION_BLOCKER_DRIFT_BUDGET_PREVIEW_GATE:
    &str =
...
pub const WORK_GRAPH_TERMINAL_TASK_RESULT_WRAPPER_SHADOW_ACTIVATION_ACTIVATION_BLOCKER_ACTIVATION_BLOCKER_ACTIVATION_BLOCKER_ACTIVATION_BLOCKER_ACTIVATION_BLOCKER_ACTIVATION_BLOCKER_ACTIVATION_BLOCKER_ACTIVATION_BLOCKER_DRIFT_BUDGET_SCHEMA_VERSION:
    &str =
    "work_graph_terminal_task_result_wrapper_shadow_activation_activation_blocker_activation_blocker_activation_blocker_activation_blocker_activation_blocker_activation_blocker_activation_blocker_activation_blocker_drift_budget_preview_v1";
pub const WORK_GRAPH_TERMINAL_TASK_RESULT_WRAPPER_SHADOW_ACTIVATION_ACTIVATION_BLOCKER_ACTIVATION_BLOCKER_ACTIVATION_BLOCKER_ACTIVATION_BLOCKER_ACTIVATION_BLOCKER_ACTIVATION_BLOCKER_ACTIVATION_BLOCKER_ACTIVATION_BLOCKER_DRIFT_BUDGET_RECOMMENDED_NEXT_GATE:
    &str =
...
pub struct WorkGraphTerminalTaskResultWrapperShadowActivationActivationBlockerActivationBlockerActivationBlockerActivationBlockerActivationBlockerActivationBlockerActivationBlockerActivationBlockerDriftBudgetPreviewReport {
    ...
    pub drift_budgets:
        Vec<WorkGraphTaskResultWrapperShadowActivationActivationBlockerActivationBlockerActivationBlockerActivationBlockerActivationBlockerActivationBlockerActivationBlockerActivationBlockerDriftBudgetPreview>,
    pub operator_summaries:
        Vec<WorkGraphTaskResultWrapperShadowActivationActivationBlockerActivationBlockerActivationBlockerActivationBlockerActivationBlockerActivationBlockerActivationBlockerActivationBlockerDriftOperatorSummaryPreview>,
    pub activation_preconditions:
        Vec<WorkGraphTaskResultWrapperShadowActivationActivationBlockerActivationBlockerActivationBlockerActivationBlockerActivationBlockerActivationBlockerActivationBlockerActivationBlockerDriftPreconditionPreview>,
    pub blockers:
        Vec<WorkGraphTaskResultWrapperShadowActivationActivationBlockerActivationBlockerActivationBlockerActivationBlockerActivationBlockerActivationBlockerActivationBlockerActivationBlockerDriftBudgetBlockerPreview>,
    pub required_prior_gates: Vec<&'static str>,
    pub recommended_next_gate: &'static str,
    pub ready_for_shadow_activation_activation_blocker_activation_blocker_activation_blocker_activation_blocker_activation_blocker_activation_blocker_activation_blocker_activation_blocker_promotion_precondition_preview: bool,
    ...
    pub side_effects:
        WorkGraphTerminalTaskResultWrapperShadowActivationActivationBlockerActivationBlockerActivationBlockerActivationBlockerActivationBlockerActivationBlockerActivationBlockerActivationBlockerDriftBudgetPreviewSideEffects,
}

#[derive(Debug, Clone, PartialEq, Eq, Serialize)]
pub struct WorkGraphTaskResultWrapperShadowActivationActivationBlockerActivationBlockerActivationBlockerActivationBlockerActivationBlockerActivationBlockerActivationBlockerActivationBlockerDriftBudgetPreview
{
    pub id: &'static str,
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize)]
pub struct WorkGraphTaskResultWrapperShadowActivationActivationBlockerActivationBlockerActivationBlockerActivationBlockerActivationBlockerActivationBlockerActivationBlockerActivationBlockerDriftOperatorSummaryPreview
{
    pub id: &'static str,
    pub drift_detector_id: &'static str,
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize)]
pub struct WorkGraphTaskResultWrapperShadowActivationActivationBlockerActivationBlockerActivationBlockerActivationBlockerActivationBlockerActivationBlockerActivationBlockerActivationBlockerDriftPreconditionPreview
{
    pub id: &'static str,
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize)]
pub struct WorkGraphTaskResultWrapperShadowActivationActivationBlockerActivationBlockerActivationBlockerActivationBlockerActivationBlockerActivationBlockerActivationBlockerActivationBlockerDriftBudgetBlockerPreview
{
    pub id: &'static str,
    pub severity: &'static str,
...
pub struct WorkGraphTerminalTaskResultWrapperShadowActivationActivationBlockerActivationBlockerActivationBlockerActivationBlockerActivationBlockerActivationBlockerActivationBlockerActivationBlockerDriftBudgetPreviewSideEffects
{
    pub filesystem_written: bool,
    pub shadow_activation_blocker_activation_blocker_activation_blocker_activation_blocker_activation_blocker_activation_blocker_activation_blocker_activation_blocker_drift_budget_persisted:
        bool,
...
pub fn hepta_work_graph_terminal_task_result_wrapper_shadow_activation_activation_blocker_activation_blocker_activation_blocker_activation_blocker_activation_blocker_activation_blocker_activation_blocker_activation_blocker_drift_budget_preview_report()
-> WorkGraphTerminalTaskResultWrapperShadowActivationActivationBlockerActivationBlockerActivationBlockerActivationBlockerActivationBlockerActivationBlockerActivationBlockerActivationBlockerDriftBudgetPreviewReport{
    let drift_budgets =
        work_graph_terminal_task_result_wrapper_shadow_activation_activation_blocker_activation_blocker_activation_blocker_activation_blocker_activation_blocker_activation_blocker_activation_blocker_activation_blocker_drift_budgets(
        );
    let operator_summaries =
        work_graph_terminal_task_result_wrapper_shadow_activation_activation_blocker_activation_blocker_activation_blocker_activation_blocker_activation_blocker_activation_blocker_activation_blocker_activation_blocker_drift_operator_summaries(
        );
    let activation_preconditions =
        work_graph_terminal_task_result_wrapper_shadow_activation_activation_blocker_activation_blocker_activation_blocker_activation_blocker_activation_blocker_activation_blocker_activation_blocker_activation_blocker_drift_preconditions();
    let blockers =
        work_graph_terminal_task_result_wrapper_shadow_activation_activation_blocker_activation_blocker_activation_blocker_activation_blocker_activation_blocker_activation_blocker_activation_blocker_activation_blocker_drift_budget_blockers(
        );
    let required_prior_gates =
        work_graph_terminal_task_result_wrapper_shadow_activation_activation_blocker_activation_blocker_activation_blocker_activation_blocker_activation_blocker_activation_blocker_activation_blocker_activation_blocker_drift_budget_required_prior_gates();
    ...
    WorkGraphTerminalTaskResultWrapperShadowActivationActivationBlockerActivationBlockerActivationBlockerActivationBlockerActivationBlockerActivationBlockerActivationBlockerActivationBlockerDriftBudgetPreviewReport {
        ...
        status: "ready",
        gate:
            WORK_GRAPH_TERMINAL_TASK_RESULT_WRAPPER_SHADOW_ACTIVATION_ACTIVATION_BLOCKER_ACTIVATION_BLOCKER_ACTIVATION_BLOCKER_ACTIVATION_BLOCKER_ACTIVATION_BLOCKER_ACTIVATION_BLOCKER_ACTIVATION_BLOCKER_ACTIVATION_BLOCKER_DRIFT_BUDGET_PREVIEW_GATE,
        schema_version:
            WORK_GRAPH_TERMINAL_TASK_RESULT_WRAPPER_SHADOW_ACTIVATION_ACTIVATION_BLOCKER_ACTIVATION_BLOCKER_ACTIVATION_BLOCKER_ACTIVATION_BLOCKER_ACTIVATION_BLOCKER_ACTIVATION_BLOCKER_ACTIVATION_BLOCKER_ACTIVATION_BLOCKER_DRIFT_BUDGET_SCHEMA_VERSION,
        preview_mode:
            "read_only_terminal_task_result_wrapper_shadow_activation_activation_blocker_activation_blocker_activation_blocker_activation_blocker_activation_blocker_activation_blocker_activation_blocker_activation_blocker_drift_budget_preview_no_execution",
        ...
        recommended_next_gate:
            WORK_GRAPH_TERMINAL_TASK_RESULT_WRAPPER_SHADOW_ACTIVATION_ACTIVATION_BLOCKER_ACTIVATION_BLOCKER_ACTIVATION_BLOCKER_ACTIVATION_BLOCKER_ACTIVATION_BLOCKER_ACTIVATION_BLOCKER_ACTIVATION_BLOCKER_ACTIVATION_BLOCKER_DRIFT_BUDGET_RECOMMENDED_NEXT_GATE,
        ...
        side_effects:
            WorkGraphTerminalTaskResultWrapperShadowActivationActivationBlockerActivationBlockerActivationBlockerActivationBlockerActivationBlockerActivationBlockerActivationBlockerActivationBlockerDriftBudgetPreviewSideEffects::none(),
    }
}

pub fn work_graph_terminal_task_result_wrapper_shadow_activation_activation_blocker_activation_blocker_activation_blocker_activation_blocker_activation_blocker_activation_blocker_activation_blocker_activation_blocker_drift_budgets()
-> Vec<
    WorkGraphTaskResultWrapperShadowActivationActivationBlockerActivationBlockerActivationBlockerActivationBlockerActivationBlockerActivationBlockerActivationBlockerActivationBlockerDriftBudgetPreview,
>{
    vec![
        drift_budget(
...
pub fn work_graph_terminal_task_result_wrapper_shadow_activation_activation_blocker_activation_blocker_activation_blocker_activation_blocker_activation_blocker_activation_blocker_activation_blocker_activation_blocker_drift_operator_summaries()
-> Vec<WorkGraphTaskResultWrapperShadowActivationActivationBlockerActivationBlockerActivationBlockerActivationBlockerActivationBlockerActivationBlockerActivationBlockerActivationBlockerDriftOperatorSummaryPreview>{
    vec![
        operator_summary(
            "shadow_activation_blocker_activation_blocker_surface_state_drift_operator_summary",
...
pub fn work_graph_terminal_task_result_wrapper_shadow_activation_activation_blocker_activation_blocker_activation_blocker_activation_blocker_activation_blocker_activation_blocker_activation_blocker_activation_blocker_drift_preconditions()
-> Vec<WorkGraphTaskResultWrapperShadowActivationActivationBlockerActivationBlockerActivationBlockerActivationBlockerActivationBlockerActivationBlockerActivationBlockerActivationBlockerDriftPreconditionPreview>{
    vec![
        activation_precondition(
            "all_shadow_activation_blocker_activation_blocker_activation_blocker_activation_blocker_activation_blocker_activation_blocker_activation_blocker_activation_blocker_drift_budgets_zero_tolerance",
            work_graph_terminal_task_result_wrapper_shadow_activation_activation_blocker_activation_blocker_activation_blocker_activation_blocker_activation_blocker_activation_blocker_activation_blocker_activation_blocker_drift_budget_ids(),
            work_graph_terminal_task_result_wrapper_shadow_activation_activation_blocker_activation_blocker_activation_blocker_activation_blocker_activation_blocker_activation_blocker_activation_blocker_activation_blocker_drift_operator_summary_ids(),
...
pub fn work_graph_terminal_task_result_wrapper_shadow_activation_activation_blocker_activation_blocker_activation_blocker_activation_blocker_activation_blocker_activation_blocker_activation_blocker_activation_blocker_drift_budget_blockers()
-> Vec<WorkGraphTaskResultWrapperShadowActivationActivationBlockerActivationBlockerActivationBlockerActivationBlockerActivationBlockerActivationBlockerActivationBlockerActivationBlockerDriftBudgetBlockerPreview>{
    vec![
        blocker(
...
pub fn work_graph_terminal_task_result_wrapper_shadow_activation_activation_blocker_activation_blocker_activation_blocker_activation_blocker_activation_blocker_activation_blocker_activation_blocker_activation_blocker_drift_budget_required_prior_gates()
-> Vec<&'static str> {
    vec![
...
fn operator_summary(
    ...
    drift_detector_id: &'static str,
    title: &'static str,
) -> WorkGraphTaskResultWrapperShadowActivationActivationBlockerActivationBlockerActivationBlockerActivationBlockerActivationBlockerActivationBlockerActivationBlockerActivationBlockerDriftOperatorSummaryPreview{
    WorkGraphTaskResultWrapperShadowActivationActivationBlockerActivationBlockerActivationBlockerActivationBlockerActivationBlockerActivationBlockerActivationBlockerActivationBlockerDriftOperatorSummaryPreview {
        id,
        drift_detector_id,
        title,
...
) -> WorkGraphTaskResultWrapperShadowActivationActivationBlockerActivationBlockerActivationBlockerActivationBlockerActivationBlockerActivationBlockerActivationBlockerActivationBlockerDriftPreconditionPreview{
    WorkGraphTaskResultWrapperShadowActivationActivationBlockerActivationBlockerActivationBlockerActivationBlockerActivationBlockerActivationBlockerActivationBlockerActivationBlockerDriftPreconditionPreview {
        id,
        required_budget_ids,
...
fn blocker(
    ...
    severity: &'static str,
    reason: &'static str,
) -> WorkGraphTaskResultWrapperShadowActivationActivationBlockerActivationBlockerActivationBlockerActivationBlockerActivationBlockerActivationBlockerActivationBlockerActivationBlockerDriftBudgetBlockerPreview{
    WorkGraphTaskResultWrapperShadowActivationActivationBlockerActivationBlockerActivationBlockerActivationBlockerActivationBlockerActivationBlockerActivationBlockerActivationBlockerDriftBudgetBlockerPreview {
        id,
        severity,
        reason,
...
fn work_graph_terminal_task_result_wrapper_shadow_activation_activation_blocker_activation_blocker_activation_blocker_activation_blocker_activation_blocker_activation_blocker_activation_blocker_activation_blocker_drift_budget_ids()
-> Vec<&'static str> {
    work_graph_terminal_task_result_wrapper_shadow_activation_activation_blocker_activation_blocker_activation_blocker_activation_blocker_activation_blocker_activation_blocker_activation_blocker_activation_blocker_drift_budgets()
        .iter()
...
fn work_graph_terminal_task_result_wrapper_shadow_activation_activation_blocker_activation_blocker_activation_blocker_activation_blocker_activation_blocker_activation_blocker_activation_blocker_activation_blocker_drift_operator_summary_ids()
-> Vec<&'static str> {
    work_graph_terminal_task_result_wrapper_shadow_activation_activation_blocker_activation_blocker_activation_blocker_activation_blocker_activation_blocker_activation_blocker_activation_blocker_activation_blocker_drift_operator_summaries()
        .iter()
...
mod tests {
    ...
    fn shadow_activation_blocker_activation_blocker_drift_budget_declares_zero_tolerance_budgets() {
        let report =
            hepta_work_graph_terminal_task_result_wrapper_shadow_activation_activation_blocker_activation_blocker_activation_blocker_activation_blocker_activation_blocker_activation_blocker_activation_blocker_activation_blocker_drift_budget_preview_report();
    ...
    fn shadow_activation_blocker_activation_blocker_drift_budget_blocks_activation_until_reviewed()
    {
        ...
        assert!(
            report.ready_for_shadow_activation_activation_blocker_activation_blocker_activation_blocker_activation_blocker_activation_blocker_activation_blocker_activation_blocker_activation_blocker_promotion_precondition_preview
        );
        assert_eq!(
    ...
    fn shadow_activation_blocker_activation_blocker_drift_budget_requires_readback_prior() {
        ...
        assert_eq!(report.required_prior_gate_count, 51);
        assert_eq!(
