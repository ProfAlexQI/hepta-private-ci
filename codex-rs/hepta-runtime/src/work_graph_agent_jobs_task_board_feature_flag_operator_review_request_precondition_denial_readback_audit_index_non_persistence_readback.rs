...
use crate::work_graph_agent_jobs_task_board_feature_flag_operator_review_request_precondition_denial_readback_audit_index::{
...
pub const WORK_GRAPH_AGENT_JOBS_TASK_BOARD_FEATURE_FLAG_OPERATOR_REVIEW_REQUEST_PRECONDITION_DENIAL_READBACK_AUDIT_INDEX_NON_PERSISTENCE_READBACK_GATE:
    &str =
...
pub const WORK_GRAPH_AGENT_JOBS_TASK_BOARD_FEATURE_FLAG_OPERATOR_REVIEW_REQUEST_PRECONDITION_DENIAL_READBACK_AUDIT_INDEX_NON_PERSISTENCE_READBACK_SCHEMA_VERSION:
    &str = "work_graph_agent_jobs_task_board_feature_flag_operator_review_request_precondition_denial_readback_audit_index_non_persistence_readback_v1";
pub const WORK_GRAPH_AGENT_JOBS_TASK_BOARD_FEATURE_FLAG_OPERATOR_REVIEW_REQUEST_PRECONDITION_DENIAL_READBACK_AUDIT_INDEX_NON_PERSISTENCE_READBACK_RECOMMENDED_NEXT_GATE:
    &str = "hepta_work_graph_agent_jobs_task_board_feature_flag_operator_review_request_precondition_terminal_no_request_closeout_gate";

#[derive(Debug, Clone, PartialEq, Eq, Serialize)]
pub struct WorkGraphAgentJobsTaskBoardFeatureFlagOperatorReviewRequestPreconditionDenialReadbackAuditIndexNonPersistenceReadbackReport {
    ...
    pub source_audit_index_preconditions_complete: bool,
    pub source_audit_index_no_record_persist_request_confirmed: bool,
    ...
    pub readback_scope:
        WorkGraphOperatorReviewRequestPreconditionDenialReadbackAuditIndexNonPersistenceReadbackScopePreview,
    pub readback_entries:
        Vec<WorkGraphOperatorReviewRequestPreconditionDenialReadbackAuditIndexNonPersistenceReadbackEntryPreview>,
    pub readback_blockers:
        Vec<WorkGraphOperatorReviewRequestPreconditionDenialReadbackAuditIndexNonPersistenceReadbackBlockerPreview>,
    pub required_prior_gates: Vec<&'static str>,
    pub recommended_next_gate: &'static str,
    pub readback_scope_non_persistent_complete: bool,
    pub readback_entries_non_persistent_complete: bool,
    ...
    pub ready_for_terminal_no_request_closeout: bool,
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize)]
pub struct WorkGraphOperatorReviewRequestPreconditionDenialReadbackAuditIndexNonPersistenceReadbackScopePreview
{
    pub id: &'static str,
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize)]
pub struct WorkGraphOperatorReviewRequestPreconditionDenialReadbackAuditIndexNonPersistenceReadbackEntryPreview
{
    pub id: &'static str,
    pub stable_readback_key: &'static str,
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize)]
pub struct WorkGraphOperatorReviewRequestPreconditionDenialReadbackAuditIndexNonPersistenceReadbackBlockerPreview
{
    pub id: &'static str,
...
pub struct WorkGraphAgentJobsTaskBoardFeatureFlagOperatorReviewRequestPreconditionDenialReadbackAuditIndexNonPersistenceReadbackSideEffects
{
...
pub fn hepta_work_graph_agent_jobs_task_board_feature_flag_operator_review_request_precondition_denial_readback_audit_index_non_persistence_readback_report()
-> WorkGraphAgentJobsTaskBoardFeatureFlagOperatorReviewRequestPreconditionDenialReadbackAuditIndexNonPersistenceReadbackReport{
    let source =
        hepta_work_graph_agent_jobs_task_board_feature_flag_operator_review_request_precondition_denial_readback_audit_index_report();
    let readback_scope =
        work_graph_agent_jobs_task_board_feature_flag_operator_review_request_precondition_denial_readback_audit_index_non_persistence_readback_scope();
    let readback_entries =
        work_graph_agent_jobs_task_board_feature_flag_operator_review_request_precondition_denial_readback_audit_index_non_persistence_readback_entries();
    let readback_blockers =
        work_graph_agent_jobs_task_board_feature_flag_operator_review_request_precondition_denial_readback_audit_index_non_persistence_readback_blockers();
    let required_prior_gates =
        work_graph_agent_jobs_task_board_feature_flag_operator_review_request_precondition_denial_readback_audit_index_non_persistence_readback_required_prior_gates();
    let source_audit_index_no_record_persist_request_confirmed = source.audit_index_visible
    ...
    let source_audit_index_no_authorization_confirmed = !source
        .audit_index_authorizes_operator_review_request
        && !source.audit_index_authorizes_operator_packet_send
        ...
        && !source.audit_index_authorizes_scheduler_enforcement
    ...
    let source_audit_index_ready = source.gate
        == WORK_GRAPH_AGENT_JOBS_TASK_BOARD_FEATURE_FLAG_OPERATOR_REVIEW_REQUEST_PRECONDITION_DENIAL_READBACK_AUDIT_INDEX_GATE
        && source.request_denial_audit_index_preconditions_complete
        && source.ready_for_non_persistence_readback
        && source_audit_index_no_record_persist_request_confirmed
        && source_audit_index_no_authorization_confirmed;
    let readback_scope_non_persistent_complete = readback_scope.audit_index_visible
    ...
    let readback_entries_non_persistent_complete = !readback_entries.is_empty()
    ...
    let non_persistence_readback_preconditions_complete = source_audit_index_ready
        && readback_scope_non_persistent_complete
        && readback_entries_non_persistent_complete
    ...
    WorkGraphAgentJobsTaskBoardFeatureFlagOperatorReviewRequestPreconditionDenialReadbackAuditIndexNonPersistenceReadbackReport {
        ...
        runtime: "hepta",
        status: "ready",
        gate: WORK_GRAPH_AGENT_JOBS_TASK_BOARD_FEATURE_FLAG_OPERATOR_REVIEW_REQUEST_PRECONDITION_DENIAL_READBACK_AUDIT_INDEX_NON_PERSISTENCE_READBACK_GATE,
        schema_version:
            WORK_GRAPH_AGENT_JOBS_TASK_BOARD_FEATURE_FLAG_OPERATOR_REVIEW_REQUEST_PRECONDITION_DENIAL_READBACK_AUDIT_INDEX_NON_PERSISTENCE_READBACK_SCHEMA_VERSION,
        ...
        source_audit_index_preconditions_complete: source
            .request_denial_audit_index_preconditions_complete,
        source_audit_index_no_record_persist_request_confirmed,
        source_audit_index_no_authorization_confirmed,
        ...
        recommended_next_gate:
            WORK_GRAPH_AGENT_JOBS_TASK_BOARD_FEATURE_FLAG_OPERATOR_REVIEW_REQUEST_PRECONDITION_DENIAL_READBACK_AUDIT_INDEX_NON_PERSISTENCE_READBACK_RECOMMENDED_NEXT_GATE,
        readback_scope_non_persistent_complete,
        readback_entries_non_persistent_complete,
        readback_blockers_complete,
        ...
        ready_for_terminal_no_request_closeout: non_persistence_readback_preconditions_complete,
...
pub fn work_graph_agent_jobs_task_board_feature_flag_operator_review_request_precondition_denial_readback_audit_index_non_persistence_readback_scope()
-> WorkGraphOperatorReviewRequestPreconditionDenialReadbackAuditIndexNonPersistenceReadbackScopePreview
{
    WorkGraphOperatorReviewRequestPreconditionDenialReadbackAuditIndexNonPersistenceReadbackScopePreview {
...
pub fn work_graph_agent_jobs_task_board_feature_flag_operator_review_request_precondition_denial_readback_audit_index_non_persistence_readback_entries()
-> Vec<WorkGraphOperatorReviewRequestPreconditionDenialReadbackAuditIndexNonPersistenceReadbackEntryPreview>
{
    vec![
        readback_entry(
            "operator_review_request_denial_audit_index_surface_readback",
            "operator_review_request_denial_audit_index_visible_unrecorded",
        ...
        readback_entry(
            ...
            "operator_review_request_denial_audit_index_required_priors_visible",
            "nineteen_required_prior_gates_visible_but_not_persisted",
        ),
        readback_entry(
            "operator_review_request_denial_audit_index_blocker_readback",
            "operator_review_request_denial_audit_index_blockers_visible",
            "nineteen_blockers_visible_and_still_blocking",
        ),
        readback_entry(
            "operator_review_request_denial_audit_index_non_persistence_boundary_readback",
            "operator_review_request_denial_audit_index_non_persistence_boundary",
        ...
        readback_entry(
            ...
            "operator_review_request_denial_audit_index_no_request_boundary",
            "audit_index_does_not_request_operator_review_or_acceptance",
        ),
    ]
}

pub fn work_graph_agent_jobs_task_board_feature_flag_operator_review_request_precondition_denial_readback_audit_index_non_persistence_readback_blockers()
-> Vec<WorkGraphOperatorReviewRequestPreconditionDenialReadbackAuditIndexNonPersistenceReadbackBlockerPreview>
{
    vec![
        readback_blocker(
...
pub fn work_graph_agent_jobs_task_board_feature_flag_operator_review_request_precondition_denial_readback_audit_index_non_persistence_readback_required_prior_gates()
-> Vec<&'static str> {
    vec![
        WORK_GRAPH_AGENT_JOBS_TASK_BOARD_FEATURE_FLAG_OPERATOR_REVIEW_REQUEST_PRECONDITION_DENIAL_READBACK_AUDIT_INDEX_GATE,
...
) -> WorkGraphOperatorReviewRequestPreconditionDenialReadbackAuditIndexNonPersistenceReadbackEntryPreview{
    WorkGraphOperatorReviewRequestPreconditionDenialReadbackAuditIndexNonPersistenceReadbackEntryPreview {
        id,
        stable_readback_key,
        observed_state,
...
) -> WorkGraphOperatorReviewRequestPreconditionDenialReadbackAuditIndexNonPersistenceReadbackBlockerPreview{
    WorkGraphOperatorReviewRequestPreconditionDenialReadbackAuditIndexNonPersistenceReadbackBlockerPreview {
        id,
        blocked_action,
        blocked: true,
        reason:
            "operator review request denial audit index non-persistence readback cannot authorize this action",
    }
}
...
mod tests {
    ...
    #[test]
    fn request_denial_audit_index_readback_derives_from_audit_index() {
        let report =
        ...
        assert_eq!(report.source_audit_index_blocker_count, 19);
        assert_eq!(report.source_required_prior_gate_count, 19);
        assert!(report.source_audit_index_preconditions_complete);
        assert!(report.source_audit_index_no_record_persist_request_confirmed);
        ...
        assert_eq!(report.readback_blocker_count, 20);
    }

    #[test]
    fn request_denial_audit_index_readback_entries_are_visible_only() {
        let report =
            hepta_work_graph_agent_jobs_task_board_feature_flag_operator_review_request_precondition_denial_readback_audit_index_non_persistence_readback_report();

        assert_eq!(
            report.readback_scope.readback_mode,
            "operator_review_request_precondition_denial_readback_audit_index_non_persistence_readback_only"
        );
        ...
        assert!(report.readback_scope_non_persistent_complete);
        ...
        assert!(report.readback_entries_non_persistent_complete);
    }

    #[test]
    fn request_denial_audit_index_readback_blocks_request_and_live_paths() {
        let report =
            hepta_work_graph_agent_jobs_task_board_feature_flag_operator_review_request_precondition_denial_readback_audit_index_non_persistence_readback_report();
        ...
        assert!(report.ready_for_terminal_no_request_closeout);
    ...
    #[test]
    fn request_denial_audit_index_readback_has_no_side_effects() {
        let report =
            hepta_work_graph_agent_jobs_task_board_feature_flag_operator_review_request_precondition_denial_readback_audit_index_non_persistence_readback_report();
