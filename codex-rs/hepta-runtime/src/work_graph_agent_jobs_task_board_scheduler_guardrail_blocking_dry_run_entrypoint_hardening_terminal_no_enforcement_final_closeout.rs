...
pub struct WorkGraphAgentJobsTaskBoardSchedulerGuardrailBlockingDryRunEntrypointHardeningTerminalNoEnforcementFinalCloseoutReport {
    ...
    pub terminal_no_enforcement_final_closeout_preconditions_complete: bool,
...
-> WorkGraphAgentJobsTaskBoardSchedulerGuardrailBlockingDryRunEntrypointHardeningTerminalNoEnforcementFinalCloseoutReport{
    ...
    let source_non_persistence_readback_ready = source.gate
        ...
        && source.readback_blocker_count == 33
        && source.required_prior_gate_count == 14
    ...
    let source_non_persistence_readback_ready_for_terminal_closeout =
        source_non_persistence_readback_ready
            && source.ready_for_terminal_no_enforcement_final_closeout;
    ...
    let final_closeout_blockers_complete = final_closeout_blockers.len() == 36
        && final_closeout_blockers
            .iter()
            .all(|blocker| blocker.blocked);
    let terminal_no_enforcement_final_closeout_preconditions_complete =
        source_non_persistence_readback_ready
            && source_non_persistence_readback_no_persistence_confirmed
            && source_non_persistence_readback_no_live_confirmed
    ...
    WorkGraphAgentJobsTaskBoardSchedulerGuardrailBlockingDryRunEntrypointHardeningTerminalNoEnforcementFinalCloseoutReport {
        ...
        terminal_no_enforcement_branch_closed:
            terminal_no_enforcement_final_closeout_preconditions_complete,
...
-> Vec<&'static str> {
    ...
    required_prior_gates.extend(crate::work_graph_agent_jobs_task_board_scheduler_guardrail_blocking_dry_run_entrypoint_hardening_readback_audit_index_non_persistence_readback::work_graph_agent_jobs_task_board_scheduler_guardrail_blocking_dry_run_entrypoint_hardening_readback_audit_index_non_persistence_readback_required_prior_gates());
    required_prior_gates
}
...
mod tests {
    ...
    fn scheduler_guardrail_terminal_no_enforcement_final_closeout_blocks_live_paths() {
        ...
        assert!(report.terminal_no_enforcement_final_closeout_preconditions_complete);
