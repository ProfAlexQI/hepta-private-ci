...
use crate::controlled_live_evidence_receipt_store_recording_denial_receipt_readback_without_persistence::controlled_live_evidence_receipt_store_recording_denial_receipt_readback_without_persistence_report;
use std::sync::OnceLock;

use serde::Serialize;

pub const CONTROLLED_LIVE_EVIDENCE_RECEIPT_STORE_RECORDING_DENIAL_RECEIPT_RETENTION_REPLAY_READBACK_WITHOUT_PERSISTENCE_GATE:
    &str = "controlled_live_evidence_receipt_store_recording_denial_receipt_retention_replay_readback_without_persistence_gate";
pub const CONTROLLED_LIVE_EVIDENCE_RECEIPT_STORE_RECORDING_DENIAL_RECEIPT_RETENTION_REPLAY_READBACK_WITHOUT_PERSISTENCE_SCHEMA_VERSION:
    &str = "controlled_live_evidence_receipt_store_recording_denial_receipt_retention_replay_readback_without_persistence_v1";
pub const CONTROLLED_LIVE_EVIDENCE_RECEIPT_STORE_RECORDING_DENIAL_RECEIPT_RETENTION_REPLAY_READBACK_WITHOUT_PERSISTENCE_RECOMMENDED_NEXT_GATE:
    &str = "controlled_live_evidence_receipt_store_positive_acceptance_preconditions_readback_without_acceptance";

const RETENTION_REPLAY_COLLECTION_ID: &str =
    "controlled-live-evidence-receipt-store-recording-denial-retention-replay";
const RETENTION_REPLAY_COLLECTION_ROUTE: &str =
    "readback://controlled-live/evidence-receipt-store/recording-denial-receipts/retention-replay";

#[derive(Debug, Clone, PartialEq, Eq, Serialize)]
pub struct ControlledLiveEvidenceReceiptStoreRecordingDenialReceiptRetentionReplayReadbackWithoutPersistenceReport {
    ...
    pub entries: Vec<
        ControlledLiveEvidenceReceiptStoreRecordingDenialReceiptRetentionReplayReadbackWithoutPersistenceEntry,
    >,
    pub recommended_next_gate: &'static str,
    pub side_effects:
        ControlledLiveEvidenceReceiptStoreRecordingDenialReceiptRetentionReplayReadbackWithoutPersistenceSideEffects,
}

#[derive(Debug, Clone, PartialEq, Eq, Serialize)]
pub struct ControlledLiveEvidenceReceiptStoreRecordingDenialReceiptRetentionReplayReadbackWithoutPersistenceEntry
{
    pub id: String,
...
pub struct ControlledLiveEvidenceReceiptStoreRecordingDenialReceiptRetentionReplayReadbackWithoutPersistenceSideEffects
{
    pub retention_policy_persisted: bool,
    pub replay_index_written: bool,
    pub expiry_enforced: bool,
...
pub fn controlled_live_evidence_receipt_store_recording_denial_receipt_retention_replay_readback_without_persistence_report()
-> ControlledLiveEvidenceReceiptStoreRecordingDenialReceiptRetentionReplayReadbackWithoutPersistenceReport{
    static REPORT: OnceLock<ControlledLiveEvidenceReceiptStoreRecordingDenialReceiptRetentionReplayReadbackWithoutPersistenceReport> = OnceLock::new();
    REPORT
        .get_or_init(|| {
    let source =
        controlled_live_evidence_receipt_store_recording_denial_receipt_readback_without_persistence_report();
    let entries =
        controlled_live_evidence_receipt_store_recording_denial_receipt_retention_replay_readback_without_persistence_entries();
    ...
    let retention_replay_readback_ready = source.recording_denial_receipt_readback_ready
        ...
        && entries.iter().all(|entry| {
            entry.observed_state
                == "recording_denial_receipt_retention_replay_projected_without_persistence"
    ...
    ControlledLiveEvidenceReceiptStoreRecordingDenialReceiptRetentionReplayReadbackWithoutPersistenceReport {
        ...
        gate:
            CONTROLLED_LIVE_EVIDENCE_RECEIPT_STORE_RECORDING_DENIAL_RECEIPT_RETENTION_REPLAY_READBACK_WITHOUT_PERSISTENCE_GATE,
        schema_version:
            CONTROLLED_LIVE_EVIDENCE_RECEIPT_STORE_RECORDING_DENIAL_RECEIPT_RETENTION_REPLAY_READBACK_WITHOUT_PERSISTENCE_SCHEMA_VERSION,
        plugin_id: "hepta-system@hepta-local",
        source_recording_denial_receipt_readback_ready: source.recording_denial_receipt_readback_ready,
        ...
        recommended_next_gate:
            CONTROLLED_LIVE_EVIDENCE_RECEIPT_STORE_RECORDING_DENIAL_RECEIPT_RETENTION_REPLAY_READBACK_WITHOUT_PERSISTENCE_RECOMMENDED_NEXT_GATE,
        side_effects:
            ControlledLiveEvidenceReceiptStoreRecordingDenialReceiptRetentionReplayReadbackWithoutPersistenceSideEffects::none(),
    }
        })
        .clone()
}

pub fn controlled_live_evidence_receipt_store_recording_denial_receipt_retention_replay_readback_without_persistence_entries()
-> Vec<
    ControlledLiveEvidenceReceiptStoreRecordingDenialReceiptRetentionReplayReadbackWithoutPersistenceEntry,
>{
    controlled_live_evidence_receipt_store_recording_denial_receipt_readback_without_persistence_report()
        ...
        .map(|entry| {
            ...
            ControlledLiveEvidenceReceiptStoreRecordingDenialReceiptRetentionReplayReadbackWithoutPersistenceEntry {
                id: format!(
                    "evidence_receipt_store_recording_denial_receipt_retention_replay_without_persistence_{}",
                ...
                retention_policy_id: format!(
                    "retention-policy:controlled-live-evidence-receipt-store-recording-denial:{}",
                    entry.source_blocker_id
                ),
                retention_policy_route: format!("{RETENTION_REPLAY_COLLECTION_ROUTE}/retention/{hyphenated}"),
                expiry_guard_id: format!(
                    "expiry-guard:controlled-live-evidence-receipt-store-recording-denial:{}",
                    entry.source_blocker_id
                ),
                replay_key: format!(
                    "replay-key:controlled-live-evidence-receipt-store-recording-denial:{}",
                    entry.source_blocker_id
                ),
                replay_idempotency_key: format!(
                    "controlled-live-evidence-receipt-store.recording-denial-retention-replay.idempotency.{}",
                    entry.source_blocker_id
                ),
                ...
                garbage_collection_denial_id: format!(
                    "garbage-collection-denial:controlled-live-evidence-receipt-store-recording-denial:{}",
                    entry.source_blocker_id
                ),
                supersession_guard_id: format!(
                    "supersession-guard:controlled-live-evidence-receipt-store-recording-denial:{}",
                    entry.source_blocker_id
                ),
                zero_effect_digest: format!(
                    "sha256:controlled-live-evidence-receipt-store-recording-denial-retention-replay-zero-effect:{}",
                    entry.source_blocker_id
                ),
...
impl ControlledLiveEvidenceReceiptStoreRecordingDenialReceiptRetentionReplayReadbackWithoutPersistenceSideEffects {
...
mod tests {
    ...
    #[test]
    fn retention_replay_projects_all_entries_without_persistence() {
        let report =
    ...
    #[test]
    fn retention_replay_keeps_all_writes_closed() {
        let report =
            controlled_live_evidence_receipt_store_recording_denial_receipt_retention_replay_readback_without_persistence_report();
    ...
    #[test]
    fn retention_replay_entries_are_stable_and_unpersisted() {
        let report =
            controlled_live_evidence_receipt_store_recording_denial_receipt_retention_replay_readback_without_persistence_report();
        ...
        assert!(report.entries.iter().any(|entry| entry.source_blocker_id
            ...
            && entry.retention_policy_route
                == "readback://controlled-live/evidence-receipt-store/recording-denial-receipts/retention-replay/retention/dirty-worktree-boundary"
            && entry.replay_idempotency_key
                == "controlled-live-evidence-receipt-store.recording-denial-retention-replay.idempotency.dirty_worktree_boundary"));
