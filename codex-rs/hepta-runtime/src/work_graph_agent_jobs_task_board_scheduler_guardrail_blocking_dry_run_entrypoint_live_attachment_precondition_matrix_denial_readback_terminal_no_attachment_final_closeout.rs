...
use crate::work_graph_agent_jobs_task_board_scheduler_guardrail_blocking_dry_run_entrypoint_live_attachment_precondition_matrix_denial_readback_audit_index_non_persistence_readback::{
    WORK_GRAPH_AGENT_JOBS_TASK_BOARD_SCHEDULER_GUARDRAIL_BLOCKING_DRY_RUN_ENTRYPOINT_LIVE_ATTACHMENT_PRECONDITION_MATRIX_DENIAL_READBACK_AUDIT_INDEX_NON_PERSISTENCE_READBACK_GATE,
    WorkGraphAgentJobsTaskBoardSchedulerGuardrailBlockingDryRunEntrypointLiveAttachmentPreconditionMatrixDenialReadbackAuditIndexNonPersistenceReadbackSideEffects,
    hepta_work_graph_agent_jobs_task_board_scheduler_guardrail_blocking_dry_run_entrypoint_live_attachment_precondition_matrix_denial_readback_audit_index_non_persistence_readback_report,
};

pub const WORK_GRAPH_AGENT_JOBS_TASK_BOARD_SCHEDULER_GUARDRAIL_BLOCKING_DRY_RUN_ENTRYPOINT_LIVE_ATTACHMENT_PRECONDITION_MATRIX_DENIAL_READBACK_TERMINAL_NO_ATTACHMENT_FINAL_CLOSEOUT_GATE:
    &str =
    "hepta_work_graph_agent_jobs_task_board_scheduler_guardrail_blocking_dry_run_entrypoint_live_attachment_precondition_matrix_denial_readback_terminal_no_attachment_final_closeout_gate";
pub const WORK_GRAPH_AGENT_JOBS_TASK_BOARD_SCHEDULER_GUARDRAIL_BLOCKING_DRY_RUN_ENTRYPOINT_LIVE_ATTACHMENT_PRECONDITION_MATRIX_DENIAL_READBACK_TERMINAL_NO_ATTACHMENT_FINAL_CLOSEOUT_SCHEMA_VERSION:
    &str = "work_graph_agent_jobs_task_board_scheduler_guardrail_blocking_dry_run_entrypoint_live_attachment_precondition_matrix_denial_readback_terminal_no_attachment_final_closeout_v1";
pub const WORK_GRAPH_AGENT_JOBS_TASK_BOARD_SCHEDULER_GUARDRAIL_BLOCKING_DRY_RUN_ENTRYPOINT_LIVE_ATTACHMENT_PRECONDITION_MATRIX_DENIAL_READBACK_TERMINAL_NO_ATTACHMENT_FINAL_CLOSEOUT_RECOMMENDED_NEXT_GATE:
    &str =
...
pub struct WorkGraphAgentJobsTaskBoardSchedulerGuardrailBlockingDryRunEntrypointLiveAttachmentPreconditionMatrixDenialReadbackTerminalNoAttachmentFinalCloseoutReport {
    ...
    pub final_closeout_scope:
        WorkGraphSchedulerGuardrailLiveAttachmentPreconditionMatrixDenialReadbackTerminalNoAttachmentFinalCloseoutScopePreview,
    pub final_closeout_entries:
        Vec<WorkGraphSchedulerGuardrailLiveAttachmentPreconditionMatrixDenialReadbackTerminalNoAttachmentFinalCloseoutEntryPreview>,
    pub final_closeout_blockers:
        Vec<WorkGraphSchedulerGuardrailLiveAttachmentPreconditionMatrixDenialReadbackTerminalNoAttachmentFinalCloseoutBlockerPreview>,
    ...
    pub ready_for_live_attachment_attachability_precondition_readiness: bool,
    pub ready_for_live_attachment: bool,
    pub ready_for_live_execution: bool,
    pub side_effects:
        WorkGraphAgentJobsTaskBoardSchedulerGuardrailBlockingDryRunEntrypointLiveAttachmentPreconditionMatrixDenialReadbackTerminalNoAttachmentFinalCloseoutSideEffects,
}

#[derive(Debug, Clone, PartialEq, Eq, Serialize)]
pub struct WorkGraphSchedulerGuardrailLiveAttachmentPreconditionMatrixDenialReadbackTerminalNoAttachmentFinalCloseoutScopePreview
{
    pub id: &'static str,
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize)]
pub struct WorkGraphSchedulerGuardrailLiveAttachmentPreconditionMatrixDenialReadbackTerminalNoAttachmentFinalCloseoutEntryPreview
{
    pub id: &'static str,
    pub stable_closeout_key: &'static str,
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize)]
pub struct WorkGraphSchedulerGuardrailLiveAttachmentPreconditionMatrixDenialReadbackTerminalNoAttachmentFinalCloseoutBlockerPreview
{
    pub id: &'static str,
...
pub struct WorkGraphAgentJobsTaskBoardSchedulerGuardrailBlockingDryRunEntrypointLiveAttachmentPreconditionMatrixDenialReadbackTerminalNoAttachmentFinalCloseoutSideEffects
{
...
pub fn hepta_work_graph_agent_jobs_task_board_scheduler_guardrail_blocking_dry_run_entrypoint_live_attachment_precondition_matrix_denial_readback_terminal_no_attachment_final_closeout_report()
-> WorkGraphAgentJobsTaskBoardSchedulerGuardrailBlockingDryRunEntrypointLiveAttachmentPreconditionMatrixDenialReadbackTerminalNoAttachmentFinalCloseoutReport{
    let source =
        hepta_work_graph_agent_jobs_task_board_scheduler_guardrail_blocking_dry_run_entrypoint_live_attachment_precondition_matrix_denial_readback_audit_index_non_persistence_readback_report();
    let final_closeout_scope =
        work_graph_agent_jobs_task_board_scheduler_guardrail_blocking_dry_run_entrypoint_live_attachment_precondition_matrix_denial_readback_terminal_no_attachment_final_closeout_scope();
    let final_closeout_entries =
        work_graph_agent_jobs_task_board_scheduler_guardrail_blocking_dry_run_entrypoint_live_attachment_precondition_matrix_denial_readback_terminal_no_attachment_final_closeout_entries();
    let final_closeout_blockers =
        work_graph_agent_jobs_task_board_scheduler_guardrail_blocking_dry_run_entrypoint_live_attachment_precondition_matrix_denial_readback_terminal_no_attachment_final_closeout_blockers();
    ...
    let source_non_persistence_readback_no_persistence_confirmed =
        source.source_audit_index_no_persistence_confirmed
            ...
            && !source.matrix_recording_allowed
            && !source.matrix_persistence_allowed
            && !source.work_graph_event_persistence_allowed
            && !source.projection_persistence_allowed
            && source.side_effects
                == WorkGraphAgentJobsTaskBoardSchedulerGuardrailBlockingDryRunEntrypointLiveAttachmentPreconditionMatrixDenialReadbackAuditIndexNonPersistenceReadbackSideEffects::none();
    ...
    let source_non_persistence_readback_ready = source.gate
        ...
        && source.readback_scope_visible_only_complete
        && source.readback_entries_visible_only_complete
        && source.readback_blockers_complete
        && source.non_persistence_readback_preconditions_complete
        && source.readback_entry_count == 6
        && source.readback_blocker_count == 42
        && source.required_prior_gate_count == 19
    ...
    let final_closeout_blockers_complete = final_closeout_blockers.len() == 45
    ...
    WorkGraphAgentJobsTaskBoardSchedulerGuardrailBlockingDryRunEntrypointLiveAttachmentPreconditionMatrixDenialReadbackTerminalNoAttachmentFinalCloseoutReport {
        ...
        schema_version:
            WORK_GRAPH_AGENT_JOBS_TASK_BOARD_SCHEDULER_GUARDRAIL_BLOCKING_DRY_RUN_ENTRYPOINT_LIVE_ATTACHMENT_PRECONDITION_MATRIX_DENIAL_READBACK_TERMINAL_NO_ATTACHMENT_FINAL_CLOSEOUT_SCHEMA_VERSION,
        preview_mode:
            "scheduler_guardrail_blocking_dry_run_entrypoint_live_attachment_precondition_matrix_denial_readback_terminal_no_attachment_final_closeout_report_only",
        ...
        recommended_next_gate:
            WORK_GRAPH_AGENT_JOBS_TASK_BOARD_SCHEDULER_GUARDRAIL_BLOCKING_DRY_RUN_ENTRYPOINT_LIVE_ATTACHMENT_PRECONDITION_MATRIX_DENIAL_READBACK_TERMINAL_NO_ATTACHMENT_FINAL_CLOSEOUT_RECOMMENDED_NEXT_GATE,
        ...
        ready_for_live_attachment_attachability_precondition_readiness:
            terminal_no_attachment_final_closeout_preconditions_complete,
        ready_for_live_attachment: false,
        ready_for_live_execution: false,
        side_effects:
            WorkGraphAgentJobsTaskBoardSchedulerGuardrailBlockingDryRunEntrypointLiveAttachmentPreconditionMatrixDenialReadbackTerminalNoAttachmentFinalCloseoutSideEffects::none(),
    }
}

pub fn work_graph_agent_jobs_task_board_scheduler_guardrail_blocking_dry_run_entrypoint_live_attachment_precondition_matrix_denial_readback_terminal_no_attachment_final_closeout_scope()
-> WorkGraphSchedulerGuardrailLiveAttachmentPreconditionMatrixDenialReadbackTerminalNoAttachmentFinalCloseoutScopePreview{
    WorkGraphSchedulerGuardrailLiveAttachmentPreconditionMatrixDenialReadbackTerminalNoAttachmentFinalCloseoutScopePreview {
        ...
        closeout_mode:
            "live_attachment_precondition_matrix_denial_readback_terminal_no_attachment_final_closeout_report_only",
        stable_closeout_key:
            "work_graph.agent_jobs_task_board.scheduler_guardrail.live_attachment_precondition_matrix.denial_readback.terminal_no_attachment.final_closeout",
        visible: true,
        recorded: false,
        persisted: false,
        authoritative: false,
...
pub fn work_graph_agent_jobs_task_board_scheduler_guardrail_blocking_dry_run_entrypoint_live_attachment_precondition_matrix_denial_readback_terminal_no_attachment_final_closeout_entries()
-> Vec<WorkGraphSchedulerGuardrailLiveAttachmentPreconditionMatrixDenialReadbackTerminalNoAttachmentFinalCloseoutEntryPreview>{
    vec![
        final_closeout_entry(
            "live_attachment_no_attachment_branch_final_closeout",
            "live_attachment_denial_readback.terminal_no_attachment.final_closeout.branch_closed",
        ...
        final_closeout_entry(
            ...
            "live_attachment_denial_readback.terminal_no_attachment.final_closeout.audit_index_surface",
            "live_attachment_audit_index_surface_non_persistence_readback",
            "audit_index_surface",
        ),
        final_closeout_entry(
            "live_attachment_audit_index_entry_inventory_final_closeout",
            "live_attachment_denial_readback.terminal_no_attachment.final_closeout.audit_index_entries",
        ...
        final_closeout_entry(
            ...
            "live_attachment_denial_readback.terminal_no_attachment.final_closeout.audit_index_blockers",
        ...
        final_closeout_entry(
            ...
            "live_attachment_denial_readback.terminal_no_attachment.final_closeout.required_priors",
        ...
        final_closeout_entry(
            ...
            "live_attachment_denial_readback.terminal_no_attachment.final_closeout.non_persistence_boundary",
        ...
        final_closeout_entry(
            ...
            "live_attachment_denial_readback.terminal_no_attachment.final_closeout.no_live_authority",
            "live_attachment_audit_index_no_live_authority_readback",
            "no_live_authority",
        ),
        final_closeout_entry(
            "live_attachment_entrypoint_scope_final_closeout",
            "live_attachment_denial_readback.terminal_no_attachment.final_closeout.entrypoint_scope",
            "live_attachment_audit_index_entry_inventory_non_persistence_readback",
            "entrypoint_scope",
        ),
        final_closeout_entry(
            "live_attachment_scheduler_guardrail_boundary_final_closeout",
            "live_attachment_denial_readback.terminal_no_attachment.final_closeout.scheduler_guardrail_boundary",
            "live_attachment_audit_index_no_live_authority_readback",
...
pub fn work_graph_agent_jobs_task_board_scheduler_guardrail_blocking_dry_run_entrypoint_live_attachment_precondition_matrix_denial_readback_terminal_no_attachment_final_closeout_blockers()
-> Vec<WorkGraphSchedulerGuardrailLiveAttachmentPreconditionMatrixDenialReadbackTerminalNoAttachmentFinalCloseoutBlockerPreview>{
    let source_blockers =
        crate::work_graph_agent_jobs_task_board_scheduler_guardrail_blocking_dry_run_entrypoint_live_attachment_precondition_matrix_denial_readback_audit_index_non_persistence_readback::work_graph_agent_jobs_task_board_scheduler_guardrail_blocking_dry_run_entrypoint_live_attachment_precondition_matrix_denial_readback_audit_index_non_persistence_readback_blockers();
    let mut blockers = vec![
        blocker(
            "final_closeout_record_blocked",
            "record_live_attachment_terminal_no_attachment_final_closeout",
        ),
        blocker(
            "final_closeout_persistence_blocked",
            "persist_live_attachment_terminal_no_attachment_final_closeout",
        ),
        blocker(
            "final_closeout_acceptance_blocked",
            "accept_live_attachment_terminal_no_attachment_final_closeout",
        ),
    ];
    blockers.extend(
        source_blockers
...
pub fn work_graph_agent_jobs_task_board_scheduler_guardrail_blocking_dry_run_entrypoint_live_attachment_precondition_matrix_denial_readback_terminal_no_attachment_final_closeout_required_prior_gates()
-> Vec<&'static str> {
    let mut required_prior_gates = vec![
        WORK_GRAPH_AGENT_JOBS_TASK_BOARD_SCHEDULER_GUARDRAIL_BLOCKING_DRY_RUN_ENTRYPOINT_LIVE_ATTACHMENT_PRECONDITION_MATRIX_DENIAL_READBACK_AUDIT_INDEX_NON_PERSISTENCE_READBACK_GATE,
    ];
    required_prior_gates.extend(crate::work_graph_agent_jobs_task_board_scheduler_guardrail_blocking_dry_run_entrypoint_live_attachment_precondition_matrix_denial_readback_audit_index_non_persistence_readback::work_graph_agent_jobs_task_board_scheduler_guardrail_blocking_dry_run_entrypoint_live_attachment_precondition_matrix_denial_readback_audit_index_non_persistence_readback_required_prior_gates());
    required_prior_gates
}

impl WorkGraphAgentJobsTaskBoardSchedulerGuardrailBlockingDryRunEntrypointLiveAttachmentPreconditionMatrixDenialReadbackTerminalNoAttachmentFinalCloseoutSideEffects {
...
) -> WorkGraphSchedulerGuardrailLiveAttachmentPreconditionMatrixDenialReadbackTerminalNoAttachmentFinalCloseoutEntryPreview{
    WorkGraphSchedulerGuardrailLiveAttachmentPreconditionMatrixDenialReadbackTerminalNoAttachmentFinalCloseoutEntryPreview {
        id,
        stable_closeout_key,
        source_readback_id,
...
) -> WorkGraphSchedulerGuardrailLiveAttachmentPreconditionMatrixDenialReadbackTerminalNoAttachmentFinalCloseoutBlockerPreview{
    WorkGraphSchedulerGuardrailLiveAttachmentPreconditionMatrixDenialReadbackTerminalNoAttachmentFinalCloseoutBlockerPreview {
        id,
        blocked_action,
        blocked: true,
        reason:
            "scheduler/guardrail live attachment terminal no-attachment final closeout cannot authorize this action",
    }
}
...
mod tests {
    ...
    #[test]
    fn live_attachment_terminal_no_attachment_final_closeout_derives_from_readback() {
        let report =
        ...
        assert_eq!(report.source_readback_blocker_count, 42);
        assert_eq!(report.source_required_prior_gate_count, 19);
        ...
        assert_eq!(report.final_closeout_blocker_count, 45);
        assert_eq!(report.required_prior_gate_count, 20);
    }

    #[test]
    fn live_attachment_terminal_no_attachment_final_closeout_is_visible_only() {
        let report =
            hepta_work_graph_agent_jobs_task_board_scheduler_guardrail_blocking_dry_run_entrypoint_live_attachment_precondition_matrix_denial_readback_terminal_no_attachment_final_closeout_report();
    ...
    #[test]
    fn live_attachment_terminal_no_attachment_final_closeout_blocks_live_paths() {
        let report =
            hepta_work_graph_agent_jobs_task_board_scheduler_guardrail_blocking_dry_run_entrypoint_live_attachment_precondition_matrix_denial_readback_terminal_no_attachment_final_closeout_report();
        ...
        assert!(report.ready_for_live_attachment_attachability_precondition_readiness);
        assert!(!report.ready_for_live_attachment);
        assert!(!report.ready_for_live_execution);
    }

    #[test]
    fn live_attachment_terminal_no_attachment_final_closeout_links_priors_and_side_effects() {
        let report =
            hepta_work_graph_agent_jobs_task_board_scheduler_guardrail_blocking_dry_run_entrypoint_live_attachment_precondition_matrix_denial_readback_terminal_no_attachment_final_closeout_report();

        assert_eq!(
            report.required_prior_gates,
            work_graph_agent_jobs_task_board_scheduler_guardrail_blocking_dry_run_entrypoint_live_attachment_precondition_matrix_denial_readback_terminal_no_attachment_final_closeout_required_prior_gates()
        );
        assert_eq!(
