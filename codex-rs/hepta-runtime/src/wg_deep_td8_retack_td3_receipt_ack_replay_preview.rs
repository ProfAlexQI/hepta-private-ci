...
pub struct DeepTd8Td3TerminalDecisionReceiptAckReplayPreviewReport {
    ...
    pub replay_scenarios: Vec<DeepTd8Td3TerminalDecisionReceiptAckReplayItem>,
    pub idempotency_guards: Vec<DeepTd8Td3TerminalDecisionReceiptAckReplayItem>,
    pub replay_denials: Vec<DeepTd8Td3TerminalDecisionReceiptAckReplayItem>,
    pub monotonicity_checks: Vec<DeepTd8Td3TerminalDecisionReceiptAckReplayItem>,
    pub local_views: Vec<DeepTd8Td3TerminalDecisionReceiptAckReplayItem>,
    pub invariants: Vec<DeepTd8Td3TerminalDecisionReceiptAckReplayItem>,
    ...
    pub side_effects: DeepTd8Td3TerminalDecisionReceiptAckReplaySideEffects,
}

#[derive(Debug, Clone, PartialEq, Eq, Serialize)]
pub struct DeepTd8Td3TerminalDecisionReceiptAckReplayItem {
    pub id: String,
...
pub struct DeepTd8Td3TerminalDecisionReceiptAckReplaySideEffects {
...
pub fn deep_td8_retack_td3_receipt_retention_expiry_gate() -> String {
    format!(
...
pub fn hepta_work_graph_deep_td8_retack_td3_receipt_ack_replay_preview_report()
-> DeepTd8Td3TerminalDecisionReceiptAckReplayPreviewReport {
    let replay_scenarios = td3_replay_items("replay_scenario", 6);
    let idempotency_guards = td3_replay_items("idempotency_guard", 7);
    let replay_denials = td3_replay_items("replay_denial", 7);
    let monotonicity_checks = td3_replay_items("monotonicity_check", 5);
    let local_views = td3_replay_items("local_view", 4);
    let invariants = td3_replay_items("invariant", 6);
    let gate = crate::deep_td8_retack_td3_receipt_ack_replay_gate();
    ...
    DeepTd8Td3TerminalDecisionReceiptAckReplayPreviewReport {
        ...
        gate,
        preview_mode: "read_only_deep_td8_td3_terminal_decision_receipt_acknowledgement_replay_idempotency_preview_no_replay_write",
        ...
        required_prior_gates: deep_td8_retack_td3_receipt_ack_replay_required_prior_gates(),
        replay_scenarios,
        idempotency_guards,
        replay_denials,
        monotonicity_checks,
        local_views,
        invariants,
        recommended_next_gate: deep_td8_retack_td3_receipt_retention_expiry_gate(),
        ready_for_receipt_retention_expiry_preview: true,
        ready_for_operator_acceptance: false,
        ready_for_live_persistence: false,
        side_effects: DeepTd8Td3TerminalDecisionReceiptAckReplaySideEffects::none(),
    }
}

pub fn deep_td8_retack_td3_receipt_ack_replay_required_prior_gates() -> Vec<String> {
    let mut gates = crate::deep_td8_retack_td3_receipt_ack_required_prior_gates();
    gates.push(crate::deep_td8_retack_td3_receipt_acknowledgement_gate());
    gates
}
...
fn td3_replay_items(
    prefix: &str,
    count: usize,
) -> Vec<DeepTd8Td3TerminalDecisionReceiptAckReplayItem> {
    let source_acknowledgement_ids = crate::deep_td8_retack_td3_receipt_ack_ids();

    (0..count)
        .map(|index| DeepTd8Td3TerminalDecisionReceiptAckReplayItem {
            id: format!("deep_td8_retack_td3_receipt_ack_replay_{prefix}_{index}"),
...
impl DeepTd8Td3TerminalDecisionReceiptAckReplaySideEffects {
    pub fn none() -> Self {
        Self {
...
mod tests {
    ...
    #[test]
    fn work_graph_td3_receipt_ack_replay_requires_ack_gate() {
        let report = hepta_work_graph_deep_td8_retack_td3_receipt_ack_replay_preview_report();

        assert_eq!(
            report.required_prior_gates.last(),
            Some(&crate::deep_td8_retack_td3_receipt_acknowledgement_gate())
        );
    }

    #[test]
    fn work_graph_td3_receipt_ack_replay_declares_blocked_scenarios() {
        let report = hepta_work_graph_deep_td8_retack_td3_receipt_ack_replay_preview_report();
    ...
    #[test]
    fn work_graph_td3_receipt_ack_replay_requires_idempotency_guards() {
        let report = hepta_work_graph_deep_td8_retack_td3_receipt_ack_replay_preview_report();
    ...
    #[test]
    fn work_graph_td3_receipt_ack_replay_denies_mutating_outcomes() {
        let report = hepta_work_graph_deep_td8_retack_td3_receipt_ack_replay_preview_report();
    ...
    #[test]
    fn work_graph_td3_receipt_ack_replay_points_to_retention() {
        let report = hepta_work_graph_deep_td8_retack_td3_receipt_ack_replay_preview_report();

        assert_eq!(
            report.recommended_next_gate,
            deep_td8_retack_td3_receipt_retention_expiry_gate()
        );
    ...
    #[test]
    fn work_graph_td3_receipt_ack_replay_has_no_side_effects() {
        let report = hepta_work_graph_deep_td8_retack_td3_receipt_ack_replay_preview_report();
