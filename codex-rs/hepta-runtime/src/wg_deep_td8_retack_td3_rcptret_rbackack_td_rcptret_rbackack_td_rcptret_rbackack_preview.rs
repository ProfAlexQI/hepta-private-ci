...
pub struct DeepTd8Td3RbackAckTd2ReceiptRetentionReadbackAckPreviewReport {
    ...
    pub acknowledgement_contracts: Vec<DeepTd8Td3RbackAckTd2ReceiptRetentionReadbackAckItem>,
    pub non_acceptance_reasons: Vec<DeepTd8Td3RbackAckTd2ReceiptRetentionReadbackAckItem>,
    pub recording_denials: Vec<DeepTd8Td3RbackAckTd2ReceiptRetentionReadbackAckItem>,
    pub expiry_replay_guards: Vec<DeepTd8Td3RbackAckTd2ReceiptRetentionReadbackAckItem>,
    pub local_views: Vec<DeepTd8Td3RbackAckTd2ReceiptRetentionReadbackAckItem>,
    pub invariants: Vec<DeepTd8Td3RbackAckTd2ReceiptRetentionReadbackAckItem>,
    ...
    pub side_effects: DeepTd8Td3RbackAckTd2ReceiptRetentionReadbackAckSideEffects,
}

#[derive(Debug, Clone, PartialEq, Eq, Serialize)]
pub struct DeepTd8Td3RbackAckTd2ReceiptRetentionReadbackAckItem {
    pub id: String,
...
pub struct DeepTd8Td3RbackAckTd2ReceiptRetentionReadbackAckSideEffects {
...
pub fn deep_td8_retack_td3_rcptret_rbackack_td_rcptret_rbackack_td_rcptret_readback_ack_replay_gate()
-> String {
    format!(
...
pub fn hepta_work_graph_deep_td8_retack_td3_rcptret_rbackack_td_rcptret_rbackack_td_rcptret_rbackack_preview_report()
-> DeepTd8Td3RbackAckTd2ReceiptRetentionReadbackAckPreviewReport {
    ...
    DeepTd8Td3RbackAckTd2ReceiptRetentionReadbackAckPreviewReport {
        ...
        gate,
        preview_mode: "read_only_deep_td8_td3_rbackack_td2_receipt_retention_readback_acknowledgement_preview_no_recording",
        ...
        required_prior_gates:
            deep_td8_retack_td3_rcptret_rbackack_td_rcptret_rbackack_td_rcptret_rbackack_required_prior_gates(),
        ...
        recommended_next_gate:
            deep_td8_retack_td3_rcptret_rbackack_td_rcptret_rbackack_td_rcptret_readback_ack_replay_gate(),
        ready_for_readback_acknowledgement_replay_preview: true,
        ready_for_operator_acceptance: false,
        ready_for_live_persistence: false,
        side_effects: DeepTd8Td3RbackAckTd2ReceiptRetentionReadbackAckSideEffects::none(),
    }
}

pub fn deep_td8_retack_td3_rcptret_rbackack_td_rcptret_rbackack_td_rcptret_rbackack_required_prior_gates()
-> Vec<String> {
    let mut gates =
        crate::deep_td8_retack_td3_rcptret_rbackack_td_rcptret_rbackack_td_rcptret_rbrcpt_required_prior_gates();
    gates.push(
...
fn ack_items(
    prefix: &str,
    count: usize,
) -> Vec<DeepTd8Td3RbackAckTd2ReceiptRetentionReadbackAckItem> {
    (0..count)
        .map(
            |index| DeepTd8Td3RbackAckTd2ReceiptRetentionReadbackAckItem {
                id: format!(
                    "deep_td8_td3_rcptret_rbackack_td_rcptret_rbackack_td_rcptret_rbackack_{prefix}_{index}"
                ),
...
impl DeepTd8Td3RbackAckTd2ReceiptRetentionReadbackAckSideEffects {
    pub fn none() -> Self {
        Self {
...
mod tests {
    ...
    fn work_graph_td3_rbackack_td2_rcptret_rbackack_requires_readback_receipt_gate() {
        let report =
            hepta_work_graph_deep_td8_retack_td3_rcptret_rbackack_td_rcptret_rbackack_td_rcptret_rbackack_preview_report();
