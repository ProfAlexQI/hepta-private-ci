...
use crate::controlled_live_evidence_receipt_store_local_evidence_acceptance_recording_denial_receipt_positive_preconditions::controlled_live_evidence_receipt_store_local_evidence_acceptance_recording_denial_receipt_positive_preconditions_readback_without_persistence_report;
use serde::Serialize;

pub const CONTROLLED_LIVE_EVIDENCE_RECEIPT_STORE_LOCAL_EVIDENCE_ACCEPTANCE_RECORDING_DENIAL_RECEIPT_PERSISTENCE_DENIAL_RECOMMENDED_NEXT_GATE: &str =
    "controlled_live_evidence_receipt_store_local_evidence_acceptance_recording_denial_receipt_persistence_denial_retention_replay_readback_without_persistence";

const SURFACE: &str = "controlled_live_evidence_receipt_store_local_evidence_acceptance_recording_denial_receipt_persistence_denial_readback_without_persistence";
const GATE: &str = "controlled_live_evidence_receipt_store_local_evidence_acceptance_recording_denial_receipt_persistence_denial_readback_without_persistence_gate";
const SCHEMA_VERSION: &str = "controlled_live_evidence_receipt_store_local_evidence_acceptance_recording_denial_receipt_persistence_denial_readback_without_persistence_v1";
const PERSISTENCE_DENIAL_ROUTE: &str = "readback://controlled-live/evidence-receipt-store/local-evidence-acceptance/recording-denial-receipts/persistence-denial";
const PERSISTENCE_DENIAL_REASON: &str = "local_evidence_acceptance_recording_denial_receipt_persistence_disabled_positive_preconditions_missing";

#[derive(Debug, Clone, PartialEq, Eq, Serialize)]
pub struct ControlledLiveEvidenceReceiptStoreLocalEvidenceAcceptanceRecordingDenialReceiptPersistenceDenialReport {
    ...
    pub entries:
        Vec<ControlledLiveEvidenceReceiptStoreLocalEvidenceAcceptanceRecordingDenialReceiptPersistenceDenialEntry>,
    pub recommended_next_gate: &'static str,
    pub side_effects:
        ControlledLiveEvidenceReceiptStoreLocalEvidenceAcceptanceRecordingDenialReceiptPersistenceDenialSideEffects,
}

#[derive(Debug, Clone, PartialEq, Eq, Serialize)]
pub struct ControlledLiveEvidenceReceiptStoreLocalEvidenceAcceptanceRecordingDenialReceiptPersistenceDenialEntry
{
    pub id: String,
...
pub struct ControlledLiveEvidenceReceiptStoreLocalEvidenceAcceptanceRecordingDenialReceiptPersistenceDenialSideEffects
{
    pub acceptance_source_recorded: bool,
    pub acceptance_source_persisted: bool,
    pub denial_receipt_persistence_attempt_recorded: bool,
...
pub fn controlled_live_evidence_receipt_store_local_evidence_acceptance_recording_denial_receipt_persistence_denial_readback_without_persistence_report()
-> ControlledLiveEvidenceReceiptStoreLocalEvidenceAcceptanceRecordingDenialReceiptPersistenceDenialReport
{
...
) -> ControlledLiveEvidenceReceiptStoreLocalEvidenceAcceptanceRecordingDenialReceiptPersistenceDenialReport
{
    ...
    let entries =
        controlled_live_evidence_receipt_store_local_evidence_acceptance_recording_denial_receipt_persistence_denial_entries();
    ...
    ControlledLiveEvidenceReceiptStoreLocalEvidenceAcceptanceRecordingDenialReceiptPersistenceDenialReport {
        ...
        recommended_next_gate:
            CONTROLLED_LIVE_EVIDENCE_RECEIPT_STORE_LOCAL_EVIDENCE_ACCEPTANCE_RECORDING_DENIAL_RECEIPT_PERSISTENCE_DENIAL_RECOMMENDED_NEXT_GATE,
        side_effects:
            ControlledLiveEvidenceReceiptStoreLocalEvidenceAcceptanceRecordingDenialReceiptPersistenceDenialSideEffects::none(),
    }
}

pub fn controlled_live_evidence_receipt_store_local_evidence_acceptance_recording_denial_receipt_persistence_denial_entries()
-> Vec<
    ControlledLiveEvidenceReceiptStoreLocalEvidenceAcceptanceRecordingDenialReceiptPersistenceDenialEntry,
>{
    controlled_live_evidence_receipt_store_local_evidence_acceptance_recording_denial_receipt_positive_preconditions_readback_without_persistence_report()
        .entries
        .into_iter()
        .map(|entry| {
            ...
            ControlledLiveEvidenceReceiptStoreLocalEvidenceAcceptanceRecordingDenialReceiptPersistenceDenialEntry {
                id: format!(
                    "evidence_receipt_store_local_evidence_acceptance_recording_denial_receipt_persistence_denial_without_persistence_{}",
                ...
                persistence_denial_id: format!(
                    "local-evidence-acceptance-recording-denial-receipt-persistence-denial:controlled-live-evidence-receipt-store:{}",
                    entry.source_blocker_id
                ),
                persistence_denial_route: format!("{PERSISTENCE_DENIAL_ROUTE}/{hyphenated}"),
                persistence_denial_reason: PERSISTENCE_DENIAL_REASON,
                observed_state:
                    "local_evidence_acceptance_recording_denial_receipt_persistence_denied_without_persistence",
...
fn count(
    entries: &[ControlledLiveEvidenceReceiptStoreLocalEvidenceAcceptanceRecordingDenialReceiptPersistenceDenialEntry],
    predicate: impl Fn(&ControlledLiveEvidenceReceiptStoreLocalEvidenceAcceptanceRecordingDenialReceiptPersistenceDenialEntry) -> bool,
) -> usize {
    entries.iter().filter(|entry| predicate(entry)).count()
}

fn entry_is_ready_blocked(
    entry: &ControlledLiveEvidenceReceiptStoreLocalEvidenceAcceptanceRecordingDenialReceiptPersistenceDenialEntry,
) -> bool {
...
impl ControlledLiveEvidenceReceiptStoreLocalEvidenceAcceptanceRecordingDenialReceiptPersistenceDenialSideEffects {
    ...
    fn local_denial_receipt_persistence_denial_entries_are_stable() {
        ...
        assert!(report.entries.iter().any(|entry| entry.source_blocker_id
            ...
            && entry.persistence_denial_route
                == "readback://controlled-live/evidence-receipt-store/local-evidence-acceptance/recording-denial-receipts/persistence-denial/dirty-worktree-boundary"
            && entry.persistence_denial_reason
                == "local_evidence_acceptance_recording_denial_receipt_persistence_disabled_positive_preconditions_missing"));
        assert!(report.entries.iter().all(|entry| {
            entry.source_positive_precondition_set_id.starts_with(
                "local-evidence-acceptance-recording-denial-receipt-positive-preconditions:",
            ) && entry
                .source_denial_receipt_id
                .starts_with("local-evidence-acceptance-recording-denial-receipt:")
                && entry.persistence_denial_id.starts_with(
                    "local-evidence-acceptance-recording-denial-receipt-persistence-denial:",
                )
