...
impl Session {
    ...
    async fn maybe_warn_on_server_model_mismatch(
        ...
        let warning_message = format!(
            "Your account was flagged for potentially high-risk cyber activity and this request was routed to {server_model} as a fallback. To regain access to {requested_model}, apply for trusted access: {CYBER_VERIFY_URL}"
        );
