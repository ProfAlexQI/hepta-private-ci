...
pub struct ContextMemoryShadowQualityTrendSnapshotReport {
    ...
    pub ranked_recall_routing_diff_window_pass_count: usize,
    ...
    pub ranked_recall_real_workload_trace_window_pass_count: usize,
...
impl Default for ContextMemoryShadowQualityTrendSnapshotReport {
    fn default() -> Self {
        Self {
            ...
            ranked_recall_routing_diff_window_pass_count: 0,
            ...
            ranked_recall_real_workload_trace_window_pass_count: 0,
...
impl ContextMemoryShadowQualityTrendSnapshotReport {
    pub fn from_summary(summary: &ContextMemoryShadowQualitySummaryReport) -> Self {
        ...
        let ranked_recall_routing_diff_window_pass_count = if summary
            .ranked_recall_routing_diff_shadow_only_count
            == 4
            && summary.ranked_recall_routing_diff_win_count == 3
            && summary.ranked_recall_routing_diff_loss_count == 1
            && summary.ranked_recall_min_positive_routing_diff_delta_basis_points >= 640
            && summary.ranked_recall_max_positive_routing_diff_latency_delta_ms <= 10
            && summary.ranked_recall_min_positive_routing_diff_token_tradeoff_basis_points >= 3_000
            && summary.ranked_recall_routing_diff_regression_blocked_count == 1
        {
            SHADOW_QUALITY_TREND_SNAPSHOT_WINDOW_OBSERVATION_COUNT
        } else {
            0
        };
        let ranked_recall_real_workload_trace_window_pass_count = if summary
            .ranked_recall_real_workload_trace_shadow_only_count
            == 4
            && summary.ranked_recall_real_workload_trace_slo_pass_count == 3
            && summary.ranked_recall_real_workload_trace_win_count == 3
            && summary.ranked_recall_real_workload_trace_loss_count == 1
            && summary.ranked_recall_real_workload_trace_operator_review_required_count == 4
            && summary.ranked_recall_real_workload_trace_total_leak_count == 0
            && summary.ranked_recall_real_workload_trace_max_leak_rate_basis_points == 0
            && summary.ranked_recall_min_positive_real_workload_trace_coverage_basis_points >= 8_000
            && summary.ranked_recall_min_positive_real_workload_trace_precision_basis_points
                >= 8_000
            && summary.ranked_recall_total_positive_real_workload_trace_token_saved >= 2_140
            && summary.ranked_recall_max_positive_real_workload_trace_latency_ms <= 55
            && summary.ranked_recall_real_workload_trace_regression_loss_count == 1
        {
            SHADOW_QUALITY_TREND_SNAPSHOT_WINDOW_OBSERVATION_COUNT
        } else {
            0
        ...
        Self {
            ...
            ranked_recall_min_positive_routing_diff_delta_basis_points: summary
                .ranked_recall_min_positive_routing_diff_delta_basis_points,
            ranked_recall_max_positive_routing_diff_latency_delta_ms: summary
                .ranked_recall_max_positive_routing_diff_latency_delta_ms,
            ranked_recall_min_positive_routing_diff_token_tradeoff_basis_points: summary
                .ranked_recall_min_positive_routing_diff_token_tradeoff_basis_points,
            ranked_recall_real_workload_trace_window_pass_count,
            ranked_recall_real_workload_trace_slo_pass_count: summary
                .ranked_recall_real_workload_trace_slo_pass_count,
            ranked_recall_real_workload_trace_win_count: summary
                .ranked_recall_real_workload_trace_win_count,
            ranked_recall_real_workload_trace_loss_count: summary
                .ranked_recall_real_workload_trace_loss_count,
            ranked_recall_real_workload_trace_operator_review_required_count: summary
                .ranked_recall_real_workload_trace_operator_review_required_count,
            ranked_recall_real_workload_trace_total_leak_count: summary
                .ranked_recall_real_workload_trace_total_leak_count,
            ranked_recall_real_workload_trace_max_leak_rate_basis_points: summary
                .ranked_recall_real_workload_trace_max_leak_rate_basis_points,
            ranked_recall_min_positive_real_workload_trace_coverage_basis_points: summary
                .ranked_recall_min_positive_real_workload_trace_coverage_basis_points,
            ranked_recall_min_positive_real_workload_trace_precision_basis_points: summary
                .ranked_recall_min_positive_real_workload_trace_precision_basis_points,
            ranked_recall_total_positive_real_workload_trace_token_saved: summary
    ...
    pub fn has_shadow_quality_trend_snapshot_integrity(&self) -> bool {
        self.schema_version == CONTEXT_MEMORY_SHADOW_QUALITY_TREND_SNAPSHOT_SCHEMA_VERSION
            ...
            && self.ranked_recall_comparison_window_pass_count
                == SHADOW_QUALITY_TREND_SNAPSHOT_WINDOW_OBSERVATION_COUNT
            && self.ranked_recall_routing_diff_window_pass_count
                == SHADOW_QUALITY_TREND_SNAPSHOT_WINDOW_OBSERVATION_COUNT
