...
pub(super) fn activation_target_order(target: ContextPlaneActivationTarget) -> usize {
    match target {
        ...
        ContextPlaneActivationTarget::MemoryTemporalFacts => 6,
        ContextPlaneActivationTarget::MemoryTemporalFactGraph => 7,
        ContextPlaneActivationTarget::MemoryTemporalGraphShadowEval => 8,
        ContextPlaneActivationTarget::EvalHarnessSeed => 9,
        ContextPlaneActivationTarget::AdaptiveAllocatorEvalShadow => 10,
        ContextPlaneActivationTarget::RecallQualityGate => 11,
        ContextPlaneActivationTarget::MemoryRankedRecallShadowEval => 12,
        ContextPlaneActivationTarget::MemoryProviderBoundary => 13,
        ContextPlaneActivationTarget::MemoryProviderV2Boundary => 14,
        ContextPlaneActivationTarget::MemoryShadowCanaryReadiness => 15,
        ContextPlaneActivationTarget::MemoryShadowCanaryPromotionReadiness => 16,
        ContextPlaneActivationTarget::SourceAwareFrontDoor => 17,
        ContextPlaneActivationTarget::OperatorApproval => 18,
        ContextPlaneActivationTarget::Unknown => 19,
    }
}
...
pub(in crate::memory::context_plane) fn activation_blocker_reason_order(
    ...
    match reason {
        ...
        ContextPlaneActivationBlockerReason::MemoryShadowCanaryReadinessShadowOnly => 11,
        ContextPlaneActivationBlockerReason::MemoryShadowCanaryPromotionReadinessShadowOnly => 12,
        ContextPlaneActivationBlockerReason::SourceAwareFrontDoorDisabled => 13,
        ContextPlaneActivationBlockerReason::OperatorApprovalMissing => 14,
        ContextPlaneActivationBlockerReason::UnexpectedStatus => 15,
        ContextPlaneActivationBlockerReason::SideEffectFlagEnabled => 16,
        ContextPlaneActivationBlockerReason::Unknown => 17,
    }
}
