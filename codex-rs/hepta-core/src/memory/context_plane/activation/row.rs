...
impl ContextPlaneActivationBlockerRow {
    ...
    pub(super) fn from_status_entry(
        ...
        if report_side_effect_flag_enabled || entry_side_effect_flag_enabled {
            ...
            .with_memory_temporal_graph_shadow_store_rollup(target, entry)
    ...
    fn with_memory_temporal_graph_shadow_store_rollup(
        mut self,
        target: ContextPlaneActivationTarget,
        entry: Option<&ContextPlaneStatusEntry>,
    ) -> Self {
        if target == ContextPlaneActivationTarget::MemoryTemporalGraphShadowStore
            && let Some(entry) = entry
        {
            self.memory_temporal_graph_shadow_store_node_count =
                entry.memory_temporal_graph_shadow_store_node_count;
            self.memory_temporal_graph_shadow_store_edge_count =
                entry.memory_temporal_graph_shadow_store_edge_count;
            self.memory_temporal_graph_shadow_store_provenance_edge_count =
                entry.memory_temporal_graph_shadow_store_provenance_edge_count;
            self.memory_temporal_graph_shadow_store_validity_window_edge_count =
                entry.memory_temporal_graph_shadow_store_validity_window_edge_count;
            self.memory_temporal_graph_shadow_store_supersedes_edge_count =
                entry.memory_temporal_graph_shadow_store_supersedes_edge_count;
            self.memory_temporal_graph_shadow_store_invalidated_node_count =
                entry.memory_temporal_graph_shadow_store_invalidated_node_count;
            self.memory_temporal_graph_shadow_store_stage_required_count =
                entry.memory_temporal_graph_shadow_store_stage_required_count;
            self.memory_temporal_graph_shadow_store_stage_projected_count =
                entry.memory_temporal_graph_shadow_store_stage_projected_count;
            self.memory_temporal_graph_shadow_store_digest_count =
                entry.memory_temporal_graph_shadow_store_digest_count;
            self.memory_temporal_graph_shadow_store_freshness_pass_count =
                entry.memory_temporal_graph_shadow_store_freshness_pass_count;
            self.memory_temporal_graph_shadow_store_replay_guard_pass_count =
                entry.memory_temporal_graph_shadow_store_replay_guard_pass_count;
            self.memory_temporal_graph_shadow_store_stale_replay_rejected_count =
                entry.memory_temporal_graph_shadow_store_stale_replay_rejected_count;
            self.memory_temporal_graph_shadow_store_operator_approval_required_count =
                entry.memory_temporal_graph_shadow_store_operator_approval_required_count;
            self.memory_temporal_graph_shadow_store_operator_approval_recorded_count =
                entry.memory_temporal_graph_shadow_store_operator_approval_recorded_count;
            self.memory_temporal_graph_shadow_store_recorded_receipt_count =
                entry.memory_temporal_graph_shadow_store_recorded_receipt_count;
            self.memory_temporal_graph_shadow_store_persisted_receipt_count =
                entry.memory_temporal_graph_shadow_store_persisted_receipt_count;
            self.memory_temporal_graph_shadow_store_production_write_count =
                entry.memory_temporal_graph_shadow_store_production_write_count;
            self.memory_temporal_graph_shadow_store_graph_write_count =
                entry.memory_temporal_graph_shadow_store_graph_write_count;
        }
        self
    }

    fn with_memory_temporal_graph_shadow_replay_rollup(
        mut self,
        target: ContextPlaneActivationTarget,
        entry: Option<&ContextPlaneStatusEntry>,
    ) -> Self {
        if target == ContextPlaneActivationTarget::MemoryTemporalGraphShadowReplay
            && let Some(entry) = entry
        {
            self.memory_temporal_graph_shadow_replay_node_count =
                entry.memory_temporal_graph_shadow_replay_node_count;
            self.memory_temporal_graph_shadow_replay_edge_count =
                entry.memory_temporal_graph_shadow_replay_edge_count;
            self.memory_temporal_graph_shadow_replay_provenance_count =
                entry.memory_temporal_graph_shadow_replay_provenance_count;
            self.memory_temporal_graph_shadow_replay_bitemporal_validity_count =
                entry.memory_temporal_graph_shadow_replay_bitemporal_validity_count;
            self.memory_temporal_graph_shadow_replay_fact_invalidation_count =
                entry.memory_temporal_graph_shadow_replay_fact_invalidation_count;
            self.memory_temporal_graph_shadow_replay_supersede_tombstone_count =
                entry.memory_temporal_graph_shadow_replay_supersede_tombstone_count;
            self.memory_temporal_graph_shadow_replay_stage_required_count =
                entry.memory_temporal_graph_shadow_replay_stage_required_count;
            self.memory_temporal_graph_shadow_replay_stage_projected_count =
                entry.memory_temporal_graph_shadow_replay_stage_projected_count;
            self.memory_temporal_graph_shadow_replay_digest_count =
                entry.memory_temporal_graph_shadow_replay_digest_count;
            self.memory_temporal_graph_shadow_replay_freshness_pass_count =
                entry.memory_temporal_graph_shadow_replay_freshness_pass_count;
            self.memory_temporal_graph_shadow_replay_guard_pass_count =
                entry.memory_temporal_graph_shadow_replay_guard_pass_count;
            self.memory_temporal_graph_shadow_replay_stale_replay_rejected_count =
                entry.memory_temporal_graph_shadow_replay_stale_replay_rejected_count;
            self.memory_temporal_graph_shadow_replay_operator_approval_required_count =
                entry.memory_temporal_graph_shadow_replay_operator_approval_required_count;
            self.memory_temporal_graph_shadow_replay_operator_approval_recorded_count =
                entry.memory_temporal_graph_shadow_replay_operator_approval_recorded_count;
            self.memory_temporal_graph_shadow_replay_recorded_receipt_count =
                entry.memory_temporal_graph_shadow_replay_recorded_receipt_count;
            self.memory_temporal_graph_shadow_replay_persisted_receipt_count =
                entry.memory_temporal_graph_shadow_replay_persisted_receipt_count;
            self.memory_temporal_graph_shadow_replay_production_write_count =
                entry.memory_temporal_graph_shadow_replay_production_write_count;
            self.memory_temporal_graph_shadow_replay_graph_write_count =
                entry.memory_temporal_graph_shadow_replay_graph_write_count;
        }
        self
    }

    fn with_memory_temporal_graph_shadow_traversal_diff_rollup(
        mut self,
        target: ContextPlaneActivationTarget,
        entry: Option<&ContextPlaneStatusEntry>,
    ) -> Self {
        if target == ContextPlaneActivationTarget::MemoryTemporalGraphShadowTraversalDiff
            && let Some(entry) = entry
        {
            self.memory_temporal_graph_shadow_traversal_diff_production_selection_count =
                entry.memory_temporal_graph_shadow_traversal_diff_production_selection_count;
            self.memory_temporal_graph_shadow_traversal_diff_lexical_bm25_candidate_count =
                entry.memory_temporal_graph_shadow_traversal_diff_lexical_bm25_candidate_count;
            self.memory_temporal_graph_shadow_traversal_diff_semantic_candidate_count =
                entry.memory_temporal_graph_shadow_traversal_diff_semantic_candidate_count;
            ...
            self.memory_temporal_graph_shadow_traversal_diff_hybrid_candidate_count =
                entry.memory_temporal_graph_shadow_traversal_diff_hybrid_candidate_count;
            self.memory_temporal_graph_shadow_traversal_diff_overlap_candidate_count =
                entry.memory_temporal_graph_shadow_traversal_diff_overlap_candidate_count;
            ...
            self.memory_temporal_graph_shadow_traversal_diff_win_count =
                entry.memory_temporal_graph_shadow_traversal_diff_win_count;
            self.memory_temporal_graph_shadow_traversal_diff_loss_count =
                entry.memory_temporal_graph_shadow_traversal_diff_loss_count;
            self.memory_temporal_graph_shadow_traversal_diff_cost_count =
                entry.memory_temporal_graph_shadow_traversal_diff_cost_count;
            self.memory_temporal_graph_shadow_traversal_diff_stage_required_count =
                entry.memory_temporal_graph_shadow_traversal_diff_stage_required_count;
            self.memory_temporal_graph_shadow_traversal_diff_stage_projected_count =
                entry.memory_temporal_graph_shadow_traversal_diff_stage_projected_count;
            self.memory_temporal_graph_shadow_traversal_diff_digest_count =
                entry.memory_temporal_graph_shadow_traversal_diff_digest_count;
            self.memory_temporal_graph_shadow_traversal_diff_freshness_pass_count =
                entry.memory_temporal_graph_shadow_traversal_diff_freshness_pass_count;
            self.memory_temporal_graph_shadow_traversal_diff_replay_guard_pass_count =
                entry.memory_temporal_graph_shadow_traversal_diff_replay_guard_pass_count;
            self.memory_temporal_graph_shadow_traversal_diff_stale_replay_rejected_count =
                entry.memory_temporal_graph_shadow_traversal_diff_stale_replay_rejected_count;
            self.memory_temporal_graph_shadow_traversal_diff_llm_rerank_count =
                entry.memory_temporal_graph_shadow_traversal_diff_llm_rerank_count;
            self.memory_temporal_graph_shadow_traversal_diff_graph_persistence_count =
                entry.memory_temporal_graph_shadow_traversal_diff_graph_persistence_count;
            self.memory_temporal_graph_shadow_traversal_diff_production_route_count =
                entry.memory_temporal_graph_shadow_traversal_diff_production_route_count;
            self.memory_temporal_graph_shadow_traversal_diff_production_write_count =
                entry.memory_temporal_graph_shadow_traversal_diff_production_write_count;
            self.memory_temporal_graph_shadow_traversal_diff_graph_write_count =
                entry.memory_temporal_graph_shadow_traversal_diff_graph_write_count;
        }
        self
    }

    fn with_memory_temporal_graph_shadow_traversal_quality_rollup(
        mut self,
        target: ContextPlaneActivationTarget,
        entry: Option<&ContextPlaneStatusEntry>,
    ) -> Self {
        if target == ContextPlaneActivationTarget::MemoryTemporalGraphShadowTraversalQuality
            && let Some(entry) = entry
        {
            self.memory_temporal_graph_shadow_traversal_quality_fixture_count =
                entry.memory_temporal_graph_shadow_traversal_quality_fixture_count;
            self.memory_temporal_graph_shadow_traversal_quality_slo_required_count =
                entry.memory_temporal_graph_shadow_traversal_quality_slo_required_count;
            self.memory_temporal_graph_shadow_traversal_quality_slo_pass_count =
                entry.memory_temporal_graph_shadow_traversal_quality_slo_pass_count;
            self.memory_temporal_graph_shadow_traversal_quality_coverage_basis_points =
                entry.memory_temporal_graph_shadow_traversal_quality_coverage_basis_points;
            ...
            self.memory_temporal_graph_shadow_traversal_quality_leak_rate_basis_points =
                entry.memory_temporal_graph_shadow_traversal_quality_leak_rate_basis_points;
            self.memory_temporal_graph_shadow_traversal_quality_latency_budget_ms =
                entry.memory_temporal_graph_shadow_traversal_quality_latency_budget_ms;
            self.memory_temporal_graph_shadow_traversal_quality_projected_latency_ms =
                entry.memory_temporal_graph_shadow_traversal_quality_projected_latency_ms;
            self.memory_temporal_graph_shadow_traversal_quality_token_saved_estimate =
                entry.memory_temporal_graph_shadow_traversal_quality_token_saved_estimate;
            self.memory_temporal_graph_shadow_traversal_quality_operator_review_required_count =
                entry.memory_temporal_graph_shadow_traversal_quality_operator_review_required_count;
            self.memory_temporal_graph_shadow_traversal_quality_win_count =
                entry.memory_temporal_graph_shadow_traversal_quality_win_count;
            self.memory_temporal_graph_shadow_traversal_quality_loss_count =
                entry.memory_temporal_graph_shadow_traversal_quality_loss_count;
            self.memory_temporal_graph_shadow_traversal_quality_cost_count =
                entry.memory_temporal_graph_shadow_traversal_quality_cost_count;
            self.memory_temporal_graph_shadow_traversal_quality_stage_required_count =
                entry.memory_temporal_graph_shadow_traversal_quality_stage_required_count;
            self.memory_temporal_graph_shadow_traversal_quality_stage_projected_count =
                entry.memory_temporal_graph_shadow_traversal_quality_stage_projected_count;
            self.memory_temporal_graph_shadow_traversal_quality_digest_count =
                entry.memory_temporal_graph_shadow_traversal_quality_digest_count;
            self.memory_temporal_graph_shadow_traversal_quality_freshness_pass_count =
                entry.memory_temporal_graph_shadow_traversal_quality_freshness_pass_count;
            self.memory_temporal_graph_shadow_traversal_quality_replay_guard_pass_count =
                entry.memory_temporal_graph_shadow_traversal_quality_replay_guard_pass_count;
            ...
            self.memory_temporal_graph_shadow_traversal_quality_llm_rerank_count =
                entry.memory_temporal_graph_shadow_traversal_quality_llm_rerank_count;
            self.memory_temporal_graph_shadow_traversal_quality_graph_persistence_count =
                entry.memory_temporal_graph_shadow_traversal_quality_graph_persistence_count;
            self.memory_temporal_graph_shadow_traversal_quality_production_route_count =
                entry.memory_temporal_graph_shadow_traversal_quality_production_route_count;
            self.memory_temporal_graph_shadow_traversal_quality_production_write_count =
                entry.memory_temporal_graph_shadow_traversal_quality_production_write_count;
            self.memory_temporal_graph_shadow_traversal_quality_graph_write_count =
                entry.memory_temporal_graph_shadow_traversal_quality_graph_write_count;
        }
        self
    }
    ...
    fn with_memory_temporal_graph_shadow_retrieval_rollback_kill_switch_rollup(
        mut self,
        target: ContextPlaneActivationTarget,
        entry: Option<&ContextPlaneStatusEntry>,
    ) -> Self {
            ...
            && let Some(entry) = entry
        {
            self.memory_temporal_graph_shadow_retrieval_rollback_kill_switch_fixture_count =
                entry.memory_temporal_graph_shadow_retrieval_rollback_kill_switch_fixture_count;
            ...
            self.memory_temporal_graph_shadow_retrieval_rollback_kill_switch_digest_count =
                entry.memory_temporal_graph_shadow_retrieval_rollback_kill_switch_digest_count;
            ...
            self.memory_temporal_graph_shadow_retrieval_rollback_kill_switch_llm_rerank_count =
                entry.memory_temporal_graph_shadow_retrieval_rollback_kill_switch_llm_rerank_count;
    ...
    pub fn has_row_integrity(&self) -> bool {
        !self.target.is_unknown()
            ...
            && self.has_memory_temporal_graph_shadow_store_rollup_integrity()
    ...
    fn has_memory_temporal_graph_shadow_store_rollup_integrity(&self) -> bool {
        let counts = [
            self.memory_temporal_graph_shadow_store_node_count,
            self.memory_temporal_graph_shadow_store_edge_count,
            self.memory_temporal_graph_shadow_store_provenance_edge_count,
        ...
        if self.target != ContextPlaneActivationTarget::MemoryTemporalGraphShadowStore {
            return counts.iter().all(|count| *count == 0);
        }
    ...
    fn has_memory_temporal_graph_shadow_replay_rollup_integrity(&self) -> bool {
        let counts = [
            self.memory_temporal_graph_shadow_replay_node_count,
            self.memory_temporal_graph_shadow_replay_edge_count,
            self.memory_temporal_graph_shadow_replay_provenance_count,
        ...
        if self.target != ContextPlaneActivationTarget::MemoryTemporalGraphShadowReplay {
            return counts.iter().all(|count| *count == 0);
        }
    ...
    fn has_memory_temporal_graph_shadow_traversal_diff_rollup_integrity(&self) -> bool {
        let counts = [
            self.memory_temporal_graph_shadow_traversal_diff_production_selection_count,
            self.memory_temporal_graph_shadow_traversal_diff_lexical_bm25_candidate_count,
            self.memory_temporal_graph_shadow_traversal_diff_semantic_candidate_count,
        ...
        if self.target != ContextPlaneActivationTarget::MemoryTemporalGraphShadowTraversalDiff {
            return counts.iter().all(|count| *count == 0);
        }
    ...
    fn has_memory_temporal_graph_shadow_traversal_quality_rollup_integrity(&self) -> bool {
        let counts = [
            self.memory_temporal_graph_shadow_traversal_quality_fixture_count,
            self.memory_temporal_graph_shadow_traversal_quality_slo_required_count,
            self.memory_temporal_graph_shadow_traversal_quality_slo_pass_count,
        ...
        if self.target != ContextPlaneActivationTarget::MemoryTemporalGraphShadowTraversalQuality {
            return counts.iter().all(|count| *count == 0)
    ...
    fn has_memory_temporal_graph_shadow_retrieval_rollback_kill_switch_rollup_integrity(
        &self,
    ) -> bool {
        let counts = [
            self.memory_temporal_graph_shadow_retrieval_rollback_kill_switch_fixture_count,
