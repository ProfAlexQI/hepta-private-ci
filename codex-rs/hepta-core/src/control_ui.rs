...
pub fn control_ui_contract_audit_report() -> ControlUiContractAuditReport {
    ...
    let app_has_telegram_multi_agent_workspace = CONTROL_UI_RUST_RENDERER_MARKERS
        ...
        && CONTROL_UI_STYLES_CSS.contains(":popover-open")
        && CONTROL_UI_STYLES_CSS.contains("prefers-reduced-transparency")
        && CONTROL_UI_STYLES_CSS.contains("forced-colors")
...
<html lang="en" dir="auto" data-theme="premium" data-theme-mode="light" data-rust-frontend-renderer="hepta-core::control_ui" data-no-js-frontend="true">
  ...
  <body data-view="chat" data-rust-rendered-control-ui="true" data-hepta-route-surface-first="false" data-control-ui-product-first="true" data-control-ui-primary-path="telegram-chat-shell" data-control-ui-telegram-shell="true" data-control-ui-top-design-referee="liquid-glass-2026-wcag22-320-reflow" data-control-ui-harsh-referee="2026-06-08-liquid-glass-menus-sidebars-scroll-search">
    ...
    .replace(
        "popovertarget=\"row-menu-ui-chat-agent\" aria-haspopup=\"menu\"",
        "popovertarget=\"row-menu-ui-chat-agent\" aria-haspopup=\"menu\" aria-controls=\"row-menu-ui-chat-agent\"",
    )
    .replace(
        "popovertarget=\"row-menu-task-queue\" aria-haspopup=\"menu\"",
        "popovertarget=\"row-menu-task-queue\" aria-haspopup=\"menu\" aria-controls=\"row-menu-task-queue\"",
    )
    .replace(
        "popovertarget=\"row-menu-operator-plane\" aria-haspopup=\"menu\"",
        "popovertarget=\"row-menu-operator-plane\" aria-haspopup=\"menu\" aria-controls=\"row-menu-operator-plane\"",
    )
    .replace(
        "popovertarget=\"command-palette\" aria-label=\"Open command palette\"",
        "popovertarget=\"command-palette\" aria-haspopup=\"dialog\" aria-controls=\"command-palette\" aria-label=\"Open command palette\"",
    )
    .replace(
        "popovertarget=\"thread-tools-popover\" data-control-ui-menu-trigger",
        "popovertarget=\"thread-tools-popover\" aria-haspopup=\"menu\" aria-controls=\"thread-tools-popover\" data-control-ui-menu-trigger",
    )
    .replace(
        "popovertarget=\"composer-tools-popover\" data-control-ui-menu-trigger",
        "popovertarget=\"composer-tools-popover\" aria-haspopup=\"menu\" aria-controls=\"composer-tools-popover\" data-control-ui-menu-trigger",
    )
    .replace(
        "data-chat-row-menu-item=\"pin\" role=\"menuitem\"",
        "data-chat-row-menu-item=\"pin\" autofocus role=\"menuitem\"",
    )
    .replace(
        "data-control-ui-menu-item=\"history\" href=",
        "data-control-ui-menu-item=\"history\" autofocus href=",
    )
    .replace(
        "id=\"chat-routing-mode\" class=",
        "id=\"chat-routing-mode\" autofocus class=",
    )
    .replace(
        "data-chat-composer-picker-search=\"artifact\" data-control-ui-composer-popover-search",
        "data-chat-composer-picker-search=\"artifact\" autofocus data-control-ui-composer-popover-search",
    )
    .replace(
        "data-chat-composer-picker-search=\"command\" data-control-ui-composer-popover-search",
        "data-chat-composer-picker-search=\"command\" autofocus data-control-ui-composer-popover-search",
    )
    .replace(
        "id=\"command-palette-input\" data-control-ui-command-palette-input",
        "id=\"command-palette-input\" autofocus data-control-ui-command-palette-input",
    )
    .replace(
        "data-control-ui-command-palette-surface=\"light-glass\" role=\"dialog\" aria-modal=\"true\"",
        "data-control-ui-command-palette-surface=\"light-glass\" role=\"dialog\" aria-modal=\"false\"",
    )
}
