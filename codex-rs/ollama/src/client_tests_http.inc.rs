    ...
    wiremock::Mock::given(wiremock::matchers::method("GET"))
        ...
        .respond_with(
            wiremock::ResponseTemplate::new(200)
                .set_body_json(serde_json::json!({"models": [{"name": "llama3.2:3b"}]})),
        )
        .mount(&server)
        .await;
...
async fn fetch_models_rejects_malformed_entry() {
    ...
    wiremock::Mock::given(wiremock::matchers::method("GET"))
        .and(wiremock::matchers::path("/api/tags"))
        .respond_with(
            wiremock::ResponseTemplate::new(200).set_body_json(serde_json::json!({"models": [{}]})),
        )
        .mount(&server)
        .await;
...
async fn fetch_version_rejects_non_success_and_bad_semver() {
    ...
    wiremock::Mock::given(wiremock::matchers::method("GET"))
        ...
        .respond_with(
            wiremock::ResponseTemplate::new(200)
                .set_body_json(serde_json::json!({"version": "not-semver"})),
        )
        .mount(&server)
        .await;
