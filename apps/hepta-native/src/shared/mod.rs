...
pub fn script_mod(vm: &mut ScriptVm) {
    ...
    // Register the concrete migration templates after the legacy graph and the
    // semantic v4 overrides, before downstream widgets consume compatibility
    // names such as RobrixTextInput.
