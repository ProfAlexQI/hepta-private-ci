...
pub const INVITE_RESPONSE_CONFIRMATION_COMPACT_LABEL: &str =
    "Invite response runs only after confirmation.";
        ...
        if let Event::Actions(actions) = event {
            ...
            if self.view.button(cx, ids!(cancel_button)).clicked(actions) {
                ...
                enqueue_popup_notification(
                    format!(
                        "Invite rejection confirmation opened for {}. {INVITE_RESPONSE_CONFIRMATION_COMPACT_LABEL}",
                        info.room_name_id()
                    ),
                    PopupKind::Info,
                    Some(3.0),
            ...
            if self.view.button(cx, ids!(accept_button)).clicked(actions) {
                ...
                enqueue_popup_notification(
                    format!(
                        "Invite accept confirmation opened for {}. {INVITE_RESPONSE_CONFIRMATION_COMPACT_LABEL}",
                        info.room_name_id()
                    ),
                    PopupKind::Info,
                    Some(3.0),
