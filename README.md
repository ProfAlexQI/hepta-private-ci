...
- Current machine pointer: `docs/architecture/HEPTA_CURRENT_PLAN.json`
...
- Active execution plan: `docs/architecture/HEPTA_ARCHITECTURE_CONVERGENCE_PLAN_V3.md`
- Gap ledger: `docs/architecture/HEPTA_ARCHITECTURE_GAP_LEDGER_V3.json`
- Document authority: `docs/architecture/HEPTA_DOCUMENT_AUTHORITY_INDEX_V2.json`
...
Change the active Plan and gap ledger together when package order or exit
criteria change.
...
generation, fencing token, and the exact grant digest. P0.7 adds a separately
signed start-time bootstrap and moves every physical boundary to current per-use
verification; neither source presence nor qualification activates authority.
