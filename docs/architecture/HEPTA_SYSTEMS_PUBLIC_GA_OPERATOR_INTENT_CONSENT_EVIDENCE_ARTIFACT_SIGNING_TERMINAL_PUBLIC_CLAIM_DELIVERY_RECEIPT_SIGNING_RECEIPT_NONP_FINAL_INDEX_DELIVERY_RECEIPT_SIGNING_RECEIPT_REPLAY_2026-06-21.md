...
This attachment consumes the terminal public claim delivery receipt artifact signing receipt signing receipt non-persistence final index and proves that the next artifact signing receipt signing receipt replay/idempotency target is present for this branch.
