...
The route gate validates the source audit/evidence denial gate, native route wiring, route/source parity 137/137, terminal coverage 277/277, the focused `codex-cli` native unit test, and optional live endpoint parity.
