...
- route/source coverage reaches 127/127;
- terminal preflight coverage reaches 267/267;
...
With `HEPTA_ROUTE_GATE_REQUIRE_LIVE_ENDPOINT=1`, the route gate also verifies the active gateway endpoint and requires route parity 127/127.
