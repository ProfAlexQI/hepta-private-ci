...
2. [`PAPER_TRACEABILITY.json`](PAPER_TRACEABILITY.json) — content-digested source artifacts, exact sentence locators, claim/non-claim hashes and separately owned Hepta extensions.
