...
> **Current global plan pointer (E.45 / 2026-08-27):**
> `OpenClaw/hepta-vnext-development-plan-final-2026-08-23.md#development-docs-sync-e45`
> (SHA-256 `f0a98ae0e6cb1ff3c4bb660bfe50ca921cda434926a755d127dcc7399c4a5620`).
> This contextual pointer does not rebind the stale inference parent or authorize model/NPU
> execution; implementation evidence remains `NOT_RUN` and unknown tuples fail closed.
