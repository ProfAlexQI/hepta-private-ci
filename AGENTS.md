...
- Do not add general product or user-facing documentation to the `docs/` folder. Hepta product documentation belongs outside this low-level Rust workspace. The exception is app-server API documentation, which is covered by the app-server guidance below.
...
- Prefer the utilities in `core_test_support::responses` when writing end-to-end Hepta tests.
